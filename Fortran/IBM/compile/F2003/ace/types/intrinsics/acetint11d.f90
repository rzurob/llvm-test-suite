...
!*  test the second half: verify that values are correctly rejected.  The
!*  test is successful if the programme does not compile.
!*
!* ====================================================================
...
program acetint11d
  ...
  iarr  = (/varying(1), varying(2.0), varying('3',1), varying(.true.), varying((1.0,1.0))/)
  rarr  = (/varying(1), varying(2.0), varying('3',1), varying(.true.), varying((1.0,1.0))/)
  darr  = (/varying(1), varying(2.0), varying('3',1), varying(.true.), varying((1.0,1.0))/)
  zarr  = (/varying(1), varying(2.0), varying('3',1), varying(.true.), varying((1.0,1.0))/)
  larr  = (/varying(1), varying(2.0), varying('3',1), varying(.true.), varying((1.0,1.0))/)
  charr = (/varying(1), varying(2.0), varying('3',1), varying(.true.), varying((1.0,1.0))/)

end program acetint11d
