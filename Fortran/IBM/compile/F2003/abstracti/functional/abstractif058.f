...
program abstractif058
   use ISO_C_BINDING, ONLY : C_PTR, C_F_POINTER
   use mxdtyia01
   use modop
   abstract interface
      function fun1ai(dt) bind(c)
         import dt1
         type(dt1) :: fun1ai, dt
      end function fun1ai
      function fun2ai(dt) bind(c)
         import dt1
         type(dt1), value :: dt
         type(dt1) :: fun2ai
      end function fun2ai
      function fun3ai(dtx,dty) bind(c)
         import dt1
         type(dt1), intent(in) :: dtx
         type(dt1), intent(out) :: dty
         type(dt1) :: fun3ai
      end function fun3ai
      function fun4ai(dtx,dty) bind(c)
         import dt1, C_PTR
         type(dt1), intent(in) :: dtx
         type(dt1), intent(out) :: dty
         type(C_PTR) :: fun4ai
   ...
   procedure (fun1ai) :: fun1
   procedure (fun2ai) :: fun2
   procedure (fun3ai) :: fun3
   procedure (fun4ai) :: fun4
