...
! %START
! %MAIN: YES
! %PRECMD: rm -f dtParamDummyValueC528_02.out
! %COMPOPTS:
! %GROUP: dtParamDummyValueC528_02.f
! %VERIFY: dtParamDummyValueC528_02.out:dtParamDummyValueC528_02.vf
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD:
...
!* =================================================================== *
!*                                                                     *
!* TEST CASE NAME             : dtParamDummyValueC528_02.f             *
!*                                                                     *
!* DATE                       : May 13, 2008                           *
!*                                                                     *
