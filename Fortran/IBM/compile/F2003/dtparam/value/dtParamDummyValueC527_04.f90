...
! %START
! %MAIN: YES
! %PRECMD: rm -f dtParamDummyValueC527_04.out
! %COMPOPTS:
! %GROUP: dtParamDummyValueC527_04.f
! %VERIFY: dtParamDummyValueC527_04.out:dtParamDummyValueC527_04.vf
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD:
...
!*                                                                     *
!* TEST CASE NAME             : dtParamDummyValueC527_04.f             *
!*                                                                     *
...
!*         specified, the VOLATILE attribute shall not be specified.   *
!*                                                                     *
!* STRUCTURE                  : MAIN                                   *
!*                                                                     *
!* EXECUTABLE                 : No                                     *
...
!***********************************************************************
      ...
      ! INTENT(OUT) attribute shall not be specified.
       ...
       subroutine sub(a,b1,b2,b3,c1,c2,c3,d1,d2,d3,d4,d5)
         ...
         volatile :: b2, d2, d3
         value :: c2, d2, d4
         type(dt), value, volatile :: a
         type(dt), value :: b1, b2, b3
         type(dt), volatile :: c1, c2, c3
