...
! %START
! %MAIN: YES
! %PRECMD: rm -f dtParamDummyValueC527_06.out
! %COMPOPTS:
! %GROUP: dtParamDummyValueC527_06.f
! %VERIFY: dtParamDummyValueC527_06.out:dtParamDummyValueC527_06.vf
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD:
...
!* =================================================================== *
!*                                                                     *
!* TEST CASE NAME             : dtParamDummyValueC527_06.f             *
!*                                                                     *
!* DATE                       : May 13, 2008                           *
!*                                                                     *
