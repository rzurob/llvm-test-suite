...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dfinal003k.f
!*  TEST CASE NAME             : type-bound procedure dfinal003k
!*
!*  PROGRAMMER                 : David Forster (derived from dfinal003 by Catherine Sun)
...
module m
    ...
    contains
       final :: finalizeChild !FE supress error message here since the parent is aleady in error
    end type
