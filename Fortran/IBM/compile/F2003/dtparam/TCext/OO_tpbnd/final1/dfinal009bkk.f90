...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dfinal009bkk.f
!*  TEST CASE NAME             : type-bound procedure dfinal009bkk
!*
!*  PROGRAMMER                 : David Forster (derived from dfinal009b by Catherine Sun)
...
contains
   subroutine finalChild(arg1)
      type(child(4,4)),intent(inout)  :: arg1 ! tcx: (4,4)
      pointer :: arg1
      print *, "finalizeChild"
   end subroutine
