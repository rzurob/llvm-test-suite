...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dfinal009ll.f
!*  TEST CASE NAME             : type-bound procedure dfinal009ll
!*
...
! type: child - added parameters (lchild) to invoke with (0,0) / declare with (*,*) - 3 changes
