...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dfinal009ak.f
!*  TEST CASE NAME             : type-bound procedure dfinal009ak
!*
!*  PROGRAMMER                 : David Forster (derived from dfinal009a by Catherine Sun)
...
contains
   subroutine finalChild(arg1)
      type(child(4)),intent(inout), allocatable :: arg1 ! tcx: (4)
      print *, "finalizeChild"
   end subroutine
