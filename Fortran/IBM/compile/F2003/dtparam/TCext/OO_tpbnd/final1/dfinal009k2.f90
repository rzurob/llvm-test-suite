...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dfinal009k2.f
!*  TEST CASE NAME             : type-bound procedure dfinal009k2
!*
...
! type: child - added parameters (kchild) to invoke with (4) / declare with (4) - 3 changes
