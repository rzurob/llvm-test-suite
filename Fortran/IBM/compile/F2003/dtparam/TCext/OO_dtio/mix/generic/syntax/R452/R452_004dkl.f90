...
!*  ===================================================================
!*
!*  TEST CASE NAME             : R452_004dkl
!*
!*  PROGRAMMER                 : David Forster (derived from R452_004d by Robert Ma)
...
module m
   ...
   type base (lbase_1) ! lbase_1=3
      ...
      contains
         ...
         generic, private, public :: read(unformatted) => read
         generic, public, public :: write(unformatted) => write
   end type
