...
!*  ===================================================================
!*
!*  TEST CASE NAME             : resolve007alll
!*
!*  PROGRAMMER                 : David Forster (derived from resolve007a by Robert Ma)
...
program resolve007alll
   use m

   interface write(unformatted)
      subroutine writebaseext (dtv, unit, iostat, iomsg) ! line 107
   ...
   open ( 1, file = 'resolve007alll.1', form='unformatted', access='sequential' )
