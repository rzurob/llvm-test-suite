...
!*  ===================================================================
!*
!*  TEST CASE NAME             : resolve002l
!*
!*  PROGRAMMER                 : David Forster (derived from resolve002 by Robert Ma)
...
program resolve002l
   ...
   allocate ( g1, source = gen3(3)('mno','pqr','stu') ) ! tcx: (3)

   open ( 1, file = 'resolve002l.1', form='formatted', access='sequential' )
   ...
   allocate (child(3):: c1 ) ! tcx: child(3)
   allocate (gen3(3)::  g1 ) ! tcx: gen3(3)
   rewind 1
   ...
   deallocate ( b1 )
   allocate ( b1, source = child(3)() ) ! tcx: (3)
   ...
   deallocate ( b1 )
   allocate ( b1, source = gen3(3)() ) ! tcx: (3)
...
! type: gen3 - added parameters () to invoke with (3) / declare with (*) - 6 changes
