...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArgCharctrstc006k
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArgCharctrstc006 by Robert Ma)
...
program dummyArgCharctrstc006k
   use m
   
   interface read(unformatted)
      subroutine readUnformatted (dtv, unit, iostat, iomsg)
         import base
         class(base(*)), intent(inout), OPTIONAL :: dtv     !<- defines OPTIONAL attribute here ! tcx: (*)
