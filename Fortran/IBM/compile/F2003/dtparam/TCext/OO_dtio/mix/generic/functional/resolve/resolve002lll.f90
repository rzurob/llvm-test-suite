...
program resolve002lll
   ...
   open ( 1, file = 'resolve002lll.1', form='formatted', access='sequential' )
...
! type: gen3 - added parameters (lgen31) to invoke with (3,3,3) / declare with (*,*,*) - 6 changes
