...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : fdtio500dkl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtio500d by Jim Xia)
...
!*
!*  DESCRIPTION                : DTIO generics (a test case testing the runtime
!                               error during DTIO that causes the program to
!                               terminate if the caller does not supply
!                               iostat= or err=)
...
module m
    ...
    type container (kcontainer_1) ! kcontainer_1=4
       integer, kind :: kcontainer_1
        type (base(kcontainer_1)), allocatable :: data ! tcx: (kcontainer_1)
    end type
end module
...
use m
    ...
    write (1)  container(4)(base(4)(null())) ! tcx: (4) ! tcx: (4)
