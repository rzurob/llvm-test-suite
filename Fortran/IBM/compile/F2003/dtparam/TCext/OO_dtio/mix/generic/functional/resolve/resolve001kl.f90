...
!*  ===================================================================
!*
!*  TEST CASE NAME             : resolve001kl
!*
!*  PROGRAMMER                 : David Forster (derived from resolve001 by Robert Ma)
...
program resolve001kl
   ...
   open ( 1, file = 'resolve001kl.1', form='formatted', access='sequential' )
