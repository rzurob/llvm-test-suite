...
!*
!*  PROGRAMMER                 : David Forster (derived from iounit002 by Robert Ma)
...
!*                               - do not specify io-unit in child data transfer statements
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
use m1
    ...
    character(3) :: temp
    read (iostat=iostat, iomsg=iomsg ) temp
...
use m1
    ...
    write (iostat=iostat, iomsg=iomsg ) dtv%getC()
