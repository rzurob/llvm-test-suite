...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fdtedit001dkl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtedit001d by Robert Ma)
...
use m
   ...
   open (1, file = 'fdtedit001dkl.1', form='formatted', access='sequential' )
