...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : fdtioC936_001d1kl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtioC936_001d1 by Jim Xia)
...
program fdtioC936_001d1kl
use m
    interface WRITE(FORMATTED)
        subroutine writePointFormatted (dtv, unit, iotype, v_list, iostat, iomsg)
        use m
            class (point(4)), intent(in) :: dtv  !<-- must use class keyword ! tcx: (4)
