...
! ftcx_dtp -qnol -qreuse=base /tstdev/OO_poly/intrinsics/reshape/functionReturn002.f
...
module m
    ...
    function func1()
        ...
        allocate(func1(20), SOURCE=(/ (Child(4)(i+1,i-1), i=1,20) /))
    end function
end module

program functionReturn002
use m
    print *, reshape(func1(), (/3,5/), (/Child(4)(22,33)/), (/1,2/))
end
