...
! ftcx_dtp -ql -qreuse=self /tstdev/F2003/asynchIO/statements/dtio/parentAsynchSpec01.f
...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : parentAsynchSpec01 - Derived-Type I/O
...
MODULE mBase
    ...
    INTERFACE read(unformatted)
        SUBROUTINE TBaseRead(obj, unit, iostat, iomsg)
            IMPORT tBase
            CLASS(tBase(*,4)), INTENT(inout) :: obj
            INTEGER, INTENT(in) :: unit
            INTEGER, INTENT(out) :: iostat
            CHARACTER(*), INTENT(inout) :: iomsg
...
PROGRAM parentAsynchSpec01
    ...
    TYPE(tBase(20,4)) :: baseObj2
    TYPE(tBase(20,4)) :: baseObj1 = tBase(20,4)(6543,2.109,(876.5,4.321))
