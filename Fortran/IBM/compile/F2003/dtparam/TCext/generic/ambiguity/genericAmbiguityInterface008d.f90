...
! ftcx_dtp -qnol /tstdev/F2003/generic/ambiguity/genericAmbiguityInterface008d.f
! opt variations: -ql
...
!*
!*  DESCRIPTION                : ambiguous but between interface and type bounds, external procs, with elemental, recursive and non-elemental
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
...
module binoperator
   ...
   type, extends(child1) :: gen2    ! (4)
   end type

   interface
      elemental type(base1(4)) function adda(a, b)
...
elemental subroutine assgn2(a, b)
   use assignment
   class(child3(4)), intent(out) :: a
...
program genericAmbiguityInterface008d
   use assignment
   use binoperator
