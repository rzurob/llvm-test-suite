...
! ftcx_dtp -qk -ql /tstdev/F2003/generic/ambiguity/genericAmbiguityTypeBound016d.f
...
!*                                  - one arg being unlimited polymorphic, the ambiguous tb has derived-type arg
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
...
module assignment
   ...
   type, extends(b12) :: c12(k4,n4)    ! (20,4,4,20)
       integer, kind :: k4
       integer, len  :: n4
   end type
   ...
   contains
      ...
      subroutine assgn2(a, b)
         class(b12(*,4)), intent(out) :: a
         type(c12(*,4,4,*)), intent(in)  :: b

      end subroutine

end module

program genericAmbiguityTypeBound016d
end program
