...
! ftcx_dtp -qnol /tstdev/F2003/generic/ambiguity/genericAmbiguityTypeBound020d.f
! opt variations: -ql
...
!*                                 (Child1) (Child2)
!*
!*                               - more ambiguity in this class hierarchy
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
...
program genericAmbiguityTypeBound020d
end program
