...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : C938IDSpec01d - WAIT() Statement
!*
...
!*  SECONDARY FUNCTIONS TESTED : Multiple ID= Specifiers
!*
...
PROGRAM C938IDSpec01d

    OPEN(8200, ASYNCHRONOUS='yes')

    WRITE(8200, ASYNCHRONOUS='yes', ID=ioID) 42

    WAIT(ID=iID, UNIT=8200, ID=ioID)

    CLOSE( 8200 )

END PROGRAM C938IDSpec01d
