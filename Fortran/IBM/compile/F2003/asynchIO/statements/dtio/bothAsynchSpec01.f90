...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : bothAsynchSpec01 - Derived-Type I/O
...
MODULE mBothAsynchSpec01
    ...
    INTERFACE write(unformatted)
        SUBROUTINE bothAsynchSpecWrite(obj, unit, iostat, iomsg)
            ...
            class(tBothAsynchSpec01), intent(in) :: obj
    ...
    INTERFACE read(unformatted)
        SUBROUTINE bothAsynchSpecRead(obj, unit, iostat, iomsg)
            import tBothAsynchSpec01
            class(tBothAsynchSpec01), intent(inout) :: obj
            integer, intent(in) :: unit
            integer, intent(out) :: iostat
            character(len = *), intent(inout) :: iomsg
...
PROGRAM bothAsynchSpec01
    ...
    type(tBothAsynchSpec01) :: bothIn
    type(tBothAsynchSpec01) :: bothOut = tBothAsynchSpec01(1234,5678)
