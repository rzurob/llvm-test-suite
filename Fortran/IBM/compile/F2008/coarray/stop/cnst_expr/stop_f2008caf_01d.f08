...
!*  sizeof, KIND, loop counters and constants
!*
!* ============================================================================
...
program main
   ...
   STOP numImagesI          ! - Error
   STOP 101                 ! - No error
   STOP LEN("numImagesI")   ! - No error
   STOP KIND(numImagesI)    ! - No error
   STOP numImagesC          ! - Error
   STOP 'C'                 ! - No error
   STOP LEN(numImagesC)     ! - No error
   STOP KIND('C')           ! - No error
