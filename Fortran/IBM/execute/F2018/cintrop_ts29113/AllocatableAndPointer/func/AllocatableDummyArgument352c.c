...
// Test 1: use the Fortran intrinsic "associated" to check association status before allocation/deallocation

   // calling the Fortran subroutine with a non-associated var and associate it using the allocate statement on the Fortran side
   value = -99;
...
// Test 2: Use the error recovery for allocate / deallocate 
   ...
   // calling the Fortran subroutine with a non-associated var and allocate it on the Fortran side
   value = 55;
