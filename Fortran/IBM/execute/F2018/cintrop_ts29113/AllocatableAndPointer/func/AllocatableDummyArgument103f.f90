...
!* ===================================================================
!*
!* TEST CASE TITLE              : AllocatableDummyArgument103f.f
!*
...
module mod
   ...
   interface
     subroutine sub_bind_c(N, M, A, B, C, D) bind(C)
       ...
       implicit none
       integer :: N, M
       integer(c_long), allocatable :: A(:,:), B(:,:), C(:,:), D(:,:,:,:,:,:,:,:,:,:)
...
program AllocatableDummyArgument103f 
   use iso_c_binding, only: c_long
   use mod
   implicit none
...
end program AllocatableDummyArgument103f
...
subroutine sub_bind_c(N, M, A, B, C, D) bind(C)
     ...
     interface
        subroutine sub_bind_c_ext(N, M, A1, B1, C1, D1) 
           ...
           integer :: N, M
           integer :: i, j, k
           integer(c_long), allocatable :: A1(:,:), B1(:,:), C1(:,:), D1(:,:,:,:,:,:,:,:,:,:)
           integer(c_long), allocatable :: A2(:,:), B2(:,:), C2(:,:), D2(:,:,:,:,:,:,:,:,:,:)
