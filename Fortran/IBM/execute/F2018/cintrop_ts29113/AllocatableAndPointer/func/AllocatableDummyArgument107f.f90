...
!* ===================================================================
!*
!* TEST CASE TITLE              : AllocatableDummyArgument107f.f
!*
...
program AllocatableDummyArgument107f 
   use iso_c_binding, only: c_int
   use mod
   implicit none
...
end program AllocatableDummyArgument107f
