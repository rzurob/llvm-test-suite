...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : AssumedType15f
!*
...
!*                               actual argument is scalar assumed type
!*
!**********************************************************************
...
module mod
  ...
  subroutine inner_mod_sub(c)
     type(*) :: c

  end subroutine inner_mod_sub

end module mod

program AssumedType15f
use mod
implicit none
