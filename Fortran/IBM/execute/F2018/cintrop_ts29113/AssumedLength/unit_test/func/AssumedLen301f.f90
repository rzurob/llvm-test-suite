...
!* ===================================================================
!*
!* TEST CASE TITLE              : AssumedLen301f.f
!*
...
!*
!*                                - type character(*)
!*                                - Dummy argument is an assumed_size array(rank=2)
...
Program AssumedLen 
 ...
 ! non-contig pointer array
 character(3), pointer :: c8(:)
 character(3), target :: t8(16) 
 ...
 ! c8
 do i = 1,16
   t8(i) = CHAR((i+1)/2+64) // CHAR((i+1)/2+64) // CHAR((i+1)/2+64)
 end do 
