...
!* ===================================================================
!*
!* TEST CASE TITLE              : AssumedLen401f.f
!*
...
Program main 
 interface
   ...
   subroutine sub_2(arg2) bind(c)
     character(:), allocatable :: arg2(..)
   end subroutine 
   subroutine sub_3(arg3) bind(c)
     character(:), allocatable :: arg3(:,:)
   end subroutine
   subroutine sub_4(arg4) bind(c)
     character(*) :: arg4(..)
   end subroutine
 end interface 
...
contains 
  subroutine sub_int1(arg2)
    character(3) :: arg2(2,*)
 !!---- actual argument for sub_4 is an assumed_size array
    call sub_4(arg2) 
  end subroutine
...
! Definition of sub_2 subroutine :
subroutine sub_2(arg2) bind(c)
  character(:), allocatable :: arg2(..)
  interface
   subroutine sub_1(arg1) bind(c)
  ...
  !!----- actual argument for sub_1 is an assumed_rank array 
end subroutine
