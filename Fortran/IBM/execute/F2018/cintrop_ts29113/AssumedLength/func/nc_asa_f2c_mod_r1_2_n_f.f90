...
!23456789012345678901234567890123456789012345678901234567890123456789012     
      ...
      module module1
        ...
        a1 = 'F2F2C'
        call check_f_to_f_to_c(a1, LEN(a1),4, SIZE(a1), 3)

        a1 = 'F2F2F'
        call check_f_to_f_to_f(a1, LEN(a1),4, SIZE(a1), 4)

        a1 = 'F2C2F'
        call check_f_to_c_to_f(a1, LEN(a1),4, SIZE(a1), 5)
      ...
      subroutine check_f_to_f(c_arg2, c_len, n,extent, test_no) bind(c)
        ...
        if(LBOUND(c_arg2,1) .NE. 2*n+1) then
