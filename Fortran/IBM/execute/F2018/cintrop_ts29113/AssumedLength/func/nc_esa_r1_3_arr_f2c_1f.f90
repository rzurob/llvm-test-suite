...
!23456789012345678901234567890123456789012345678901234567890123456789012     
      ...
      program assumed_lenght001
        ...
        interface
          subroutine check_f_to_c(c_arg1, c_len, test_no) bind(c)
            ...
            character(*), DIMENSION(c_len) :: c_arg1
        ...
        ! --Other attributes
         ...
         ! b) Deferred Shape array
          ...
          CHARACTER(5), PARAMETER :: v_arg18(4:*) = ["EIGHTEEN", "EIGHTEEN","EIGHTEEN", "EIGHTEEN","EIGHTEEN", "EIGHTEEN"]
          !"
          CHARACTER(*), PARAMETER :: v_arg19(4:*) = ["NINETEEN", "NINETEEN","NINETEEN", "NINETEEN", "NINETEEN","NINETEEN","NINETEEN", "NINETEEN", "NINETEEN"]
          !"
          character(10) v_arg22(10,10,10)
          character(12) v_arg23(12,12,12)
   
          character(11) v_arg24(11,11,11)
        ...
        call SUB22(1, v_arg22, "F2C")
        call SUB23(1, v_arg23, "F2C")
        ...
        call check_f_to_c((/ 'ONE', 'ONE', 'ONE', 'ONE', 'ONE' /), 3, 1)
      ...
      ! automatic array 
       ...
       FUNCTION func3() RESULT (v_char)
          character(12) v_char(12)
          v_char = "TWENTY_THREE"
       END FUNCTION func3
      end program
       FUNCTION func1 () RESULT (v_char)
          character(11) v_char(11)
          v_char = "TWENTY_FOUR"
       END FUNCTION func1
