...
!23456789012345678901234567890123456789012345678901234567890123456789012
      ...
      module module1
        interface
          ...
          module subroutine check_f_to_f(c_arg2, c_len,n, extent, test_no) bind(c)
            use, intrinsic :: iso_c_binding
            character(*) :: c_arg2(n:*)
            integer(C_INT) c_len, n, extent, test_no
          end subroutine
          module subroutine check_f_to_f_to_c(c_arg3, c_len,n, extent, test_no) bind(c)
            use, intrinsic :: iso_c_binding
            character(*) :: c_arg3(n:*)
            integer(C_INT) c_len,n, extent, test_no
          end subroutine
          module subroutine check_f_to_f_to_f(c_arg3, c_len,n, extent, test_no) bind(c)
            use, intrinsic :: iso_c_binding
            character(*) :: c_arg3(n:*)
            integer(C_INT) c_len,n, extent, test_no
          end subroutine
      ...
      program assumed_lenght001
        ...
        a1 = 'F2C__'
        call check_f_to_c(a1, LEN(a1), 5, SIZE(a1),1)

        a1 = 'F2F__'
        call check_f_to_f(a1, LEN(a1), 5, SIZE(a1), 2)
