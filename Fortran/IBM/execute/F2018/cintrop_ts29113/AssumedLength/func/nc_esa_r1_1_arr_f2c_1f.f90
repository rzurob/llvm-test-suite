...
!23456789012345678901234567890123456789012345678901234567890123456789012     
      ...
      program assumed_lenght001
        ...
        ! --DIMENSION attribute
          ...
          character(4), dimension(1) :: v_arg1
        ...
        ! --Other attributes
         ...
         ! c) Implied Shape Array (All elements in an array constructor must have the same type and type parameters)
          ...
          CHARACTER(5), PARAMETER :: v_arg18(4:*) = ["EIGHTEEN", "EIGHTEEN"]
          !"
          CHARACTER(*), PARAMETER :: v_arg19(4:*) = ["NINETEEN", "NINETEEN"]
          !"
        ...
        ! Initialization
          ...
          v_arg2(1,1) = "TWOS"
          v_arg3(1:5) = "THREES"
          v_arg4(1:1,1:1) = "FOURS"
          v_arg5(1:1, -5:-5, 1:1) = "FIVES  "
          v_arg6 = "SIXES"
          v_arg7 = "SEVENS"
          v_arg8 = "EIGHTS"
          v_arg9 = "NINES" 
