...
!23456789012345678901234567890123456789012345678901234567890123456789012
      ...
      program assumed_lenght001
        interface
          subroutine esa2r_1(c_arg1, i_len, d0_ext, d1_ext) bind(c)
            USE, INTRINSIC :: ISO_C_BINDING
            character(*), DIMENSION(5,5) :: c_arg1
            integer(C_INT) i_len, d0_ext, d1_ext
          end subroutine
        end interface

        ! Explicit Shape array
          character(3), dimension(5,5) :: v_arg1
        ...
        ! Deferred Shape array
          ...
          v_arg1 = "ABC"
          call esa2r_1(v_arg1, 3, 5, 5)

          v_arg2(1:5,1) = "ABCD"
          call esa2r_1(v_arg2, 4, 5, 5)

          v_arg3(1:2) = "FIVES"
          call esa2r_1(v_arg3(1:3), 5, 5, 5)

          v_arg4(1:5,1:5) = "SIXES1"
          call esa2r_1(v_arg4, 6, 5, 5)

          v_arg5(1:5, -5:-5, 1:1) = "SEVENS"
          call esa2r_1(v_arg5, 7, 5, 5)

          v_arg6 = "EIGHTS"
          call esa2r_1(v_arg6,8, 5, 5)

          v_arg7 = "NINES"
          call esa2r_1(v_arg7, 9, 5, 5)

          v_arg8 = "TEN"
          call esa2r_1(v_arg8, 3, 5, 5)

          v_arg9 = "TEST12"
          call esa2r_1(v_arg9, 6, 5, 5)
          call esa2r_1(v_arg1_2,6, 5, 5)
          ...
          call esa2r_1(v_arg11,6, 5, 5)
          call esa2r_1(v_arg12,6, 5, 5)
          call esa2r_1(v_arg13,7, 5, 5)

          allocate(v_arg14(8, -1:3, 5))
          v_arg14 = "TEST14"
          call esa2r_1(v_arg14, LEN(v_arg14), 5, 5 )

          allocate(v_arg15(10))
          v_arg15 = "TEST15"
          call esa2r_1(v_arg15, LEN(v_arg15), 5, 5)


          allocate(character(len=16) :: v_arg16(10,10))
          v_arg16 = "TEST"
          call esa2r_1(v_arg16, LEN(v_arg16), 5, 5)



           ! Implied Shape Array

          call esa2r_1(v_arg21,2, 5, 5)
          call esa2r_1(v_arg22,6, 5, 5)
      ...
      contains
       ...
       SUBROUTINE SUB4_1(ARRAY, L)
         CHARACTER(*) ARRAY(*)
         integer L
         call esa2r_1(ARRAY, L, 5,5)
       END SUBROUTINE

       SUBROUTINE SUB4_2(ARRAY)
         CHARACTER(5) ARRAY(*)
         call esa2r_1(ARRAY, 5, 5,5 )
       END SUBROUTINE


       SUBROUTINE SUB4_3(ARRAY)
         CHARACTER(10) ARRAY(2,*)
         call esa2r_1(ARRAY, 10, 5, 5)
       END SUBROUTINE
