...
!23456789012345678901234567890123456789012345678901234567890123456789012
      program assumed_lenght001
        ...
        interface
          subroutine asar2_1(c_arg1, n, d0_ext, arr_size) bind(c)
            USE, INTRINSIC :: ISO_C_BINDING
            character(*), DIMENSION(5,2:*) :: c_arg1
            integer(C_INT) n, d0_ext, d1_ext, arr_size
          end subroutine
        end interface

          ! Explicit Shape array
            ! Allowed attributes: DIMENSION
          ...
          v_arg1(1) = "ABC"
          call asar2_1(v_arg1, 3, 5, SIZE(v_arg1))

          v_arg2(1,1) = "ABCD"
          call asar2_1(v_arg2, 4, 5, SIZE(v_arg2))

          v_arg3(1:5) = "FIVES"
          print *, SIZE(v_arg3(1:5))

          call asar2_1(v_arg3(1:3),5, 5, SIZE(v_arg3))

          v_arg4(1:1,1:1) = "SIXES1"
          call asar2_1(v_arg4, 6,5, SIZE(v_arg4(1:1,1:1)))

          v_arg5(1:1, -5:-5, 1:1) = "SEVENS"
          call asar2_1(v_arg5, 7, 5, SIZE(v_arg5))

          v_arg6 = "EIGHTS"
          call asar2_1(v_arg6,8, 5, SIZE(v_arg6))

          v_arg7 = "NINES"
          call asar2_1(v_arg7, 9,5, SIZE(v_arg7))

          v_arg8 = "TEN"
          call asar2_1(v_arg8, 3,5, SIZE(v_arg8))

          v_arg9 = "TEST12"
          call asar2_1(v_arg9, 6,5,  SIZE(v_arg9))

          call asar2_1(v_arg1_2,6, 5, SIZE(v_arg1_2))
          ...
          call asar2_1(v_arg11,6,5, SIZE(v_arg11))
          call asar2_1(v_arg12,6,5, SIZE(v_arg12))
          call asar2_1(v_arg13,7,5, SIZE(v_arg12))
          ...
          v_arg14 = "TEST14"
          call asar2_1(v_arg14, 7,5,  SIZE(v_arg14))



          allocate(v_arg15(10))
          v_arg15 = "TEST15"
          call asar2_1(v_arg15, 7,5, SIZE(v_arg15))


          allocate(character(len=16) :: v_arg16(10,10))
          v_arg16 = "TEST"
          print *, LEN(v_arg16(1,1))
          call asar2_1(v_arg16, 4,5, SIZE(v_arg16))  !defect 103037



           ! Implied Shape Array

          call asar2_1(v_arg21,5,5, SIZE(v_arg21))
          call asar2_1(v_arg22,6,5,  SIZE(v_arg22))
      ...
      SUBROUTINE SUB2_1(X, Y)
       ...
       ! Do I need to check them in functions also?
