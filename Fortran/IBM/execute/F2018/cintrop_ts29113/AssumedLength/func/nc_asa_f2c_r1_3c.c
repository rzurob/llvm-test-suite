...
void check_f_to_f(CFI_cdesc_t* a, int *c_len, int *extent, int *test_no);
...
void check_f_to_c_to_f(CFI_cdesc_t* a, int *c_len, int * extent, int *test_no)
{
    check_f_to_f(a, c_len, extent, test_no);
    return;
}
