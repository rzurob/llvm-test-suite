...
!23456789012345678901234567890123456789012345678901234567890123456789012     
      ...
      program assumed_lenght001
        ...
        a1 = 'F2C__'         
        call check_f_to_c_in(a1,5)
        call check_f_to_f_in(a1,5)
        
         a1 = 'F2C__'
        call check_f_to_c_out(a1,5)
        call check_f_to_f_out(a1,5)

         a1 = 'F2C__'
        call check_f_to_c_inout(a1,5)
        call check_f_to_f_inout(a1,5)
