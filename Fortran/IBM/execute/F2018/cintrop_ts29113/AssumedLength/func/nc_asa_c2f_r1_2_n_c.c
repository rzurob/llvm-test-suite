...
void check_c_to_f(CFI_cdesc_t* a, int * c_len, int *n, int * extent, int *test_no);
void check_c_to_f_to_f(CFI_cdesc_t* a,int * c_len, int *n,int * extent, int *test_no);
void check_c_to_f_to_c(CFI_cdesc_t* a, int * c_len,int *n,int * extent, int *test_no);

int main()
{
    CFI_cdesc_t* a;
    int c_len, test_no, rc,n, extent; 
    char *p = "C2F__";
    ...
    extent = 5;
    n = 3;
    check_c_to_f(a, &c_len,&n, &extent, &test_no);
    ...
    extent = 5;
    n = 3;
    check_c_to_f_to_f(a, &c_len,&n,&extent, &test_no);   
    ...
    extent = 4;
    n = 3;
    check_c_to_f_to_c(a, &c_len, &n,&extent, &test_no); 
