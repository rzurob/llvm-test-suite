...
!23456789012345678901234567890123456789012345678901234567890123456789012
      ...
      program assumed_lenght001
        ...
        a1 = 'F2C__'
        call check_f_to_c(a1, LEN(a1), 6, SIZE(a1),1)

        a1 = 'F2F__'
        call check_f_to_f(a1, LEN(a1), 6, SIZE(a1), 2)

        a1 = 'F2F2C'
        call check_f_to_f_to_c(a1, LEN(a1),11, SIZE(a1), 3)

        a1 = 'F2F2F'
        call check_f_to_f_to_f(a1, LEN(a1),11, SIZE(a1), 4)

        a1 = 'F2C2F'
        call check_f_to_c_to_f(a1, LEN(a1),11, SIZE(a1), 5)
