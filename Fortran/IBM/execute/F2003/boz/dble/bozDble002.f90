...
program bozDble002
    ...
    0_4) /= transfer(REAL(B"11111111110011110000001100100001110101101111000110111001101001", &
    KIND(0.0D0)), 0_4)) error stop 1_4

    if (transfer(DBLE(O"407140357524563001666"), 0_4) /= &
    transfer(REAL(O"407140357524563001666",KIND(0.0D0)), 0_4)) &
    error stop 2_4
    ...
    0_4) /= transfer(REAL(B"111111111101111111111111111111111111111111111111111111111111111",&
    KIND(0.0D0)), 0_4)) error stop 4_4

    if (transfer(DBLE(O"777577777777777777777"), 0_4) /= &
    transfer(REAL(O"777577777777777777777",KIND(0.0D0)), 0_4)) &
    error stop 5_4
    ...
    transfer(REAL(B"1",KIND(0.0D0)), 0_4)) error stop 7_4

    if (transfer(DBLE(O"1"), 0_4) /= &
    transfer(REAL(O"1",KIND(0.0D0)), 0_4)) error stop 8_4

    if (transfer(DBLE(Z"1"), 0_4) /= &
    transfer(REAL(Z"1",KIND(0.0D0)), 0_4)) error stop 9_4
