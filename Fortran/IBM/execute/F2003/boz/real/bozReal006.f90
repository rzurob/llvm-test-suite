...
program bozReal006
    ...
    if (transfer(REAL(Z"7FEFFFFFFFFFFFFF"), 0_8) /= Z"7FEFFFFFFFFFFFFF") &
    error stop 6_4
    ...
    !Test Kind Value
    if (KIND(REAL(B"111111100111100000011001000010", 8)) /= 8) &
    error stop 10_4

    if (KIND(REAL(O"10432657462", 8)) /= 8) error stop 11_4
    if (KIND(REAL(Z"4A02F53B", 8)) /= 8) error stop 12_4


    if (KIND(REAL(B"1111111011111111111111111111101", 8)) /= 8) &
    error stop 13_4

    if (KIND(REAL(O"17737777775", 8)) /= 8) error stop 14_4
    if (KIND(REAL(Z"7F7FFFFD", 8)) /= 8) error stop 15_4


    if (KIND(REAL(B"1", 8)) /= 8) error stop 16_4
    if (KIND(REAL(O"1", 8)) /= 8) error stop 17_4
    if (KIND(REAL(Z"1", 8)) /= 8) error stop 18_4
