...
program bozCmplx001
    ...
    b4 = CMPLX(B"111111100111100000011001000010")
    o4 = CMPLX(O"10432657462")
    z4 = CMPLX(Z"4A02F53B")
    ...
    if (transfer(aimag(b4), 0_4) /= 0.0) error stop 4_4
    if (transfer(aimag(o4), 0_4) /= 0.0) error stop 5_4
    if (transfer(aimag(z4), 0_4) /= 0.0) error stop 6_4


    !Upper Bound
    b4 = CMPLX(B"1111111011111111111111111111101")
    ...
    if (transfer(aimag(b4), 0_4) /= 0.0) error stop 10_4
    if (transfer(aimag(o4), 0_4) /= 0.0) error stop 11_4
    if (transfer(aimag(z4), 0_4) /= 0.0) error stop 12_4
    ...
    if (transfer(aimag(b4), 0_4) /= 0.0) error stop 16_4
    if (transfer(aimag(o4), 0_4) /= 0.0) error stop 17_4
    if (transfer(aimag(z4), 0_4) /= 0.0) error stop 18_4
