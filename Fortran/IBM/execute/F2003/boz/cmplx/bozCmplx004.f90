...
program bozCmplx004
    ...
    b8 = cmplx(B"11111111110011110000001100100001110101101111000110111001101001")
    o8 = cmplx(O"407140357524563001666")
    z8 = cmplx(Z"42B383C9B0D69ED0")
    ...
    !Upper Bound
    b8 = cmplx(B"111111111101111111111111111111111111111111111111111111111111111")
    o8 = cmplx(O"777577777777777777777")
    z8 = cmplx(Z"7FEFFFFFFFFFFFFF")
    ...
    !Test Kind Value
    if (KIND(CMPLX(B"11111111110011110000001100100001110101101111000110111001101001")) /= 8) &
    error stop 19_4

    if (KIND(CMPLX(O"407140357524563001666")) /= 8) error stop 20_4
    if (KIND(CMPLX(Z"42B383C9B0D69ED0")) /= 8) error stop 21_4

    if (KIND(CMPLX(B"111111111101111111111111111111111111111111111111111111111111111")) /= 8) &
    error stop 22_4

    if (KIND(CMPLX(O"777577777777777777777")) /= 8) error stop 23_4
    if (KIND(CMPLX(Z"7FEFFFFFFFFFFFFF")) /= 8) error stop 24_4

    if (KIND(CMPLX(B"1")) /= 8) error stop 25_4
    if (KIND(CMPLX(O"1")) /= 8) error stop 26_4
    if (KIND(CMPLX(Z"1")) /= 8) error stop 27_4
