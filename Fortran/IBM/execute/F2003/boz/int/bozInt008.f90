...
program bozInt008
      ...
      8) /= 8993291374322636141_8) error stop 1_4

      if (INT(O'763164555550005352555', 8) /= 8993291374322636141_8) &
      error stop 2_4

      if (INT(Z'7CCE96DB4015D56D', 8) /= 8993291374322636141_8) error stop 3_4
      if (INT(B'0111110011001110100101101101101101000000000101011101010101101101') &
      ...
      b8 = INT(B'0111110011001110100101101101101101000000000101011101010101101101', 8)
      o8 = INT(O'763164555550005352555', 8)
      z8 = INT(Z'7CCE96DB4015D56D', 8)

      if (b8 /= 8993291374322636141_8) error stop 7_4
      if (o8 /= 8993291374322636141_8) error stop 8_4
      if (z8 /= 8993291374322636141_8) error stop 9_4
      if (b8 /= B'0111110011001110100101101101101101000000000101011101010101101101') &
      error stop 10_4
      ...
      if (KIND(INT(O'763164555550005352555', 8)) /= 8) error stop 17_4
      if (KIND(INT(Z'7CCE96DB4015D56D', 8)) /= 8) error stop 18_4
