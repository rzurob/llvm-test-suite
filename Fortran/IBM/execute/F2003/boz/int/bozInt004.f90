...
program bozInt004
      ...
      ! Four Bytes
      if (INT(B'1011110001011001101010011111011', 4) /= 1579996411) &
      error stop 1_4

      if (INT(O'13613152373', 4) /= 1579996411) error stop 2_4
      if (INT(Z'5E2CD4FB', 4) /= 1579996411) error stop 3_4
      ...
      b4 = INT(B'1011110001011001101010011111011', 4)
      o4 = INT(O'13613152373', 4)
      z4 = INT(Z'5E2CD4FB', 4)
      ...
      if (KIND(INT(B'1011110001011001101010011111011', 4)) /= 4) &
      error stop 13_4

      if (KIND(INT(O'13613152373', 4)) /= 4) error stop 14_4
      if (KIND(INT(Z'5E2CD4FB', 4)) /= 4) error stop 15_4
