...
program valueScalarAllocatableComponent006
   ...
   allocate ( b1, source = base ( (/ inner(100), inner(200), inner(300), inner(400) /) ) )
   call foo ( b1 )

   ! b1 is undefined

   allocate ( b1, source = base ( (/ cinner( 1001, 2001 ), cinner( 1002, 2002 ), cinner( 1003, 2003 ), cinner( 1004, 2004 ), cinner( 1005, 2005 ) /) ) )
   call foo ( b1 )
