/*
        C code for testcase "fxisob14.f" and "fxisob15.f"
*/
...
long fnt7a(const struct dt0 *dt) {
...
long fnt8a(const struct dt0 dt) {
...
long fnt9a(const struct dt1 *dt) {
...
long fnt10a(const struct dt1 dt) {
...
long fnt11a(const struct dt2 *dt) {
...
long fnt12a(const struct dt2 dt) {
