...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa00.presh fxisob08 cxisob08
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
program fxisob08
   ...
   interface
      ...
      integer(C_LONG) function fnt2a(a,b)
         use ISO_C_BINDING
         integer(C_LONG), intent(in) :: a(5)
         integer(C_LONG_LONG), intent(in) :: b(5)
      end function fnt2a
