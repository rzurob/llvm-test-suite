...
/*
        C code for testcase "fxisob20b.f" and "fxisob21b.f"
*/
...
long fnt7a(const struct dtd0 *dt) {
...
long fnt8a(const struct dtd0 dt) {
...
long fnt9a(const struct dtd1 *dt) {
...
long fnt10a(const struct dtd1 dt) {
...
long fnt11a(const struct dtd2 *dt) {
...
long fnt12a(const struct dtd2 dt) {
