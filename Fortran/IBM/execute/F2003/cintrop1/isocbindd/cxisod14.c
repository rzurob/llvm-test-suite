/*
        C code for testcase "fxisod14.f" and "fxisod15.f"
*/
...
int32_t fnt7a(const struct dt0 *dt) {
...
int32_t fnt8a(const struct dt0 dt) {
...
int32_t fnt9a(const struct dt1 *dt) {
...
int32_t fnt10a(const struct dt1 dt) {
...
int32_t fnt11a(const struct dt2 *dt) {
...
int32_t fnt12a(const struct dt2 dt) {
