/*
        C code for testcase "fxisoc14.f" and "fxisoc15.f"
*/
...
int8_t fnt7a(const struct dt0 *dt) {
...
int8_t fnt8a(const struct dt0 dt) {
...
int8_t fnt9a(const struct dt1 *dt) {
...
int8_t fnt10a(const struct dt1 dt) {
...
int8_t fnt11a(const struct dt2 *dt) {
...
int8_t fnt12a(const struct dt2 dt) {
