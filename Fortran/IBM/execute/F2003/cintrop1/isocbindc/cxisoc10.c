...
/*
        C code for testcase "fxisoc10.f" and "fxisoc11.f"
*/
...
void sub2a(const int8_t *a, const int16_t *b) {
   int i;
...
void sub5(int8_t aa[][10], int16_t bb[][10]) {
   int i, j;
...
void sub6(int8_t aa[][10], int16_t bb[][10]) {
   int i, j;
...
void sub6a(const int8_t aa[][10], const int16_t bb[][10]) {
   int i, j;
...
void sub7(int8_t aa[][10], int16_t bb[][10]) {
   int i, j;
...
void sub8(int8_t aa[][10], int16_t bb[][10]) {
   int i, j;
