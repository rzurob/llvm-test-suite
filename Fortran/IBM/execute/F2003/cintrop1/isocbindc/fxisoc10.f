...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa00.presh fxisoc10 cxisoc10
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
program fxisoc10
   ...
   integer(C_INT8_T) :: a(5), aa(10,5), ret
   integer(C_INT16_T) :: b(5), bb(10,5)
   integer i, j
...
end program fxisoc10

subroutine initarr1d(x,y)
   use ISO_C_BINDING

   integer(C_INT8_T) :: x(5)
   integer(C_INT16_T) :: y(5)
...
subroutine initarr2d(xx,yy)
   ...
   integer(C_INT8_T) :: xx(10,5)
   integer(C_INT16_T) :: yy(10,5)
