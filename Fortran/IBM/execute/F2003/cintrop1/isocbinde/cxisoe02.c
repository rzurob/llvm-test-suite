...
/*
        C code for testcase "fxisoe02.f" and "fxisoe03.f"
*/
...
int_least8_t fnt5(const int_least8_t *a, const int_least16_t *b) {
...
int_least8_t fnt6(const int_least8_t a, const int_least16_t b) {
