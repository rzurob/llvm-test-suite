...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa00.presh fxisoe09 cxisoe08
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
module mxisob09
   interface
      ...
      integer(C_INT_LEAST8_T) function fnt2a(a,b)
         use ISO_C_BINDING
         integer(C_INT_LEAST8_T), intent(in) :: a(5)
         integer(C_INT_LEAST16_T), intent(in) :: b(5)
      end function fnt2a
      ...
      integer(C_INT_LEAST8_T) function fnt6a(aa,bb)
         use ISO_C_BINDING
         integer(C_INT_LEAST8_T), intent(in) :: aa(10,5)
         integer(C_INT_LEAST16_T), intent(in) :: bb(10,5)
      end function fnt6a
