...
/*
        C code for testcase "fxisof04.f" and "fxisof05.f"
*/
...
void sub5(const int_least32_t *a, const int_least64_t *b) {
...
void sub6(const int_least32_t a, const int_least64_t b) {
