...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa01.presh fxisop26
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 9
   ...
   if ( dtb%a /= 5.0q0 ) error stop 48
   if ( dtb%d0%a /= 5.0q0 ) error stop 50
...
!! Test 11
   ...
   if ( dtc%a /= 5.0q0 ) error stop 56
   if ( dtc%d1%a /= 5.0q0 ) error stop 58
   if ( dtc%d1%d0%a /= 5.0q0 ) error stop 60
...
!! Test 12
   ...
   if ( dtc%a /= 5.0q0 ) error stop 62
   if ( dtc%d1%a /= 5.0q0 ) error stop 64
   if ( dtc%d1%d0%a /= 5.0q0 ) error stop 66
...
!! Test 14
   ...
   if ( dtb%a /= 10.0q0 ) error stop 70
   if ( dtb%d0%a /= 10.0q0 ) error stop 72
...
!! Test 15
   ...
   if ( dtc%a /= 10.0q0 ) error stop 74
   if ( dtc%d1%a /= 10.0q0 ) error stop 76
   if ( dtc%d1%d0%a /= 10.0q0 ) error stop 78
...
real(16) function fnt3(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 84
   if ( dt%d0%a /= 5.0q0 ) error stop 86
...
real(16) function fnt4(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 88
   if ( dt%d0%a /= 5.0q0 ) error stop 90
...
real(16) function fnt5(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 92
   if ( dt%d1%a /= 5.0q0 ) error stop 94
   if ( dt%d1%d0%a /= 5.0q0 ) error stop 96
...
real(16) function fnt6(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 98
   if ( dt%d1%a /= 5.0q0 ) error stop 100
   if ( dt%d1%d0%a /= 5.0q0 ) error stop 102
...
real(16) function fnt9(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 108
   if ( dt%d0%a /= 5.0q0 ) error stop 110
...
real(16) function fnt10(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 112
   if ( dt%d0%a /= 5.0q0 ) error stop 114
...
real(16) function fnt11(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 116
   if ( dt%d1%a /= 5.0q0 ) error stop 118
   if ( dt%d1%d0%a /= 5.0q0 ) error stop 120
...
real(16) function fnt12(dt) bind(c)
   ...
   if ( dt%a /= 5.0q0 ) error stop 122
   if ( dt%d1%a /= 5.0q0 ) error stop 124
   if ( dt%d1%d0%a /= 5.0q0 ) error stop 126
