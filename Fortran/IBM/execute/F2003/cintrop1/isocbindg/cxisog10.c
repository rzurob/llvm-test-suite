...
/*
        C code for testcase "fxisog10.f" and "fxisog11.f"
*/
...
void sub2a(const int_fast8_t *a, const intmax_t *b) {
   int i;
...
void sub5(int_fast8_t aa[][10], intmax_t bb[][10]) {
   int i, j;
...
void sub6(int_fast8_t aa[][10], intmax_t bb[][10]) {
   int i, j;
...
void sub6a(const int_fast8_t aa[][10], const intmax_t bb[][10]) {
   int i, j;
...
void sub7(int_fast8_t aa[][10], intmax_t bb[][10]) {
   int i, j;
...
void sub8(int_fast8_t aa[][10], intmax_t bb[][10]) {
   int i, j;
