...
int main() {
   ...
   int_fast8_t fnt1(int_fast8_t *, intmax_t *);
   int_fast8_t fnt2(int_fast8_t *, intmax_t *);
   int_fast8_t fnt2a(const int_fast8_t *, const intmax_t *);
   int_fast8_t fnt3(int_fast8_t *, intmax_t *);
   int_fast8_t fnt4(int_fast8_t *, intmax_t *);
   int_fast8_t fnt5(int_fast8_t [], intmax_t []);
   int_fast8_t fnt6(int_fast8_t [], intmax_t []);
   int_fast8_t fnt6a(const int_fast8_t [], const intmax_t []);
   int_fast8_t fnt7(int_fast8_t [], intmax_t []);
   int_fast8_t fnt8(int_fast8_t [], intmax_t []);
