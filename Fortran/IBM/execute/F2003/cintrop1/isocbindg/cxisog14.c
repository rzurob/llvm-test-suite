/*
        C code for testcase "fxisog14.f" and "fxisog15.f"
*/
...
int_fast8_t fnt1(struct dt0 *dt) {
...
int_fast8_t fnt2(struct dt0 dt) {
...
int_fast8_t fnt3(struct dt1 *dt) {
...
int_fast8_t fnt4(struct dt1 dt) {
...
int_fast8_t fnt5(struct dt2 *dt) {
...
int_fast8_t fnt6(struct dt2 dt) {
...
int_fast8_t fnt7(struct dt0 *dt) {
...
int_fast8_t fnt7a(const struct dt0 *dt) {
...
int_fast8_t fnt8(struct dt0 dt) {
...
int_fast8_t fnt8a(const struct dt0 dt) {
...
int_fast8_t fnt9(struct dt1 *dt) {
...
int_fast8_t fnt9a(const struct dt1 *dt) {
...
int_fast8_t fnt10(struct dt1 dt) {
...
int_fast8_t fnt10a(const struct dt1 dt) {
...
int_fast8_t fnt11(struct dt2 *dt) {
...
int_fast8_t fnt11a(const struct dt2 *dt) {
...
int_fast8_t fnt12(struct dt2 dt) {
...
int_fast8_t fnt12a(const struct dt2 dt) {
...
int_fast8_t fnt13(struct dt0 *dt) {
...
int_fast8_t fnt14(struct dt1 *dt) {
...
int_fast8_t fnt15(struct dt2 *dt) {
