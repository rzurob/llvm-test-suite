...
int main() {
   ...
   void sub2a(const float *, const double *);
   void sub3(float *, double *);
   void sub4(float *, double *);
   void sub5(float [], double []);
   void sub6(float [], double []);
   void sub6a(const float [], const double []);
   void sub7(float [], double []);
   void sub8(float [], double []);
