...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrison00.presh fxisoo12 cxisoo12
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt1(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 20
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt2(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 22
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt3(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 24
   if ( dt%d0%a /= (5.0d0,5.0d0) ) error stop 26
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt4(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 28
   if ( dt%d0%a /= (5.0d0,5.0d0) ) error stop 30
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt5(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 32
   if ( dt%d1%a /= (5.0d0,5.0d0) ) error stop 34
   if ( dt%d1%d0%a /= (5.0d0,5.0d0) ) error stop 36
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt6(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 38
   if ( dt%d1%a /= (5.0d0,5.0d0) ) error stop 40
   if ( dt%d1%d0%a /= (5.0d0,5.0d0) ) error stop 42
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt7(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 44
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt7a(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 46
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt8(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 48
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt8a(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 50
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt9(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 52
   if ( dt%d0%a /= (5.0d0,5.0d0) ) error stop 54
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt9a(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 56
   if ( dt%d0%a /= (5.0d0,5.0d0) ) error stop 58
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt10(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 60
   if ( dt%d0%a /= (5.0d0,5.0d0) ) error stop 62
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt10a(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 64
   if ( dt%d0%a /= (5.0d0,5.0d0) ) error stop 66
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt11(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 68
   if ( dt%d1%a /= (5.0d0,5.0d0) ) error stop 70
   if ( dt%d1%d0%a /= (5.0d0,5.0d0) ) error stop 72
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt11a(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 74
   if ( dt%d1%a /= (5.0d0,5.0d0) ) error stop 76
   if ( dt%d1%d0%a /= (5.0d0,5.0d0) ) error stop 78
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt12(dt) bind(c)
   ...
   if ( dt%d1%a /= (5.0d0,5.0d0) ) error stop 82
   if ( dt%d1%d0%a /= (5.0d0,5.0d0) ) error stop 84
...
complex(C_LONG_DOUBLE_COMPLEX) function fnt12a(dt) bind(c)
   ...
   if ( dt%a /= (5.0d0,5.0d0) ) error stop 86
   if ( dt%d1%a /= (5.0d0,5.0d0) ) error stop 88
   if ( dt%d1%d0%a /= (5.0d0,5.0d0) ) error stop 90
