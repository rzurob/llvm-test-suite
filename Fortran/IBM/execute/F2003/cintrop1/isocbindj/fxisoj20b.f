...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa00.presh fxisoj20b cxisoj20b
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
module mxisob20b
   ...
   type, bind(c) :: dtd0
      integer(C_SIZE_T) :: a(10,5)
      integer(C_INTPTR_T) :: b(6,3)
   end type
...
program fxisoj20b
   ...
   interface
      integer(C_SIZE_T) function fnt1(dt) bind(c)
         use mxisob20b
         type(dtd0), intent(inout) :: dt
      end function fnt1
      integer(C_SIZE_T) function fnt2(dt) bind(c)
         use mxisob20b
         type(dtd0), value :: dt
      end function fnt2
      integer(C_SIZE_T) function fnt3(dt) bind(c)
         use mxisob20b
         type(dtd1), intent(inout) :: dt
      end function fnt3
      integer(C_SIZE_T) function fnt4(dt) bind(c)
         use mxisob20b
         type(dtd1), value :: dt
      end function fnt4
      integer(C_SIZE_T) function fnt5(dt) bind(c)
         use mxisob20b
         type(dtd2), intent(inout) :: dt
      end function fnt5
      integer(C_SIZE_T) function fnt6(dt) bind(c)
         use mxisob20b
         type(dtd2), value :: dt
      end function fnt6
      integer(C_SIZE_T) function fnt7(dt) bind(c)
         use mxisob20b
         type(dtd0), intent(in) :: dt
      end function fnt7
      integer(C_SIZE_T) function fnt7a(dt) bind(c)
         use mxisob20b
         type(dtd0), intent(in) :: dt
      end function fnt7a
      integer(C_SIZE_T) function fnt8(dt) bind(c)
         use mxisob20b
         type(dtd0), intent(in), value :: dt
      end function fnt8
      integer(C_SIZE_T) function fnt8a(dt) bind(c)
         use mxisob20b
         type(dtd0), intent(in), value :: dt
      end function fnt8a
      integer(C_SIZE_T) function fnt9(dt) bind(c)
         use mxisob20b
         type(dtd1), intent(in) :: dt
      end function fnt9
      integer(C_SIZE_T) function fnt9a(dt) bind(c)
         use mxisob20b
         type(dtd1), intent(in) :: dt
      end function fnt9a
      integer(C_SIZE_T) function fnt10(dt) bind(c)
         use mxisob20b
         type(dtd1), intent(in), value :: dt
      end function fnt10
      integer(C_SIZE_T) function fnt10a(dt) bind(c)
         use mxisob20b
         type(dtd1), intent(in), value :: dt
      end function fnt10a
      integer(C_SIZE_T) function fnt11(dt) bind(c)
         use mxisob20b
         type(dtd2), intent(in) :: dt
      end function fnt11
      integer(C_SIZE_T) function fnt11a(dt) bind(c)
         use mxisob20b
         type(dtd2), intent(in) :: dt
      end function fnt11a
      integer(C_SIZE_T) function fnt12(dt) bind(c)
         use mxisob20b
         type(dtd2), intent(in), value :: dt
      end function fnt12
      integer(C_SIZE_T) function fnt12a(dt) bind(c)
         use mxisob20b
         type(dtd2), intent(in), value :: dt
      end function fnt12a
      integer(C_SIZE_T) function fnt13(dt) bind(c)
         use mxisob20b
         type(dtd0), intent(out) :: dt
      end function fnt13
      integer(C_SIZE_T) function fnt14(dt) bind(c)
         use mxisob20b
         type(dtd1), intent(out) :: dt
      end function fnt14
      integer(C_SIZE_T) function fnt15(dt) bind(c)
         use mxisob20b
