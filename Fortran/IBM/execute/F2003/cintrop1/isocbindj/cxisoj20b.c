...
/*
        C code for testcase "fxisoj20b.f" and "fxisoj21b.f"
*/
...
size_t fnt7a(const struct dtd0 *dt) {
...
size_t fnt8a(const struct dtd0 dt) {
...
size_t fnt9a(const struct dtd1 *dt) {
...
size_t fnt10a(const struct dtd1 dt) {
...
size_t fnt11a(const struct dtd2 *dt) {
...
size_t fnt12a(const struct dtd2 dt) {
