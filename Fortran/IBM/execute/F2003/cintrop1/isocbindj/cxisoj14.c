/*
        C code for testcase "fxisoj14.f" and "fxisoj15.f"
*/
...
size_t fnt7a(const struct dt0 *dt) {
...
size_t fnt8a(const struct dt0 dt) {
...
size_t fnt9a(const struct dt1 *dt) {
...
size_t fnt10a(const struct dt1 dt) {
...
size_t fnt11a(const struct dt2 *dt) {
...
size_t fnt12a(const struct dt2 dt) {
