...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa00.presh fxisoj08 cxisoj08
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
program fxisoj08
   ...
   interface
      ...
      integer(C_SIZE_T) function fnt2(a,b)
         use ISO_C_BINDING
         integer(C_SIZE_T), intent(in) :: a(5)
         integer(C_INTPTR_T), intent(in) :: b(5)
      end function fnt2
      integer(C_SIZE_T) function fnt2a(a,b)
         use ISO_C_BINDING
         integer(C_SIZE_T), intent(in) :: a(5)
         integer(C_INTPTR_T), intent(in) :: b(5)
      end function fnt2a
      integer(C_SIZE_T) function fnt3(a,b)
         use ISO_C_BINDING
         integer(C_SIZE_T), intent(inout) :: a(5)
         integer(C_INTPTR_T), intent(inout) :: b(5)
      end function fnt3
      integer(C_SIZE_T) function fnt4(a,b)
         use ISO_C_BINDING
         integer(C_SIZE_T), intent(out) :: a(5)
         integer(C_INTPTR_T), intent(out) :: b(5)
      end function fnt4
      integer(C_SIZE_T) function fnt5(aa,bb)
         use ISO_C_BINDING
         integer(C_SIZE_T) :: aa(10,5)
         integer(C_INTPTR_T) :: bb(10,5)
      end function fnt5
      integer(C_SIZE_T) function fnt6(aa,bb)
         use ISO_C_BINDING
         integer(C_SIZE_T), intent(in) :: aa(10,5)
         integer(C_INTPTR_T), intent(in) :: bb(10,5)
      end function fnt6
      integer(C_SIZE_T) function fnt6a(aa,bb)
         use ISO_C_BINDING
         integer(C_SIZE_T), intent(in) :: aa(10,5)
         integer(C_INTPTR_T), intent(in) :: bb(10,5)
      end function fnt6a
      integer(C_SIZE_T) function fnt7(aa,bb)
         use ISO_C_BINDING
         integer(C_SIZE_T), intent(inout) :: aa(10,5)
         integer(C_INTPTR_T), intent(inout) :: bb(10,5)
      end function fnt7
      integer(C_SIZE_T) function fnt8(aa,bb)
         use ISO_C_BINDING
   ...
   integer(C_SIZE_T) :: a(5), aa(10,5), ret
   integer(C_INTPTR_T) :: b(5), bb(10,5)
   integer i, j
...
end program fxisoj08

subroutine initarr1d(x,y)
   use ISO_C_BINDING

   integer(C_SIZE_T) :: x(5)
   integer(C_INTPTR_T) :: y(5)
...
subroutine initarr2d(xx,yy)
   ...
   integer(C_SIZE_T) :: xx(10,5)
   integer(C_INTPTR_T) :: yy(10,5)
