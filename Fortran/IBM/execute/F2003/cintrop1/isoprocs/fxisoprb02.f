...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa00.presh fxisoprb02 cxisoprb02
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
!! Test 2
   ...
   do i = 1, DIMT
      do j = 1, DIMB
         if ( pb(i)%b(j) /= real(j+1,C_DOUBLE) ) error stop 42
      end do
   end do
...
!! Test 3
   ...
   do i = 1, DIMT
      do j = 1, DIMT
         do k = 1, DIMC
            do l = 1, DIMC
               dtc(i,j)%c(k,l) = real(k+l,C_DOUBLE)
            end do
         end do
      end do
   end do
   ...
   do i = 1, DIMT
      do j = 1, DIMT
         do k = 1, DIMC
            do l = 1, DIMC
               if ( pc(i,j)%c(k,l) /= real(k+l+1,C_DOUBLE) ) error stop 54
            end do
         end do
      end do
   end do
...
!! Test 6
   ...
   do i = 1, DIMT
      do j = 1, DIMT
         do k = 1, DIMC
            do l = 1, DIMC
               dtcl(i,j)%c(k,l) = real(k+l,C_DOUBLE)
            end do
         end do
      end do
   end do
