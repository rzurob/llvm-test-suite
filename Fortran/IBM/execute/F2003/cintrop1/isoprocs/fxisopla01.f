...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoo00.presh fxisopla01 cxisopla01
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 1
   ...
   if ( pa%a .neqv. .false. ) error stop 30
...
!! Test 2
   ...
   do i = 1, DIMB
      if ( pb%b(i) .neqv. .false. ) error stop 42
   end do
...
!! Test 3
   ...
   do i = 1, DIMC
      do j = 1, DIMC
         if ( pc%c(i,j) .neqv. .false. ) error stop 54
      end do
   end do
...
!! Test 4
   ...
   if ( pa%a .neqv. .false. ) error stop 66
...
!! Test 5
   ...
   do i = 1, DIMB
      if ( pb%b(i) .neqv. .false. ) error stop 78
   end do
...
!! Test 6
   ...
   do i = 1, DIMC
      do j = 1, DIMC
         if ( pc%c(i,j) .neqv. .false. ) error stop 90
      end do
   end do

end program fxisopla01
