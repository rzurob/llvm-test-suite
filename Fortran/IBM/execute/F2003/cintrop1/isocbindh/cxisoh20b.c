...
/*
        C code for testcase "fxisoh20b.f" and "fxisoh21b.f"
*/
...
int_fast32_t fnt1(struct dtd0 *dt) {
...
int_fast32_t fnt2(struct dtd0 dt) {
...
int_fast32_t fnt3(struct dtd1 *dt) {
...
int_fast32_t fnt4(struct dtd1 dt) {
...
int_fast32_t fnt5(struct dtd2 *dt) {
...
int_fast32_t fnt6(struct dtd2 dt) {
...
int_fast32_t fnt7(struct dtd0 *dt) {
...
int_fast32_t fnt7a(const struct dtd0 *dt) {
...
int_fast32_t fnt8(struct dtd0 dt) {
...
int_fast32_t fnt8a(const struct dtd0 dt) {
...
int_fast32_t fnt9(struct dtd1 *dt) {
...
int_fast32_t fnt9a(const struct dtd1 *dt) {
...
int_fast32_t fnt10(struct dtd1 dt) {
...
int_fast32_t fnt10a(const struct dtd1 dt) {
...
int_fast32_t fnt11(struct dtd2 *dt) {
...
int_fast32_t fnt11a(const struct dtd2 *dt) {
...
int_fast32_t fnt12(struct dtd2 dt) {
...
int_fast32_t fnt12a(const struct dtd2 dt) {
...
int_fast32_t fnt13(struct dtd0 *dt) {
...
int_fast32_t fnt14(struct dtd1 *dt) {
...
int_fast32_t fnt15(struct dtd2 *dt) {
