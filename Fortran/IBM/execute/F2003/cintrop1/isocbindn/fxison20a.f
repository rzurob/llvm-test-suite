...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrison00.presh fxison20a cxison20a
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 8
   ...
   do i = 1, 5
      if ( dta%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 76
   end do

   do i = 1, 3
      if ( dta%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 78
   end do
...
!! Test 8a
   ...
   do i = 1, 5
      if ( dta%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 80
   end do

   do i = 1, 3
      if ( dta%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 82
   end do
...
!! Test 9a
   ...
   do i = 1, 5
      if ( dtb%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 92
      if ( dtb%d0%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 94
   end do

   do i = 1, 3
      if ( dtb%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 96
      if ( dtb%d0%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 98
   end do
...
!! Test 10
   ...
   do i = 1, 5
      if ( dtb%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 100
      if ( dtb%d0%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 102
   end do

   do i = 1, 3
      if ( dtb%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 104
      if ( dtb%d0%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 106
   end do
...
!! Test 10a
   ...
   do i = 1, 5
      if ( dtb%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 108
      if ( dtb%d0%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 110
   end do

   do i = 1, 3
      if ( dtb%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 112
      if ( dtb%d0%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 114
   end do
...
!! Test 11
   ...
   do i = 1, 5
      if ( dtc%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 116
      if ( dtc%d1%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 118
      if ( dtc%d1%d0%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 120
   end do

   do i = 1, 3
      if ( dtc%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 122
      if ( dtc%d1%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 124
      if ( dtc%d1%d0%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 126
   end do
...
!! Test 11a
   ...
   do i = 1, 5
      if ( dtc%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 128
      if ( dtc%d1%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 130
      if ( dtc%d1%d0%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 132
   end do

   do i = 1, 3
      if ( dtc%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 134
      if ( dtc%d1%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 136
      if ( dtc%d1%d0%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 138
   end do
...
!! Test 12
   ...
   do i = 1, 5
      if ( dtc%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 140
      if ( dtc%d1%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 142
      if ( dtc%d1%d0%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 144
   end do

   do i = 1, 3
      if ( dtc%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 146
      if ( dtc%d1%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 148
      if ( dtc%d1%d0%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 150
   end do
...
!! Test 12a
   ...
   do i = 1, 5
      if ( dtc%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 152
      if ( dtc%d1%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 154
      if ( dtc%d1%d0%a(i) /= cmplx(i,i,C_FLOAT_COMPLEX) ) error stop 156
   end do

   do i = 1, 3
      if ( dtc%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 158
      if ( dtc%d1%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 160
      if ( dtc%d1%d0%b(i) /= cmplx(i,i,C_DOUBLE_COMPLEX) ) error stop 162
   end do
...
!! Test 13
   ...
   do i = 1, 5
      if ( dta%a(i) /= cmplx(i*2,i*2,C_FLOAT_COMPLEX) ) error stop 164
   end do

   do i = 1, 3
      if ( dta%b(i) /= cmplx(i*2,i*2,C_DOUBLE_COMPLEX) ) error stop 166
   end do
...
!! Test 14
   ...
   do i = 1, 5
      if ( dtb%a(i) /= cmplx(i*2,i*2,C_FLOAT_COMPLEX) ) error stop 168
      if ( dtb%d0%a(i) /= cmplx(i*2,i*2,C_FLOAT_COMPLEX) ) error stop 170
   end do

   do i = 1, 3
      if ( dtb%b(i) /= cmplx(i*2,i*2,C_DOUBLE_COMPLEX) ) error stop 172
      if ( dtb%d0%b(i) /= cmplx(i*2,i*2,C_DOUBLE_COMPLEX) ) error stop 174
   end do
...
!! Test 15
   ...
   do i = 1, 5
      if ( dtc%a(i) /= cmplx(i*2,i*2,C_FLOAT_COMPLEX) ) error stop 176
      if ( dtc%d1%a(i) /= cmplx(i*2,i*2,C_FLOAT_COMPLEX) ) error stop 178
      if ( dtc%d1%d0%a(i) /= cmplx(i*2,i*2,C_FLOAT_COMPLEX) ) error stop 180
   end do

   do i = 1, 3
      if ( dtc%b(i) /= cmplx(i*2,i*2,C_DOUBLE_COMPLEX) ) error stop 182
      if ( dtc%d1%b(i) /= cmplx(i*2,i*2,C_DOUBLE_COMPLEX) ) error stop 184
      if ( dtc%d1%d0%b(i) /= cmplx(i*2,i*2,C_DOUBLE_COMPLEX) ) error stop 186
   end do

end program fxison20a
