/*
        C code for testcase "fxisoi20a.f" and "fxisoi21a.f"
*/
...
int fnt5(struct dts2 *dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      if ( dt->a[i] != i+1 ) exit(33);
      dt->a[i] = dt->a[i]+i+1;
      if ( dt->d1.a[i] != i+1 ) exit(35);
      dt->d1.a[i] = dt->d1.a[i]+i+1;
      if ( dt->d1.d0.a[i] != i+1 ) exit(37);
...
int fnt6(struct dts2 dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      if ( dt.a[i] != i+1 ) exit(39);
      dt.a[i] = dt.a[i]+i+1;
      if ( dt.d1.a[i] != i+1 ) exit(41);
      dt.d1.a[i] = dt.d1.a[i]+i+1;
      if ( dt.d1.d0.a[i] != i+1 ) exit(43);
      dt.d1.d0.a[i] = dt.d1.d0.a[i]+i+1;
   }
...
int fnt9(struct dts1 *dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      if ( dt->a[i] != i+1 ) exit(53);
      if ( dt->d0.a[i] != i+1 ) exit(55);
   }
...
int fnt10(struct dts1 dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      if ( dt.a[i] != i+1 ) exit(61);
      if ( dt.d0.a[i] != i+1 ) exit(63);
   }
...
int fnt10a(const struct dts1 dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      if ( dt.a[i] != i+1 ) exit(65);
      if ( dt.d0.a[i] != i+1 ) exit(67);
   }
...
int fnt11(struct dts2 *dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      ...
      if ( dt->d1.a[i] != i+1 ) exit(71);
      if ( dt->d1.d0.a[i] != i+1 ) exit(73);
   }
...
int fnt11a(const struct dts2 *dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      if ( dt->a[i] != i+1 ) exit(75);
      if ( dt->d1.a[i] != i+1 ) exit(77);
      if ( dt->d1.d0.a[i] != i+1 ) exit(79);
   }
...
int fnt12(struct dts2 dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      ...
      if ( dt.d1.a[i] != i+1 ) exit(83);
      if ( dt.d1.d0.a[i] != i+1 ) exit(85);
   }
...
int fnt12a(const struct dts2 dt) {
   ...
   for ( i = 0; i < 5; i++ ) {
      if ( dt.a[i] != i+1 ) exit(87);
      if ( dt.d1.a[i] != i+1 ) exit(89);
      if ( dt.d1.d0.a[i] != i+1 ) exit(91);
   }
