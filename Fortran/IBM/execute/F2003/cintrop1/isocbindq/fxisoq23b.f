...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoq00.presh fxisoq23b cxisoq22b
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 3
   ...
   do i = 1, 5
      do j = 1, 10
         ...
         if ( dtb%d0%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 26
      end do
   end do
...
!! Test 5
   ...
   do i = 1, 5
      do j = 1, 10
         ...
         if ( dtc%d1%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 34
         if ( dtc%d1%d0%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 36
      end do
   end do
...
!! Test 8
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dta%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 48
      end do
   end do
...
!! Test 8a
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dta%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 50
      end do
   end do
...
!! Test 9a
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtb%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 56
         if ( dtb%d0%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 58
      end do
   end do
...
!! Test 10
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtb%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 60
         if ( dtb%d0%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 62
      end do
   end do
...
!! Test 10a
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtb%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 64
         if ( dtb%d0%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 66
      end do
   end do
...
!! Test 11
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtc%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 68
         if ( dtc%d1%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 70
         if ( dtc%d1%d0%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 72
      end do
   end do
...
!! Test 11a
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtc%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 74
         if ( dtc%d1%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 76
         if ( dtc%d1%d0%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 78
      end do
   end do
...
!! Test 12
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtc%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 80
         if ( dtc%d1%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 82
         if ( dtc%d1%d0%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 84
      end do
   end do
...
!! Test 12a
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtc%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 86
         if ( dtc%d1%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 88
         if ( dtc%d1%d0%a(j,i) /= cmplx(i+j-1,i+j-1,16) ) error stop 90
      end do
   end do
...
!! Test 13
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dta%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 92
      end do
   end do
...
!! Test 14
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtb%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 94
         if ( dtb%d0%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 96
      end do
   end do
...
!! Test 15
   ...
   do i = 1, 5
      do j = 1, 10
         if ( dtc%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 98
         if ( dtc%d1%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 100
         if ( dtc%d1%d0%a(j,i) /= cmplx(i+j,i+j,16) ) error stop 102
      end do
   end do


end program fxisoq23b
