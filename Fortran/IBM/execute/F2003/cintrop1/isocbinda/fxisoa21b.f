...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa00.presh fxisoa21b cxisoa20b
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
module mxisob21c
   interface
      ...
      integer(C_INT) function fnt7a(dt) bind(c)
         use mxisob21b
         type(dtd0), intent(in) :: dt
      end function fnt7a
      ...
      integer(C_INT) function fnt8a(dt) bind(c)
         use mxisob21b
         type(dtd0), intent(in), value :: dt
      end function fnt8a
      ...
      integer(C_INT) function fnt9a(dt) bind(c)
         use mxisob21b
         type(dtd1), intent(in) :: dt
      end function fnt9a
      ...
      integer(C_INT) function fnt10a(dt) bind(c)
         use mxisob21b
         type(dtd1), intent(in), value :: dt
      end function fnt10a
      ...
      integer(C_INT) function fnt11a(dt) bind(c)
         use mxisob21b
         type(dtd2), intent(in) :: dt
      end function fnt11a
      ...
      integer(C_INT) function fnt12a(dt) bind(c)
         use mxisob21b
         type(dtd2), intent(in), value :: dt
      end function fnt12a
