...
/*
        C code for testcase "fxisoa20b.f" and "fxisoa21b.f"
*/
...
int fnt7a(const struct dtd0 *dt) {
...
int fnt8a(const struct dtd0 dt) {
...
int fnt9a(const struct dtd1 *dt) {
...
int fnt10a(const struct dtd1 dt) {
...
int fnt11a(const struct dtd2 *dt) {
...
int fnt12a(const struct dtd2 dt) {
