...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrisoa01.presh fxisom25
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 3
   ...
   do i = 1, 5
      if ( a(i) /= real(i+1,C_LONG_DOUBLE) ) error stop 24
   end do
...
!! Test 5
   ...
   do i = 1, 5
      do j = 1, 10
         if ( aa(j,i) /= real(i+j,C_LONG_DOUBLE) ) error stop 28
      end do
   end do
...
!! Test 7
   ...
   do i = 1, 5
      do j = 1, 10
         if ( aa(j,i) /= real(i+j,C_LONG_DOUBLE) ) error stop 32
      end do
   end do
...
!! Test 8
   ...
   do i = 1, 5
      do j = 1, 10
         if ( aa(j,i) /= real(i+j,C_LONG_DOUBLE) ) error stop 34
      end do
   end do

end program fxisom25
...
real(C_LONG_DOUBLE) function fnt1(a)
   ...
   do i = 1, 5
      if ( a(i) /= real(i,C_LONG_DOUBLE) ) error stop 36
...
real(C_LONG_DOUBLE) function fnt2(a)
   ...
   do i = 1, 5
      if ( a(i) /= real(i,C_LONG_DOUBLE) ) error stop 38
   end do
...
real(C_LONG_DOUBLE) function fnt3(a)
   ...
   do i = 1, 5
      if ( a(i) /= real(i,C_LONG_DOUBLE) ) error stop 40
      a(i) = real(i+1,C_LONG_DOUBLE)
   end do
...
real(C_LONG_DOUBLE) function fnt5(aa)
   ...
   do i = 1, 5
      do j = 1, 10
         if ( aa(j,i) /= real(i+j-1,C_LONG_DOUBLE) ) error stop 42
...
real(C_LONG_DOUBLE) function fnt6(aa)
   ...
   do i = 1, 5
      do j = 1, 10
         if ( aa(j,i) /= real(i+j-1,C_LONG_DOUBLE) ) error stop 44
      end do
   end do
...
real(C_LONG_DOUBLE) function fnt7(aa)
   ...
   do i = 1, 5
      do j = 1, 10
         if ( aa(j,i) /= real(i+j-1,C_LONG_DOUBLE) ) error stop 46
         aa(j,i) = real(i+j,C_LONG_DOUBLE)
      end do
   end do
