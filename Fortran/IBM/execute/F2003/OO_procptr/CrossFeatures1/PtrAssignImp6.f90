...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  PtrInt1 => Int1
  IF ( PtrInt1(-1_1) .NE. -1_1 ) ERROR STOP 11

  PtrInt2 => Int2
  IF ( PtrInt2(-2_2) .NE. -2_2 ) ERROR STOP 12

  PtrInt4 => Int4
  IF ( PtrInt4(-4_4) .NE. -4_4 ) ERROR STOP 14

  PtrInt8 => Int8
  IF ( PtrInt8(-8_8) .NE. -8_8 ) ERROR STOP 18


  PtrLog1 => Log1
  IF ( PtrLog1(.TRUE._1) .NEQV. .TRUE._1 ) ERROR STOP 21

  PtrLog2 => Log2
  IF ( PtrLog2(.TRUE._2) .NEQV. .TRUE._2 ) ERROR STOP 22

  PtrLog4 => Log4
  IF ( PtrLog4(.TRUE._4) .NEQV. .TRUE._4 ) ERROR STOP 24

  PtrLog8 => Log8
  IF ( PtrLog8(.FALSE._8) .NEQV. .FALSE._8 ) ERROR STOP 28
