...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (.NOT. Equal(V, DT(Base=Base(ProcPtr1), ProcPtr2=ModFun2 )) ) ERROR STOP 11

  V1 = Base(ModFun1)
  IF (.NOT. Equal(V1, Base(ProcPtr1)) ) ERROR STOP 12

  ALLOCATE(V2, SOURCE=DT(Base=Base(ProcPtr1), ProcPtr2=ModFun2 ))
  IF (.NOT. Equal(V2, DT(Base=Base(ProcPtr1), ProcPtr2=ModFun2 )) ) ERROR STOP 13

  ALLOCATE(V3, SOURCE=Base(ProcPtr1) )
  IF (.NOT. Equal(V3, Base(ProcPtr1)) ) ERROR STOP 14
