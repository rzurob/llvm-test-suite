...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (ExtDABS(-2.D0) .NE. 2.D0 ) ERROR STOP 11

  IF (ABS(ExtDACOS(0.54030231D0) - 1.0D0 ) .GT. .00001 ) ERROR STOP 12

  IF (ABS(ExtDATAN(1.5574077D0) - 1.D0) .GT. .00001 ) ERROR STOP 13

  IF (ABS(ExtDATAN2(1.5574077D0, 1.0D0) - 1.D0) .GT. .00001 ) ERROR STOP 14

  IF (ABS(ExtDCOS(1.0D0) - 0.54030231D0 ) .GT. .00001 ) ERROR STOP 15

  IF (ABS(ExtDCOSH(1.0D0) - 1.5430806D0 ) .GT. .00001 ) ERROR STOP 16

  IF (ExtDDIM(-3.0D0, 2.0D0) .NE. 0.0D0 ) ERROR STOP 17

  IF (ABS(ExtDEXP(1.0D0) - 2.7182818D0) .GT. .00001 ) ERROR STOP 18

  IF (ExtDDIM(-3.0_8, 2.0_8) .NE. 0.0 ) ERROR STOP 19

  IF (ExtDINT(-2.783D0) .NE. -2.0D0 )   ERROR STOP 20
