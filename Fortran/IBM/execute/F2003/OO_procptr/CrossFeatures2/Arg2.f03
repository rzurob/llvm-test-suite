...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (ExtABS(-1.0) .NE.  1.0  ) ERROR STOP 11

  IF (ABS(ExtACOS(0.54030231) - 1.0) .GT. .00001 ) ERROR STOP 12

  IF (ExtAIMAG((2.0, -1.0)) .NE. -1.0 )   ERROR STOP 13

  IF (ExtAINT(-2.783) .NE. -2.0 )   ERROR STOP 14

  IF (ExtALOG(1.0) .NE. 0.0 ) ERROR STOP 15

  IF (ExtALOG10(1.0) .NE. 0.0 ) ERROR STOP 16

  IF (ExtAMOD(3.0, 2.0) .NE. 1.0 ) ERROR STOP 17

  IF (ExtANINT(2.783) .NE. 3.0 ) ERROR STOP 18

  IF (ABS(ExtASIN(0.84147098)-1.0) .GT. .00001 ) ERROR STOP 19

  IF (ABS(ExtATAN(1.5574077)-1.0) .GT. .00001 ) ERROR STOP 20
