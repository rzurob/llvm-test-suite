...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (ABS(ExtDLOG(10.0D0) - 2.3025851D0 ) .GT. .00001 ) ERROR STOP 11

  IF (ABS(ExtDLOG10(10.0D0) - 1.0D0 ) .GT. .00001 ) ERROR STOP 12

  IF (ABS(ExtDMOD(3.0D0, 2.0D0) - 1.0D0 ) .GT. .00001 ) ERROR STOP 13

  IF (ExtDNINT(2.783D0) .NE. 3.D0) ERROR STOP 14

  IF (ExtDPROD(3.0, 2.0) .NE. 6.0D0 ) ERROR STOP 15

  IF (ExtDSIGN(-3.0D0, 2.0D0) .NE. 3.0D0  ) ERROR STOP 16

  IF (ABS(ExtDSIN(1.0D0) - 0.84147098D0 ) .GT. .00001 ) ERROR STOP 17

  IF (ABS(ExtDSINH(1.0D0) - 1.1752012D0 ) .GT. .00001 ) ERROR STOP 18

  IF (ABS(ExtDSQRT(4.0D0) - 2.D0) .GT. .00001 ) ERROR STOP 19

  IF (ABS(ExtDTAN(1.0D0) - 1.5574077D0) .GT. .00001 ) ERROR STOP 20
