...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : asynchSpecOpen10d - ASYNCHRONOUS=
...
!*                               Statement
!*  SECONDARY FUNCTIONS TESTED : File Previously OPEN()ed for Asynchronous I/O
!*
...
PROGRAM asynchSpecOpen10d
    ...
    !
    OPEN(UNIT=15, ASYNCHRONOUS='no', IOSTAT=ioStatus, IOMSG=ioErrorMsg)
    ...
    !
    CLOSE(IOSTAT=ioStatus, IOMSG=ioErrorMsg, UNIT=15)
