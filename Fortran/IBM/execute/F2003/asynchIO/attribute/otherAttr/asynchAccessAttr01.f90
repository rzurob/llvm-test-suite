...
MODULE mPublic
    PUBLIC
        ...
        TYPE(tPublicPt), PRIVATE, ASYNCHRONOUS :: publicPrivatePt
        TYPE(tPublicPt), ASYNCHRONOUS :: publicPublicPt
        TYPE(tPublicPt) :: publicDefaultPt
    ...
    CONTAINS
        ...
        SUBROUTINE SetPrivatePt(anX, anY)
            ...
            publicPrivatePt = tPublicPt(anX , anY)
...
PROGRAM asynchAccessAttr01
    ...
    ELSE
        publicPublicPt = tPublicPt( 234.123,808.5 )
        publicDefaultPt = tPublicPt( 23.6,65.2 )
