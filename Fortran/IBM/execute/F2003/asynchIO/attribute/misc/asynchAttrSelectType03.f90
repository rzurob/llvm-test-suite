...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : asynchAttrSelectType03 - ASYNCHRONOUS
...
PROGRAM asynchAttrSelectType03
    ...
    INTERFACE
        INTEGER FUNCTION Load(ioUnit, n, d1)
            ...
            INTEGER, INTENT(IN) :: n
            CLASS(tBase), POINTER, DIMENSION( : ), INTENT(INOUT) :: d1
        END FUNCTION Load
    END INTERFACE

    CHARACTER(LEN = 256) :: iMsg

    TYPE(tDerived1), ALLOCATABLE, TARGET, DIMENSION( : ) :: derived1
    CLASS(tBase), POINTER, DIMENSION( : ) :: base
    ...
    ALLOCATE(tDerived1::derived1( 1000 ), STAT=iStat, ERRMSG=iMsg)
    IF (iStat <> 0) THEN
