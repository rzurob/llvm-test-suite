...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : asynchAttrSelectType04 - ASYNCHRONOUS
...
PROGRAM asynchAttrSelectType04
    ...
    TYPE(tBase) :: base
    TYPE(tDerived1) :: derived1
    TYPE(tDerived2) :: derived2
...
INTEGER FUNCTION Init(ioUnit, iMsg, anObj)
    ...
    INTEGER, INTENT(IN) :: ioUnit
    CHARACTER(LEN = 256), INTENT(OUT) :: iMsg
    CLASS(tBase), ASYNCHRONOUS, INTENT(OUT) :: anObj
