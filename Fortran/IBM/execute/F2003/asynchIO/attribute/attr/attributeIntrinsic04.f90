...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : attributeIntrinsic04 - ASYNCHRONOUS
...
PROGRAM attributeIntrinsic04
    IMPLICIT NONE

    CHARACTER(LEN = 13), ASYNCHRONOUS :: asynchCharacter

    asynchCharacter = 'Hello, World!'

END PROGRAM attributeIntrinsic04
