...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : specExprPending03 - ASYNCHRONOUS
...
MODULE mPixel
    ...
    TYPE(tPixel), ASYNCHRONOUS :: asynchPixel =&
                  tPixel(233,198,201, 43.289,15.124)
END MODULE mPixel
...
PROGRAM specExprPending03
    ...
    !
    startPixel = tPixel(asynchPixel%red,&
                        &asynchPixel%green,&
                        &asynchPixel%blue,&
                        &12.236, 27.118)
