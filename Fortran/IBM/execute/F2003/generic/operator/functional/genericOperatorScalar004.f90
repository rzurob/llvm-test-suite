...
program genericOperatorScalar004
   ...
   class(mycomplex), allocatable :: c1, c11
   type(mycomplex) :: c2, c21

   allocate ( c1,  source = mycomplex (101.101_8, 201.201_8 ) )
   allocate ( c11, source = mycomplex (100.101_8, 202.202_8 ) )

   c2  = mycomplex ( 102.102_8, 202.202_8 )
   c21 = mycomplex ( 103.102_8, 201.202_8 )
   ...
   deallocate ( c1 )
   allocate ( c1, source = mycomplex ( 0.0_8, 0.0_8 ) )
