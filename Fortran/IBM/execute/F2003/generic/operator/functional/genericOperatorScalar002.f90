...
module m
   ...
   function mybmul ( a, b )
      ...
      class(base), allocatable :: mybmul
      allocate ( mybmul, source = base() )
   ...
   function mybdiv ( a, b )
      ...
      class(base), pointer :: mybdiv

      allocate ( base :: mybdiv )
   ...
   function divwint ( a, b )
      ...
      class(base), pointer :: divwint

      allocate ( base :: divwint )
