...
program genericAssignmentDtIntrinAssgn025
   ...
   allocate ( c2%b1(-1000:-998), source = (/ base(11), base(12), base(13) /) )
   allocate ( c2%c1(10000:10002), source = (/ child(14,15), child(16,17), child(18,19) /) )
   ...
   allocate ( c3%b1(10:0) )          ! zero-sized
   allocate ( c3%c1(-1:1), source = (/ child(14,15), child(16,17), child(18,19) /) )
