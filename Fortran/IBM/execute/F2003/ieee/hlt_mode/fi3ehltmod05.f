...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxi3e.presh fi3ehltmod05 
! %COMPOPTS: -qfloat=nofold -qflttrap=inexact -qsigtrap -qfree=f90 -qstrict   
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*                               REAL*4. Halting on INEXACT exception. 
!*                               
!234567890123456789012345678901234567890123456789012345678901234567890
       
         program fi3ehltmod05
