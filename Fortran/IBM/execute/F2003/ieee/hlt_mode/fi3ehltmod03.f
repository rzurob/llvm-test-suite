...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxi3e.presh fi3ehltmod03 
! %COMPOPTS: -qfloat=nofold -qflttrap=invalid -qsigtrap -qfree=f90 -qstrict
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT:
...
!*                               REAL*4. Halting on IEEE_INVALID exception. 
!*                               
!*
!234567890123456789012345678901234567890123456789012345678901234567890
       
         program fi3ehltmod03
...
!...halting on exception IEEE_INVALID
         ...
         if (ieee_is_nan(tr_4) .neqv. .true. ) then
            call zzrc(caseid+5)
         endif
