...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxi3e2.presh fxfinite05
! %COMPOPTS: -qfloat=nans:nofold -qrealsize=8 -qfree=f90 -qstrict
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!234567890123456789012345678901234567890123456789012345678901234567890
        ...
        real :: neg_r1 = -1.0, neg_r2 = -0.1
        real :: neg_r3 = -tiny(1.0), neg_r4 = -huge(1.0)
