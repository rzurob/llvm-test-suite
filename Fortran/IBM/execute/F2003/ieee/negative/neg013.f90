...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxieee.presh neg013
! %COMPOPTS: -qstrict -qfloat=nomaf -qautodbl=dbl8 -qfree=f90 -qxlf90=signedzero
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*
!*  SECONDARY FUNCTIONS TESTED : -qautodbl=dbl8 option
!*
