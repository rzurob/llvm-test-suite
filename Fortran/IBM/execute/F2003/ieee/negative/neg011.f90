...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxieee.presh neg011
! %COMPOPTS: -qstrict -qfloat=nomaf -qautodbl=dbl4 -qfree=f90 -qxlf90=signedzero
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*
!*  SECONDARY FUNCTIONS TESTED : -qautodbl=dbl4 option
!*
!*  REQUIRED COMPILER OPTIONS  : -qautodbl=dbl4
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
