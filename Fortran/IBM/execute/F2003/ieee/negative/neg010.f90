...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxieee.presh neg010 
! %COMPOPTS: -qstrict -qfloat=nomaf -qautodbl=dblpad -qfree=f90 -qxlf90=signedzero
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*
!*  SECONDARY FUNCTIONS TESTED : -qautodbl=dblpad option
!*
!*
!*  DRIVER STANZA              : xlf95
