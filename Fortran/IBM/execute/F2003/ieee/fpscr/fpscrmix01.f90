...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/fpscr.presh fpscrmix01
...
!*  and rounding mode is also not modified and is ieee_up.
          ...
          if (any(hlt_values .neqv. .true.))            error stop 20
...
!*  true and set divide_by_zero and underflow flags to false.
...
!*  subroutine.
          ...
          call ieee_get_halting_mode(ieee_all, hlt_values)
          if (any(hlt_values .neqv. .true.))            error stop 8
...
!*  Set all flags to true and rounding mode to ieee_down. 
          ...
          call ieee_set_halting_mode(ieee_all, .true.)
          call ieee_get_halting_mode(ieee_all, hlt_values2)
          if (any(hlt_values2 .neqv. .true.))            error stop 14
...
!*  halting flags are not modified and are all true;
