...
!*				 This testcase uses default REAL variables.
!*                               It should have the same result as REAL*4,
!*				 which is fpscrflg_r4.f
!*
...
!***********************************************************************
          ...
          exp4 = -150
	  zero4	= 0.0
          overflow_r4 		= huge(tmpr4)**(128)
	  divbyzero_r4 		= 10./zero4
          underflow_r4 		= tmpr4**(exp4)
...
!***********************************************************************
!*  The if loops below are to ensure that variables: overflow_r4,
!*  divbyzero_r4, invalid_r4, underflow_r4 affect the output of the program.
!*  If a variable doesn't affect the output, TOBEY throws away the variable
!*  - we don't want that to happen in this situation.
!***********************************************************************
	  if (overflow_r4 .le.(2**127))			error stop 101
	  if (divbyzero_r4 .le.(2**127))		error stop 102
	  if (underflow_r4 .gt.(2**(-149)))		error stop 104
...
!*** sub8: flag was set then cleared in subroutine; flag can not be cleared on exit
          call ext_sub8()
          call ieee_get_flag(ieee_all, flag_values)
...
!*** Set flag on entry to subroutine
...
!*  Assign true to all exception flags.
          ...
          overflow_r4           = huge(tmpr4) + huge(tmpr4)
          divbyzero_r4          = 10./zero4
          underflow_r4          = tiny(tmpr4)/huge(tmpr4)

!*** IPA optimizes invalid calculations too well, so force ieee_invalid to TRUE
          call ieee_set_flag(ieee_invalid, .true.)

          if (overflow_r4 .le.(2**127))                 error stop 204
          if (divbyzero_r4 .le.(2**127))                error stop 205
          if (underflow_r4 .gt.(2**(-149)))             error stop 206
...
!*** IPA optimizes invalid calculations too well, so force ieee_invalid to TRUE
          ...
          if (overflow_r4 .le.(2**127))                 error stop 209
          if (divbyzero_r4 .le.(2**127))                error stop 210
          if (underflow_r4 .gt.(2**(-149)))             error stop 211
...
!*** IPA optimizes invalid calculations too well, so force ieee_invalid to TRUE
          ...
          if (overflow_r4 .le.(2**127))                 error stop 214
          if (divbyzero_r4 .le.(2**127))                error stop 215
          if (underflow_r4 .gt.(2**(-149)))             error stop 216
...
!*  Check if all flags are cleared when entering procedure.
          ...
          if (overflow_r4 .le.(2**127))                 error stop 220
          if (divbyzero_r4 .le.(2**127))                error stop 221
          if (underflow_r4 .gt.(2**(-149)))             error stop 222
...
!*  Assign true to all exception flags.
          ...
          if (overflow_r4 .le.(2**127))                 error stop 226
          if (divbyzero_r4 .le.(2**127))                error stop 227
          if (underflow_r4 .gt.(2**(-149)))             error stop 228
...
!*** IPA optimizes invalid calculations too well, so force ieee_invalid to TRUE
          ...
          if (overflow_r4 .le.(2**127))                 error stop 231
          if (divbyzero_r4 .le.(2**127))                error stop 232
          if (underflow_r4 .gt.(2**(-149)))             error stop 233
...
!*  Assign true to all exception flags.
          ...
          if (overflow_r4 .le.(2**127))                 error stop 236
          if (divbyzero_r4 .le.(2**127))                error stop 237
          if (underflow_r4 .gt.(2**(-149)))             error stop 238
...
!*  Assign true to all exception flags.
          ...
          if (overflow_r4 .le.(2**127))                 error stop 242
          if (divbyzero_r4 .le.(2**127))                error stop 243
          if (underflow_r4 .gt.(2**(-149)))             error stop 244
...
!*** IPA optimizes invalid calculations too well, so force ieee_invalid to TRUE
          ...
          if (overflow_r4 .le.(2**127))                 error stop 249
          if (divbyzero_r4 .le.(2**127))                error stop 250
          if (underflow_r4 .gt.(2**(-149)))             error stop 251
...
!*** IPA optimizes invalid calculations too well, so force ieee_invalid to TRUE
          ...
          if (overflow_r4 .le.(2**127))                 error stop 254
          if (divbyzero_r4 .le.(2**127))                error stop 255
          if (underflow_r4 .gt.(2**(-149)))             error stop 256
...
!*** IPA optimizes invalid calculations too well, so force ieee_invalid to TRUE
          ...
          if (overflow_r4 .le.(2**127))                 error stop 261
          if (divbyzero_r4 .le.(2**127))                error stop 262
          if (underflow_r4 .gt.(2**(-149)))             error stop 263
...
!*  Try to reset flag to false by calculation  -- NOT POSSIBLE
          overflow_r4           = tmpr4
          divbyzero_r4          = 5./1.
          underflow_r4          = tmpr4**(-1)
	  invalid_r4 		= 5./1.

          if (overflow_r4 .ge. (2.0**127))              error stop 265
          if (divbyzero_r4 .ge. (2.0**127))             error stop 266
          if (underflow_r4 .lt. (2.0**(-149)))          error stop 267
...
!*  Try to reset flag to false by calculation  -- NOT POSSIBLE
          ...
          if (overflow_r4 .ge. (2.0**127))              error stop 274
          if (divbyzero_r4 .ge. (2.0**127))             error stop 275
          if (underflow_r4 .lt. (2.0**(-149)))          error stop 276
