...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxieee.presh select007
! %COMPOPTS: -qfree=f90 -qstrict -qautodbl=dbl8
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*                               numbers when -qautodbl=dbl8 option is used.
!*                               Only real*8 will be promoted.
!*  SECONDARY FUNCTIONS TESTED : -qautodbl=dbl8
!*
!*  DRIVER STANZA              : xlf95
!*  REQUIRED COMPILER OPTIONS  : -qautodbl=dbl8
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
