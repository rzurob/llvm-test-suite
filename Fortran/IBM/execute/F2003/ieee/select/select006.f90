...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxieee.presh select006
! %COMPOPTS: -qfree=f90 -qstrict -qautodbl=dbl4
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*                               numbers when -qautodbl=dbl4 option is used.
!*                               Only real*4 will be promoted.
!*  SECONDARY FUNCTIONS TESTED : -qautodbl=dbl4
!*
!*  DRIVER STANZA              : xlf95
