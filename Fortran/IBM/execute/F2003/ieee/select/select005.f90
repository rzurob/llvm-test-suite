...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxieee.presh select005
! %COMPOPTS: -qfree=f90 -qstrict -qautodbl=dbl
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*                               numbers when -qautodbl=dbl option is used.
!*                               Only real*4 and real*8 will be promoted.
!*  SECONDARY FUNCTIONS TESTED : -qautodbl=dbl
!*
!*  DRIVER STANZA              : xlf95
!*  REQUIRED COMPILER OPTIONS  : -qautodbl=dbl
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
