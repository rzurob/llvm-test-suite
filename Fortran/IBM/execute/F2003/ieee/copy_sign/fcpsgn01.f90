...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxieee.presh fcpsgn01
...
!*
!*  DESCRIPTION                : Test COPY_SIGN elemental function i
!*                                with REAL(4)
!*                               
!234567890123456789012345678901234567890123456789012345678901234567890
        ...
        real(8) :: xr_8, yr_8
        real(16) :: xr_16, yr_16
        real(4), parameter, dimension(4) :: nan_val = &
     &  (/ PNANS_4, NNANS_4, PNANQ_4, NNANQ_4 / )

        real(4), parameter, dimension(2) :: inf_val = (/ PINF_4, NINF_4/ )

        real(4), parameter, dimension(4) :: normal_val = &
     &  (/ huge(PINF_4), tiny(PINF_4), -tiny(PINF_4), -huge(PINF_4)/ )

        real(4), parameter, dimension(2) :: zero_val = (/ PZERO_4, NZERO_4/)

        real(4), parameter, dimension(4) :: denormal_val = &
     &  (/ PHD_4, PTD_4, NTD_4, NHD_4 / )

        real(4), dimension(4) :: xnan_res, ynan_sgn
        real(4), dimension(2) :: xinf_res, yinf_sgn
        real(4), dimension(4) :: xnormal_res, ynormal_sgn
        real(4), dimension(2) :: xzero_res, yzero_sgn
        real(4), dimension(4) :: xdenorm_res, ydenorm_sgn
