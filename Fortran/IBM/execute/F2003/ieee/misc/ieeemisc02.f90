...
! %VERIFY:
! %STDIN:
! %STDOUT: ieeemisc02.out
! %EXECARGS:
! %POSTCMD: rm -f ieeemisc02.out
! %END
!**********************************************************************
!*  ===================================================================
!*  AIX XL FORTRAN/6000 TEST CASE                 IBM INTERNAL USE ONLY
!*  ===================================================================
!*  TEST CASE TITLE            : ieeemisc02.f
!*
...
!*  integer(8) and real(4) negative infinity
          ...
          print *,"NINF_4 : int0,1,2,4,8 =",int0,int1,int2,int4,int8
!* --------------------------------------------------------------------
...
!*  integer(8) and real(8) negative infinity
          ...
          print *,"NINF_8 : int0,1,2,4,8 =",int0,int1,int2,int4,int8
!* --------------------------------------------------------------------
!*  default integer and real(16) negative infinity
          int0 = ceiling(NINF_16)
          call ieee_get_flag(ieee_all, flag_values)
...
!*  integer(8) and real(16) negative infinity
          ...
          print *,"NINF_16: int0,1,2,4,8 =",int0,int1,int2,int4,int8
