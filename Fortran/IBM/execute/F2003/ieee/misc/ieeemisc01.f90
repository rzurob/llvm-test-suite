...
! %VERIFY:
! %STDIN:
! %STDOUT: ieeemisc01.out
! %EXECARGS:
! %POSTCMD: rm -f ieeemisc01.out
! %END
!**********************************************************************
!*  ===================================================================
!*  AIX XL FORTRAN/6000 TEST CASE                 IBM INTERNAL USE ONLY
!*  ===================================================================
!*  TEST CASE TITLE            : ieeemisc01.f
!*
!*  PROGRAMMER                 : Kobi Vinayagamoorthy
!*  DATE                       : April 15, 2002
!*  ORIGIN                     : AIX Compiler Development, Toronto Lab
!*
!*  PRIMARY FUNCTIONS TESTED   : ceiling()
!*				 ieee_invalid
!*
...
!*				 CEILING function, ieee_invalid flag
!*				 is set to true.  
...
!*  integer(8) and real(4) positive infinity
          ...
          print *,"PINF_4 : int0,1,2,4,8 =",int0,int1,int2,int4,int8
!* --------------------------------------------------------------------
...
!*  integer(8) and real(8) positive infinity
          ...
          print *,"PINF_8 : int0,1,2,4,8 =",int0,int1,int2,int4,int8
!* --------------------------------------------------------------------
!*  default integer and real(16) positive infinity
          int0 = ceiling(PINF_16)
          call ieee_get_flag(ieee_all, flag_values)
...
!*  integer(8) and real(16) positive infinity
          ...
          print *,"PINF_16: int0,1,2,4,8 =",int0,int1,int2,int4,int8
