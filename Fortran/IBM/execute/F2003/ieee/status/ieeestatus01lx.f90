...
!*  ===================================================================
!*  TEST CASE TITLE            : ieeestatus01lx.f
!*
...
!*      Then set all exception flags to true, keep halting mode as false, 
!*      and set rounding mode to ieee_up, then 
...
!***********************************************************************
!*  Test 2: Restore all exception flags to true 
!*      and rounding mode to ieee_down.
!*
...
!*  Exception flags
          call ieee_get_flag(ieee_all, flag_values)
          if (flag_values(1) .neqv. .true.)             error stop 72
          if (flag_values(2) .neqv. .false.)            error stop 73
          if (flag_values(3) .neqv. .true.)             error stop 74
          if (flag_values(4) .neqv. .false.)            error stop 75
          if (flag_values(5) .neqv. .true.)             error stop 76

!*  Halting flags
          call ieee_get_halting_mode(ieee_all, hlt_values)
          if (hlt_values(1) .neqv. .false.)        	error stop 77
          if (hlt_values(2) .neqv. .true.)         	error stop 78
          if (hlt_values(3) .neqv. .false.)        	error stop 79
          if (hlt_values(4) .neqv. .true.)         	error stop 80
          if (hlt_values(5) .neqv. .false.)        	error stop 81
