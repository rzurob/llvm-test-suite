...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxi3e2.presh fnormal04
...
!*                               using -qrealsize=4 compiler option
!*
...
!...test IEEE_IS_NORMAL with normal values resulting from operations
        ...
        normal_result(5) = PNORMAL1_4 - PNORMAL1_4
        if (ieee_support_datatype(normal_result)) then
...
!...lowest range values
        test_pnanq_lowest = pnanq_lowest_4
        ...
        test_nnanq_lowest = nnanq_lowest_4
...
!...highest range values
        test_pnanq_highest = pnanq_highest_4
        ...
        test_nnanq_highest = nnanq_highest_4
...
!...lowest range values
        ...
        test_pnans_lowest = pnans_lowest_4
        ...
        test_nnans_lowest = nnans_lowest_4
...
!...highest range values
        ...
        test_pnans_highest = pnans_highest_4
        ...
        test_nnans_highest = nnans_highest_4
