...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/fxi3e2.presh fnormal09
! %COMPOPTS: -qfloat=nans:nofold -qautodbl=dblpad -qfree=f90 -qstrict
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
...
!*
!*  REQUIRED COMPILER OPTIONS  : -qfloat=nans:nofold -qautodbl=dblpad
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
...
!*                               of REAL(4) using -qautodbl=dblpad option.
!*
