...
!234567890123456789012345678901234567890123456789012345678901234567890
	   ...
	   if (r4(3) .ne. 9) error stop 11_3

	   r5 = ubound(A, 1, kind = 4);
           if (r5 .ne. 15) error stop 12

	   r6 = ubound(A, 2, 4);
           if (r6 .ne. 5) error stop 13

	   r7 = ubound(A, dim = 2, kind = 4);
