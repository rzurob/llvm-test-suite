...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  DO I1 = 0, 127
    ...
    IF (ICHAR(CHAR(I1), KIND=KIND((/K4/))-3)     .NE. I1)                   STOP 13
    IF (ICHAR(CHAR(I1), KIND=KIND((/K8/))-7)     .NE. I1)                   STOP 14
  END DO

  DO I2 = 0, 127
    IF (ICHAR(CHAR(I2), KIND=KIND((/K1/))  )     .NE. I2)                   STOP 21
    IF (ICHAR(CHAR(I2), KIND=KIND((/K2/))-1)     .NE. I2)                   STOP 22
    IF (ICHAR(CHAR(I2), KIND=KIND((/K4/))-3)     .NE. I2)                   STOP 23
    IF (ICHAR(CHAR(I2), KIND=KIND((/K8/))-7)     .NE. I2)                   STOP 24
  END DO

  DO I4 = 0, 127
    IF (ICHAR(CHAR(I4), KIND=KIND((/K1/))  )     .NE. I4)                   STOP 41
    IF (ICHAR(CHAR(I4), KIND=KIND((/K2/))-1)     .NE. I4)                   STOP 42
    IF (ICHAR(CHAR(I4), KIND=KIND((/K4/))-3)     .NE. I4)                   STOP 43
    IF (ICHAR(CHAR(I4), KIND=KIND((/K8/))-7)     .NE. I4)                   STOP 44
  END DO

  DO I8 = 0, 127
    IF (ICHAR(CHAR(I8), KIND=KIND((/K1/))  )     .NE. I8)                   STOP 81
    IF (ICHAR(CHAR(I8), KIND=KIND((/K2/))-1)     .NE. I8)                   STOP 82
    IF (ICHAR(CHAR(I8), KIND=KIND((/K4/))-3)     .NE. I8)                   STOP 83
    IF (ICHAR(CHAR(I8), KIND=KIND((/K8/))-7)     .NE. I8)                   STOP 84
  END DO
