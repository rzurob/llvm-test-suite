...
! %PRECMD:
! %COMPOPTS: 
! %GROUP: ../ieeeconsts.f ../fake_ieee_modules.f intrimod06n.f
! %VERIFY: intrimod06n.out:fakeout2.vf
! %STDIN:
! %STDOUT: intrimod06n.out
! %EXECARGS:
