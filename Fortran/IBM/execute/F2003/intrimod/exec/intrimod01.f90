...
! %PRECMD:
! %COMPOPTS:
! %GROUP: ../ieeeconsts.f intrimod01.f
! %VERIFY: intrimod01.out:../emptyout.vf
! %STDIN:
! %STDOUT: intrimod01.out
! %EXECARGS:
! %POSTCMD: rm -f ieee_*.mod xlf_fp_util.mod constants_for_ieee.mod
! %END
!************************************************************************
!*
!*  Test Case Name   : intrimod01.f
!*  Created By       : Bahram Chehrazy
!*  DATE             : January, 2004
!*  Description      : Use INTRINSIC and NON_INTRINSIC modules in the main program
!*
!*************************************************************************
!*  REVISION HISTORY
!*
