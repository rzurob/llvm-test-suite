...
!*  DATE             : January, 2004
!*  Description      : Use INTRINSIC modules with ONLY clause.
       ...
       module mod1
         ...
         interface
            subroutine sub1(rt_nearest, flags)
               use, intrinsic :: ieee_arithmetic, only :ieee_round_type
               use, intrinsic :: xlf_fp_util, only:fpscr_kind
...
!... intrinsic ieee module must have been called.
      subroutine sub1(rt_nearest, flags)
         use, intrinsic :: ieee_arithmetic, only: ieee_get_flag, ieee_all,  &
     &        ieee_support_datatype, ieee_is_finite, ieee_get_status,       &
