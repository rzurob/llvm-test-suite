...
! %PRECMD:
! %COMPOPTS:
! %GROUP: ../ieeeconsts.f intrimod07.f
! %VERIFY: intrimod07.out:../emptyout.vf
! %STDIN:
! %STDOUT: intrimod07.out
! %EXECARGS:
! %POSTCMD: rm -f ieee_*.mod xlf_fp_util.mod constants_for_ieee.mod
! %END
!************************************************************************
!*
!*  Test Case Name   : intrimod07.f
!*  Created By       : Bahram Chehrazy
!*  DATE             : January, 2004
!*  Description      : Use INTRINSIC and NON_INTRINSIC modules in an interface
!*                     in another non_intrinsic module
