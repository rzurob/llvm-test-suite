...
! %PRECMD:
! %COMPOPTS:
! %GROUP: ../ieeeconsts.f ../fake_ieee_modules.f intrimod04n.f
! %VERIFY: intrimod04n.out:fakeout2.vf
! %STDIN:
! %STDOUT: intrimod04n.out
! %EXECARGS:
! %POSTCMD: rm -f ieee_*.mod xlf_fp_util.mod constants_for_ieee.mod
! %END
!************************************************************************
!*
!*  Test Case Name   : intrimod04n.f
!*  Created By       : Bahram Chehrazy
!*  DATE             : January, 2004
!*  Description      : Use NON_INTRINSIC modules with same name as an
!*                     INTRINSIC module in another module.
!*
!*************************************************************************
!*  REVISION HISTORY
!*
...
!... A non_intrinsic module that uses the non_intrinsic modules
       module mod1
	  ...
	  use, non_intrinsic :: ieee_exceptions
          ...
          type(ieee_status_type), save :: status_value
