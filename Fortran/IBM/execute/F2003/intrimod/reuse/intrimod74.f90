...
! %GROUP: ../fake_omp_lib_module.f intrimod74.f
! %VERIFY: intrimod74.out:intrimod74.vf
! %STDIN:
! %STDOUT: intrimod74.out
! %EXECARGS:
! %POSTCMD: 
! %END
!**********************************************************************
...
!*                             : with -qnoswapomp and NON_INTRINSIC module nature.
!*
!* ===================================================================
!*  
!*  REVISION HISTORY
...
!*  14/01/04   BC     Modified and reused with NON_INTRINSIC module nature
...
subroutine OMP_INIT_LOCK(svar)
   use, non_intrinsic :: omp_lib,only: OMP_LOCK_KIND 
