...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryComplexNaN006.f
!*
!*  DATE                       : June 14, 2006
!*
...
!*  positive vs. negative) for complex(4)/(8)/(16) with the Q edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(2Q1.1,/,2Q2.1,/,2Q3.2,/,2Q4.2,/,2Q5.2' //                    &
     & ',/,2Q6.2,/,2Q7.2,/,2Q15.2)'

      equivalence(rli, rliequiv)
      equivalence(rlr, rlrequiv)

      open(unit, file='boundaryComplexNaN006.out', action='write')
