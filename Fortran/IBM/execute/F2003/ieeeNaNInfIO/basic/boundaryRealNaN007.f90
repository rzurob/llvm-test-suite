...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryRealNaN007.f
!*
!*  DATE                       : June 12, 2006
!*
...
!*  positive vs. negative) for reals(4)/(8)/(16) with the G edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(G1.1,/,G2.1,/,G3.2,/,G4.2,/,G5.2,/,G6.2,/,G7.2,/,G15.2)'

      equivalence(rl3, rl3equiv)

      open(unit, file='boundaryRealNaN007.out', action='write')
