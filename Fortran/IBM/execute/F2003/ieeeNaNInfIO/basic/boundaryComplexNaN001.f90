...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryComplexNaN001.f
!*
!*  DATE                       : June 14, 2006
!*
...
!*  positive vs. negative) for complex(4)/(8)/(16) with the F edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & ',/,2F6.2,/,2F7.2,/,2F15.2)'
      ...
      open(unit, file='boundaryComplexNaN001.out', action='write')
