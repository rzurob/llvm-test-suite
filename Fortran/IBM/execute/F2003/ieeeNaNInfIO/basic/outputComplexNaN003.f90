...
!*  ===================================================================
!*
!*  TEST CASE NAME             : outputComplexNaN003.f
!*  TEST CASE TITLE            :
!*
...
!*  for complex(4)/(8)/(16) with the D edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      open(unit, file='outputComplexNaN003.out', action='write')
