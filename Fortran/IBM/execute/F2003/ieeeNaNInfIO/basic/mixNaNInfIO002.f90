...
!*  ===================================================================
!*
!*  TEST CASE NAME             : mixNaNInfIO002.f
!*  TEST CASE TITLE            :
!*
...
!*  specification, with real or complex of kind=4. Try combination of
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      open(in, file='mixNaNInfIO002.dat', action='read')
      open(out, file='mixNaNInfIO002.out', action='write')
