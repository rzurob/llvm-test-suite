...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryRealNaN001.f
!*
!*  DATE                       : June 12, 2006
!*
...
!*  positive vs. negative) for reals(4)/(8)/(16) with the F edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(F0.0,/,F1.1,/,F2.1,/,F3.2,/,F4.2,/,F5.2,/,F6.2,/,F7.2,/,F15.2)'

      equivalence(rl3, rl3equiv)

      open(unit, file='boundaryRealNaN001.out', action='write')
      ...
      write(unit, fmt=myfmt) rl3, rl3, rl3, rl3, rl3, rl3, rl3, rl3, rl3
