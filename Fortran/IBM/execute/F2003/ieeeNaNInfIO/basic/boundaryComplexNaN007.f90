...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryComplexNaN007.f
!*
!*  DATE                       : June 14, 2006
!*
...
!*  positive vs. negative) for complex(4)/(8)/(16) with the G edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(2G1.1,/,2G2.1,/,2G3.2,/,2G4.2,/,2G5.2' //                    &
     & ',/,2G6.2,/,2G7.2,/,2G15.2)'

      equivalence(rli, rliequiv)
      equivalence(rlr, rlrequiv)

      open(unit, file='boundaryComplexNaN007.out', action='write')
