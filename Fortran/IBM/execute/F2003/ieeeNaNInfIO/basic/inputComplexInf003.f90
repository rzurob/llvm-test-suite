...
!*  ===================================================================
!*
!*  TEST CASE NAME             : inputComplexInf003.f
!*
!*  DATE                       : June 8, 2006
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      do
         ...
         read(unit,'(2D15.1)',iostat=ios) cx1
     ...
     &        ieee_is_negative( rl4i ) ) call zzrc(2000_4+i)
      ...
      do
         ...
         read(unit,'(2D15.1)',iostat=ios) cx2
     ...
     &        ieee_is_negative( rl8i ) ) call zzrc(4000_4+i)
      ...
      do
         ...
         read(unit,'(2D15.1)',iostat=ios) cx3
