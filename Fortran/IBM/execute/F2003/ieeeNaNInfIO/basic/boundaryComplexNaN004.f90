...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryComplexNaN004.f
!*
!*  DATE                       : June 14, 2006
!*
...
!*  positive vs. negative) for complex(4)/(8)/(16) with the EN edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(2EN1.1,/,2EN2.1,/,2EN3.2,/,2EN4.2,/,2EN5.2' //               &
     & ',/,2EN6.2,/,2EN7.2,/,2EN15.2)'

      equivalence(rli, rliequiv)
      equivalence(rlr, rlrequiv)

      open(unit, file='boundaryComplexNaN004.out', action='write')
