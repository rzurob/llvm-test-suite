...
!*  ===================================================================
!*
!*  TEST CASE NAME             : inputComplexNaN001.f
!*  TEST CASE TITLE            :
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      do
         ...
         read(unit,'(2F15.1)',iostat=ios) cx1
     ...
     &        call zzrc(2000_4+i)
      ...
      do
         ...
         read(unit,'(2F15.1)',iostat=ios) cx2
     ...
     &        call zzrc(4000_4+i)
      ...
      do
         ...
         read(unit,'(2F15.1)',iostat=ios) cx3
