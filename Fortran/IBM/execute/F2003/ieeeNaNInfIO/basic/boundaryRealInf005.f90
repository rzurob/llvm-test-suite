...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryRealInf005.f
!*
!*  DATE                       : June 12, 2006
!*
...
!*  negative) for reals(4)/(8)/(16) with the ES edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     &'(ES1.1,/,ES2.1,/,ES3.2,/,ES4.2,/,ES5.2,/,ES8.2,/,ES9.2,/,ES15.2)'

      equivalence(rl3, rl3equiv)

      open(unit, file='boundaryRealInf005.out', action='write')
