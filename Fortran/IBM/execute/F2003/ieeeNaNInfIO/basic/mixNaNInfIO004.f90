...
!*  ===================================================================
!*
!*  TEST CASE NAME             : mixNaNInfIO004.f
!*  TEST CASE TITLE            :
!*
...
!*  specification, with real or complex of kind=16. Try combination of
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      open(in, file='mixNaNInfIO004.dat', action='read')
      open(out, file='mixNaNInfIO004.out', action='write')
