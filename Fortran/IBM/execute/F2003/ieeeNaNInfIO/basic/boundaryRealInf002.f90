...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryRealInf002.f
!*
!*  DATE                       : June 12, 2006
!*
...
!*  negative) for reals(4)/(8)/(16) with the E edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(E1.1,/,E2.1,/,E3.2,/,E4.2,/,E5.2,/,E8.2,/,E9.2,/,E15.2)'

      equivalence(rl3, rl3equiv)

      open(unit, file='boundaryRealInf002.out', action='write')
