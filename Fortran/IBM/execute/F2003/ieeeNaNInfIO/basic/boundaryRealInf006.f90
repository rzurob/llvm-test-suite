...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryRealInf006.f
!*  TEST CASE TITLE            :
!*
...
!*  negative) for reals(4)/(8)/(16) with the Q edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(Q1.1,/,Q2.1,/,Q3.2,/,Q4.2,/,Q5.2,/,Q8.2,/,Q9.2,/,Q15.2)'

      equivalence(rl3, rl3equiv)

      open(unit, file='boundaryRealInf006.out', action='write')
