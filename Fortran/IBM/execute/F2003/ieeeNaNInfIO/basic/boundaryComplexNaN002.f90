...
!*  ===================================================================
!*
!*  TEST CASE NAME             : boundaryComplexNaN002.f
!*
!*  DATE                       : June 14, 2006
!*
...
!*  positive vs. negative) for complex(4)/(8)/(16) with the E edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     & '(2E1.1,/,2E2.1,/,2E3.2,/,2E4.2,/,2E5.2' //                    &
     & ',/,2E6.2,/,2E7.2,/,2E15.2)'

      equivalence(rli, rliequiv)
      equivalence(rlr, rlrequiv)

      open(unit, file='boundaryComplexNaN002.out', action='write')
