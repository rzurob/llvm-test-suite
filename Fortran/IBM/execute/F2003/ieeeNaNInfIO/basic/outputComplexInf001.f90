...
!*  ===================================================================
!*
!*  TEST CASE NAME             : outputComplexInf001.f
!*  TEST CASE TITLE            :
!*
...
!*  for complex(4)/(8)/(16) with the F edit descriptor.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      open(unit, file='outputComplexInf001.out', action='write')
