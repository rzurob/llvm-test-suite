...
!*  ===================================================================
!*
!*  TEST CASE NAME             : inputComplexNaN006.f
!*
!*  DATE                       : June 8, 2006
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      do
         ...
         read(unit,'(2Q15.1)',iostat=ios) cx1
     ...
     &        call zzrc(2000_4+i)
      ...
      do
         ...
         read(unit,'(2Q15.1)',iostat=ios) cx2
     ...
     &        call zzrc(4000_4+i)
      ...
      do
         ...
         read(unit,'(2Q15.1)',iostat=ios) cx3
