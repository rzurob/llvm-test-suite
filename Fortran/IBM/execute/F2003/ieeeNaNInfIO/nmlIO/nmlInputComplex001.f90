...
!*  ===================================================================
!*
!*  TEST CASE NAME             : nmlInputComplex001.f
!*  TEST CASE TITLE            :
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      complex(4)   :: cx1, cx2, cx3, cx4, cx5, cx6, cx7, cx8
      real(4)      :: rl1r, rl1i, rl2r, rl2i, rl3r, rl3i, rl4r, rl4i,  &
     &                rl5r, rl5i, rl6r, rl6i, rl7r, rl7i, rl8r, rl8i
      integer(4)   :: ii1r, ii1i, ii2r, ii2i, ii3r, ii3i, ii4r, ii4i,  &
     &                ii5r, ii5i, ii6r, ii6i, ii7r, ii7i, ii8r, ii8i
      ...
      open(in, file='nmlInputComplex001.dat', action='read')
     ...
     &        ( ii5r .ge. 0 ) ) call zzrc( (inputno*100_4) + 11_4 )
         ...
         if ( .not. precision_r4(3.14_4, rl5i) )                       &
     &        call zzrc( (inputno*100_4) + 12_4 )
         ...
         if ( .not. precision_r4(-3.14_4, rl6r) )                      &
