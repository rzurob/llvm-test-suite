...
!*  IEEE NaN and Inf values. Testing list-directed I/O in this testcase.
!*
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      read(in, *) real_arr1(1:2), real_arr1(3:6)
      read(in, *, decimal='comma') real_arr2

      read(in, *, round='zero')    cx_arr1
      read(in, *, decimal='comma') cx_arr2
