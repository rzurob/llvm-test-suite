...
!*  ===========================================================================
!*
!*  TEST CASE NAME             : acetint22d
!*
!*  DATE                       : 2006-06-08 (YYYY-MM-DD)
!*
!*  PRIMARY FUNCTIONS TESTED   : Array Constructor Enhancements
!*
!*  SECONDARY FUNCTIONS TESTED : intrinsic type specifier with incorrect KIND in assignment
!*
...
program acetint22d
  ...
  use mod
  implicit none
  type (double), parameter :: dp4 = double(4), kind = double(4), dp3 = double(3)
