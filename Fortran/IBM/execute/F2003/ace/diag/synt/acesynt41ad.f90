...
!*
!*  SECONDARY FUNCTIONS TESTED : AC containing assumed-size array (assignment)
!*
...
!*
!*  KEYWORD(S)                 : dummy argument, array constructor, assumed-size, assignment
!*  TARGET(S)                  : 
