...
!*
!*  KEYWORD(S)                 : dummy argument, array constructor, assumed-size, print
!*  TARGET(S)                  : 
...
program acesynt41pd
  ...
  drank1 = [derived(), derived()];  drank2 = reshape([derived:: (derived(),i=1,4)],[2,2])
...
contains
  ...
  subroutine printAssumed3Derived(l, m, arr)
    integer :: l, m
    type(derived) :: arr(m,l:*)
    print *, (/ derived:: arr /)
    print *, (/ integer:: arr % field /)
  end subroutine printAssumed3Derived

end program acesynt41pd
