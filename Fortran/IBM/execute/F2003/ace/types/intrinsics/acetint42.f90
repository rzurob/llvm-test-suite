...
contains
  ...
  subroutine buildWithDeferred(arg0, arg1, arg2)
    ...
    character(len(arg1)) :: array(1 + 2*size(arg1) + size(arg2)), val
    integer    :: i

    array = [character(len(arg1)) :: arg0, arg1, arg2, (arg1(i),i=1,size(arg1))]
    print *, "D1: ", array
    print *, "D2: ", (/ character(len(arg1)) :: arg0, arg1, arg2, (arg1(i),i=1,size(arg1)) /)
    ...
    print *, "D5: ", [character(len(arg1)) ::arg0, arg1, arg1(size(arg1)), (arg1(i),i=1,size(arg1)), &
                                    arg2, arg2(ubound(arg2,1),ubound(arg2,2))]
    val = funTest([character(len(arg1)) ::  arg0, arg1, arg1(size(arg1)), (arg1(i),i=1,size(arg1)), &
                                    arg2, arg2(ubound(arg2,1),ubound(arg2,2))], 5)
    print *, "D6: ", val
    if (len(arg1) == 4) then
        print *, "D7: ", eTest4([character(len(arg1)) :: arg0, arg1, arg1(size(arg1)), (arg1(i),i=1,size(arg1)), &
                                    arg2, arg2(ubound(arg2,1),ubound(arg2,2))])
        print *, "D8: ", eTest4(reshape([character(len(arg1)) :: arg2],[integer:: 2, 2]))
    else if (len(arg1) == 7) then
        print *, "D7: ", eTest7([character(len(arg1)) :: arg0, arg1, arg1(size(arg1)), (arg1(i),i=1,size(arg1)), &
                                    arg2, arg2(ubound(arg2,1),ubound(arg2,2))])
        print *, "D8: ", eTest7(reshape([character(len(arg1)) :: arg2],[integer:: 2, 2]))
    end if
  ...
  subroutine buildWithAssumed(arg0, s1, arg1, u1, l2, s2, arg2, arg2a)
    ...
    character(len(arg1)) :: array(s1 + 2*s2 + 4), val

    array = (/character(len(arg1)) :: arg0, (arg1(i),i=1,s1), arg1(s1), &
                      ((arg2(i,j),i=1,u1),j=1,s2/u1), arg2(u1,s2/u1), &
                      ((arg2a(i,j),i=1,u1),j=l2,s2/u1), arg2a(u1,l2) /)
    print *, "A1: ", array
    print *, "A2: ", [character(len(arg1)) :: arg0, (arg1(i),i=1,s1), arg1(s1), &
                      ((arg2(i,j),i=1,u1),j=1,s2/u1), arg2(u1,s2/u1), &
                      ((arg2a(i,j),i=1,u1),j=l2,s2/u1), arg2a(u1,l2)]
    print *, "A3: ", maxval([character(len(arg1)) :: arg0, (arg1(i),i=1,s1), arg1(s1), &
                      ((arg2(i,j),i=1,u1),j=1,s2/u1), arg2(u1,s2/u1), &
                      ((arg2a(i,j),i=1,u1),j=l2,s2/u1), arg2a(u1,l2)])

    call subTest("A4",(/character(len(arg1)) :: arg0, (arg1(i),i=1,s1), arg1(s1), &
                        ((arg2(i,j),i=1,u1),j=1,s2/u1), arg2(u1,s2/u1), &
                        ((arg2a(i,j),i=1,u1),j=l2,s2/u1), arg2a(u1,l2) /))
    val = funTest([character(len(arg1)) :: arg0, (arg1(i),i=1,s1), arg1(s1), &
                      ((arg2(i,j),i=1,u1),j=1,s2/u1), arg2(u1,s2/u1), &
                      ((arg2a(i,j),i=1,u1),j=l2,s2/u1), arg2a(u1,l2)], 5)
    print *, "A5: ", val

    if (len(arg1) == 4) then
        print *, "A6: ", eTest4([character(len(arg1)) :: arg0, (arg1(i),i=1,s1), arg1(s1), &
                               ((arg2(i,j),i=1,u1),j=1,s2/u1), arg2(u1,s2/u1), &
                               ((arg2a(i,j),i=1,u1),j=l2,s2/u1), arg2a(u1,l2)])
    else if (len(arg1) == 7) then
        print *, "A6: ", eTest7([character(len(arg1)) :: arg0, (arg1(i),i=1,s1), arg1(s1), &
                               ((arg2(i,j),i=1,u1),j=1,s2/u1), arg2(u1,s2/u1), &
                               ((arg2a(i,j),i=1,u1),j=l2,s2/u1), arg2a(u1,l2)])
    end if
