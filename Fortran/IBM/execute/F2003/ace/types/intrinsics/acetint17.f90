...
program acetint17
  ...
  iarr  = [integer:: (varying(1), varying(2), varying(3), i=1,1)]
  print *, iarr
  print *, [integer:: (varying(1), varying(2), varying(3), i=1,1)]

  rarr  = [real:: varying(1.0), varying(2.0), varying(3.0)]
  print *, rarr
  print *, [real:: varying(1.0), varying(2.0), varying(3.0)]

  rarr  = [real:: (varying(1.0), varying(2.0), varying(3.0), i=1,1)]
  print *, rarr
  print *, [real:: (varying(1.0), varying(2.0), varying(3.0), i=1,1)]
  ...
  darr  = [double precision:: (varying(1.0d0), varying(2.0d0), varying(3.0d0), i=1,1)]
  print *, darr
  print *, [double precision:: (varying(1.0d0), varying(2.0d0), varying(3.0d0), i=1,1)]

  zarr  = [complex:: varying((1.0,0.0))]
  print *, zarr
  print *, [complex:: varying((1.0,0.0))]

  zarr  = [complex:: (varying((1.0,0.0)), i=1,1)]
  print *, zarr
  print *, [complex:: (varying((1.0,0.0)), i=1,1)]

  larr  = [logical:: varying(.true.), varying(.false.)]
  print *, larr
  print *, [logical:: varying(.true.), varying(.false.)]

  larr  = [logical:: (varying(.true.), varying(.false.), i=1,1)]
  print *, larr
  print *, [logical:: (varying(.true.), varying(.false.), i=1,1)]

  charr = [character:: varying('a',1), varying('bbb',1), varying('',1)]
  print *, charr
  print *, [character:: varying('a',1), varying('bbb',1), varying('',1)]

  charr = [character:: (varying('a',1), varying('bbb',1), varying('',1), i=1,1)]
  print *, charr
  print *, [character:: (varying('a',1), varying('bbb',1), varying('',1), i=1,1)]

  ! Now play around with types:
  print *, [integer:: varying(1), varying((2.1111d3,3.0d0)), varying(3.111d2)]
  print *, [integer:: (varying(1), varying((2.1111d3,3.0d0)), varying(3.111d2), i=1,1)]
  print *, [real:: varying(1.0), varying(2), varying((3.0,5.1))]
  print *, [real:: (varying(1.0), varying(2), varying((3.0,5.1)), i=1,1)]
  print *, [double precision:: varying(1), varying(2.2d0), varying((3.0d0,4.2d0))]
  print *, [double precision:: (varying(1), varying(2.2d0), varying((3.0d0,4.2d0)), i=1,1)]
  print *, [complex(16):: varying((1.0,0.0)), varying(1), varying(1.3d0)]
  print *, [complex(16):: (varying((1.0,0.0)), varying(1), varying(1.3d0), i=1,1)]
  print *, [logical(8):: varying(.true.), varying(.false.)]
  print *, [logical(8):: (varying(.true.), varying(.false.), i=1,1)]
  print *, [character(3):: varying('a',1), varying('bbb',1), varying('',1)]
  print *, [character(3):: (varying('a',1), varying('bbb',1), varying('',1), i=1,1)]
  print *, [character(3):: varying('a',3), varying('bbb',3), varying('wxyz',3)]
  print *, [character(3):: (varying('a',3), varying('bbb',3), varying('wxyz',3), i=1,1)]

end program acetint17
