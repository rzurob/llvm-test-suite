...
program acetint07
  ...
  if (any([integer:: 1, ([real:: 2.1], [double precision:: 3.1d0], [complex:: (4.1,5.1)], [integer::6], i=1,1)] &
          /= [integer:: 1, 2, 3, 4, 6]) ) call noteError(3)
  iarr = [integer:: 1, ([real:: 2.1], [double precision:: 3.1d0], [complex:: (4.1,5.1)], [integer::6], i=1,1)]
  if (any(iarr /= [integer:: 1, 2, 3, 4, 6]) ) call noteError(4)
  print *, [integer:: 1, ([real:: 2.1], [double precision:: 3.1d0], [complex:: (4.1,5.1)], [integer::6], i=1,1)]
  ...
  if (.not.all(isSameReal4([real:: 1.2, ([integer:: 2], [double precision:: 3.1d0], [complex:: (4.1,5.1)], [real::6.1], i=1,1)], &
                           [real:: 1.2, 2.0, 3.1, 4.1, 6.1]))) call noteError(7)
  rarr = [real:: 1.2, ([integer:: 2], [double precision:: 3.1d0], [complex:: (4.1,5.1)], [real::6.1], i=1,1)]
  if (.not.all(isSameReal4(rarr, [real:: 1.2, 2.0, 3.1, 4.1, 6.1]))) call noteError(8)
  print *, [real:: 1.2, ([integer:: 2], [double precision:: 3.1d0], [complex:: (4.1,5.1)], [real::6.1], i=1,1)]
  ...
  if (.not.all(isSameReal8([double precision:: 1.2d0, ([integer:: 2], [real:: 3.1], [complex:: (4.1,5.1)], [double precision::6.1d0], i=1,1)], &
                           [double precision:: 1.2d0, 2.0_4, 3.1_4, 4.1_4, 6.1d0]))) call noteError(11)
  darr = [double precision:: 1.2d0, ([integer:: 2], [real:: 3.1], [complex:: (4.1,5.1)], [double precision::6.1d0], i=1,1)]
  if (.not.all(isSameReal8(darr, [double precision:: 1.2d0, 2.0_4, 3.1_4, 4.1_4, 6.1d0]))) call noteError(12)
  print *, [double precision:: 1.2d0, ([integer:: 2], [real:: 3.1], [complex:: (4.1,5.1)], [double precision::6.1d0], i=1,1)]
  ...
  if (.not.all(isSameComplex4([complex:: ((4.1,5.1), [integer:: 2], [double precision:: 3.1d0], [real:: 1.2], [complex::(6.2,7.3)], i=1,1)], &
                              [complex:: (4.1,5.1), (2,0), (3.1,0), (1.2,0), (6.2,7.3)]))) call noteError(15)
  zarr = [complex:: ((4.1,5.1), [integer:: 2], [double precision:: 3.1d0], [real:: 1.2], [complex::(6.2,7.3)], i=1,1)]
  if (.not.all(isSameComplex4(zarr, [complex:: (4.1,5.1), (2,0), (3.1,0), (1.2,0), (6.2,7.3)]))) call noteError(16)
  print *, [complex:: ((4.1,5.1), [integer:: 2], [double precision:: 3.1d0], [real:: 1.2], [complex::(6.2,7.3)], i=1,1)]
  ...
  print *, 'x', [real:: 1.2, 3.1, 4.1, 2.0, 6.0]

  if (.not.all(isSameReal8([double precision:: 1.2d0, [integer:: 2, [real:: 3.1, [complex:: (4.1,5.1), [double precision:: 6.1d0]]]]], &
                           [double precision:: 1.2d0, 2.0d0, 3.0d0, 4.0d0, 6.0d0]))) call noteError(19)
  print *, [double precision:: 1.2d0, [integer:: 2, [real:: 3.1, [complex:: (4.1,5.1), [double precision:: 6.1d0]]]]]
  print *, 'x', [double precision:: 1.2d0, 2.0d0, 3.0d0, 4.0d0, 6.0d0]
  ...
  print *, 'x', [double precision:: 1.2d0, 6.1d0, 4.1_4, 3.1_4, 2.0_4]
  ...
  print *, 'x', [complex:: (4.1,5.1), (3.1,0.0), (1.2,0.0), (6.1,0.0), (2.0,0.0)]
  ...
  print *, 'x', [double complex:: (4.1d0,5.1d0), (3.1d0,0.0d0), (1.2_4,0.0_4), (6.1_4,0.0_4), (2.0_4,0.0_4)]
  ...
  iarr = [integer:: 1, aimag([double complex:: ([double precision:: 3.1d0, [real:: 2.1, [complex:: (4.1,5.1), [integer::6]]]], i=1,1)])]
  if (any(iarr /= [integer:: 1, 0, 0, 0, 0])) call noteError(24)
  print *, iarr
  ...
  iarr6 = [integer:: 1, aimag([complex:: (4.1,5.1), ([double precision:: 3.1d0, [complex:: (7.1,8.1), [real:: 2.1, [integer::6]]]], i=1,1)])]
  if (any(iarr6 /= [integer:: 1, 5, 0, 0, 0, 0])) call noteError(26)
  print *, iarr6
