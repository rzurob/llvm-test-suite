...
program acetnone10t
  ...
  type(derived) :: darr(4), da2(3,4), dmulti(2,3,4,5,6,7), dmulti2(7,6,5,4,3,2)
  type(derived) :: da1(size(da2)), d25(25), dflat(size(dmulti)), dempty(0)
  integer       :: i, j
  save          :: dflat
  ...
  print *, reshape((/ (derived(i), i=1,12) /), (/3,4/))
  call test2(reshape((/ (derived(i), i=1,12) /), (/3,4/)))
  da2 = reshape((/ (derived(i), i=1,12) /), (/3,4/))
  print *, da2
  ...
  print *, (/ da2(:,2), derived(100) /)
  call test1((/ da2(:,2), derived(100) /))
  darr = (/ da2(:,2), derived(100) /)
  print *, darr
  ...
  dflat = (/ (derived(i),i=1,size(dflat)) /)
