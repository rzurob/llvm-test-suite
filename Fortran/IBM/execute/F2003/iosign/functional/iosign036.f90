...
!*  stmts with format declarations and printing to a file with stream access,
...
program iosign036
    ...
    open (1,file="iosign036.1",form='formatted',access='stream', &
          sign='plus')
...
12  format(A4,I8)
    ...
    open (1,file="iosign036.1",form='formatted',position='append',&
