...
5 format(4(F5.2))
  ...
  open (1,file="iosign060.in",access='sequential',sign='suppress')
...
10 format(2(F5.2,X),F6.3,X,F7.4)
  ...
  open (1,file="iosign060.in",access='sequential',sign='processor_defined')
  read (1,5) r,r4,r8,r16
  close(1)
  ...
  open (1,file="iosign060.in",access='sequential',sign='plus')
  read (1,5) r,r4,r8,r16
  close(1)

  write (*,10,sign='suppress') r,r4,r8,r16

end program iosign060
