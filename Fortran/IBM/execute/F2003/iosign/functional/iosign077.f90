...
5 format(4(E10.4))
  ...
  open (1,file="iosign077.in",access='stream',form='formatted',sign='suppress')
  read (1,nml=myvals)
  close(1)
  ...
  open (1,file="iosign077.in",access='stream',form='formatted',&
  ...
  open (1,file="iosign077.in",access='stream',form='formatted',sign='plus')
  read (1,nml=myvals)
  close(1)

  write (*,nml=myvals,sign='suppress')

end program iosign077
