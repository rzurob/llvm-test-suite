...
program iosign084
  ...
  open (1,file="iosign084.in",access='sequential',sign='suppress')
  read (1,nml=myvals)
  close(1)
  ...
  open (1,file="iosign084.in",access='sequential',sign='processor_defined')
  read (1,nml=myvals)
  close(1)
  ...
  open (1,file="iosign084.in",access='sequential',sign='plus')
  read (1,nml=myvals)
  close(1)

  write (*,nml=myvals,sign='suppress')

end program iosign084
