...
program iosign068
  ...
  open (1,file="iosign068.in",access='sequential',sign='suppress')
  read (1,*) q,q4,q8,q16
  close(1)
...
10 format(4(E10.4,X),2(E12.5,X),2(E14.6,X))
  ...
  open (1,file="iosign068.in",access='sequential',sign='processor_defined')
  read (1,*) q,q4,q8,q16
  close(1)
  ...
  open (1,file="iosign068.in",access='sequential',sign='plus')
  read (1,*) q,q4,q8,q16
  close(1)

  write (*,10,sign='suppress') q,q4,q8,q16

end program iosign068
