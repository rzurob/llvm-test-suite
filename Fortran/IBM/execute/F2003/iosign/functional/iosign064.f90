...
5 format(4(E10.4))
  ...
  open (1,file="iosign064.in",access='sequential',sign='suppress')
...
10 format(2(G10.4,X),G12.5,X,G14.6)
  ...
  open (1,file="iosign064.in",access='sequential',sign='processor_defined')
  read (1,5) r,r4,r8,r16
  close(1)
  ...
  open (1,file="iosign064.in",access='sequential',sign='plus')
  read (1,5) r,r4,r8,r16
  close(1)

  write (*,10,sign='suppress') r,r4,r8,r16

end program iosign064
