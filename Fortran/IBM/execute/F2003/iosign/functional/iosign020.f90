...
!*  stream access, and testing format SIGN selectors(SS,SP,S). Testing complex
!*  variables.
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
...
program iosign020
    ...
    open (1,file="iosign020.1",form='formatted',access='stream')
...
12  format(A4,2(X,F7.4))
    ...
    open (1,file="iosign020.1",form='formatted',position='append',&
          access='stream')
