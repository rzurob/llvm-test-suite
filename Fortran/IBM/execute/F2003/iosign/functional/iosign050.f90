...
program iosign050
    ...
    open (1,file="iosign050.1",form='formatted',status='replace', &
          access='direct',sign='processor_defined',recl=40)
...
12  format(A4,2(X,E14.6))
    ...
    open (1,file="iosign050.1",form='formatted',status='old', &
           access='direct',sign='plus',recl=40)
...
18  format(A4,2(X,E14.6))
    ...
    open (1,file="iosign050.1",form='formatted',status='old',&
          access='direct',sign='suppress',recl=40)
