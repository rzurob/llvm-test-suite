...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ANY(LI1  .NEQV. .FALSE. ) ) ERROR STOP 11
  IF ( ANY(LI2  .NEQV. .FALSE. ) ) ERROR STOP 12
  IF ( ANY(LI4  .NEQV. .FALSE. ) ) ERROR STOP 13
  IF ( ANY(LI8  .NEQV. .TRUE.  ) ) ERROR STOP 14

  IF ( ANY(LR4  .NEQV. .FALSE. ) ) ERROR STOP 21
  IF ( ANY(LR8  .NEQV. .TRUE.  ) ) ERROR STOP 22
  IF ( ANY(LR6  .NEQV. .TRUE.  ) ) ERROR STOP 23

  IF ( ANY(LZ4  .NEQV. .FALSE. ) ) ERROR STOP 31
  IF ( ANY(LZ8  .NEQV. .TRUE.  ) ) ERROR STOP 32
  IF ( ANY(LZ6  .NEQV. .TRUE.  ) ) ERROR STOP 33
