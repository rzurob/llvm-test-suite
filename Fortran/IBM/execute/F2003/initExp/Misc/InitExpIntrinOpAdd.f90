...
!*  ===================================================================
!*
!*  TEST CASE NAME             : InitExpIntrinOpAdd.f  
!*  TEST CASE TITLE            :
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : Aug. 29, 2006
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  COMPLEX(4),  PARAMETER :: Z42(128)=(/(-I, I=127, 0, -1)/)
  COMPLEX(8),  PARAMETER :: Z82(128)=(/(-I, I=127, 0, -1)/)
  COMPLEX(16), PARAMETER :: Z62(128)=(/(-I, I=127, 0, -1)/)
