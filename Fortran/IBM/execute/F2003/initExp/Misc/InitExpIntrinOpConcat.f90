...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ANY(C9   .NE. "         " ) )                   ERROR STOP 10
  IF ( ANY(TC1  .NE. ACHAR(0)//ACHAR(0)//"       " ) ) ERROR STOP 11
  IF ( ANY(TC2  .NE. "123412345" ) )                   ERROR STOP 12
  IF ( ANY(TC3  .NE. "12345"//ACHAR(0)//"123" ) )      ERROR STOP 13
  IF ( ANY(TC4  .NE. "     "//ACHAR(0)//"   " ) )      ERROR STOP 14
