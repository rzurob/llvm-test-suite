...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  !INTEGER(1),  PARAMETER  :: MI1(128)=(/(1,-1, I=1,128,2)/)
   INTEGER(2),  PARAMETER  :: MI2(128)=(/(1,-1, I=1,128,2)/)
   INTEGER(4),  PARAMETER  :: MI4(128)=(/(1,-1, I=1,128,2)/)
   INTEGER(8),  PARAMETER  :: MI8(128)=(/(1,-1, I=1,128,2)/)
   REAL(4),     PARAMETER  :: MR4(128)=(/(1.,-1., I=1,128,2)/)
   REAL(8),     PARAMETER  :: MR8(128)=(/(1.,-1., I=1,128,2)/)
   REAL(16),    PARAMETER  :: MR6(128)=(/(1.,-1., I=1,128,2)/)
 ...
 !INTEGER(KIND(CVMGM(TSOURCE=I2, FSOURCE=II2, MASK=MI8)))  :: III1(128) = CVMGM(TSOURCE=I1, FSOURCE=II1, MASK=MI4)
  INTEGER(KIND(CVMGM(TSOURCE=I2, FSOURCE=II2, MASK=MI8)))  :: III2(128) = CVMGM(TSOURCE=I2, FSOURCE=II2, MASK=MI8)
  INTEGER(KIND(CVMGM(TSOURCE=I4, FSOURCE=II4, MASK=MI2)))  :: III4(128) = CVMGM(TSOURCE=I4, FSOURCE=II4, MASK=MI2)
  INTEGER(KIND(CVMGM(TSOURCE=I8, FSOURCE=II8, MASK=MI4)))  :: III8(128) = CVMGM(TSOURCE=I8, FSOURCE=II8, MASK=MI4)
  REAL(KIND(CVMGM(TSOURCE=R4, FSOURCE=RR4, MASK=MR6)))     :: RRR4(128) = CVMGM(TSOURCE=R4, FSOURCE=RR4, MASK=MR6)
  REAL(KIND(CVMGM(TSOURCE=R8, FSOURCE=RR8, MASK=MR6)))     :: RRR8(128) = CVMGM(TSOURCE=R8, FSOURCE=RR8, MASK=MR6)
  REAL(KIND(CVMGM(TSOURCE=R6, FSOURCE=RR6, MASK=MR4)))     :: RRR6(128) = CVMGM(TSOURCE=R6, FSOURCE=RR6, MASK=MR4)
