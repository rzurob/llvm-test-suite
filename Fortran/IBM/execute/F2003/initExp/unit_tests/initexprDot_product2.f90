...
if (l1 .neqv. dot_product((/.true._1, .false._1/), &
  & (/.false._1, .false._1/))) stop 1
if (l2 .neqv. dot_product((/.true._2, .true._2/), &
  & (/.true._2, .true._2/))) stop 2
if (l4 .neqv. dot_product((/.true._4, .false._4/), &
  & (/.false._4, .true._4/))) stop 3
if (l8 .neqv. dot_product((/.true._8, .true._8/), &
  & (/.true._8, .true._8/))) stop 4

if (i1 .ne. dot_product((/-4_1, -4_1/), (/2_1, 30_1/))) stop 5
if (i1 .ne. -128) stop 55
if (i2 .ne. dot_product((/71_2, 2_2/), (/32_2, 31_2/))) stop 6
if (i4 .ne. dot_product((/1_4, 65536_4/), (/2_4, 3_4/))) stop 7
if (i8 .ne. dot_product((/1_8, 2_8/), (/2_8, 1073741824_8/))) stop 8
end
