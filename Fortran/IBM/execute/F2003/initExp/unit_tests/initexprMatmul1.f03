...
res1b = matmul(A1,B1)
if (.not. all(res1a .eq. res1b)) error stop 1

res2b = matmul(A2,B2)
if (.not. all(res2a .eq. res2b)) error stop 2

res4b = matmul(A4,B4)
if (.not. all(res4a .eq. res4b)) error stop 3

res8b = matmul(A8,B8)
if (.not. all(res8a .eq. res8b)) error stop 4
