...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE :: DT
    LOGICAL :: C1(16)=LGT(STRING_A=(/C%C1/), STRING_B=(/C%C2(1:0)/))
    LOGICAL :: C2(16)=LGT(STRING_A=(/C%C1/), STRING_B=(/C%C2(10:10)/))
    LOGICAL :: C3(16)=LGT(STRING_A=(/C%C2/), STRING_B=(/C%C2(1:9)/))
    LOGICAL :: C4(16)=LGT(STRING_A=(/C%C2//C%C1/), STRING_B=(/C%C2(:9)//C%C2(1:0)/))
    LOGICAL :: C5(16)=LGT(STRING_A=(/C%C2//C%C3/), STRING_B=(/C%C2(:)//C%C3(:9)/))
    LOGICAL :: C6(16)=LGT(STRING_A=(/C%C1//C%C3/), STRING_B=(/C%C1(:)//C%C3(1:1)/))
    LOGICAL :: C7(16)=LGT(STRING_A=(/C%C2(1:6)/),  STRING_B=(/C%C2(1:6)/))
  END TYPE
