...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ANY (TR4   .NE.   R4 ))  ERROR STOP 21
  IF ( ANY (TR8   .NE.   R8 ))  ERROR STOP 22
  IF ( ANY (TR6   .NE.   R6 ))  ERROR STOP 23

  IF ( ANY (X4   .NE.   NEAREST(X=(/(REAL(I, KIND=4), I=0,127)/), S=-1._4)))   ERROR STOP 31
  IF ( ANY (X8   .NE.   NEAREST(X=(/(REAL(I, KIND=8), I=0,127)/), S=-1._8)))   ERROR STOP 32
  IF ( ANY (X6   .NE.   NEAREST(X=(/(REAL(I, KIND=16),I=0,127)/), S=-1._16)))  ERROR STOP 33
