...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (ANY( TA11    .NE.  (/5,5,5/) ))      ERROR STOP 11
  ...
  IF (ANY(ICHAR( TC4) .NE.  (/5,5,5/) ))     ERROR STOP 77
