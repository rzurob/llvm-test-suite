...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (R4        .NE. 4.0 )                                 STOP 22

  IF (KIND(R8)  .NE. 8   )                                 STOP 23
  IF (R8        .NE. 8.0 )                                 STOP 24

  IF (KIND(R16) .NE. 16  )                                 STOP 25
  IF (R16       .NE. 16.0)                                 STOP 26

  IF (KIND(L1)  .NE.   1   )                               STOP 31
  IF (L1        .NEQV. .TRUE. )                            STOP 32

  IF (KIND(L2)  .NE.   2   )                               STOP 33
  IF (L2        .NEQV. .TRUE. )                            STOP 34

  IF (KIND(L4)  .NE.   4   )                               STOP 35
  IF (L4        .NEQV. .TRUE. )                            STOP 36

  IF (KIND(L8)  .NE.   8   )                               STOP 37
  IF (L8        .NEQV. .TRUE. )                            STOP 38

  IF (KIND(C4)  .NE. 4   )                                 STOP 41
  IF (C4        .NE. (0.0, -0.0) )                         STOP 42

  IF (KIND(C8)  .NE. 8   )                                 STOP 43
  IF (C8        .NE. (8.0, -8.0) )                         STOP 44

  IF (KIND(C16) .NE. 16  )                                 STOP 45
  IF (C16       .NE. (16.0, -16.0))                        STOP 46
