...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (KIND(Z4R)  .NE. 4 )                ERROR STOP 41
  IF (ANY( Z4R   .NE. (8.0_4, 16.0_4)))  ERROR STOP 42
  IF (KIND(Z8R)  .NE. 8 )                ERROR STOP 43
  IF (ANY( Z8R   .NE. (4.0_4, 16.0_4)))  ERROR STOP 44
  IF (KIND(Z16R) .NE. 16 )               ERROR STOP 45
  IF (ANY( Z16R  .NE. (4.0_4, 8.0_4)))   ERROR STOP 46

  IF (KIND(Z4RX)  .NE. 4 )               ERROR STOP 51
  IF (ANY( Z4RX   .NE. (8.0_4, 0.0_4)))  ERROR STOP 52
  IF (KIND(Z8RX)  .NE. 8 )               ERROR STOP 53
  IF (ANY( Z8RX   .NE. (16.0_4, 0.0_4))) ERROR STOP 54
  IF (KIND(Z16RX) .NE. 16 )              ERROR STOP 55
  IF (ANY( Z16RX  .NE. (4.0_4, 0.0_4)))  ERROR STOP 56

  IF (KIND(Z4RXZ)  .NE. 4 )              ERROR STOP 61
  IF (ANY( Z4RXZ   .NE. (4.0_4, 8.0_4))) ERROR STOP 62
  IF (KIND(Z8RXZ)  .NE. 8 )              ERROR STOP 63
  IF (ANY( Z8RXZ   .NE. (8.0_4, 16.0_4)))ERROR STOP 64
  IF (KIND(Z16RXZ) .NE. 16 )             ERROR STOP 65
  IF (ANY( Z16RXZ  .NE. (4.0_4, 16.0_4)))ERROR STOP 66


  IF (KIND(Z4I)  .NE. 4 )                ERROR STOP 11
  IF (ANY( Z4I   .NE. (1.0_4, 2.0_4)))   ERROR STOP 12
  IF (KIND(Z8I)  .NE. 8 )                ERROR STOP 13
  IF (ANY( Z8I   .NE. (2.0_4, 4.0_4)))   ERROR STOP 14
  IF (KIND(Z16I) .NE. 16 )               ERROR STOP 15
  IF (ANY( Z16I  .NE. (1.0_4, 8.0_4)))   ERROR STOP 16

  IF (KIND(Z4IX)  .NE. 4 )               ERROR STOP 21
  IF (ANY( Z4IX   .NE. (1.0_4, 0.0_4)))  ERROR STOP 22
  IF (KIND(Z8IX)  .NE. 8 )               ERROR STOP 23
  IF (ANY( Z8IX   .NE. (2.0_4, 0.0_4)))  ERROR STOP 24
  IF (KIND(Z16IX) .NE. 16 )              ERROR STOP 25
  IF (ANY( Z16IX  .NE. (1.0_4, 0.0_4)))  ERROR STOP 26

  IF (KIND(Z4IXZ)  .NE. 4 )              ERROR STOP 31
  IF (ANY( Z4IXZ   .NE. (1.0_4, 8.0_4))) ERROR STOP 32
  IF (KIND(Z8IXZ)  .NE. 8 )              ERROR STOP 33
  IF (ANY( Z8IXZ   .NE. (1.0_4, 2.0_4))) ERROR STOP 34
  IF (KIND(Z16IXZ) .NE. 16 )             ERROR STOP 35
  IF (ANY( Z16IXZ  .NE. (2.0_4, 4.0_4))) ERROR STOP 36
