...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE :: DT
    LOGICAL :: C1(16)=LLE(STRING_B=C%C1, STRING_A=C%C2(1:0))
    LOGICAL :: C2(16)=LLE(STRING_B=C%C1, STRING_A=C%C2(10:10))
    LOGICAL :: C3(16)=LLE(STRING_B=C%C2, STRING_A=C%C2(:))
    LOGICAL :: C4(16)=LLE(STRING_B=C%C2//C%C1, STRING_A=C%C2(:)//C%C2(1:0))
    LOGICAL :: C5(16)=LLE(STRING_B=C%C2//C%C3, STRING_A=C%C2(:)//C%C3)
    LOGICAL :: C6(16)=LLE(STRING_B=C%C1//C%C3, STRING_A=C%C1(:)//C%C3)
    LOGICAL :: C7(16)=LLE(STRING_B=C%C2(1:6),  STRING_A=C%C2(2:6))
  END TYPE
