    ...
    error stop 500
      ...
      subroutine sub1(x16, x8, r4, i8, flag)
         ...
         if (flag .eq. 1) then
            ...
            expect_r4 = r4
            expect_i8 = i8
         if(num(1) .ne. 2*num(2))      error stop 222
         if(num(3) .ne. num(4))      error stop 223
         if(fsize  .ne. num(1)*5)    error stop 224
         if(fpos   .ne. (num(1)*5+1)) error stop 225
            close(1)
