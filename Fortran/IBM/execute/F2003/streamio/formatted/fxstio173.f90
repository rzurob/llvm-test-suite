...
!*
!*  DESCRIPTION                : Test PAD='no' in Stream I/O. This also
!*                               test SIZE= specifier in READ stmt.
!*
!* ===================================================================
!*  REVISION HISTORY
...
!************************************************************* 
     ...
     OPEN(1, FILE='fxstio173.dat', FORM='FORMATTED', ACCESS='STREAM', &
    &     STATUS='REPLACE', IOSTAT=ios, ERR=90, PAD='no')
...
!
! EOF for PAD='no', ADVANCE='yes' at the end of file
!
...
!
! EOF for PAD='no', ADVANCE='no' at the end of file
!
...
!
! EOF for PAD='no', ADVANCE='yes' in the last record
!
...
!
! EOF for PAD='no', ADVANCE='no' in the last record
!
...
!***************************************************************** 
    ...
    &     STATUS='OLD', IOSTAT=ios, ERR=90, PAD='yes')
     ...
     READ(1, FMT='(A25)', SIZE=size, IOSTAT=ios, EOR=201, ERR=92, ADVANCE='no') ch22_out
     error stop 55
