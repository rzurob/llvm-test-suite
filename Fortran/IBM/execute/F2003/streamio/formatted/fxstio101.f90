...
!*
!*  DESCRIPTION                : Test differet interinsic data types with
...
!**********************************************************
     ...
     OPEN(1, FILE='fxstio101.dat', FORM='FORMATTED', ACCESS='STREAM', &
    &     STATUS='NEW', IOSTAT=ios, ERR=90)

     WRITE(1, FMT='(I2, I5, I10, I20)', IOSTAT=ios, ERR=91) &
    &     i1_in, i2_in, i4_in, i8_in
     WRITE(1, FMT='(F9.6,D25.17,Q40.32)', IOSTAT=ios, ERR=91) &
    &      r4_in, r8_in, r16_in
     WRITE(1, FMT='(D25.17)', IOSTAT=ios, ERR=91) d8_in
     WRITE(1, FMT='(2E15.7,2D25.17,2Q40.32)', IOSTAT=ios, ERR=91) &
    &      x8_in, x16_in, x32_in
     WRITE(1, FMT='(3L5)', IOSTAT=ios, ERR=91) l2_in, l4_in, l8_in
     WRITE(1, FMT='(A1,A16)', IOSTAT=ios, ERR=91) ch1_in, ch15_in
     WRITE(1, FMT='(B8)', IOSTAT=ios, ERR=91) b_in

     REWIND(1, IOSTAT=ios, ERR=93)

     READ(1, FMT='(I2, I5, I10, I20)', IOSTAT=ios, ERR=92) &
    &     i1_out, i2_out, i4_out, i8_out
     READ(1, FMT='(F9.6,D25.17,Q40.32)', IOSTAT=ios, ERR=92) &
    &     r4_out, r8_out, r16_out
     READ(1, FMT='(D25.17)', IOSTAT=ios, ERR=92) d8_out
