...
!*
!*  DESCRIPTION                : Test B edit descriptors in
...
!********************************************************** 
     ...
     OPEN(1, FILE='fxstio144a.dat', FORM='FORMATTED', ACCESS='STREAM', &
    &     STATUS='REPLACE', IOSTAT=ios, ERR=90)

     WRITE(1, FMT='(B8, B20.16, B32.0)', IOSTAT=ios, ERR=91, ADVANCE='no') &
    &      i1_out, i2_out, i4_out
     WRITE(1, FMT='(B0)', IOSTAT=ios, ERR=91) i8_out
     WRITE(1, FMT='(B34.32, B66, B130)', IOSTAT=ios, ERR=91) &
    &      r4_out, r8_out, r16_out
     WRITE(1, FMT='(B9, B17.16, B3, B1)', IOSTAT=ios, ERR=91) &
    &      l1_out, l2_out, l4_out, l8_out 
     WRITE(1, FMT='(B8)', IOSTAT=ios, ERR=91) b1_out
     WRITE(1, FMT='(B8)', IOSTAT=ios, ERR=91) ch1_out
     WRITE(1, FMT='(B66.32)', IOSTAT=ios, ERR=91) i8_par_out
     WRITE(1, FMT='(B0.0)', IOSTAT=ios, ERR=91) l8_par_out
     WRITE(1, FMT='(B32.16)', IOSTAT=ios, ERR=91) 9876543_4
     WRITE(1, FMT='(B32)', IOSTAT=ios, ERR=91) 3.14 
     WRITE(1, FMT='(B66)', IOSTAT=ios, ERR=91) 3.1456789D-20 
     WRITE(1, FMT='(B130)', IOSTAT=ios, ERR=91) -3.1456789Q+120 
     WRITE(1, FMT='(B2, 8H 101010 ))', IOSTAT=ios, ERR=91) .false._4

     REWIND(1)

     READ(1, FMT='(B8, B20, B32.0, B64)', IOSTAT=ios, ERR=92) &
    &       i1_in, i2_in, i4_in, i8_in
     READ(1, FMT='(B34.32, B66, B130)', IOSTAT=ios, ERR=92) &
    &       r4_in, r8_in, r16_in
     READ(1, FMT='(B9, B17.16, B3, B1)', IOSTAT=ios, ERR=92) &
    &       l1_in, l2_in, l4_in, l8_in
     READ(1, FMT='(B8)', IOSTAT=ios, ERR=92) b1_in
     READ(1, FMT='(B8)', IOSTAT=ios, ERR=92) ch1_in
     READ(1, FMT='(B66)', IOSTAT=ios, ERR=92) i8_par_in
     READ(1, FMT='(B64)', IOSTAT=ios, ERR=92) l8_par_in
     READ(1, FMT='(B32)', IOSTAT=ios, ERR=92) i4_ltrl_in
     READ(1, FMT='(B32)', IOSTAT=ios, ERR=92) r4_ltrl_in
     READ(1, FMT='(B66)', IOSTAT=ios, ERR=92) r8_ltrl_in
     READ(1, FMT='(B130)', IOSTAT=ios, ERR=92) r16_ltrl_in
     READ(1, FMT='(B2, B8)', IOSTAT=ios, ERR=92) l4_ltrl_in, b1_ltrl_in
...
!********************************************************** 
     ...
     if ( b1_ltrl_in .ne. b'101010') error stop 38
