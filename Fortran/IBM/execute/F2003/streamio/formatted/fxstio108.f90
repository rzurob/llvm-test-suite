...
!*
!*  DESCRIPTION                : Test parameter with
...
!********************************************************** 
     ...
     OPEN(1, FILE='fxstio108.dat', FORM='FORMATTED', ACCESS='STREAM', &
    &     STATUS='NEW', IOSTAT=ios, ERR=90)

     WRITE(1, FMT='(I5, I10, I20)', IOSTAT=ios, ERR=91) i2_in, i4_in, i8_in
