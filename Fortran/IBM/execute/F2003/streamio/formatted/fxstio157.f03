...
!*
!*  DESCRIPTION                : Test List-Directed Stream I/O
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  program fxstio157
     ...
     complex*16   :: x16_out
     complex*32   :: x32_in = (0.5 * huge(r16_in), -0.5 * huge(r16_in))
     complex*32   :: x32_out
...
!**********************************************************
    ...
    &     (huge(r16_in) / 2. , -0.25Q0 * huge(r16_in) * .2Q1)
     WRITE(1, FMT=*, IOSTAT=ios, ERR=91) &
    &      .true._2, .false., (l8_in .or. .false._8)
     WRITE(1, FMT=*, IOSTAT=ios, ERR=91, POS=500) &
    &      'A', "New "//"Baby "//"Girl! "
     WRITE(1, FMT=*, IOSTAT=ios, ERR=91) &
    &      B'01010111', O'137', Z'1F'

     WRITE(1, FMT=*, IOSTAT=ios, ERR=91) "The last\n one!"


     READ(1, FMT=*, IOSTAT=ios, ERR=92, POS=10) i2_out, i4_out, i8_out
     READ(1, FMT=*, IOSTAT=ios, ERR=92) &
    ...
    &      x8_out, x16_out, x32_out
     ...
     READ(1, FMT=*, IOSTAT=ios, ERR=92, POS=500) ch1_out, ch15_out
     READ(1, FMT=*, IOSTAT=ios, ERR=92) b_out, O_out, Z_out
...
!**********************************************************
     ...
     if ( H_out .ne. 14HThe last one! ) error stop 27
