...
!*
!*  DESCRIPTION                : Test record structure (scalar and array) with
...
!********************************************************** 
    ...
    &     STATUS='NEW', IOSTAT=ios, ERR=90)
     ...
     WRITE(1, FMT=190, IOSTAT=ios, ERR=91) st_in1
     WRITE(1, FMT=191, IOSTAT=ios, ERR=91) (st_in2(i),i=1,N)
     WRITE(1, FMT=192, IOSTAT=ios, ERR=91) st_in3

     REWIND(1, IOSTAT=ios, ERR=93)

     READ(1, FMT=190, IOSTAT=ios, ERR=92) st_out1
     READ(1, FMT=191, IOSTAT=ios, ERR=92) st_out2
...
192  FORMAT (100(I10, 10F9.6, 2E15.7, L5, A16))
