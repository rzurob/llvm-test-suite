...
/*
        C code for testcase "fxisoj08.f" and "fxisoj09.f"
*/
...
size_t fnt2a(const size_t *a, const intptr_t *b) {
   int i;
...
size_t fnt5(size_t aa[][10], intptr_t bb[][10]) {
   int i, j;
...
size_t fnt6(size_t aa[][10], intptr_t bb[][10]) {
   int i, j;
...
size_t fnt6a(const size_t aa[][10], const intptr_t bb[][10]) {
   int i, j;
...
size_t fnt7(size_t aa[][10], intptr_t bb[][10]) {
   int i, j;
...
size_t fnt8(size_t aa[][10], intptr_t bb[][10]) {
   int i, j;
