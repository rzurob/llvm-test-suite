...
/*
        C code for testcase "fxisod08.f" and "fxisod09.f"
*/
...
int32_t fnt2a(const int32_t *a, const int64_t *b) {
   int i;
...
int32_t fnt5(int32_t aa[][10], int64_t bb[][10]) {
   int i, j;
...
int32_t fnt6(int32_t aa[][10], int64_t bb[][10]) {
   int i, j;
...
int32_t fnt6a(const int32_t aa[][10], const int64_t bb[][10]) {
   int i, j;
...
int32_t fnt7(int32_t aa[][10], int64_t bb[][10]) {
   int i, j;
...
int32_t fnt8(int32_t aa[][10], int64_t bb[][10]) {
   int i, j;
