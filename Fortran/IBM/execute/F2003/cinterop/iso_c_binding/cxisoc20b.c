...
/*
        C code for testcase "fxisoc20b.f" and "fxisoc21b.f"
*/
...
int8_t fnt7a(const struct dtd0 *dt) {
...
int8_t fnt8a(const struct dtd0 dt) {
...
int8_t fnt9a(const struct dtd1 *dt) {
...
int8_t fnt10a(const struct dtd1 dt) {
...
int8_t fnt11a(const struct dtd2 *dt) {
...
int8_t fnt12a(const struct dtd2 dt) {
