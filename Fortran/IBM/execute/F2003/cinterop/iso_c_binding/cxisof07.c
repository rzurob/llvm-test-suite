...
int main() {
   ...
   void sub2a(const int_least32_t *, const int_least64_t *);
   void sub3(int_least32_t *, int_least64_t *);
   void sub4(int_least32_t *, int_least64_t *);
   void sub5(int_least32_t [], int_least64_t []);
   void sub6(int_least32_t [], int_least64_t []);
   void sub6a(const int_least32_t [], const int_least64_t []);
   void sub7(int_least32_t [], int_least64_t []);
   void sub8(int_least32_t [], int_least64_t []);
