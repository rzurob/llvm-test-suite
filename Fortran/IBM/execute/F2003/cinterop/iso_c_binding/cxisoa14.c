/*
        C code for testcase "fxisoa14.f" and "fxisoa15.f"
*/
...
int fnt10a(const struct dt1 dt) {
...
int fnt11a(const struct dt2 *dt) {
...
int fnt12a(const struct dt2 dt) {
