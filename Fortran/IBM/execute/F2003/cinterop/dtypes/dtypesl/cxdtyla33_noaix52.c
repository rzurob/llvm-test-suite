...
int main() {
    ...
    for ( l = 0; l < DIM1; l++ ) {
     for ( i = 0; i < DIM1; i++ ) {
      for ( j = 0; j < DIM2; j++ ) {
       ...
       if ( dta[k][l].vdt1[j][i].var_a[i][j] != 1 ) exit(53);
       if ( dta[k][l].vdt1[j][i].var_b[i][j] != i*DIM2+j+3 ) exit(55);
       if ( dta[k][l].vdt1[j][i].var_c[i][j] != 'B' ) exit(57);
       if ( dta[k][l].vdt1[j][i].var_d[i][j] != i*DIM2+j+5 ) exit(59);
       if ( dta[k][l].vdt1[j][i].var_e[i][j] != i*DIM2+j+6 ) exit(61);
       if ( dta[k][l].vdt1[j][i].var_f[i][j] != i*DIM2+j+7 ) exit(63);
       if ( dta[k][l].vdt1[j][i].var_g[i][j] != 1 ) exit(65);
       if ( dta[k][l].vdt1[j][i].var_h[i][j] != i*DIM2+j+9 ) exit(67);

       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_a[i][j] != 1 ) exit(69);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_b[i][j] != i*DIM2+j+3 ) exit(71);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_c[i][j] != 'B' ) exit(73);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_d[i][j] != i*DIM2+j+5 ) exit(75);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_e[i][j] != i*DIM2+j+6 ) exit(77);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_f[i][j] != i*DIM2+j+7 ) exit(79);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_g[i][j] != 1 ) exit(81);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_h[i][j] != i*DIM2+j+9 ) exit(83);
      }
     }
    }
   }
   ...
   for ( k = 0; k < DIM2; k++ ) {
    for ( l = 0; l < DIM1; l++ ) {
     for ( i = 0; i < DIM1; i++ ) {
      for ( j = 0; j < DIM2; j++ ) {
       if ( dtb[k][l].var_a[i][j] != (float)(2*(i*DIM2+j+2)-1) ) exit(85);
       if ( dtb[k][l].var_b[i][j] != 1 ) exit(87);
       if ( dtb[k][l].var_c[i][j] != (long double)(2*(i*DIM2+j+4)+1) ) exit(89);
       if ( dtb[k][l].var_d[i][j] != (double)(2*(i*DIM2+j+5)+2) ) exit(91);
       if ( dtb[k][l].var_e[i][j] != (float)(2*(i*DIM2+j+6)+3) ) exit(93);
       if ( dtb[k][l].var_f[i][j] != 1 ) exit(95);
       if ( dtb[k][l].var_g[i][j] != (double)(2*(i*DIM2+j+8)+5) ) exit(97);
       if ( dtb[k][l].var_h[i][j] != 'B' ) exit(99);

       if ( (dtr+k*DIM1+l)->var_a[i][j] != (float)(2*(i*DIM2+j+2)-1) ) exit(101);
       if ( (dtr+k*DIM1+l)->var_b[i][j] != 1 ) exit(103);
       if ( (dtr+k*DIM1+l)->var_c[i][j] != (long double)(2*(i*DIM2+j+4)+1) ) exit(105);
       if ( (dtr+k*DIM1+l)->var_d[i][j] != (double)(2*(i*DIM2+j+5)+2) ) exit(107);
       if ( (dtr+k*DIM1+l)->var_e[i][j] != (float)(2*(i*DIM2+j+6)+3) ) exit(109);
       if ( (dtr+k*DIM1+l)->var_f[i][j] != 1 ) exit(111);
       if ( (dtr+k*DIM1+l)->var_g[i][j] != (double)(2*(i*DIM2+j+8)+5) ) exit(113);
       if ( (dtr+k*DIM1+l)->var_h[i][j] != 'B' ) exit(115);

       if ( dtb[k][l].vdt1[j][i].var_a[i][j] != 1 ) exit(117);
       if ( dtb[k][l].vdt1[j][i].var_b[i][j] != 2*(i*DIM2+j+3) ) exit(119);
       if ( dtb[k][l].vdt1[j][i].var_c[i][j] != 'B' ) exit(121);
       if ( dtb[k][l].vdt1[j][i].var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(123);
       if ( dtb[k][l].vdt1[j][i].var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(125);
       if ( dtb[k][l].vdt1[j][i].var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(127);
       if ( dtb[k][l].vdt1[j][i].var_g[i][j] != 1 ) exit(129);
       if ( dtb[k][l].vdt1[j][i].var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(131);

       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_a[i][j] != 1 ) exit(133);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_b[i][j] != 2*(i*DIM2+j+3) ) exit(135);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_c[i][j] != 'B' ) exit(137);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(139);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(141);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(143);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_g[i][j] != 1 ) exit(145);
       if ( (dtr+k*DIM1+l)->vdt1[j][i].var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(147);
      }
     }
    }
   }
