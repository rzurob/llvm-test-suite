   ...
   for ( k = 0; k < DIM2*DIM1; k++ ) {
    for ( i = 0; i < DIM1; i++ ) {
     for ( j = 0; j < DIM2; j++ ) {
       ...
       if ( (dta+k)->vdt1[j][i].var_b[i][j] != (double)(i*DIM2+j+3) ) exit(55);
       if ( (dta+k)->vdt1[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(57);
       if ( (dta+k)->vdt1[j][i].var_d[i][j] != (float)(i*DIM2+j+5) ) exit(59);
       if ( (dta+k)->vdt1[j][i].var_e[i][j] != (long double)(i*DIM2+j+6) ) exit(61);
       if ( (dta+k)->vdt1[j][i].var_f[i][j] != (double)(i*DIM2+j+7) ) exit(63);
       if ( (dta+k)->vdt1[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(65);
       if ( (dta+k)->vdt1[j][i].var_h[i][j] != (float)(i*DIM2+j+9) ) exit(67);

       if ( (dtr+k)->vdt1[j][i].var_a[i][j] != i*DIM2+j+2 ) exit(69);
       if ( (dtr+k)->vdt1[j][i].var_b[i][j] != (double)(i*DIM2+j+3) ) exit(71);
       if ( (dtr+k)->vdt1[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(73);
       if ( (dtr+k)->vdt1[j][i].var_d[i][j] != (float)(i*DIM2+j+5) ) exit(75);
       if ( (dtr+k)->vdt1[j][i].var_e[i][j] != (long double)(i*DIM2+j+6) ) exit(77);
       if ( (dtr+k)->vdt1[j][i].var_f[i][j] != (double)(i*DIM2+j+7) ) exit(79);
       if ( (dtr+k)->vdt1[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(81);
       if ( (dtr+k)->vdt1[j][i].var_h[i][j] != (float)(i*DIM2+j+9) ) exit(83);
     }
    }
   }
   ...
   for ( k = 0; k < DIM2*DIM1; k++ ) {
    for ( i = 0; i < DIM1; i++ ) {
     for ( j = 0; j < DIM2; j++ ) {
       ...
       if ( (dtb+k)->vdt1[j][i].var_b[i][j] != (double)(2*(i*DIM2+j+3)) ) exit(119);
       if ( (dtb+k)->vdt1[j][i].var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(121);
       if ( (dtb+k)->vdt1[j][i].var_d[i][j] != (float)(2*(i*DIM2+j+5)+2) ) exit(123);
       if ( (dtb+k)->vdt1[j][i].var_e[i][j] != (long double)(2*(i*DIM2+j+6)+3) ) exit(125);
       if ( (dtb+k)->vdt1[j][i].var_f[i][j] != (double)(2*(i*DIM2+j+7)+4) ) exit(127);
       if ( (dtb+k)->vdt1[j][i].var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(129);
       if ( (dtb+k)->vdt1[j][i].var_h[i][j] != (float)(2*(i*DIM2+j+9)+6) ) exit(131);

       if ( (dtr+k)->vdt1[j][i].var_a[i][j] != 2*(i*DIM2+j+2)-1 ) exit(133);
       if ( (dtr+k)->vdt1[j][i].var_b[i][j] != (double)(2*(i*DIM2+j+3)) ) exit(135);
       if ( (dtr+k)->vdt1[j][i].var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(137);
       if ( (dtr+k)->vdt1[j][i].var_d[i][j] != (float)(2*(i*DIM2+j+5)+2) ) exit(139);
       if ( (dtr+k)->vdt1[j][i].var_e[i][j] != (long double)(2*(i*DIM2+j+6)+3) ) exit(141);
       if ( (dtr+k)->vdt1[j][i].var_f[i][j] != (double)(2*(i*DIM2+j+7)+4) ) exit(143);
       if ( (dtr+k)->vdt1[j][i].var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(145);
       if ( (dtr+k)->vdt1[j][i].var_h[i][j] != (float)(2*(i*DIM2+j+9)+6) ) exit(147);
     }
    }
   }
