    ...
    for ( l = 0; l < DIM1; l++ ) {
     for ( i = 0; i < DIM1; i++ ) {
      for ( j = 0; j < DIM2; j++ ) {
       ...
       if ( (dtr+k*DIM1+l)->var_a[i][j] != i*DIM2+j+2 ) exit(37);
       if ( (dtr+k*DIM1+l)->var_b[i][j] != i*DIM2+j+3 ) exit(39);
       if ( (dtr+k*DIM1+l)->var_c[i][j] != i*DIM2+j+4 ) exit(41);
       if ( (dtr+k*DIM1+l)->var_d[i][j] != i*DIM2+j+5 ) exit(43);
       if ( (dtr+k*DIM1+l)->var_e[i][j] != i*DIM2+j+6 ) exit(45);
       if ( (dtr+k*DIM1+l)->var_f[i][j] != i*DIM2+j+7 ) exit(47);
       if ( (dtr+k*DIM1+l)->var_g[i][j] != i*DIM2+j+8 ) exit(49);
       if ( (dtr+k*DIM1+l)->var_h[i][j] != i*DIM2+j+9 ) exit(51);

       if ( dta[k][l].vdt2[j][i].var_a[i][j] != i*DIM2+j+2 ) exit(53);
       if ( dta[k][l].vdt2[j][i].var_b[i][j] != i*DIM2+j+3 ) exit(55);
       if ( dta[k][l].vdt2[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(57);
       if ( dta[k][l].vdt2[j][i].var_d[i][j] != i*DIM2+j+5 ) exit(59);
       if ( dta[k][l].vdt2[j][i].var_e[i][j] != i*DIM2+j+6 ) exit(61);
       if ( dta[k][l].vdt2[j][i].var_f[i][j] != i*DIM2+j+7 ) exit(63);
       if ( dta[k][l].vdt2[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(65);
       if ( dta[k][l].vdt2[j][i].var_h[i][j] != i*DIM2+j+9 ) exit(67);

       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_a[i][j] != i*DIM2+j+2 ) exit(69);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_b[i][j] != i*DIM2+j+3 ) exit(71);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(73);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_d[i][j] != i*DIM2+j+5 ) exit(75);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_e[i][j] != i*DIM2+j+6 ) exit(77);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_f[i][j] != i*DIM2+j+7 ) exit(79);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(81);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_h[i][j] != i*DIM2+j+9 ) exit(83);

       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_a[i][j] != i*DIM2+j+2 ) exit(85);
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_b[i][j] != i*DIM2+j+3 ) exit(87);
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(89);
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_d[i][j] != i*DIM2+j+5 ) exit(91);
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_e[i][j] != i*DIM2+j+6 ) exit(93);
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_f[i][j] != i*DIM2+j+7 ) exit(95);
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(97);
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_h[i][j] != i*DIM2+j+9 ) exit(99);

       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_a[i][j] != i*DIM2+j+2 ) exit(101);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_b[i][j] != i*DIM2+j+3 ) exit(103);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(105);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_d[i][j] != i*DIM2+j+5 ) exit(107);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_e[i][j] != i*DIM2+j+6 ) exit(109);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_f[i][j] != i*DIM2+j+7 ) exit(111);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(113);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_h[i][j] != i*DIM2+j+9 ) exit(115);
      }
     }
    }
   }
...
/* Test 2 */
   ...
   for ( k = 0; k < DIM2; k++ ) {
    for ( l = 0; l < DIM1; l++ ) {
     for ( i = 0; i < DIM1; i++ ) {
      for ( j = 0; j < DIM2; j++ ) {
       if ( dtb[k][l].var_a[i][j] != 2*(i*DIM2+j+2)-1 ) exit(117);
       if ( dtb[k][l].var_b[i][j] != 2*(i*DIM2+j+3) ) exit(119);
       if ( dtb[k][l].var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(121);
       if ( dtb[k][l].var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(123);
       if ( dtb[k][l].var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(125);
       if ( dtb[k][l].var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(127);
       if ( dtb[k][l].var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(129);
       if ( dtb[k][l].var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(131);

       if ( (dtr+k*DIM1+l)->var_a[i][j] != 2*(i*DIM2+j+2)-1 ) exit(133);
       if ( (dtr+k*DIM1+l)->var_b[i][j] != 2*(i*DIM2+j+3) ) exit(135);
       if ( (dtr+k*DIM1+l)->var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(137);
       if ( (dtr+k*DIM1+l)->var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(139);
       if ( (dtr+k*DIM1+l)->var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(141);
       if ( (dtr+k*DIM1+l)->var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(143);
       if ( (dtr+k*DIM1+l)->var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(145);
       if ( (dtr+k*DIM1+l)->var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(147);

       if ( dtb[k][l].vdt2[j][i].var_a[i][j] != 2*(i*DIM2+j+2)-1 ) exit(149);
       if ( dtb[k][l].vdt2[j][i].var_b[i][j] != 2*(i*DIM2+j+3) ) exit(151);
       if ( dtb[k][l].vdt2[j][i].var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(153);
       if ( dtb[k][l].vdt2[j][i].var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(155);
       if ( dtb[k][l].vdt2[j][i].var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(157);
       if ( dtb[k][l].vdt2[j][i].var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(159);
       if ( dtb[k][l].vdt2[j][i].var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(161);
       if ( dtb[k][l].vdt2[j][i].var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(163);

       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_a[i][j] != 2*(i*DIM2+j+2)-1 ) exit(165);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_b[i][j] != 2*(i*DIM2+j+3) ) exit(167);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(169);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(171);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(173);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(175);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(177);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(179);

       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_a[i][j] != 2*(i*DIM2+j+2)-1 ) exit(181);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_b[i][j] != 2*(i*DIM2+j+3) ) exit(183);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(185);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(187);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(189);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(191);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(193);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(195);

       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_a[i][j] != 2*(i*DIM2+j+2)-1 ) exit(197);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_b[i][j] != 2*(i*DIM2+j+3) ) exit(199);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_c[i][j] != 2*(i*DIM2+j+4)+1 ) exit(201);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_d[i][j] != 2*(i*DIM2+j+5)+2 ) exit(203);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_e[i][j] != 2*(i*DIM2+j+6)+3 ) exit(205);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(207);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_g[i][j] != 2*(i*DIM2+j+8)+5 ) exit(209);
       if ( (dtr+k*DIM1+l)->vdt2[j][i].vdt1[j][i].var_h[i][j] != 2*(i*DIM2+j+9)+6 ) exit(211);
      }
     }
    }
   }
