...
#else
       if ( (dta+k)->vdt1[j][i].var_b[i][j] != createcomplex((double)(i*DIM2+j+3),(double)(i*DIM2+j+3)) ) exit(55);
#endif
       if ( (dta+k)->vdt1[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(57);
#ifdef CMPLX
       if ( (dta+k)->vdt1[j][i].var_d[i][j] != (float)(i*DIM2+j+5)+I*(float)(i*DIM2+j+5) ) exit(59);
#else
       if ( (dta+k)->vdt1[j][i].var_d[i][j] != createcomplexf((float)(i*DIM2+j+5),(float)(i*DIM2+j+5)) ) exit(59);
#endif
#ifdef CMPLX
       if ( (dta+k)->vdt1[j][i].var_e[i][j] != (long double)(i*DIM2+j+6)+I*(long double)(i*DIM2+j+6) ) exit(61);
#else
       if ( (dta+k)->vdt1[j][i].var_e[i][j] != createcomplexl((long double)(i*DIM2+j+6),(long double)(i*DIM2+j+6)) ) exit(61);
#endif
#ifdef CMPLX
       if ( (dta+k)->vdt1[j][i].var_f[i][j] != (double)(i*DIM2+j+7)+I*(double)(i*DIM2+j+7) ) exit(63);
#else
       if ( (dta+k)->vdt1[j][i].var_f[i][j] != createcomplex((double)(i*DIM2+j+7),(double)(i*DIM2+j+7)) ) exit(63);
#endif
       if ( (dta+k)->vdt1[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(65);
#ifdef CMPLX
       if ( (dta+k)->vdt1[j][i].var_h[i][j] != (float)(i*DIM2+j+9)+I*(float)(i*DIM2+j+9) ) exit(67);
#else
       if ( (dta+k)->vdt1[j][i].var_h[i][j] != createcomplexf((float)(i*DIM2+j+9),(float)(i*DIM2+j+9)) ) exit(67);
#endif
...
#else
       if ( (dtr+k)->vdt1[j][i].var_b[i][j] != createcomplex((double)(i*DIM2+j+3),(double)(i*DIM2+j+3)) ) exit(71);
#endif
       if ( (dtr+k)->vdt1[j][i].var_c[i][j] != i*DIM2+j+4 ) exit(73);
#ifdef CMPLX
       if ( (dtr+k)->vdt1[j][i].var_d[i][j] != (float)(i*DIM2+j+5)+I*(float)(i*DIM2+j+5) ) exit(75);
#else
       if ( (dtr+k)->vdt1[j][i].var_d[i][j] != createcomplexf((float)(i*DIM2+j+5),(float)(i*DIM2+j+5)) ) exit(75);
#endif
#ifdef CMPLX
       if ( (dtr+k)->vdt1[j][i].var_e[i][j] != (long double)(i*DIM2+j+6)+I*(long double)(i*DIM2+j+6) ) exit(77);
#else
       if ( (dtr+k)->vdt1[j][i].var_e[i][j] != createcomplexl((long double)(i*DIM2+j+6),(long double)(i*DIM2+j+6)) ) exit(77);
#endif
#ifdef CMPLX
       if ( (dtr+k)->vdt1[j][i].var_f[i][j] != (double)(i*DIM2+j+7)+I*(double)(i*DIM2+j+7) ) exit(79);
#else
       if ( (dtr+k)->vdt1[j][i].var_f[i][j] != createcomplex((double)(i*DIM2+j+7),(double)(i*DIM2+j+7)) ) exit(79);
#endif
       if ( (dtr+k)->vdt1[j][i].var_g[i][j] != i*DIM2+j+8 ) exit(81);
#ifdef CMPLX
       if ( (dtr+k)->vdt1[j][i].var_h[i][j] != (float)(i*DIM2+j+9)+I*(float)(i*DIM2+j+9) ) exit(83);
#else
       if ( (dtr+k)->vdt1[j][i].var_h[i][j] != createcomplexf((float)(i*DIM2+j+9),(float)(i*DIM2+j+9)) ) exit(83);
#endif
     }
    }
   }
...
#else
       if ( (dtb+k)->var_a[i][j] != createcomplexf((float)(2*(i*DIM2+j+2)-1),(float)(2*(i*DIM2+j+2)-1)) ) exit(85);
#endif
...
#else
       if ( (dtb+k)->var_c[i][j] != createcomplexl((long double)(2*(i*DIM2+j+4)+1),(long double)(2*(i*DIM2+j+4)+1)) ) exit(89);
#endif
#ifdef CMPLX
       if ( (dtb+k)->var_d[i][j] != (double)(2*(i*DIM2+j+5)+2)+I*(double)(2*(i*DIM2+j+5)+2) ) exit(91);
#else
       if ( (dtb+k)->var_d[i][j] != createcomplex((double)(2*(i*DIM2+j+5)+2),(double)(2*(i*DIM2+j+5)+2)) ) exit(91);
#endif
#ifdef CMPLX
       if ( (dtb+k)->var_e[i][j] != (float)(2*(i*DIM2+j+6)+3)+I*(float)(2*(i*DIM2+j+6)+3) ) exit(93);
#else
       if ( (dtb+k)->var_e[i][j] != createcomplexf((float)(2*(i*DIM2+j+6)+3),(float)(2*(i*DIM2+j+6)+3)) ) exit(93);
#endif
       if ( (dtb+k)->var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(95);
#ifdef CMPLX
       if ( (dtb+k)->var_g[i][j] != (double)(2*(i*DIM2+j+8)+5)+I*(double)(2*(i*DIM2+j+8)+5) ) exit(97);
#else
       if ( (dtb+k)->var_g[i][j] != createcomplex((double)(2*(i*DIM2+j+8)+5),(double)(2*(i*DIM2+j+8)+5)) ) exit(97);
#endif
...
#else
       if ( (dtr+k)->var_a[i][j] != createcomplexf((float)(2*(i*DIM2+j+2)-1),(float)(2*(i*DIM2+j+2)-1)) ) exit(101);
#endif
...
#else
       if ( (dtr+k)->var_c[i][j] != createcomplexl((long double)(2*(i*DIM2+j+4)+1),(long double)(2*(i*DIM2+j+4)+1)) ) exit(105);
#endif
#ifdef CMPLX
       if ( (dtr+k)->var_d[i][j] != (double)(2*(i*DIM2+j+5)+2)+I*(double)(2*(i*DIM2+j+5)+2) ) exit(107);
#else
       if ( (dtr+k)->var_d[i][j] != createcomplex((double)(2*(i*DIM2+j+5)+2),(double)(2*(i*DIM2+j+5)+2)) ) exit(107);
#endif
#ifdef CMPLX
       if ( (dtr+k)->var_e[i][j] != (float)(2*(i*DIM2+j+6)+3)+I*(float)(2*(i*DIM2+j+6)+3) ) exit(109);
#else
       if ( (dtr+k)->var_e[i][j] != createcomplexf((float)(2*(i*DIM2+j+6)+3),(float)(2*(i*DIM2+j+6)+3)) ) exit(109);
#endif
       if ( (dtr+k)->var_f[i][j] != 2*(i*DIM2+j+7)+4 ) exit(111);
#ifdef CMPLX
       if ( (dtr+k)->var_g[i][j] != (double)(2*(i*DIM2+j+8)+5)+I*(double)(2*(i*DIM2+j+8)+5) ) exit(113);
#else
       if ( (dtr+k)->var_g[i][j] != createcomplex((double)(2*(i*DIM2+j+8)+5),(double)(2*(i*DIM2+j+8)+5)) ) exit(113);
#endif
...
#else
       if ( (dtb+k)->vdt1[j][i].var_b[i][j] != createcomplex((double)(2*(i*DIM2+j+3)),(double)(2*(i*DIM2+j+3))) ) exit(119);
#endif
...
#else
       if ( (dtb+k)->vdt1[j][i].var_d[i][j] != createcomplexf((float)(2*(i*DIM2+j+5)+2),(float)(2*(i*DIM2+j+5)+2)) ) exit(123);
#endif
#ifdef CMPLX
       if ( (dtb+k)->vdt1[j][i].var_e[i][j] != (long double)(2*(i*DIM2+j+6)+3)+I*(long double)(2*(i*DIM2+j+6)+3) ) exit(125);
#else
       if ( (dtb+k)->vdt1[j][i].var_e[i][j] != createcomplexl((long double)(2*(i*DIM2+j+6)+3),(long double)(2*(i*DIM2+j+6)+3)) ) exit(125);
#endif
#ifdef CMPLX
       if ( (dtb+k)->vdt1[j][i].var_f[i][j] != (double)(2*(i*DIM2+j+7)+4)+I*(double)(2*(i*DIM2+j+7)+4) ) exit(127);
#else
       if ( (dtb+k)->vdt1[j][i].var_f[i][j] != createcomplex((double)(2*(i*DIM2+j+7)+4),(double)(2*(i*DIM2+j+7)+4)) ) exit(127);
#endif
...
#else
       if ( (dtb+k)->vdt1[j][i].var_h[i][j] != createcomplexf((float)(2*(i*DIM2+j+9)+6),(float)(2*(i*DIM2+j+9)+6)) ) exit(131);
#endif
...
#else
       if ( (dtr+k)->vdt1[j][i].var_b[i][j] != createcomplex((double)(2*(i*DIM2+j+3)),(double)(2*(i*DIM2+j+3))) ) exit(135);
#endif
...
#else
       if ( (dtr+k)->vdt1[j][i].var_d[i][j] != createcomplexf((float)(2*(i*DIM2+j+5)+2),(float)(2*(i*DIM2+j+5)+2)) ) exit(139);
#endif
#ifdef CMPLX
       if ( (dtr+k)->vdt1[j][i].var_e[i][j] != (long double)(2*(i*DIM2+j+6)+3)+I*(long double)(2*(i*DIM2+j+6)+3) ) exit(141);
#else
       if ( (dtr+k)->vdt1[j][i].var_e[i][j] != createcomplexl((long double)(2*(i*DIM2+j+6)+3),(long double)(2*(i*DIM2+j+6)+3)) ) exit(141);
#endif
#ifdef CMPLX
       if ( (dtr+k)->vdt1[j][i].var_f[i][j] != (double)(2*(i*DIM2+j+7)+4)+I*(double)(2*(i*DIM2+j+7)+4) ) exit(143);
#else
       if ( (dtr+k)->vdt1[j][i].var_f[i][j] != createcomplex((double)(2*(i*DIM2+j+7)+4),(double)(2*(i*DIM2+j+7)+4)) ) exit(143);
#endif
...
#else
       if ( (dtr+k)->vdt1[j][i].var_h[i][j] != createcomplexf((float)(2*(i*DIM2+j+9)+6),(float)(2*(i*DIM2+j+9)+6)) ) exit(147);
#endif
     }
    }
   }
