...
struct {
        ...
        long double                     r_c_long_double_s8a;
        long double                     r_c_long_double_s8b;
        long double                     r_c_long_double_s8c;
        long double                     r_c_long_double_s8d;
...
* --------------------------------------------------------------*/
        ...
        if ( precision_ldbl( blk_real.r_c_long_double_s8a   ,  1.797693e+308l )  !=  1 ) exit (140);
        if ( precision_ldbl( blk_real.r_c_long_double_s8b   ,  2.004168e-292l )  !=  1 ) exit (141);
        if ( precision_ldbl( blk_real.r_c_long_double_s8c   , -1.797693e+308l )  !=  1 ) exit (142);
        if ( precision_ldbl( blk_real.r_c_long_double_s8d   , -2.004168e-292l )  !=  1 ) exit (143);
...
* --------------------------------------------------------------*/
        ...
        blk_real.r_c_long_double_s8d   =  1.797693e+308l;
        blk_real.r_c_long_double_s8c   =  2.004168e-292l;
        blk_real.r_c_long_double_s8b   = -1.797693e+308l;
        blk_real.r_c_long_double_s8a   = -2.004168e-292l;
...
* --------------------------------------------------------------*/
        ...
        if ( precision_ldbl( blk_real.r_c_long_double_s8d   ,  1.797693e+308l ) !=  1 ) exit (170);
        if ( precision_ldbl( blk_real.r_c_long_double_s8c   ,  2.004168e-292l ) !=  1 ) exit (171);
        if ( precision_ldbl( blk_real.r_c_long_double_s8b   , -1.797693e+308l ) !=  1 ) exit (172);
        if ( precision_ldbl( blk_real.r_c_long_double_s8a   , -2.004168e-292l ) !=  1 ) exit (173);
