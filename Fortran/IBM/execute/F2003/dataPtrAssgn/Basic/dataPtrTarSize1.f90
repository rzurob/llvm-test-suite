...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (ANY( RESHAPE(PtrI1,(/90/))        .NE. PtrI1Tar(1:90,1)))  ERROR STOP 14
  ...
  IF (ANY( RESHAPE(PtrI2,(/90/))         .NE. PtrI2Tar(1:90,1)))  ERROR STOP 24
  ...
  IF (ANY( RESHAPE(PtrI4,(/90/))         .NE. PtrI4Tar(1:90,1)))  ERROR STOP 34
  ...
  IF (ANY( RESHAPE(PtrI8,(/90/))         .NE. PtrI8Tar(1:90,1)))  ERROR STOP 44
  ...
  IF (ANY( RESHAPE(PtrR4,(/90/))         .NE. PtrR4Tar(1:90,1)))  ERROR STOP 54
  ...
  IF (ANY( RESHAPE(PtrR8,(/90/))         .NE. PtrR4Tar(1:90,1)))  ERROR STOP 64
  ...
  IF (ANY( RESHAPE(PtrR16,(/90/))         .NE. PtrR4Tar(1:90,1))) ERROR STOP 74
  ...
  IF (ANY( RESHAPE(PtrC4,(/90/))         .NE. PtrC4Tar(1:90,1)))  ERROR STOP 84
  ...
  IF (ANY( RESHAPE(PtrC8,(/90/))         .NE. PtrC8Tar(1:90,1)))  ERROR STOP 94
  ...
  IF (ANY( RESHAPE(PtrC16,(/90/))         .NE. PtrC16Tar(1:90,1)))ERROR STOP 18
  ...
  IF (ANY( RESHAPE(PtrL1,(/90/))         .NEQV. PtrL1Tar(1:90,1))) ERROR STOP 28
  ...
  IF (ANY( RESHAPE(PtrL2,(/90/))         .NEQV. PtrL2Tar(1:90,1))) ERROR STOP 38
  ...
  IF (ANY( RESHAPE(PtrL4,(/90/))         .NEQV. PtrL4Tar(1:90,1))) ERROR STOP 48
  ...
  IF (ANY( RESHAPE(PtrL8,(/90/))         .NEQV. PtrL8Tar(1:90,1))) ERROR STOP 58
