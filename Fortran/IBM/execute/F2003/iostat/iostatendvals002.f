...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : iostatendvals002 
!*
...
!*
!*  DESCRIPTION                : Ensure that only -1 ,-2 both yields true if runtime extended is specified.  This should be run with qintsize=2,4,8 
