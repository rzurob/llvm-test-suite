...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE(DT) :: U(2,2)=DT(IARR=-1)
    ...
    CLASS IS (DT)
        ...
        IF (SIZE(Ptr(2)%IArr)   .NE. 2)  ERROR STOP 30
        IF (KIND(Ptr(2)%IArr)   .NE. 8)  ERROR STOP 31
    ...
    END SELECT
        ...
        IF (ANY(Ptr(I,:)%IArr(1)  .NE. 1)) ERROR STOP 62
        IF (ANY(Ptr(I,:)%IArr(2)  .NE. 2)) ERROR STOP 63
        IF (ANY(Ptr(I,:)%GetInt(1).NE. 1)) ERROR STOP 64
        IF (ANY(Ptr(I,:)%GetInt(2).NE. 2)) ERROR STOP 65
