...
program multipleBinding001
   ...
   open ( 1, file = 'multipleBinding001.1', form='formatted', access='sequential' )
   open ( 2, file = 'multipleBinding001.2', form='unformatted', access='direct', recl = 5 )
