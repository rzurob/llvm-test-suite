...
program stream001
   ...
   allocate ( b1, source = child(x=1.0,y=2.0) )
   allocate ( b2, source = child(x=3.0,y=4.0) )
   ...
   open ( u1%get(), file = 'stream001.data', form='unformatted', access='stream' )   !<- open a external file with unit #2
