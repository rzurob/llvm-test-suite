...
program file001
   ...
   open ( 2, file = 'file001.data', form='unformatted', access='direct', recl=5 )

   INQUIRE ( file = 'file001.tmp', size=size1, exist=exist1, name=name1, named=named1, opened=opened1 )      !<- file not connected to any unit
   ...
   INQUIRE ( file = 'file001.data      ', size=size1, exist=exist1, named=named1, opened=opened1 )           !<- file does exist
   print *, size1, exist1, named1, opened1
   ...
   INQUIRE ( file = 'file001.data', size=size1, exist=exist1, name=name1, named=named1, opened=opened1 )                 !<- file does exist
   print *, size1, exist1, name1, named1, opened1
...
use m1
    ...
    if ( iostat /= 0 )                      error stop 1_4                 !<- ensure inquire was successful

    if ( (opened1) .and. (exist1) .and. (read1 == 'YES') ) then            !<- read from file only if file exists, is opened, and is readable
       if (( fileName   /= 'file001.data') .and. (fileName /= 'fort.1') )  error stop 2_4
