...
program pointer001a
   ...
   allocate ( b3(4),   source = (/ base('xx'), base('xx'), base('xx'), base('xx') /))
   allocate ( b4(2,2), source = reshape( source = (/ base('xx'), base('xx'), base('xx'), base('xx') /), shape=(/2,2/) ) )
   allocate ( b5(4),   source = (/ base('xx'), base('xx'), base('xx'), base('xx') /))
   allocate ( b6(2,2), source = reshape( source = (/ base('xx'), base('xx'), base('xx'), base('xx') /), shape=(/2,2/) ) )
