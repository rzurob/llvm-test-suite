...
module m1
   ...
   type fourintegers
      integer(1), pointer     :: c1
      integer(2), allocatable :: c2
      integer(4), pointer     :: c3
      integer(8), allocatable :: c4
   end type  
...
program integer001a
   ...
   class(fourintegers) , allocatable :: f3(:)
   class(fourintegers) , pointer     :: f4(:)
   ...
   open (unit = 1, file ='integer001a.1', form='formatted', access='sequential')
   open (unit = 2, file ='integer001a.2', form='formatted', access='stream' )   
