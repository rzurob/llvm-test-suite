...
! %PRECMD: rm -f *.mod
! %COMPOPTS: -qfree=f90
! %GROUP: position002a.f
! %VERIFY: position002a.out:position002.vf
! %STDIN:
! %STDOUT: position002a.out
! %EXECARGS:
! %POSTCMD: 
! %END
! *********************************************************************
...
program position002a
   ...
   open (unit = 1, file ='position002a.1', form='formatted', access='stream')
