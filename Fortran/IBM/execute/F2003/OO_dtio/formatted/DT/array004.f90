...
use m
   ...
   allocate ( b1(5), source = (/base(cdata(111,112), 1001), base(d=null()), base(cdata(121,122), 1002), base(d=null()), base(cdata(131,132), 1003) /))

   allocate ( b2(4), source = (/ base(data(211), 2001), base(cdata(221, 222), 2002), &
                                 base(data(231), 2002), base(cdata(241, 242), 2004) /) )

   b3 = (/ base(d=cdata(311, 312), k= 3001), base(d=cdata(321, 322), k= 3002), &
           base(d=cdata(331, 332), k= 3003), base(d=cdata(341, 342), k= 3004) /)
