...
!*
!*  KEYWORD(S)                 : ASSOCIATE,virtual,integer
!*  TARGET(S)                  :
!*  NUMBER OF TESTS            : 1
!*  STATUS                     : done
!*
...
!*
!*  DESCRIPTION                : Test: ASSOCIATE with expression with
!*                                     virtual single and double array
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      integer  arr_i, ar_i
            virtual arr_i(2), ar_i(2)
      integer*1  arr_i1, ar_i1
            virtual arr_i1(3), ar_i1(3)
      integer*2  arr_i2, ar_i2
            virtual arr_i2(4), ar_i2(4)
      integer*4  arr_i4, ar_i4
            virtual arr_i4(5), ar_i4(5)
      integer*8  arr_i8, ar_i8
            virtual arr_i8(6), ar_i8(6)

      integer  arr_i42, ar_i42
            virtual arr_i42(4,2)
      integer*1 arr_i32, ar_i32
            virtual arr_i32(3,2)
      integer*2 arr_i22, ar_i22
            virtual arr_i22(2,2)
      integer*4 arr_i52, ar_i52
            virtual arr_i52(5,2)
      integer*8 arr_i12, ar_i12
            virtual arr_i12(1,2)
      integer i,j
      ...
      associate ( arr21 => arr_i42(i,j) + 2 )
           if(arr21 .ne. (arr_i42(i,j) + 2))then
           error stop 21
           endif
      end associate
           enddo
      ...
      associate ( arr22 => arr_i32(i,j) * 2_1 )
           if(arr22 .ne. (arr_i32(i,j) * 2_1))then
           error stop 22
           endif
      end associate
           enddo
      ...
      do i = 1,2
           do j = 1,2
      associate ( arr23 => arr_i22(i,j) - 2_1 )
           if(arr23 .ne. (arr_i22(i,j) - 2_1))then
           error stop 23
           endif
      end associate
           enddo
      ...
      associate ( arr24 => arr_i52(i,j) + 2 )
           if(arr24 .ne. (arr_i52(i,j) + 2))then
           error stop 24
           endif
      end associate
           enddo
      ...
      associate ( arr25 => arr_i12(i,j) / 2 )
           if(arr25 .ne. (arr_i12(i,j) / 2)) then
           error stop 25
           endif
      end associate
           enddo
