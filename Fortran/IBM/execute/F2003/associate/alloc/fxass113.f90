...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      if (dt%i1 .ne. 1) error stop 4
      associate ( arg1 => dt%i1 + 1_1)
      if (arg1 .ne. 2_1) error stop 5
      end associate

      if (dt%i2 .ne. -1) error stop 6
      associate ( arg2 => dt%i2*(-1_2) )
      if (arg2 .ne. 1) error stop 7
      end associate

      if (dt%i4 .ne. 10) error stop 8
      associate ( arg3 => dt%i4 - 5)
      if (arg3 .ne. 5) error stop 9
      end associate

      if (dt%i8 .ne. -10) error stop 10
      associate ( arg4 => dt%i8 + 10)
      if (arg4 .ne. 0) error stop 11
      end associate
      ...
      associate ( arg6 => d_t%r8 * 2.0)
      if (.not. precision_r8((d_t%r8 * 2.0),arg6)) error stop 16
      end associate

      associate ( arg7 => d_t%r16 - 1.0 )
      if (.not. precision_r6((d_t%r16 - 1.0),arg7)) error stop 18
      end associate
