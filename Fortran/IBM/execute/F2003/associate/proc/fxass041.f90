...
!-----------   ASSOCIATE with INTEGER*1 expressions ----------------
      ...
      recursive function int1_fun() result(c1)
            ...
            if ( cont .lt. 3_1 ) then
              associate ( arg => cont*2_1 )
              if(arg .ne. cont*2_1 ) then
              error stop 11
              endif
              end associate
              c1 = int1_fun()
...
!-----------   ASSOCIATE with INTEGER*2 expressions ----------------
      ...
      recursive function int2_fun() result(c2)
            ...
            data cont /0_2/
              ...
              cont = cont + 1_2
            if ( cont .lt. 3_2 ) then
              associate ( arg => cont*2_2 - 1_2 )
              if(arg .ne. (cont*2_2 - 1_2) ) then
              error stop 12
              endif
              end associate
              c2 = int2_fun()
...
!-----------   ASSOCIATE with INTEGER*8 expressions ----------------
      ...
      recursive function int8_fun() result(c8)
            ...
            data cont /0_8/
              ...
              cont = cont + 1_8
            if ( cont .lt. 3_8 ) then
              associate ( arg => (cont + 3_8)*2_8 )
              if(arg .ne. (cont + 3_8)*2_8 ) then
              error stop 14
              endif
              end associate
              c8 = int8_fun()
