...
!-----------    ASSOCIATE  with  INTEGER  expressions   ----------------
          ...
          nest1: associate ( dertype => der_type%i1 )
           nest2: associate ( dertype => der_type%i2 )
            nest3: associate ( dertype => der_type%i4)
              nest4: associate ( dertype => der_type%i8 )
                  dertype = dertype + 3
...
!-----------   ASSOCIATE with REAL expressions ----------------
           ...
           nest5: associate ( dertype => der_type%r4 )
            nest6: associate ( dertype => der_type%r8 )
             nest7: associate ( dertype => der_type%r16 )
...
!-----------   ASSOCIATE with BYTE expressions ----------------
           ...
           nest8: associate ( dertype => der_type%c )
            nest9: associate ( dertype => der_type%b )
                  dertype = dertype + 2
...
!-----------   ASSOCIATE with COMPLEX expressions ----------------
           ...
           nest10: associate ( dertype => der_type%x )
            nest11: associate ( dertype => der_type%x8 )
