...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      character(50), parameter :: FNAME_C = 'decimaleditf029.c.dat',   &
     &                            FNAME_P = 'decimaleditf029.p.dat',   &
     &                            FNAME_OUT = 'decimaleditf029.out'
      ...
      do i = 1, NUM_TESTS
         read(IN_C, *, decimal='comma') cx2
         write(OUT, *, decimal='point') cx2
         write(OUT, *, decimal='comma') cx2

         read(IN_P, *, decimal='point') cx2
         write(OUT, *, decimal='comma') cx2
         write(OUT, *, decimal='point') cx2
      end do
...
! now test for internal files:
      ...
      read(buffer,*,decimal='point') cx2
      write(OUT,*,decimal='comma') cx2
      cx2 = (/(4.44, 5.44), (5.55, 6.55), (6.66, 6.77)/)
      buffer=''
      write(buffer, *, decimal='point') cx2
      write(OUT, *) buffer


      buffer = '(9,00;8,99);  (8,99; 9,00);(7,33; 3,77)'
      read(buffer,*,decimal='comma') cx2
      write(OUT,*,decimal='point') cx2
      cx2 = (/(4.44, 5.44), (5.55, 6.55), (6.66, 6.77)/)
      buffer=''
      write(buffer, *, decimal='comma') cx2
      write(OUT, *) buffer
