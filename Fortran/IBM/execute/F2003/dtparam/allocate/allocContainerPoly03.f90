...
MODULE cMod
    ...
    CONTAINS
        ...
        FUNCTION NewC(l1, l2, rc)
            INTEGER :: l1
            INTEGER :: l2

            INTEGER(4) :: rc

            CLASS(c(8,l1,l2)), POINTER :: NewC
            ...
            ALLOCATE(NewC, STAT=stat, ERRMSG=errmsg)
            IF (stat /= 0) THEN
                PRINT *,"ALLOCATE(NewC(8,",l1,",",l2,"),STAT=",stat,') ',errmsg
                CALL zzrc( rc )
            END IF
...
PROGRAM allocContainerPoly03
    ...
    CONTAINS
        ...
        SUBROUTINE CheckIt(n, m, rc)
            ...
            CLASS(c(8,n,m)), POINTER :: checkItem
            ...
            checkItem => checkItem%NewC(n, m, rc)
...
END PROGRAM allocContainerPoly03
