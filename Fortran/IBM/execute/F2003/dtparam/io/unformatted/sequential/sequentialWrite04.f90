...
!* =====================================================================
!*
!*  TEST CASE NAME             : sequentialWrite04
!*
...
!*
!*  DESCRIPTION                :
!*  To perform Unformatted Sequential Output of Derived Types within up to 4
...
PROGRAM sequentialWrite04
    ...
    OPEN(14, ACCESS='sequential', ACTION='write',&
    ...
    WRITE(14, IOSTAT=iostat, IOMSG=iomsg) vC4
    IF (iostat /= 0) THEN
        PRINT *, 'WRITE(', iostat, '): ', iomsg
        STOP 20
    END IF

    WRITE(14, IOSTAT=iostat, IOMSG=iomsg) vC3
    IF (iostat /= 0) THEN
        PRINT *, 'WRITE(', iostat, '): ', iomsg
        STOP 30
    END IF

    WRITE(14, IOSTAT=iostat, IOMSG=iomsg) vC2
    IF (iostat /= 0) THEN
        PRINT *, 'WRITE(', iostat, '): ', iomsg
        STOP 40
    END IF

    WRITE(14, IOSTAT=iostat, IOMSG=iomsg) vC1
    IF (iostat /= 0) THEN
        PRINT *, 'WRITE(', iostat, '): ', iomsg
        STOP 50
    END IF
