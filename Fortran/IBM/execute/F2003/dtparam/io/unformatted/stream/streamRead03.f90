...
!*
!*  PRIMARY FUNCTIONS TESTED   : Data Transfer from a STREAM File
...
!*
!*  DESCRIPTION                :
!*  To read (and verify) Extended Derived Type data from a Stream file.
!*
...
PROGRAM streamRead03
    ...
    CHARACTER(16) :: file = 'streamRead03.dat'
    CHARACTER(255) :: iomsg

    TYPE(derived(5,4)) :: d( 4 )


    OPEN(22, FILE=file, ACCESS='stream',&
    ...
    OPEN(11, FILE=file, ACCESS='stream',&
    ...
    READ(11, IOSTAT=iostat, IOMSG=iomsg) (d( i ), i = 1, 4)
    IF (iostat /= 0) THEN
