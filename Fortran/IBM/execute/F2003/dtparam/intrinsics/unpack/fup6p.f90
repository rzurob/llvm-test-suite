...
use m1
use m2
type (admatrix(4)), pointer :: vec(:) !vec(4)
type (admatrix(4)), pointer :: field1(:)  !field1(8)
type (admatrix(4)), pointer :: res(:,:), field2(:,:) !res(4,2), field2(4,2)
logical :: mask1(8) = (/.TRUE., .FALSE., .TRUE., .FALSE., .TRUE., .FALSE., .FALSE., .TRUE./)
logical :: mask2(4,2)
real :: num
real :: res2(8)

allocate( admatrix(4) :: vec(4), field1(8), res(4,2), field2(4,2))
