...
!*  ===================================================================
!*
!*  TEST CASE NAME             : mergeDTComp02.f   
!*  TEST CASE TITLE            :
!*
...
!* 4. DERIVED TYPE COMPONENT'S TYPE PARAMETER IS EXPLICITLY SPEICIFIED 
...
program mergeDTComp02
   ...
   allocate(a5(2),source=A(1,10)(b1=B(1,6)(),b2=B(4,5)()))
   allocate(a6(2),source=a4)

   call check1(merge(a1,a1,.true.))
   call check1(merge(a1,a2,.false.))
   call check1(merge(a3,A(2,3)(b1=B(1,6)(),b2=B(4,5)()),.true.))
    
   call check2(merge(a4,a5,[.false.,.true.]))
   call check2(merge([a4(1),A(1,10)(b1=B(1,6)(), &
         b2=B(4,5)())],a6,[.false.,.true.] ))
...
!          print *,dt%l1,dt%b1%l2,dt%b2%l2
          ...
          if(dt%b1%k2 /= 1)                                  error stop 12_4
          if(dt%b1%l2 /= 6)                                  error stop 13_4
          if(dt%b2%k2 /= 4)                                  error stop 14_4
          if(dt%b2%l2 /= 5)                                  error stop 15_4 
...
!          print *,dt%b2%k2,dt%b2%l2
          ...
          if(dt%b1%l2 /= 6)                                  error stop 24_4
          if(dt%b2%k2 /= 4)                                  error stop 25_4
          if(dt%b2%l2 /= 5)                                  error stop 26_4
