...
!* 3. TSOURCE AND FSOURCE ARE POLYMORPHIC ALLOCATABLE
!* 4. DEFECT 356275 356524
...
program mergegPolyAsArg01
   ...
   class(base(4,:)),allocatable :: poly1(:),poly2(:),poly5(:)
   class(base(4,:)),allocatable :: poly3(:,:),poly4(:,:),poly6(:,:)
