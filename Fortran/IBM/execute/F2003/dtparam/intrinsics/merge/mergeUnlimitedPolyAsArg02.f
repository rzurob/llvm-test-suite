...
!*  ===================================================================
!*
!*  TEST CASE NAME             : mergeUnlimitedPolyAsArg02.f
!*
!*  DATE                       : Sept. 22 2008
!*
...
program mergeUnlimitedPolyAsArg02
   use m
   implicit none
   ...
   class(*),pointer :: poly1(:)=>null(),poly2(:)=>null(),poly5(:)=>null()
   class(*),pointer :: poly3(:,:)=>null(),poly4(:,:)=>null(),poly6(:,:)=>null()
