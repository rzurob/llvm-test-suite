...
!* of a given array.
!* CASE:
!*  10) Applying reshape with PAD and ORDER to DT with integer array component of size LEN DTP with KIND DTP
!*
!* ===================================================================
...
dt1%j = reshape(dtp1%i, (/2, 4/), (/8/), (/2, 1/))
