...
!* of a given array.
!* CASE:
!*  08) Applying reshape to DT with integer array component of size LEN DTP with KIND DTP
!*
!* ===================================================================
...
dt1%j = reshape(dtp1%i, (/2, 3/))

k = 1
do while (k .LT. 3)
  print *, dt1%j(k, 1), ' ', dt1%j(k, 2), ' ', dt1%j(k, 3)
  k = k+1
end do
end
