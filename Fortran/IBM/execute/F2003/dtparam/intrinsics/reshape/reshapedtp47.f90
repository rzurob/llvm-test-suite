...
!* of a given array.
!* CASE:
!*  47) Applying EOSHIFT to a dummy argument of DT allocatable
!*
!* ===================================================================
...
subroutine sub1(dtp2, res)
  type (dtp(4,3)), allocatable :: dtp2(:,:), res(:,:)
  allocate(res(4,2), SOURCE = reshape(dtp2, (/4,2/), (/dtp(4,3)(10, 'xxx'),dtp(4,3)(11, 'yyy')/),(/2,1/)))
end subroutine
end module
