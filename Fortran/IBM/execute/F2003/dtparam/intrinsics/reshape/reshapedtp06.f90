...
!* of a given array.
!* CASE:
!*  06) Applying reshape with SOURCE, SHAPE, PAD and ORDER argument keywords to DT with integer component with KIND DTP
!*
!* ===================================================================
...
dtp2 = reshape(SOURCE=dtp1, SHAPE=(/2, 4/), PAD=(/dtp(4,3)(10, 'xxx')/), ORDER=(/2, 1/))
j = 1
do while (j .LT. 3)
