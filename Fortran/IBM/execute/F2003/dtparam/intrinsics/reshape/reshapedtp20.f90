...
!* of a given array.
!* CASE:
!*  20) Applying reshape to a DT pointer with DTP
!*
!* ===================================================================
...
type (dtp(4,3)), target :: dtp1(6) = (/dtp(4,3)(1,'abc'), dtp(4,3)(2,'def'), dtp(4,3)(3,'ghi'), dtp(4,3)(4,'jkl'), &
