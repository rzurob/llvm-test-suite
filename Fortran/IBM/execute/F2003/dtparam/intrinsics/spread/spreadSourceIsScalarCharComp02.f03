...
!*  5. CONTAINER HAS CHARACTER ARRAY COMPONENT AND DT COMPONENT
!*  6. DEFECT 355394 355186
!234567890123456789012345678901234567890123456789012345678901234567890
module m1
  type mychar(l1,l2)
    integer,len    :: l1
    integer(2),len :: l2
    character(l1+l2) :: ch1(l1:l2)
  end type
end module
...
program spreadSourceIsScalarCharComp02
  ...
  allocate(contain3(0:3),source=spread(contain1,1,4))

  if(.not. associated(contain3))                           error stop 10_4
  if(lbound(contain3,1) /= 0)                              error stop 11_4
  ...
  do i=0,3
     ...
     if(ubound(contain3(i)%ch2,1) /= 3)                    error stop 18_4

     if(contain3(i)%mychar1%l1 /= 2)                       error stop 19_4
     if(contain3(i)%mychar1%l2 /= 4)                       error stop 20_4
     if(contain3(i)%mychar1%ch1%len /= 6)                  error stop 21_4
  ...
  do i=1,20
     ...
     if(contain4(i)%ch2%len /= 3)                          error stop 24_4
     if(lbound(contain4(i)%ch2,1) /= 1)                    error stop 25_4
     if(ubound(contain4(i)%ch2,1) /= 3)                    error stop 26_4

     if(contain4(i)%mychar1%l1 /= 2)                       error stop 27_4
     if(contain4(i)%mychar1%l2 /= 4)                       error stop 28_4
     if(contain4(i)%mychar1%ch1%len /= 6)                  error stop 29_4
