...
!*
!* CASE:
!*  41) Having an implied-do array constructor as the source of RESHAPE, then apply EOSHIFT on that
!*
!* ===================================================================
...
dtp2 = eoshift((reshape((/(dtp(4)(i), i=1,9)/), (/3, 3/))), (/1,-1,0/), dtp(4)(10))
