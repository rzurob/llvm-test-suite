...
!*
!* CASE:
!*  05) Applying EOSHIFT to DT where the DTP is specified like 'k=4'
!*
!* ===================================================================
...
type (dtp(k=4,l=3)) :: dtp1(9) = (/dtp(4,3)(1,'abc'), dtp(4,3)(2,'def'), dtp(4,3)(3,'ghi'), dtp(4,3)(4,'jkl'), &
                             dtp(4,3)(5,'mno'), dtp(4,3)(6,'pqr'), dtp(4,3)(7,'stu'), dtp(4,3)(8,'vwx'), &
                             dtp(4,3)(9,'yz1')/)
type (dtp(k=4,l=3)) dtp2(3,3), res(3,3)

dtp2 = reshape(dtp1, (/3, 3/))

res = eoshift(ARRAY=dtp2, SHIFT=(/1,-1,0/), BOUNDARY=dtp(k=4,l=3)(11, 'xxx'), DIM=2)
