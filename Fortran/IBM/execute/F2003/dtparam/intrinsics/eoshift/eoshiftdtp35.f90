...
!*
!* CASE:
!*  35) Applying EOSHIFT on a DT component of an allocatable with run time known LEN DTP with boundary argument
!*
!* ===================================================================
