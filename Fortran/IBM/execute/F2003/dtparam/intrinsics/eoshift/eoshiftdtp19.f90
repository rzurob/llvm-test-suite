...
!*
!* CASE:
!*  19) Applying EOSHIFT to the source argument in an allocate statement where the source in the EOSHIFT intrinsic is an allocatable
!*
!* ===================================================================
