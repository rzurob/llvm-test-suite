...
!*
!* CASE:
!*  31) Applying EOSHIFT in a module subroutine, and both the DT and the subroutine are used in a USE statement with rename and only options.
!*
!* ===================================================================
...
contains
subroutine sub1_def(res, dtp2)
  type (dtp_def(4,3)) :: res(3,3), dtp2(3,3)
  res = eoshift(dtp2, (/1,-1,0/), dtp_def(4,3)(0,'xxx'), 2)
end subroutine

subroutine sub_not_used (res, dtp2)
  type (dtp_def(4,3)) :: res(3,3), dtp2(3,3)
  stop 1
end subroutine
end module
