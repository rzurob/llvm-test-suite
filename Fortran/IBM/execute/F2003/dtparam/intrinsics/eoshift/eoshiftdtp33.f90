...
!*
!* CASE:
!*  33) The source argument of EOSHIFT contains a EOSHIFT intrinsic
!*
!* ===================================================================
...
res = eoshift((eoshift(dtp2, (/1,-1,0/), dtp(4,3)(11,'yyy'),1)), (/1,-1,0/), dtp(4,3)(10,'xxx'), DIM=2)
