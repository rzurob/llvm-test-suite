...
!*
!* CASE:
!*  04) Applying EOSHIFT to a DT with ARRAY, SHIFT, BOUNDARY and DIM keywords specified
!*
!* ===================================================================
...
res = eoshift(ARRAY=dtp2, SHIFT=(/1,-1,0/), BOUNDARY=dtp(4,3)(11,'xxx'), DIM=2)
