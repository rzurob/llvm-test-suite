...
!*
!* CASE:
!*  61) Applying EOSHIFT to an actual argument where the dummy argument has assumed LEN DTP
!*
!* ===================================================================
...
subroutine sub1(dtp2, res)
  ...
  res = eoshift(dtp2, (/1,-1,0/), dtp(4,3)(10,'xxx'))
end subroutine
end module
...
call sub1(eoshift(dtp2, (/1,-1,0/), dtp(4,3)(11, 'yyy'), 2), res)
