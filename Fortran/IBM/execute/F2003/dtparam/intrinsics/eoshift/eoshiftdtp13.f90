...
!*
!* CASE:
!*  13) Applying EOSHIFT to a DT's DT subtype's integer array component of size LEN DTP with KIND DTP
!*
!* ===================================================================
...
res%d1%i = eoshift(dtp1%d1%i, (/1, -1, 0/), 10)
