...
!*
!* CASE:
!*  21) Applying EOSHIFT to the source argument in an allocate statement for a pointer where the source in the EOSHIFT intrinsic is a pointer
!*
!* ===================================================================
