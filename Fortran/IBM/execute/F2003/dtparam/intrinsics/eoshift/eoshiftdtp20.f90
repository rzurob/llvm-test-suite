...
!*
!* CASE:
!*  20) Applying EOSHIFT to the source argument in an allocate statement where the source in the EOSHIFT intrinsic is an allocatable which is allocated with an allocatable
!*
!* ===================================================================
...
allocate(res(3,3), SOURCE = eoshift(dtp2, (/1,-1,0/), dtp(4,3)(10,'xxx')))
