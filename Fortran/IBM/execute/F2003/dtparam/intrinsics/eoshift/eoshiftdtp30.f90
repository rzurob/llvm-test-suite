...
!*
!* CASE:
!*  30) Applying EOSHIFT in a module subroutine and DT definition declared in a sub-module
!*
!* ===================================================================
...
subroutine sub1(res, dtp2)
  ...
  res = eoshift(dtp2, (/1,-1,0/), dtp(4,3)(11, 'yyy'))
end subroutine
end module
