...
program a
use m1
type (dtp(4,2)) :: dtp4(4), dtp42(4)
type (dtp(8,2)) :: dtp8(4), dtp82(4)
type (dt(4,2)) :: dt4(2), dt42(2)
type (dt(8,2)) :: dt8(2), dt82(2)
...
dtp42 = transfer(r4,dtp4)
dtp82 = transfer(r8,dtp8)
...
dt42 = transfer(c4,dt4)
dt82 = transfer(c8,dt8)
