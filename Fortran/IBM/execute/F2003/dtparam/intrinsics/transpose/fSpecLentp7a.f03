...
length = 3
allocate(admatrix(4,length)::matrix1(10,20), matrix2(10,20), matrix1t(20,10), matrix2t(20,10), matrix3t(20,10))
allocate(admatrix(4,length)::add1(20,10), add2(20,10), mult1(10,10), mult2(10,10), mult1t(10,10))
