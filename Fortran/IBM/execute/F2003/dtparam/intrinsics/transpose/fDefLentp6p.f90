...
!*                               with an interfaced operator. Derived type has pointer attribute.
!*
module m1
...
use m1
type (admatrix(4,:)), pointer :: matrix1(:,:), matrix2(:,:), matrix1t(:,:), matrix2t(:,:), matrix3t(:,:)
!matrix1(10,20), matrix2(10,20), matrix1t(20,10), matrix2t(20,10), matrix3t(20,10)
type (admatrix(4,:)), pointer :: add1(:,:), add2(:,:), mult1(:,:), mult2(:,:), mult1t(:,:)
