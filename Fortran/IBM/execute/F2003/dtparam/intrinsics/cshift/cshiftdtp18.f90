...
!*
!* CASE:
!* 18) Applying CSHIFT to the source argument in an allocate statement where the source in the CSHIFT intrinsic is an allocatable
!*
!* ===================================================================
