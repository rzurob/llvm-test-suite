...
!*
!* CASE:
!*  40) Having an implied-do array constructor as the source of RESHAPE, then apply CSHIFT on that
!*
!* ===================================================================
...
dtp2 = cshift((reshape((/(dtp(4)(i), i=1,9)/), (/3, 3/))), (/1,-1,0/))
