...
!*
!* CASE:
!*  38) Applying CSHIFT on a DT component of an allocatable involving offsets to components with LEN DTP
!*
!* ===================================================================
...
tt2 = cshift((reshape(tt(1)%r, (/3, 3/))), (/1,-1,0/))
