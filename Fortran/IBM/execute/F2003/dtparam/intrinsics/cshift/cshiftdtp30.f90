...
!*
!* CASE:
!*  30) Applying CSHIFT in a module subroutine, and both the DT and the subroutine are used in a USE statement with rename and only options.
!*
!* ===================================================================
