...
!*
!* CASE:
!* 20) Applying CSHIFT to the source argument in an allocate statement for a pointer where the source in the CSHIFT intrinsic is a pointer
!*
!* ===================================================================
