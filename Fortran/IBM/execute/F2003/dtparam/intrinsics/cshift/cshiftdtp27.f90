...
!*
!* CASE:
!* 27) Having a RESHAPE intrinsic as the source argument for CSHIFT, where the source for RESHAPE is a list of DT
!*
!* ===================================================================
...
res = cshift(reshape((/dtp(4)(1), dtp(4)(2), dtp(4)(3), dtp(4)(4), &
