...
!*
!* CASE:
!*  41) Allocating an allocatable with RESHAPE intrinsic as the source and having an implied-do array constructor as the source of RESHAPE, then apply CSHIFT on that
!*
!* ===================================================================
