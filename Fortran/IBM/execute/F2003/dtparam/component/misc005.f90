...
!*  DATE                       : 01/23/2006
!*
!*  DESCRIPTION                : miscellaneous (defect 315329)
!*
!* ===================================================================
...
use m
    ...
    allocate (b1, source=realArray(genRealArray, 1))
...
use m, only: base, realArray
    ...
    select type (x)
        type is (real)
            allocate (genRealArray(n), source=realArray(null(), x))
    end select
end function
