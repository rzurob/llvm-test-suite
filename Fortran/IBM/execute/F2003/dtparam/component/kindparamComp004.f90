...
!                               poly-pointer parameterized component; array
!                               components.
!*
!* ===================================================================
...
use m2
    ...
    !! verify
    do i = 5, 8
        if (.not. associated(pc1(i)%p1, pc1(i-4)%p1)) error stop 1_4

        if (.not. associated(pc2(i)%p1, pc2(2*i+4)%p1)) error stop 2_4
