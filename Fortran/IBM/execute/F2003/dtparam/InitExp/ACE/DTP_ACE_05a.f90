...
PROGRAM DTP_ACE_05
      ...
      IF ( SIZE(carr) .NE. 5 ) STOP 30
      DO I = 1, 5
        IF ( SIZE(carr(I)%A01)     .NE.   J ) STOP 31
        IF ( SIZE(carr(I)%A02)     .NE. J+1 ) STOP 32
        IF ( SIZE(carr(I)%A2)      .NE.   J ) STOP 33
        IF ( LBOUND(carr(I)%A01,1) .NE.   1 ) STOP 34
        IF ( LBOUND(carr(I)%A02,1) .NE.   1 ) STOP 35
        IF ( LBOUND(carr(I)%A2,1)  .NE.   1 ) STOP 36
        IF ( UBOUND(carr(I)%A01,1) .NE.   J ) STOP 37
        IF ( UBOUND(carr(I)%A02,1) .NE. J+1 ) STOP 38
        IF ( UBOUND(carr(I)%A2,1)  .NE.   J ) STOP 39
      END DO
      IF ( ANY(carr(1)%A01 .NE. -1) ) STOP 40
      IF ( ANY(carr(2)%A01 .NE.  1) ) STOP 41
      IF ( ANY(carr(3)%A01 .NE. -1) ) STOP 42
