...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : ExplicitInitExp08.f
!*
...
MODULE Mod 
      ...
      TYPE, EXTENDS(Child) :: NextGen (k3,l3)
        ...
        CHARACTER*(l3) :: C3= 'C3'
        type(Base(k1,:)), ALLOCATABLE :: poly

        CONTAINS
        PROCEDURE, PASS :: assgnNextGen
        GENERIC :: assignment(=) => assgnNextGen
      END TYPE
...
PROGRAM ExplicitInitExp08
      ...
      allocate (base(4,10) :: n1%poly)
      n1%poly = Base(4,10) (55, 'Rubinowicz')
      n2 = n1 
