...
PROGRAM aceStrConstrSelector02
    ...
    DO i = 1, 3
        ...
        CALL ConstructContainerSelectorArray(i, bA(i), rc)
    ...
    CONTAINS
        ...
        SUBROUTINE ConstructContainerSelectorArray(l, a, rc)
            ...
            type(c(16,:)), allocatable :: array(:)

            allocate(c(16,l) :: array(3))
...
!                    c(16,l)(rA( :(l + 1) ),b((l * 2),16)(rA( :(l * 2) )))   ]
            ...
            array(1)%ra = rA( :(l + 1) )
            array(1)%ba%array = rA( :(l * 2) )
            array(2)%ra = rA( :(l + 1) )
            array(2)%ba%array = rA( :(l * 2) )
            array(3)%ra = rA( :(l + 1) )
            array(3)%ba%array = rA( :(l * 2) )
!            array(1) = c(16,l)(rA( :(l + 1) ),b((l * 2),16)(rA( :(l * 2) )))
!            array(2) = c(16,l)(rA( :(l + 1) ),b((l * 2),16)(rA( :(l * 2) )))
!            array(3) = c(16,l)(rA( :(l + 1) ),b((l * 2),16)(rA( :(l * 2) )))
