...
program mergeDTComp04
   ...
   associate(x=>merge([b1(1)%type1,b1(2)%type1], &
              [b2(1)%type1,b2(2)%type1],[.true.,.false.]))
      if(x%l1 /= 4)                                     error stop 20_4
      if(any(x%ca /= ["abc","111"]))                    error stop 21_4
   end associate

   associate(x=>merge([b1(1)%type1,b1(2)%type1], &
              [b2(1)%type1,b2(2)%type1],[.false.,.true.]))
      if(x%l1 /= 4)                                     error stop 22_4
      if(any(x%ca /= ["000","def"]))                    error stop 23_4
   end associate

   associate(x=>merge([b1(1)%type1%ca,b1(2)%type1%ca], &
              [b2(1)%type1%ca,b2(2)%type1%ca],[.false.,.true.]))
      if(len(x) /= x%len .or. x%len /= 4)               error stop 24_4
      if(any(x /= ["000","def"]))                       error stop 25_4
   end associate

   associate(x=>merge([b1(1)%type1%ca,b1(2)%type1%ca], &
              [b2(1)%type1%ca,b2(2)%type1%ca],[.true.,.false.]))
   ...
   associate(x=>merge([b3(1)%type1,b3(2)%type1], &
              [b4(1)%type1,b4(2)%type1],[.true.,.false.]))
      if(x%l1 /= 7)                                     error stop 38_4
      if(any(x%ca /= ["123","def"]))                    error stop 39_4
   end associate

   associate(x=>merge([b3(1)%type1,b3(2)%type1], &
              [b4(1)%type1,b4(2)%type1],[.false.,.true.]))
      if(x%l1 /= 7)                                     error stop 40_4
      if(any(x%ca /= ["abc","456"]))                    error stop 41_4
   end associate

   associate(x=>merge([b3(1)%type1%ca,b3(2)%type1%ca], &
              [b4(1)%type1%ca,b4(2)%type1%ca],[.false.,.true.]))
      if(len(x) /= x%len .or. x%len /= 7)               error stop 42_4
      if(any(x /= ["abc","456"]))                       error stop 43_4
   end associate

   associate(x=>merge([b3(1)%type1%ca,b3(2)%type1%ca], &
             [b4(1)%type1%ca,b4(2)%type1%ca],[.true.,.false.]))
