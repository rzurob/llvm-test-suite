...
MODULE r
    ...
    CONTAINS
        ...
        INTEGER FUNCTION ReadTR8(dTR, u)
            ...
            READ(u, IOSTAT=ReadTR8, IOMSG=iomsg) (dTR( i ), i = 1, SIZE( dTR ))
            IF (ReadTR8 /= 0) THEN
        ...
        INTEGER FUNCTION WriteTR8(dTR, u)
            ...
            WRITE(u, IOSTAT=WriteTR8, IOMSG=iomsg)&
                (dTR( i ), i = 1, SIZE( dTR ))
            IF (WriteTR8 /= 0) THEN
...
MODULE c
    ...
    CONTAINS
        ...
        INTEGER FUNCTION ReadTC8(dTC, u)
            ...
            READ(u, IOSTAT=ReadTC8, IOMSG=iomsg) (dTC( i ), i = 1, SIZE( dTC ))
            IF (ReadTC8 /= 0) THEN
        ...
        INTEGER FUNCTION WriteTC8(dTC, u)
            ...
            WRITE(u, IOSTAT=WriteTC8, IOMSG=iomsg)&
                (dTC( i ), i = 1, SIZE( dTC ))
            IF (WriteTC8 /= 0) THEN
