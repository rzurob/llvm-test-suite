...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABasicModule006
!*
!*  DATE                       : 2009-05-22
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment with Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : allocate basic DTP variable (container) with indirectly allocatable components via intrinsic assignment (in module subroutine)
!*
...
!*  ADAPTED FROM               : dtpIAABasicInternal006 (<-dtpIAABasic006<-dtpIAABasic003<-dtpIAABasic002<-dtpIAABasic001)
!*
!*  DESCRIPTION
!*
...
module dtpIAABasicModule006mod
...
end module dtpIAABasicModule006mod



program dtpIAABasicModule006

  use dtpIAABasicModule006mod
  implicit none
...
end program dtpIAABasicModule006
