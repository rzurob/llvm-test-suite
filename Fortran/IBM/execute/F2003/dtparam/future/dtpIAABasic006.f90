...
!*
!*  SECONDARY FUNCTIONS TESTED : allocate basic DTP variable (container) with indirectly allocatable components via intrinsic assignment
!*
...
end module dtpIAABasic006mod



program dtpIAABasic006

  use dtpIAABasic006mod
  implicit none
