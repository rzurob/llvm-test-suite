...
!                               function reference that returns pointer array.
!*
!* ===================================================================
...
use m
    ...
    b1 = base(8,350)(genID(i1, (/87, 4/)), genReal(r1, 350, sqrt))

    allocate (b1_m, source=base(4, 20)(genID(i1(500:)/5, (/5,4/)), &
