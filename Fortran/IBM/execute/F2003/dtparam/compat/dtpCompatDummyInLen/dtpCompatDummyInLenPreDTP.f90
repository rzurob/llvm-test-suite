...
!*  TEST CASE FILE             : dtpCompatDummyInLenPreDTP
!*
...
module dtpCompatDummyInLenPreDTPmod
...
contains
  ...
  subroutine dtpCompatDummyInLenCopy(arg)
    ...
    p => ba
  end subroutine dtpCompatDummyInLenCopy

end module dtpCompatDummyInLenPreDTPmod
