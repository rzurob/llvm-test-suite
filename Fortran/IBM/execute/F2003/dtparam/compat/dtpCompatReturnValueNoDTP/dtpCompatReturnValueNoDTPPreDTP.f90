...
!*  TEST CASE FILE             : dtpCompatReturnValueNoDTPPreDTP
!*
!*  DATE                       : 2009-06-13
!*
...
!*  code for this case does not use DTP.
!*
...
module dtpCompatReturnValueNoDTPPreDTPmod
...
contains
  ...
  subroutine dtpCompatReturnValueNoDTPCopy
    class(base), pointer :: localp
    class(base), allocatable :: ba
    localp => getBP()
    allocate(bp2, source=localp)
  end subroutine dtpCompatReturnValueNoDTPCopy

end module dtpCompatReturnValueNoDTPPreDTPmod
