...
!*  ============================================================================
!*
!*  TEST CASE FILE             : dtpCompatListComponentPreDTP
!*
!*  DATE                       : 2009-06-13
!*
...
!*  the "post" code for this case extends the base class with a DTP child (KIND + LEN).
...
!*  first element can cause them.  The routine "deepishCopy" attempts to copy more content, and
!*  will generate an error if either the "next" or the "datum" pointer reference DTP objects.
!*
...
module dtpCompatListComponentPreDTPmod
...
end module dtpCompatListComponentPreDTPmod
