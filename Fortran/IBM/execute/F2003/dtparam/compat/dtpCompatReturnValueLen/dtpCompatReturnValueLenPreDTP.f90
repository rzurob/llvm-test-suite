...
!*  ============================================================================
!*
!*  TEST CASE FILE             : dtpCompatReturnValueLenPreDTP
!*
!*  DATE                       : 2009-06-13
!*
...
!*  code for this case uses a LEN type parameter.
!*
...
module dtpCompatReturnValueLenPreDTPmod
...
contains
  ...
  subroutine dtpCompatReturnValueLenCopy
    class(base), pointer :: localp
    class(base), allocatable :: ba
    localp => getBP()
    allocate(bp2, source=localp)
  end subroutine dtpCompatReturnValueLenCopy

end module dtpCompatReturnValueLenPreDTPmod
