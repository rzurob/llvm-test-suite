...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPPCModPassMixInterfaceKLSub
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : pointer to PASS subroutines from DTP with K+L param with other args of mixed types, from module
!*
...
!*  References objects via module variables.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPPCModPassMixInterfaceKLSubmod
...
end module dtpPPCModPassMixInterfaceKLSubmod


program dtpPPCModPassMixInterfaceKLSub

  use dtpPPCModPassMixInterfaceKLSubmod
  implicit none

  t1a = dt(1,0)("",127,disp1,disp1,disp1,dispR,dispCI)
  t1b = dt(1,0)("",-127,disp1a,disp1a,disp1a,dispRa,dispCI)
  t2a = dt(2,4)("abcd",32000,disp1,disp1,disp1,dispR,dispCI)
  t2b = dt(2,4)("efgh",-12345,disp1a,disp1a,disp1a,dispRa,dispCI)
  t1c = dt(1,3)("ijk",1,disp1,disp1,disp1,dispR,dispCI)
  t1d = dt(1,3)("lmn",-1,disp1a,disp1a,disp1a,dispRa,dispCI)
  t1p => t1c
  allocate(t4ap, source=dt(4,5)("opqrs",123454321,disp1,disp1,disp1,dispR,dispCI))
  allocate(t4bp, source=dt(4,5)("tuvwx",123454321,disp1a,disp1a,disp1a,dispRa,dispCIa))
...
end program dtpPPCModPassMixInterfaceKLSub
