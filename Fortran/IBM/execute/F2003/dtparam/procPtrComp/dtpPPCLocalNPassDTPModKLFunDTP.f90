...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPPCLocalNPassDTPModKLFunDTP
!*
!*  DATE                       : 2009-03-23
!*
!*  PRIMARY FUNCTIONS TESTED   : Procedure Pointers as Components
!*
!*  SECONDARY FUNCTIONS TESTED : reference to function without passed-object dummy argument, DTP arg w/ K+L parameters, DTP result, module interface
!*
...
!*  kind and len parameters.  Uses module procedure names in the procedure pointer
!*  declaration instead of names from an abstract interface.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPPCLocalNPassDTPModKLFunDTPmod
...
end module dtpPPCLocalNPassDTPModKLFunDTPmod


program dtpPPCLocalNPassDTPModKLFunDTP

  use dtpPPCLocalNPassDTPModKLFunDTPmod
  implicit none
  type(dt(1,0)) :: t1a, t1b
  type(dt(1,40)):: t1res
  type(dt(2,4)) :: t2a, t2b
...
end program dtpPPCLocalNPassDTPModKLFunDTP
