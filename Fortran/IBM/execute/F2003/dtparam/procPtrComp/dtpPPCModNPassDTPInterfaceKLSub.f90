...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPPCModNPassDTPInterfaceKLSub
!*
!*  DATE                       : 2009-03-23
!*
!*  PRIMARY FUNCTIONS TESTED   : Procedure Pointers as Components
!*
!*  SECONDARY FUNCTIONS TESTED : via module variable, reference to subroutine without passed-object dummy argument, DTP arg w/ len parameter
!*
...
module dtpPPCModNPassDTPInterfaceKLSubmod
  ...
  type(dt(1,0)), save :: t1a, t1b
  type(dt(2,4)), save :: t2a, t2b
  type(dt(1,3)), save :: t1c, t1d
  type(dt(1,:)), save :: t1p
  type(dt(4,:)), save :: t4p
  target  :: t1c
  pointer :: t1p, t4p
...
end module dtpPPCModNPassDTPInterfaceKLSubmod


program dtpPPCModNPassDTPInterfaceKLSub

  use dtpPPCModNPassDTPInterfaceKLSubmod
  implicit none
...
end program dtpPPCModNPassDTPInterfaceKLSub
