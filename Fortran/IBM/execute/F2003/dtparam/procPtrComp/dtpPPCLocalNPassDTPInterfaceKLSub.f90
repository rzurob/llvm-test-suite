...
!*
!*  SECONDARY FUNCTIONS TESTED : reference to subroutine without passed-object dummy argument, DTP arg w/ K+L parameters
!*
...
!*  ADAPTED FROM               : dtpPPCBasicNoPassSubroutine ()
!*
!*  DESCRIPTION
!*
...
module dtpPPCLocalNPassDTPInterfaceKLSubmod
...
end module dtpPPCLocalNPassDTPInterfaceKLSubmod


program dtpPPCLocalNPassDTPInterfaceKLSub

  use dtpPPCLocalNPassDTPInterfaceKLSubmod
  implicit none
  type(dt(1,0)) :: t1a, t1b
  type(dt(2,4)) :: t2a, t2b
  type(dt(1,3)) :: t1c, t1d
...
end program dtpPPCLocalNPassDTPInterfaceKLSub
