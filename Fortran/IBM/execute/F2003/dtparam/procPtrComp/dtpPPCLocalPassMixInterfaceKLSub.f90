...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPPCLocalPassMixInterfaceKLSub
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : pointer to PASS subroutines from DTP with K+L param with other args of mixed types
!*
...
module dtpPPCLocalPassMixInterfaceKLSubmod
...
end module dtpPPCLocalPassMixInterfaceKLSubmod


program dtpPPCLocalPassMixInterfaceKLSub

  use dtpPPCLocalPassMixInterfaceKLSubmod
  implicit none
  type(dt(1,0)) :: t1a, t1b
  type(dt(2,4)) :: t2a, t2b
  type(dt(1,3)) :: t1c, t1d
...
end program dtpPPCLocalPassMixInterfaceKLSub
