...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPPCModPassDTPInterfaceKLSub
!*
!*  DATE                       : 2009-03-23
!*
!*  PRIMARY FUNCTIONS TESTED   : Procedure Pointers as Components
!*
!*  SECONDARY FUNCTIONS TESTED : reference to subroutine without passed-object dummy argument, DTP arg, refs via module var
!*
...
!*  ADAPTED FROM               : dtpPPCLocalPassDTPInterfaceKLSubExt (<-dtpPPCLocalNPassDTPInterfaceKLSub<-dtpPPCBasicNoPassSubroutine)
!*
!*  DESCRIPTION
!*
!*  Create procedure pointers which are references to subroutines
!*  which do not expect a passed-object dummy argument.
...
!*  Here, the type is a sequence type (the name dtpPPCModPassDTPInterfaceKLSub
!*  is incorrect, and should be changed to dtpPPCModNPassDTPInterfaceKLSubSequence).
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPPCModPassDTPInterfaceKLSubmod
  ...
  save :: t1a, t1b, t2a, t2b, t1c, t1d, t1p, t4p
...
end module dtpPPCModPassDTPInterfaceKLSubmod


program dtpPPCModPassDTPInterfaceKLSub

  use dtpPPCModPassDTPInterfaceKLSubmod
  implicit none
...
end program dtpPPCModPassDTPInterfaceKLSub
