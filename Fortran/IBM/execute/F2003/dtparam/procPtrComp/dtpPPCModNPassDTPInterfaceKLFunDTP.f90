...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPPCModNPassDTPInterfaceKLFunDTP
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : reference to function without passed-object dummy argument, DTP arg w/ K+L parameters, DTP result, ref via module var
!*
...
module dtpPPCModNPassDTPInterfaceKLFunDTPmod
  ...
  save :: t1a, t1b, t1c, t1d, t1p, t2a, t2b, t4p
...
end module dtpPPCModNPassDTPInterfaceKLFunDTPmod


program dtpPPCModNPassDTPInterfaceKLFunDTP

  use dtpPPCModNPassDTPInterfaceKLFunDTPmod
  implicit none
  type(dt(1,40)):: t1res
  type(dt(2,40)):: t2res
  type(dt(4,40)):: t4res
...
end program dtpPPCModNPassDTPInterfaceKLFunDTP
