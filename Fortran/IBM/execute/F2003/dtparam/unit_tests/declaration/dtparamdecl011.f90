...
! %PRECMD: rm -f *.mod
! %COMPOPTS: -qfree=f90
! %GROUP: dtparamdecl011.f
! %VERIFY: dtparamdecl011.out:dtparamdecl011.vf
! %STDIN:
! %STDOUT: dtparamdecl011.out
! %EXECARGS:
! %POSTCMD:
! %END
! *********************************************************************
...
end module dtparamdecl011m

program dtparamdecl011
  use dtparamdecl011m
  IMPLICIT NONE
