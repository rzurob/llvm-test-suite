...
! %PRECMD: rm -f *.mod
! %COMPOPTS: -qfree=f90
! %GROUP: dtparamdecl012.f
! %VERIFY: dtparamdecl012.out:dtparamdecl012.vf
! %STDIN:
! %STDOUT: dtparamdecl012.out
! %EXECARGS:
! %POSTCMD: 
! %END
! *********************************************************************
...
module dtparamdecl012m
  ...
  type(base2) :: b3
  type(base3) :: b4
end module dtparamdecl012m  
  
program dtparamdecl012  
  use dtparamdecl012m
  IMPLICIT NONE
