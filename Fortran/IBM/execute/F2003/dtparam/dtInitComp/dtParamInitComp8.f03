...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( KIND(T%t%I)   .NE. 4 )                 ERROR STOP 45
  IF ( SIZE(T%t%I)   .NE. 4 )                 ERROR STOP 46
  IF ( ANY(T%t%I     .NE. 3))                 ERROR STOP 47

  IF ( KIND(T%t%R)   .NE. 4 )                 ERROR STOP 48
  IF ( SIZE(T%t%R)   .NE. 4 )                 ERROR STOP 49
  IF ( ANY(T%t%R     .NE. 3))                 ERROR STOP 40

  IF ( KIND(T%t%Z)   .NE. 4 )                 ERROR STOP 51
  IF ( SIZE(T%t%Z)   .NE. 4 )                 ERROR STOP 52
  IF ( ANY(T%t%Z     .NE. (-3,-3)))           ERROR STOP 53

  IF ( LEN(T%t%C)    .NE. 4 )                 ERROR STOP 54
  IF ( SIZE(T%t%C)   .NE. 4 )                 ERROR STOP 55
  IF ( ANY(T%t%C     .NE. "$$$$" ))           ERROR STOP 56

  IF ( ASSOCIATED(T%t%ProcPtr) )              ERROR STOP 57
