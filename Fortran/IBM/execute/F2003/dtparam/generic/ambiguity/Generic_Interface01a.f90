...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : Generic_Interface01a
...
! when we distinguih by KIND type parameter
      ...
      IF( test1 .NE. FUNC(child1%Cmp)) STOP 20
      IF( test2 .NE. FUNC(child2%Cmp)) STOP 21
      ...
      IF( test1 .NE. FUNC(child1%Cmp)) STOP 22
      IF( test2 .NE. FUNC(child2%Cmp)) STOP 23
      ...
      IF( test1 .NE. FUNC(Arg)) STOP 24

      Arg => tgt1
      IF ( .NOT. ASSOCIATED(Arg)) STOP 15

      IF( test1 .NE. FUNC(Arg)) STOP 25
      ...
      IF( test2 .NE. FUNC(Arg)) STOP 26

      Arg => tgt2
      IF ( .NOT. ASSOCIATED(Arg)) STOP 17

      IF( test2 .NE. FUNC(Arg)) STOP 27
