...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : Generic_BOperator01a
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      TYPE, EXTENDS(Base) :: Child1 (k1,l1)
        ...
        CONTAINS 
         PROCEDURE, PASS :: add11
         PROCEDURE, PASS :: add12
         GENERIC :: operator(+) =>  add11 , add12
      END TYPE Child1 
      ...
      TYPE, EXTENDS(Base) :: Child2 (k2,l2)
        ...
        CONTAINS 
         PROCEDURE, PASS :: add21
         PROCEDURE, PASS :: add22
         GENERIC :: operator(+) =>  add21, add22
      END TYPE Child2 
...
!*
      ...
      END PROGRAM Generic_BOperator01a
