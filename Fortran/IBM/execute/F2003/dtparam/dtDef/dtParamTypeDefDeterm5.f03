...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( TRIM(T0%C).NE.   TRIM("B"))       ERROR STOP 47

  TT2 => T2

  IF ( TT2%I      .NE.   -1_8 )           ERROR STOP 53
  IF ( TT2%R      .NE.   -1.0_8 )         ERROR STOP 54
  IF ( TT2%Cplx   .NE.   (1._8, -1._8) )  ERROR STOP 55
  IF ( TT2%LL     .NEQV. .FALSE._8 )      ERROR STOP 56
  IF ( TRIM(TT2%C).NE.   TRIM("B"))       ERROR STOP 57
