...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignCommonInBlockDataWithModule
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : initialise common variables in block data with dcl in module
!*
...
!*  DESCRIPTION
!*
!*  Initialise common DTP variables in a block data, and verify that the type
!*  parameters and data values are as expected. This is included to provide a
!*  baseline for other tests which use a common.
!*  This differs from dtpIAssignCommonInBlockData in that the types are declared
!*  in a module.
!*
...
module dtpIAssignCommonInBlockDataWithModulemod
...
end module dtpIAssignCommonInBlockDataWithModulemod


block data dtpIAssignCommonInBlockDataWithModuleData

  use :: dtpIAssignCommonInBlockDataWithModulemod
  type(base(3))      :: b_3
  ...
  data b_3/base(3)('abc')/
  data d_34/derived(3,4)('def',4.1_4,.true.,[1111111111,2122222222,1333333333])/
  data d2_3482/d2(3,4,8,2)('ghi',5.9_4,.false.,[-1111111111,-2122222222,-1333333333], &
                           reshape([(1111_2*i,i=1,6)],[3,2]), &
                           derived(2,8)('xz',11235.81321D34,.true.,[76543211234567_8,-123456787654321_8]))/
  data b_5 /base(5)('abcde')/
  data d_58/derived(5,8)('defgh',1.23456789D11,.true., &
                         [1111111111111_8,2222222222222_8,3333333333333_8,4444444444444_8,5555555555555_8])/
  data d2_5841/d2(5,8,4,1)('defij',9.87654321D-12,.true., &
                           [-1111111111111_8,-2222222222222_8,-3333333333333_8,-4444444444444_8,-5555555555555_8], &
                           reshape([(1111_2*i,i=1,5)],[5,1]),derived(1,4)('y',9.87654E-12,.true.,[-12345678_4]))/

end block data dtpIAssignCommonInBlockDataWithModuleData


program dtpIAssignCommonInBlockDataWithModule
...
end program dtpIAssignCommonInBlockDataWithModule
