...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignCommonFromInternal
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign to common variables in internal subprograms
!*
...
!*  DESCRIPTION
!*
!*  In internal procedures, assign values to common variables of a parameterised
...
block data dtpIAssignCommonFromInternalData
...
end block data dtpIAssignCommonFromInternalData


program dtpIAssignCommonFromInternal
...
end program dtpIAssignCommonFromInternal
