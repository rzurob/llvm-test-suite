...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignExternalCommonFromVars
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to variables in common in external procedure
!*
...
module dtpIAssignExternalCommonFromVarsmod
...
end module dtpIAssignExternalCommonFromVarsmod


subroutine checkValues(what)

  use :: dtpIAssignExternalCommonFromVarsmod
  implicit none
  character(*) :: what
...
subroutine localTest
  ...
  implicit none
  integer :: i
  type(base(3))      :: b_3_l1, b_3
  type(derived(3,4)) :: d_34_l1, d_34
  type(d2(3,4,8,2))  :: d2_3482_l1, d2_3482

  type(base(5))      :: b_5_l1, b_5
  type(derived(5,8)) :: d_58_l1, d_58
  type(d2(5,8,4,1))  :: d2_5841_l1, d2_5841
...
subroutine hostAssociatedTest
  ...
  implicit none
  integer :: i
  type(base(3))      :: b_3, b_3_ha
  type(derived(3,4)) :: d_34, d_34_ha
  type(d2(3,4,8,2))  :: d2_3482, d2_3482_ha

  type(base(5))      :: b_5, b_5_ha
  type(derived(5,8)) :: d_58, d_58_ha
  type(d2(5,8,4,1))  :: d2_5841, d2_5841_ha
...
program dtpIAssignExternalCommonFromVars
...
end program dtpIAssignExternalCommonFromVars
