...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignModuleFromMain
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign to module variables in main program
!*
...
module dtpIAssignModuleFromMainmod
...
end module dtpIAssignModuleFromMainmod

program dtpIAssignModuleFromMain

  use dtpIAssignModuleFromMainmod
  implicit none
  integer i
...
end program dtpIAssignModuleFromMain
