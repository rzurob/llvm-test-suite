...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignInternalCommonFromVars
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to variables in common in internal procedures
!*
...
module dtpIAssignInternalCommonFromVarsmod
...
end module dtpIAssignInternalCommonFromVarsmod


program dtpIAssignInternalCommonFromVars

  use dtpIAssignInternalCommonFromVarsmod
  implicit none
  integer i
  type(base(3))      :: b_3_ha
...
end program dtpIAssignInternalCommonFromVars
