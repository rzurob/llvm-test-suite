...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignMainPolymorphic
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign from polymorphic variables in main program
!*
...
!*  DESCRIPTION
!*
!*  In the main program, assign values to variables local to the main program
...
module dtpIAssignMainPolymorphicmod
...
end module dtpIAssignMainPolymorphicmod

program dtpIAssignMainPolymorphic

  use dtpIAssignMainPolymorphicmod
  implicit none
...
end program dtpIAssignMainPolymorphic
