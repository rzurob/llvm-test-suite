...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignModuleFromInternal
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to module variables in internal subprograms
!*
...
!*  DESCRIPTION
!*
!*  In the main program, assign values to module variables of a parameterised
...
module dtpIAssignModuleFromInternalmod
...
end module dtpIAssignModuleFromInternalmod


program dtpIAssignModuleFromInternal

  use dtpIAssignModuleFromInternalmod
  implicit none
  integer i
...
end program dtpIAssignModuleFromInternal
