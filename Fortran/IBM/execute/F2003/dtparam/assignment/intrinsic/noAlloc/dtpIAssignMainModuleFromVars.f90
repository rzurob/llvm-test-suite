...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignMainModuleFromVars
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to module variables in main program
!*
...
module dtpIAssignMainModuleFromVarsmod
...
end module dtpIAssignMainModuleFromVarsmod


program dtpIAssignMainModuleFromVars

  use :: dtpIAssignMainModuleFromVarsmod
...
end program dtpIAssignMainModuleFromVars
