...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignCommonFromExternal
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to common variables in external subprograms
!*
...
!*  DESCRIPTION
!*
!*  In external procedures, assign values to common variables of a parameterised
...
block data dtpIAssignCommonFromExternalData
...
end block data dtpIAssignCommonFromExternalData


program dtpIAssignCommonFromExternal
...
end program dtpIAssignCommonFromExternal
