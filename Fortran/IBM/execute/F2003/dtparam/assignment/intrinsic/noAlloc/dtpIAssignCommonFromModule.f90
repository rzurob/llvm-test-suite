...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignCommonFromModule
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to common variables in module procedures
!*
...
!*  DESCRIPTION
!*
!*  In module procedures, assign values to common variables of a parameterised
...
module dtpIAssignCommonFromModulemod
...
end module dtpIAssignCommonFromModulemod


program dtpIAssignCommonFromModule

  use dtpIAssignCommonFromModulemod
  implicit none
  integer i
...
end program dtpIAssignCommonFromModule
