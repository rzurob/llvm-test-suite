...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignHostAssociatedExternal
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to host associated variables in external subprogram
!*
...
!*  DESCRIPTION
!*
!*  In an external subprogram, assign values to host-associated variables of a
...
module dtpIAssignHostAssociatedExternalmod
...
end module dtpIAssignHostAssociatedExternalmod


program dtpIAssignHostAssociatedExternal
...
end program dtpIAssignHostAssociatedExternal


subroutine externalTest

  use :: dtpIAssignHostAssociatedExternalmod
