...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to variables in common in main program
!*
...
module dtpIAssignMainCommonFromVarsmod
...
program dtpIAssignMainCommonFromVars

  use :: dtpIAssignMainCommonFromVarsmod
...
end program dtpIAssignMainCommonFromVars
