...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignInternalFunctionResultFromVars
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to function result in internal procedures
!*
...
module dtpIAssignInternalFunctionResultFromVarsmod
...
end module dtpIAssignInternalFunctionResultFromVarsmod


program dtpIAssignInternalFunctionResultFromVars

  use :: dtpIAssignInternalFunctionResultFromVarsmod
  implicit none
...
end program dtpIAssignInternalFunctionResultFromVars
