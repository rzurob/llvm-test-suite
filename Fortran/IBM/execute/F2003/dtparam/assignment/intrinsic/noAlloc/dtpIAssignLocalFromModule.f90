...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignLocalFromModule
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to local variables in module procedure
!*
...
!*  DESCRIPTION
!*
!*  In a module procedure, assign values to local variables of a parameterised
...
module dtpIAssignLocalFromModulemod
...
end module dtpIAssignLocalFromModulemod


program dtpIAssignLocalFromModule

  use :: dtpIAssignLocalFromModulemod
  implicit none

  call moduleTest

end program dtpIAssignLocalFromModule
