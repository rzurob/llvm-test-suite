...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignInternalModuleFromVars
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to module variables in internal subprogram
!*
...
module dtpIAssignInternalModuleFromVarsmod
...
end module dtpIAssignInternalModuleFromVarsmod


program dtpIAssignInternalModuleFromVars

  use :: dtpIAssignInternalModuleFromVarsmod
...
end program dtpIAssignInternalModuleFromVars
