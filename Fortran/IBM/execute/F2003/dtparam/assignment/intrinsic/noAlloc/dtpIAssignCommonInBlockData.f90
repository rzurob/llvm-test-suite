...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignCommonInBlockData
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : initialise common variables in block data
!*
...
block data dtpIAssignCommonInBlockDataData
...
end block data dtpIAssignCommonInBlockDataData


program dtpIAssignCommonInBlockData
...
end program dtpIAssignCommonInBlockData
