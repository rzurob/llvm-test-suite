...
!*
!*  SECONDARY FUNCTIONS TESTED : assign polymorphic module function results
!*
...
module dtpIAssignFunctionResultFromModulePolymorphicmod
...
end module dtpIAssignFunctionResultFromModulePolymorphicmod


program dtpIAssignFunctionResultFromModulePolymorphic

  use :: dtpIAssignFunctionResultFromModulePolymorphicmod
  implicit none
  ...
  call testBase1(baseFun(1))
  b_3 = baseFun(1)
  call testBase1(b_3)

  call testBase1D(baseFun(3))
  b_3 = baseFun(3)
  call testBase1D(b_3)

  call testBase1D2(baseFun(5))
  b_3 = baseFun(5)
  call testBase1D2(b_3)

  call testBase2(baseFun(2))
  b_5 = baseFun(2)
  call testBase2(b_5)

  call testBase2D(baseFun(4))
  b_5 = baseFun(4)
  call testBase2D(b_5)

  call testBase2D2(baseFun(6))
  b_5 = baseFun(6)
  call testBase2D2(b_5)

  call testDerived4(derivedFun4(1))
  d_34 = derivedFun4(1)
  call testDerived4(d_34)

  call testDerived4D2(derivedFun4(2))
  d_34 = derivedFun4(2)
  call testDerived4D2(d_34)

  call testDerived8(derivedFun8(1))
  d_58 = derivedFun8(1)
  call testDerived8(d_58)

  call testDerived8D2(derivedFun8(2))
  d_58 = derivedFun8(2)
  call testDerived8D2(d_58)

  call testD2_48(d2Fun48())
  d2_3482 = d2Fun48()
  call testD2_48(d2_3482)

  call testD2_84(d2Fun84())
  d2_5841 = d2Fun84()
  call testD2_84(d2_5841)

  print *, 'done'

end program dtpIAssignFunctionResultFromModulePolymorphic
