...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignFunctionResultFromInternal
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to function result in internal procedure
!*
...
!*  DESCRIPTION
!*
!*  In internal procedures, assign values to a function result of a parameterised
...
module dtpIAssignFunctionResultFromInternalmod
...
end module dtpIAssignFunctionResultFromInternalmod


program dtpIAssignFunctionResultFromInternal
...
contains
  ...
  function baseFun1(n)
    use :: dtpIAssignFunctionResultFromInternalmod
    implicit none
    integer, intent(in) :: n
...
end program dtpIAssignFunctionResultFromInternal
