...
!*
!*  SECONDARY FUNCTIONS TESTED : assign scalars to arrays in main program
!*
...
!*  DESCRIPTION
!*
!*  In the main program, assign scalars to arrays of a parameterised derived type for
!*  which there is no user-defined assignment, and verify that the type parameters and
!*  data values are as expected.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpIAssignArraymod
...
end module dtpIAssignArraymod

program dtpIAssignArray

  use dtpIAssignArraymod
  implicit none

  integer i

  type(base(3))      :: b_3(5)
  type(derived(3,4)) :: d_34(3)
  type(d2(3,4,8,2))  :: d2_3482(1)

  type(base(5))      :: b_5(4)
  type(derived(5,8)) :: d_58(2)
  type(d2(5,8,4,1))  :: d2_5841(1)
