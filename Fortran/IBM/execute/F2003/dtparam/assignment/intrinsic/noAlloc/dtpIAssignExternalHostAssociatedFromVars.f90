...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignExternalHostAssociatedFromVars
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to host associated variables in external subprogram
!*
...
module dtpIAssignExternalHostAssociatedFromVarsmod
...
end module dtpIAssignExternalHostAssociatedFromVarsmod


program dtpIAssignExternalHostAssociatedFromVars

  implicit none
  external :: externalTest
  call externalTest

end program dtpIAssignExternalHostAssociatedFromVars


subroutine externalTest

  use :: dtpIAssignExternalHostAssociatedFromVarsmod
  implicit none
