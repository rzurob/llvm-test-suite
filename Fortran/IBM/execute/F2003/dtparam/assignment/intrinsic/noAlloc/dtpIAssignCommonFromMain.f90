...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignCommonFromMain
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign to common variables in main program
!*
...
!*  DESCRIPTION
!*
!*  In main program, assign values to common variables of a parameterised
...
block data dtpIAssignCommonFromMainData
...
end block data dtpIAssignCommonFromMainData


program dtpIAssignCommonFromMain
...
end program dtpIAssignCommonFromMain
