...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignExternalModule
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to module variables in external procedures
!*
...
!*  DESCRIPTION
!*
!*  In external routines, assign values to variables of a parameterised derived type for
...
module dtpIAssignExternalModulemod
...
end module dtpIAssignExternalModulemod

program dtpIAssignExternalModule

  use dtpIAssignExternalModulemod
  implicit none
  external assignSC
...
end program dtpIAssignExternalModule
