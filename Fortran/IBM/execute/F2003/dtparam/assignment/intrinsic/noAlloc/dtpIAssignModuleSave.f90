...
!*
!*  SECONDARY FUNCTIONS TESTED : initial assignment to SAVEd module variables
!*
...
!*  DESCRIPTION
!*
!*  Assign initial values to variables of a parameterised derived type for which
!*  there is no user-defined assignment, and verify that the type parameters and
!*  data values are as expected.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpIAssignModuleSavemod
  ...
  type, extends(derived) :: d2 (k2, l2)
   ...
   type(base(3)), save      :: b_3 = base(3)('abc')
   type(derived(3,4)), save :: d_34 = derived(3,4)('def',4.1_4,.true.,[1111111111,2122222222,1333333333])
   type(d2(3,4,8,2)), save  :: d2_3482 = d2(3,4,8,2)('ghi',5.9_4,.false.,[-1111111111,-2122222222,-1333333333], &
                                                     reshape([(1111_2*i,i=1,6)],[3,2]),&
                                                     derived(2,8)('xz',11235.81321D34,.true.,[76543211234567_8,-123456787654321_8]))

   type(base(5)), save      :: b_5  = base(5)('abcde')
   type(derived(5,8)), save :: d_58 = derived(5,8)('defgh',1.23456789D11,.true., &
                                                   [1111111111111_8,2222222222222_8,3333333333333_8,4444444444444_8,5555555555555_8])
   type(d2(5,8,4,1)), save  :: d2_5841 = d2(5,8,4,1)('defij',9.87654321D-12,.true., &
                                                     [-1111111111111_8,-2222222222222_8,-3333333333333_8,-4444444444444_8,-5555555555555_8], &
                                                     reshape([(1111_2*i,i=1,5)],[5,1]), &
                                                     derived(1,4)('y',9.87654E-12,.true.,[-12345678_4]))

end module dtpIAssignModuleSavemod

program dtpIAssignModuleSave

  use dtpIAssignModuleSavemod
  implicit none
