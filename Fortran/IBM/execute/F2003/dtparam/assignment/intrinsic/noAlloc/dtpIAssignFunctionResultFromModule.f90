...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignFunctionResultFromModule
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to function result in module procedure
!*
...
module dtpIAssignFunctionResultFromModulemod
...
end module dtpIAssignFunctionResultFromModulemod


program dtpIAssignFunctionResultFromModule

  use :: dtpIAssignFunctionResultFromModulemod
  implicit none
...
end program dtpIAssignFunctionResultFromModule
