...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignModuleFromModule
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to module variables in module procedures
!*
...
!*  DESCRIPTION
!*
!*  In module procedures, assign values to module variables of a parameterised
...
module dtpIAssignModuleFromModulemod
...
end module dtpIAssignModuleFromModulemod


program dtpIAssignModuleFromModule

  use dtpIAssignModuleFromModulemod
  implicit none
  integer i
...
end program dtpIAssignModuleFromModule
