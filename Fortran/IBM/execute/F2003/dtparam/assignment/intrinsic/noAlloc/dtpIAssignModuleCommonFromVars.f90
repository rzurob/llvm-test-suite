...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignModuleCommonFromVars
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to variables in common in module procedure
!*
...
module dtpIAssignModuleCommonFromVarsmod
...
end module dtpIAssignModuleCommonFromVarsmod


program dtpIAssignModuleCommonFromVars

  use dtpIAssignModuleCommonFromVarsmod
  implicit none
  integer i
...
end program dtpIAssignModuleCommonFromVars
