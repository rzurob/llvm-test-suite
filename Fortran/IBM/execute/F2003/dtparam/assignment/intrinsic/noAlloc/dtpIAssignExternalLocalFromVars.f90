...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignExternalLocalFromVars
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to local variables in external subprogram
!*
...
module dtpIAssignExternalLocalFromVarsmod
...
end module dtpIAssignExternalLocalFromVarsmod


program dtpIAssignExternalLocalFromVars
  implicit none
  external :: externalTest
  call externalTest
end program dtpIAssignExternalLocalFromVars


subroutine externalTest

  use :: dtpIAssignExternalLocalFromVarsmod
  implicit none
