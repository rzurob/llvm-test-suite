...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignLocalFromInternal
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign to local variables in internal subprogram
!*
...
!*  DESCRIPTION
!*
!*  In internal subprograms, assign values to local variables of a parameterised
...
module dtpIAssignLocalFromInternalmod
...
end module dtpIAssignLocalFromInternalmod


program dtpIAssignLocalFromInternal
...
contains
  ...
  subroutine internalTest
    ...
    use :: dtpIAssignLocalFromInternalmod
...
end program dtpIAssignLocalFromInternal
