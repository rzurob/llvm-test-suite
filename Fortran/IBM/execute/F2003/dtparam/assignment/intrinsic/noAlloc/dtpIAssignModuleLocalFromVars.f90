...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignModuleLocalFromVars
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to local variables in module procedure
!*
...
module dtpIAssignModuleLocalFromVarsmod
...
end module dtpIAssignModuleLocalFromVarsmod


program dtpIAssignModuleLocalFromVars

  use :: dtpIAssignModuleLocalFromVarsmod
...
end program dtpIAssignModuleLocalFromVars
