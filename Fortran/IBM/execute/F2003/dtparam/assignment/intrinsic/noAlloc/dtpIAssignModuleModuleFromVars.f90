...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignModuleModuleFromVars
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment without Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to module variables in module procedures
!*
...
module dtpIAssignModuleModuleFromVarsmod
...
end module dtpIAssignModuleModuleFromVarsmod


program dtpIAssignModuleModuleFromVars

  use :: dtpIAssignModuleModuleFromVarsmod
  implicit none
...
end program dtpIAssignModuleModuleFromVars
