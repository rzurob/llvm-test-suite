...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAssignMainLocalFromVars
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to local variables in main program
!*
...
module dtpIAssignMainLocalFromVarsmod
...
end module dtpIAssignMainLocalFromVarsmod


program dtpIAssignMainLocalFromVars

  use :: dtpIAssignMainLocalFromVarsmod
...
end program dtpIAssignMainLocalFromVars
