...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAAArrayInternal006
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : allocate DTP array (container) with indirectly allocatable components via intrinsic assignment (in internal subroutine)
!*
...
module dtpIAAArrayInternal006mod
...
end module dtpIAAArrayInternal006mod



program dtpIAAArrayInternal006

  use dtpIAAArrayInternal006mod
  implicit none
...
end program dtpIAAArrayInternal006
