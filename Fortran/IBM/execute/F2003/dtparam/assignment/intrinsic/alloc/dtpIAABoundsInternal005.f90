...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABoundsInternal005
!*
!*  DATE                       : 2009-05-22
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment with Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : allocate DTP array (len parameter) with allocatable component via intrinsic assignment and check lower and upper bounds (in internal subroutine)
!*
...
!*  ADAPTED FROM               : dtpIAABounds005 (<-dtpIAAArray005<-dtpIAABasic005<-dtpIAABasic002<-dtpIAABasic001)
!*
!*  DESCRIPTION
!*
...
!*  This adaptation passes variables and literals in to a single test subroutine
!*  (but in contrast to 001, the references are passed in by dummy argument, and
!*  not merely available by host association).
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpIAABoundsInternal005mod
...
end module dtpIAABoundsInternal005mod



program dtpIAABoundsInternal005

  use dtpIAABoundsInternal005mod
  implicit none
  ...
  call test (v1, v2, v3, v1a, v1b, v2a, v2b, v3a, v3b, v0, &
             [dla(0)('',[integer::]), dla(0)('',[integer::]), dla(0)('',[integer::]), dla(0)('',[integer::])], &
             reshape([dla(5)('abcde',[1,2,3,4,5]), dla(5)('bcdef',[2,3,4,5,6]), dla(5)('cdefg',[3,4,5,6,7]), dla(5)('defgh',[4,5,6,7,8])],[4,1]), &
             reshape([dla(1)('a',[22]), dla(1)('b',[42]), dla(1)('c',[66]), dla(1)('d',[26]), dla(1)('e',[88]), dla(1)('f',[99])],[1,2,3]))

contains

  subroutine test (v1, v2, v3, v1a, v1b, v2a, v2b, v3a, v3b, v0, a1, a2, a3)
    type(dla(:)), allocatable :: v1(:), v2(:,:), v3(:,:,:)
    type(dla(*)) :: v1a(:), v1b(:), v2a(:,:), v2b(:,:), v3a(:,:,:), v3b(:,:,:)
    type(dla(*)) :: a1(:), a2(:,:), a3(:,:,:)
    type(dla(*)) :: v0
...
end program dtpIAABoundsInternal005
