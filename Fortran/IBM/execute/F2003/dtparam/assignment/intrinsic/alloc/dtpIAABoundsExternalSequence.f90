...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABoundsExternalSequence
!*
!*  DATE                       : 2009-05-22
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment with Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : allocate basic sequence DTP array (container) with allocatable components via intrinsic assignment and check lower and upper bounds (in external subroutine)
!*
...
!*  ADAPTED FROM               : dtpIAABoundsExternal007 (<-dtpIAABoundsInternal007<-dtpIAABounds007<-dtpIAAArray007<-dtpIAABasic007<-dtpIAABasic006<-dtpIAABasic003<-dtpIAABasic002<-dtpIAABasic001)
!*
!*  DESCRIPTION
!*
...
!*  This adaptation passes variables in to a single external test subroutine.
!*  We can leave the interface implicit, as in dtpIAABasicExternal007, but we
!*  make it explicit by defining it.
!*  We use SEQUENCE types here, so there is no finalization possible, since no
!*  typebound procedures can be declared.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789


program dtpIAABoundsExternalSequence
...
end program dtpIAABoundsExternalSequence
