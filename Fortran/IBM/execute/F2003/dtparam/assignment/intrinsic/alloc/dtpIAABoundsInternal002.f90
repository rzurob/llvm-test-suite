...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABoundsInternal002
!*
!*  DATE                       : 2009-05-22
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment with Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : allocate DTP array (len) via intrinsic assignment and check lower and upper bounds (in internal subroutine)
!*
...
!*  ADAPTED FROM               : dtpIAABounds002 (<-dtpIAAArray002<-dtpIAABasic002<-dtpIAABasic001)
!*
!*  DESCRIPTION
!*
...
!*  This adaptation invokes a single internal subroutine, passing variables in.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpIAABoundsInternal002mod
...
end module dtpIAABoundsInternal002mod



program dtpIAABoundsInternal002

  use dtpIAABoundsInternal002mod
  implicit none

  type(dl(:)), allocatable :: v1(:), v2(:,:), v3(:,:,:)
  type(dl(3)) :: v1a(3), v1b(-2:1), v2a(2,1), v2b(0:1,-3:-1), v3a(1,1,1), v3b(2:3,3:4,4:5)
  type(dl(4)) :: v0
...
end program dtpIAABoundsInternal002
