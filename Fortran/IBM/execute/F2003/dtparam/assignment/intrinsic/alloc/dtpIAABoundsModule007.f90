...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABoundsModule007
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : allocate basic DTP array (container) with allocatable components via intrinsic assignment and check lower and upper bounds (in module subroutine)
!*
...
!*  This adaptation passes variables in to a single test subroutine in a module.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpIAABoundsModule007mod
...
end module dtpIAABoundsModule007mod



program dtpIAABoundsModule007

  use dtpIAABoundsModule007mod
  implicit none
...
end program dtpIAABoundsModule007
