...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABoundsExternal007
!*
!*  DATE                       : 2009-05-22
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment with Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : allocate basic DTP array (container) with allocatable components via intrinsic assignment and check lower and upper bounds (in external subroutine)
!*
...
!*  ADAPTED FROM               : dtpIAABoundsInternal007 (<-dtpIAABounds007<-dtpIAAArray007<-dtpIAABasic007<-dtpIAABasic006<-dtpIAABasic003<-dtpIAABasic002<-dtpIAABasic001)
!*
!*  DESCRIPTION
!*
...
module dtpIAABoundsExternal007mod
...
end module dtpIAABoundsExternal007mod



program dtpIAABoundsExternal007

  use dtpIAABoundsExternal007mod
  implicit none
...
end program dtpIAABoundsExternal007
