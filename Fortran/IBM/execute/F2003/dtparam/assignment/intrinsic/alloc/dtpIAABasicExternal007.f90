...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABasicExternal007
!*
!*  DATE                       : 2009-05-22
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment with Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : allocate basic DTP variable (container) with allocatable components via intrinsic assignment (in external subroutine)
!*
...
!*  as Array007, but processed in an external subroutine.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpIAABasicExternal007mod
...
end module dtpIAABasicExternal007mod



program dtpIAABasicExternal007

  use :: dtpIAABasicExternal007mod
  implicit none
...
end program dtpIAABasicExternal007
