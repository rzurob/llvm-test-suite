...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAABoundsInternal001
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : allocate basic DTP array (kind) via intrinsic assignment and check lower and upper bounds (in internal subroutine)
!*
...
!*  ADAPTED FROM               : dtpIAABounds001 (<-dtpIAAArray001<-dtpIAABasic001)
!*
!*  DESCRIPTION
!*
...
!*  This adaptation puts all the test inside a subroutine with no arguments, so
!*  everything is host-associated.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpIAABoundsInternal001mod
...
end module dtpIAABoundsInternal001mod



program dtpIAABoundsInternal001

  use dtpIAABoundsInternal001mod
  implicit none
...
end program dtpIAABoundsInternal001
