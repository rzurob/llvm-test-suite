...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpIAAArray006
!*
!*  DATE                       : 2009-05-22
!*
!*  PRIMARY FUNCTIONS TESTED   : Intrinsic Assignment with Allocation
!*
!*  SECONDARY FUNCTIONS TESTED : allocate DTP array (container) with indirectly allocatable components via intrinsic assignment
!*
...
end module dtpIAAArray006mod



program dtpIAAArray006

  use dtpIAAArray006mod
  implicit none
