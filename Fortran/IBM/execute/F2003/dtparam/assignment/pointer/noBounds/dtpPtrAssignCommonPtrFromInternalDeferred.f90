...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonPtrFromInternalDeferred
!*  TEST CASE TITLE            : 
!*
...
!*  DESCRIPTION
!*
!*  In internal procedures, via pointers in COMMON with deferred length parameters, assign
...
program dtpPtrAssignCommonPtrFromInternalDeferred
...
end program dtpPtrAssignCommonPtrFromInternalDeferred
