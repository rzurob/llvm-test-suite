...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignExternalModuleFromVarsFixed
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to module variables via fixed-length pointers in external subprogram
!*
...
module dtpPtrAssignExternalModuleFromVarsFixedmod
  ...
  type(base(3)), pointer      :: b_3p, b_3_ap
  type(derived(3,4)), pointer :: d_34p, d_34_ap
  type(d2(3,4,8,2)), pointer  :: d2_3482p, d2_3482_ap

  type(base(5)), pointer      :: b_5p, b_5_ap
  type(derived(5,8)), pointer :: d_58p, d_58_ap
  type(d2(5,8,4,1)), pointer  :: d2_5841p, d2_5841_ap

end module dtpPtrAssignExternalModuleFromVarsFixedmod


program dtpPtrAssignExternalModuleFromVarsFixed
  implicit none
  external :: externalTest
  call externalTest
end program dtpPtrAssignExternalModuleFromVarsFixed


subroutine externalTest
  use :: dtpPtrAssignExternalModuleFromVarsFixedmod
  ...
  type(base(3)), pointer      :: b_3_ha_p
  type(derived(3,4)), pointer :: d_34_ha_p
  type(d2(3,4,8,2)), pointer  :: d2_3482_ha_p

  type(base(5)), pointer      :: b_5_ha_p
  type(derived(5,8)), pointer :: d_58_ha_p
  type(d2(5,8,4,1)), pointer  :: d2_5841_ha_p
