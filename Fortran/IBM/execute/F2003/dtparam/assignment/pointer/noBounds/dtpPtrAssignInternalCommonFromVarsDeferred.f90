...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignInternalCommonFromVarsDeferred
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with deferred length parameter, assign variables to variables in common in internal procedures
!*
...
module dtpPtrAssignInternalCommonFromVarsDeferredmod
...
end module dtpPtrAssignInternalCommonFromVarsDeferredmod


program dtpPtrAssignInternalCommonFromVarsDeferred

  use :: dtpPtrAssignInternalCommonFromVarsDeferredmod
  implicit none
  integer i
  ...
  type(base(:)), pointer      :: b_3p
  type(derived(:,4)), pointer :: d_34p
  type(d2(:,4,8,:)), pointer  :: d2_3482p

  type(base(:)), pointer      :: b_5p
  type(derived(:,8)), pointer :: d_58p
  type(d2(:,8,4,:)), pointer  :: d2_5841p
...
end program dtpPtrAssignInternalCommonFromVarsDeferred
