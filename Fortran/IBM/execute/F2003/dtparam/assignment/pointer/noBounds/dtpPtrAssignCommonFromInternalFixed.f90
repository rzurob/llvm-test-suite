...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromInternalFixed
!*
!*  DATE                       : 2009-01-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with fixed length parameters, assign to common variables in internal subprograms
!*
...
!*  DESCRIPTION
!*
!*  In internal procedures, via pointers with fixed length parameters, assign values to
...
block data dtpPtrAssignCommonFromInternalFixedData
...
end block data dtpPtrAssignCommonFromInternalFixedData


program dtpPtrAssignCommonFromInternalFixed
...
end program dtpPtrAssignCommonFromInternalFixed
