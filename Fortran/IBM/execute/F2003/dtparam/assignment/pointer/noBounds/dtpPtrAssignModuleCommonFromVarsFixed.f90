...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignModuleCommonFromVarsFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to variables in common in module procedure (with fixed length parameter)
!*
...
module dtpPtrAssignModuleCommonFromVarsFixedmod
...
end module dtpPtrAssignModuleCommonFromVarsFixedmod


program dtpPtrAssignModuleCommonFromVarsFixed

  use dtpPtrAssignModuleCommonFromVarsFixedmod
  implicit none
  integer i
...
end program dtpPtrAssignModuleCommonFromVarsFixed
