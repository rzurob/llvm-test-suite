...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromMainFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with fixed length parameters, assign to COMMON variables in main program
!*
...
!*  DESCRIPTION
!*
!*  In main program, via pointers with fixed length parameters, assign to COMMON
...
block data dtpPtrAssignCommonFromMainFixedData
...
end block data dtpPtrAssignCommonFromMainFixedData


program dtpPtrAssignCommonFromMainFixed
...
end program dtpPtrAssignCommonFromMainFixed
