...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignFunctionResultFromModulePolymorphicDeferred
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign polymorphic module function results with deferred-length type parameters
!*
...
module dtpPtrAssignFunctionResultFromModulePolymorphicDeferredmod
...
end module dtpPtrAssignFunctionResultFromModulePolymorphicDeferredmod


program dtpPtrAssignFunctionResultFromModulePolymorphicDeferred

  use :: dtpPtrAssignFunctionResultFromModulePolymorphicDeferredmod
  implicit none
...
end program dtpPtrAssignFunctionResultFromModulePolymorphicDeferred
