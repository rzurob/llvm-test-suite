...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignExternalHostAssociatedFromVarsFixed
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to host associated variables via fixed-length pointers in an external subprogram
!*
...
module dtpPtrAssignExternalHostAssociatedFromVarsFixedmod
...
end module dtpPtrAssignExternalHostAssociatedFromVarsFixedmod


program dtpPtrAssignExternalHostAssociatedFromVarsFixed

  implicit none
  external :: externalTest
  call externalTest

end program dtpPtrAssignExternalHostAssociatedFromVarsFixed


subroutine externalTest

  use :: dtpPtrAssignExternalHostAssociatedFromVarsFixedmod
  implicit none
...
contains
  ...
  subroutine internalTest
    ...
    type(base(3)), pointer      :: b_3_localp, b_3_localp2
    type(derived(3,4)), pointer :: d_34_localp, d_34_localp2
    type(d2(3,4,8,2)), pointer  :: d2_3482_localp, d2_3482_localp2

    type(base(5)), pointer      :: b_5_localp, b_5_localp2
    type(derived(5,8)), pointer :: d_58_localp, d_58_localp2
    type(d2(5,8,4,1)), pointer  :: d2_5841_localp, d2_5841_localp2
