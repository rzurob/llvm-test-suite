...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromModuleFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with fixed length parameters, assign to common variables in module procedures
!*
...
!*  DESCRIPTION
!*
!*  In module procedures, via pointers with fixed length parameters, assign values to
...
module dtpPtrAssignCommonFromModuleFixedmod
...
end module dtpPtrAssignCommonFromModuleFixedmod


program dtpPtrAssignCommonFromModuleFixed

  use dtpPtrAssignCommonFromModuleFixedmod
  implicit none
...
end program dtpPtrAssignCommonFromModuleFixed
