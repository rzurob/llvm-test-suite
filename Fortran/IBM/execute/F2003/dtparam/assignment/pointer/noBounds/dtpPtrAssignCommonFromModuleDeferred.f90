...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromModuleDeferred
!*
!*  DATE                       : 2009-01-26
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with deferred length parameters, assign to common variables in module procedures
!*
...
!*  DESCRIPTION
!*
!*  In module procedures, via pointers with deferred length parameters, assign values to
...
module dtpPtrAssignCommonFromModuleDeferredmod
...
end module dtpPtrAssignCommonFromModuleDeferredmod


program dtpPtrAssignCommonFromModuleDeferred

  use dtpPtrAssignCommonFromModuleDeferredmod
  implicit none
...
end program dtpPtrAssignCommonFromModuleDeferred
