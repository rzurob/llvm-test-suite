...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignSelectTypeExprFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign from expr in select type using pointers with fixed length parameters
!*
...
module dtpPtrAssignSelectTypeExprFixedmod
...
end module dtpPtrAssignSelectTypeExprFixedmod


program dtpPtrAssignSelectTypeExprFixed

  use dtpPtrAssignSelectTypeExprFixedmod
  implicit none
...
end program dtpPtrAssignSelectTypeExprFixed
