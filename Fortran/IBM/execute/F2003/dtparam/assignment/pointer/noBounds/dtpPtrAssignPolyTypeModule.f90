...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignPolyTypeModule
!*  TEST CASE TITLE            : 
!*
...
!*  DESCRIPTION
!*
!*  - create family of types in a module, target instances of each type, and polymorphic pointers to each type in the family
!*  - pointer-assign the pointers to different targets, and test the dynamic type of each using SAME_TYPE_AS
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPtrAssignPolyTypeModuleMod
...
end module dtpPtrAssignPolyTypeModuleMod

program dtpPtrAssignPolyTypeModule

  use :: dtpPtrAssignPolyTypeModuleMod
  implicit none
...
end program dtpPtrAssignPolyTypeModule
