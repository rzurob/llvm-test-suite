...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignDummyArgDeferred
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via dummy arg pointers (with deferred length parameter), assign values to variables
!*
...
block data dtpPtrAssignDummyArgDeferredData
...
end block data dtpPtrAssignDummyArgDeferredData


program dtpPtrAssignDummyArgDeferred
  ...
  type(Base(:)), pointer      :: b_3lp, b_3rp
  type(Derived(:,4)), pointer :: d_34lp, d_34rp
  type(D2(:,4,8,:)), pointer  :: d2_3482lp, d2_3482rp

  type(Base(:)), pointer      :: b_5lp, b_5rp
  type(Derived(:,8)), pointer :: d_58lp, d_58rp
  type(D2(:,8,4,:)), pointer  :: d2_5841lp, d2_5841rp
...
end program dtpPtrAssignDummyArgDeferred
