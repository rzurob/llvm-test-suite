...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignLocalFromInternalFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via fixed-length parameter pointers, assign to local variables in internal subprogram
!*
...
!*  DESCRIPTION
!*
!*  In internal subprograms, assign values via fixed-length parameter pointers to
...
module dtpPtrAssignLocalFromInternalFixedmod
...
end module dtpPtrAssignLocalFromInternalFixedmod


program dtpPtrAssignLocalFromInternalFixed
...
contains
  ...
  subroutine internalTest
    ...
    use :: dtpPtrAssignLocalFromInternalFixedmod
...
end program dtpPtrAssignLocalFromInternalFixed
