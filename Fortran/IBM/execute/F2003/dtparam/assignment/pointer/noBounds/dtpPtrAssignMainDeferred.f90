...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignMainDeferred
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign via pointers with deferred length in main program
!*
...
!*  DESCRIPTION
!*
!*  In the main program, assign values to variables local to the main program of a
!*  parameterised derived type for which there is no user-defined assignment via pointers
!*  with deferred length, and verify that the type parameters and data values are as
!*  expected.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPtrAssignMainDeferredmod
...
end module dtpPtrAssignMainDeferredmod

program dtpPtrAssignMainDeferred

  use dtpPtrAssignMainDeferredmod
  implicit none
...
end program dtpPtrAssignMainDeferred
