...
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with deferred length parameter, assign variables to variables in common in external procedure
!*
...
module dtpPtrAssignExternalCommonFromVarsDeferredmod
...
subroutine checkValues(what)
  ...
  use :: dtpPtrAssignExternalCommonFromVarsDeferredmod
  implicit none
  character(*) :: what
...
program dtpPtrAssignExternalCommonFromVarsDeferred
...
end program dtpPtrAssignExternalCommonFromVarsDeferred
