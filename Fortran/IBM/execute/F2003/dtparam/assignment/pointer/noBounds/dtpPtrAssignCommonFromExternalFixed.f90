...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromExternalFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with fixed length parameters, assign to common variables in external subprograms
!*
...
!*  DESCRIPTION
!*
!*  In external procedures, via pointers with fixed length parameters, assign values to
...
block data dtpPtrAssignCommonFromExternalFixedData
...
end block data dtpPtrAssignCommonFromExternalFixedData


program dtpPtrAssignCommonFromExternalFixed
...
end program dtpPtrAssignCommonFromExternalFixed
