...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonPtrFromInternalMixed
!*
!*  DATE                       : 2009-01-12
!*
...
!*  DESCRIPTION
!*
!*  In internal procedures, via pointers in COMMON with mixed deferred and fixed length parameters,
...
block data dtpPtrAssignCommonPtrFromInternalMixedData
...
end block data dtpPtrAssignCommonPtrFromInternalMixedData


program dtpPtrAssignCommonPtrFromInternalMixed
...
end program dtpPtrAssignCommonPtrFromInternalMixed
