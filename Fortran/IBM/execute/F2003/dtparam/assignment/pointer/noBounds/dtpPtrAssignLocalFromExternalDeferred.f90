...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignLocalFromExternalDeferred
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via deferred-length pointers, assign to local variables in external subprogram
!*
...
!*  DESCRIPTION
!*
!*  In an external subprogram, via deferr-length pointers, assign values to local
!*  variables of a parameterised derived type for which there is no user-defined
!*  assignment, and verify that the type parameters and data values are as expected.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPtrAssignLocalFromExternalDeferredmod
...
end module dtpPtrAssignLocalFromExternalDeferredmod


program dtpPtrAssignLocalFromExternalDeferred
...
end program dtpPtrAssignLocalFromExternalDeferred


subroutine externalTest

  use :: dtpPtrAssignLocalFromExternalDeferredmod
