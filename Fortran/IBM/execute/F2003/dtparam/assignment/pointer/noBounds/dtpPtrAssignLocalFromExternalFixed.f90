...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignLocalFromExternalFixed
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via fixed-length pointers, assign to local variables in external subprogram
!*
...
!*  DESCRIPTION
!*
!*  In an external subprogram, via fixed-length pointers, assign values to local
...
module dtpPtrAssignLocalFromExternalFixedmod
...
end module dtpPtrAssignLocalFromExternalFixedmod


program dtpPtrAssignLocalFromExternalFixed
...
end program dtpPtrAssignLocalFromExternalFixed


subroutine externalTest

  use :: dtpPtrAssignLocalFromExternalFixedmod
