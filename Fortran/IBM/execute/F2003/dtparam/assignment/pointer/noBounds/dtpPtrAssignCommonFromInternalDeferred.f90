...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromInternalDeferred
!*
!*  DATE                       : 2009-01-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with deferred length parameters, assign to common variables in internal subprograms
!*
...
!*  DESCRIPTION
!*
!*  In internal procedures, via pointers with deferred length parameters, assign values to
...
block data dtpPtrAssignCommonFromInternalDeferredData
...
end block data dtpPtrAssignCommonFromInternalDeferredData


program dtpPtrAssignCommonFromInternalDeferred
...
end program dtpPtrAssignCommonFromInternalDeferred
