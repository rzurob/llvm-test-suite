...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignAssociate
!*  TEST CASE TITLE            : 
!*
...
!    call check("tb44 % dlp % l", tb44 % dlp % l, "var % dlp % l", var % dlp % l)
    temp1 = tb44 % dlp % l; temp2 = var % dlp % l
    call check("tb44 % dlp % l", temp1, "var % dlp % l", temp2)
!    call check("tb44 % dlqp % l", tb44 % dlqp % l, "var % dlqp % l", var % dlqp % l)
    temp1 = tb44 % dlqp % l; temp2 = var % dlqp % l
    call check("tb44 % dlqp % l", temp1, "var % dlqp % l", temp2)
    ! check data values
