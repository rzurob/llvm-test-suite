...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignMainCommonFromVarsDeferred
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with deferred length parameter, assign variables to variables in common in main
!*
...
module dtpPtrAssignMainCommonFromVarsDeferredmod
...
end module dtpPtrAssignMainCommonFromVarsDeferredmod


program dtpPtrAssignMainCommonFromVarsDeferred

  use :: dtpPtrAssignMainCommonFromVarsDeferredmod
  ...
  type(base(:)), pointer      :: b_3_ap
  type(derived(:,4)), pointer :: d_34_ap
  type(d2(:,4,8,:)), pointer  :: d2_3482_ap

  type(base(:)), pointer      :: b_5_ap
  type(derived(:,8)), pointer :: d_58_ap
  type(d2(:,8,4,:)), pointer  :: d2_5841_ap
...
end program dtpPtrAssignMainCommonFromVarsDeferred
