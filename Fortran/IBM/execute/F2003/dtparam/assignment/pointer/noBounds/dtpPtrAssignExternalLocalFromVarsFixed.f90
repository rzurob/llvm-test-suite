...
!*
!*  SECONDARY FUNCTIONS TESTED : assign variables to local variables via fixed-length pointers in an external subprogram
!*
...
module dtpPtrAssignExternalLocalFromVarsFixedmod
  ...
  type(base(3)), pointer      :: b_3_modp, b_3_modp2
  type(derived(3,4)), pointer :: d_34_modp, d_34_modp2
  type(d2(3,4,8,2)), pointer  :: d2_3482_modp, d2_3482_modp2

  type(base(5)), pointer      :: b_5_modp, b_5_modp2
  type(derived(5,8)), pointer :: d_58_modp, d_58_modp2
  type(d2(5,8,4,1)), pointer  :: d2_5841_modp, d2_5841_modp2

end module dtpPtrAssignExternalLocalFromVarsFixedmod


program dtpPtrAssignExternalLocalFromVarsFixed
  implicit none
  external :: externalTest
  call externalTest
end program dtpPtrAssignExternalLocalFromVarsFixed


subroutine externalTest

  use :: dtpPtrAssignExternalLocalFromVarsFixedmod
  implicit none
...
contains
  ...
  subroutine internalTest
    ...
    type(base(3)), pointer      :: b_3_l1p, b_3_l0p
    type(derived(3,4)), pointer :: d_34_l1p, d_34_l0p
    type(d2(3,4,8,2)), pointer  :: d2_3482_l1p, d2_3482_l0p

    type(base(5)), pointer      :: b_5_l1p, b_5_l0p
    type(derived(5,8)), pointer :: d_58_l1p, d_58_l0p
    type(d2(5,8,4,1)), pointer  :: d2_5841_l1p, d2_5841_l0p
  ...
  subroutine hostAssociatedTest
    ...
    type(base(3)), pointer      :: b_3_localp
    type(derived(3,4)), pointer :: d_34_localp
    type(d2(3,4,8,2)), pointer  :: d2_3482_localp

    type(base(5)), pointer      :: b_5_localp
    type(derived(5,8)), pointer :: d_58_localp
    type(d2(5,8,4,1)), pointer  :: d2_5841_localp
