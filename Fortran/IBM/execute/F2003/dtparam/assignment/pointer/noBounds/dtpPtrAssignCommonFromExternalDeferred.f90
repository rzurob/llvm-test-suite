...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromExternalDeferred
!*
!*  DATE                       : 2009-01-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with deferred length parameters, assign to common variables in external subprograms
!*
...
!*  DESCRIPTION
!*
!*  In external procedures, via pointers with deferred length parameters, assign values to
!*  common variables of a parameterised derived type for which there is no user-defined
...
block data dtpPtrAssignCommonFromExternalDeferredData
...
end block data dtpPtrAssignCommonFromExternalDeferredData


program dtpPtrAssignCommonFromExternalDeferred

  implicit none
  external assignValues, checkValues

  call assignValues
  call checkValues

end program dtpPtrAssignCommonFromExternalDeferred
