...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignMainFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : assign via pointers with fixed length in main program
!*
...
!*  with fixed length, and verify that the type parameters and data values are as
!*  expected.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPtrAssignMainFixedmod
...
end module dtpPtrAssignMainFixedmod

program dtpPtrAssignMainFixed

  use dtpPtrAssignMainFixedmod
  implicit none
...
end program dtpPtrAssignMainFixed
