...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonPtrFromExternalFixed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers in COMMON with fixed length parameters, assign to COMMON variables in external subprograms
!*
...
!*  DESCRIPTION
!*
!*  In external procedures, via pointers in COMMON with fixed length parameters, assign
...
block data dtpPtrAssignCommonPtrFromExternalFixedData
...
end block data dtpPtrAssignCommonPtrFromExternalFixedData


program dtpPtrAssignCommonPtrFromExternalFixed
...
end program dtpPtrAssignCommonPtrFromExternalFixed
