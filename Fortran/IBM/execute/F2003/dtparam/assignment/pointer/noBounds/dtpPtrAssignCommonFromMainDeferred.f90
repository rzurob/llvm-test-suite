...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonFromMainDeferred
!*
!*  DATE                       : 2009-01-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers with deferred length parameters, assign to COMMON variables in main program
!*
...
!*  DESCRIPTION
!*
!*  In main program, via pointers with deferred length parameters, assign to COMMON
...
program dtpPtrAssignCommonFromMainDeferred
...
end program dtpPtrAssignCommonFromMainDeferred
