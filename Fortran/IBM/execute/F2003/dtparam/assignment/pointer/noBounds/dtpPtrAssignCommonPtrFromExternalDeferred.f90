...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignCommonPtrFromExternalDeferred
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : via pointers in COMMON with deferred length parameters, assign to COMMON variables in external subprograms
!*
...
!*  DESCRIPTION
!*
!*  In external procedures, via pointers in COMMON with deferred length parameters, assign
...
program dtpPtrAssignCommonPtrFromExternalDeferred
...
end program dtpPtrAssignCommonPtrFromExternalDeferred
...
subroutine assignValues
  ...
  common /com/ b_Dp, b_Dp2, d_D4p, d2_D48Dp, d_D8p, d2_D84Dp
  ...
  common /tgt/ b_3, d_34, d2_3482, b_5, d_58, d2_5841
