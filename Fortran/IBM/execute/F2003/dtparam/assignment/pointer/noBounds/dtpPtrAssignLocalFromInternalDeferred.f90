...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpPtrAssignLocalFromInternalDeferred
!*
!*  DATE                       : 2008-11-12
!*
!*  PRIMARY FUNCTIONS TESTED   : Pointer Assignment without Lower Bounds Specification or Remap
!*
!*  SECONDARY FUNCTIONS TESTED : via deferred-length parameter pointers, assign to local variables in internal subprogram
!*
...
!*  DESCRIPTION
!*
!*  In internal subprograms, assign values via deferred-length parameter pointers to
!*  local variables of a parameterised derived type for which there is no user-defined
!*  assignment, and verify that the type parameters and data values are as expected.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpPtrAssignLocalFromInternalDeferredmod
...
end module dtpPtrAssignLocalFromInternalDeferredmod


program dtpPtrAssignLocalFromInternalDeferred
...
contains
  ...
  subroutine internalTest
    ...
    use :: dtpPtrAssignLocalFromInternalDeferredmod
...
end program dtpPtrAssignLocalFromInternalDeferred
