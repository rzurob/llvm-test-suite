...
module m1
   ...
   contains
      ...
      elemental subroutine assignA1(this1,ta1)
          class(A(4,*)),intent(inout)   :: this1
          type(A(4,*)),intent(in) :: ta1

          class(A(2,*)),intent(inout)   :: this2
          type(A(2,*)),intent(in) :: ta2
      ...
      entry assignA2(this2,ta2)
          ...
          this2%i1=-2*ta2%i1
          this2%c1=ta2%c1(:)(ubound(ta2%c1,1)-1:ubound(ta2%c1,1)) //  &
                   ta2%c1(:)(lbound(ta2%c1,1):lbound(ta2%c1,1)+1)
...
100    return
      ...
      function getA1(ta) Result(r)
         class(A(4,*)),intent(in) :: ta
         type(A(ta%k1,ta%l1))  :: r

         r=ta
      end function

      function getA2(ta) Result(r)
         class(A(2,*)),intent(in) :: ta
         type(A(ta%k1,ta%l1))  :: r
...
module m2
  ...
  type B(k2,l2)
    ...
    contains
       procedure :: assignB1
       procedure :: assignB2
       generic   :: assignment(=)=>assignB1,assignB2
  end type
  ...
  contains
     ...
     recursive subroutine assignB1(this,dt)
        ...
        this%a1comp=dt%a1comp  !invoke assignA1
...
program defAssignDataPtrComp04b
    ...
    type(XB(2,:)),pointer :: bobj3=>null()

    type(XB(1,:)),pointer :: bobj4=>null()
