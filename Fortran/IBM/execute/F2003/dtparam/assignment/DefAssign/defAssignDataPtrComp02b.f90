...
module m
   ...
   type,extends(base) :: child(k2)
     ...
     type(A(2*k2)) :: a2comp
     contains
        procedure :: assign1=>assignChild1
        procedure :: assign2=>assignChild2
   ...
   contains
     ...
     elemental subroutine assignA1(this,dt)
       ...
       integer :: s1,s2,s3,s4,d1,d2,d3,d4

       s1=lbound(dt%i1,1); s2=ubound(dt%i1,1)
       s3=lbound(dt%i1,2); s4=ubound(dt%i1,2)

       d1=lbound(dt%r1,1); d2=ubound(dt%r1,1)
       d3=lbound(dt%r1,2); d4=ubound(dt%r1,2)

       allocate(this%i1(s1:s2,s3:s4),source=dt%i1)
       allocate(this%r1(d1:d2,d3:d4),source=dt%r1)
     ...
     elemental subroutine assignChild1(this,dt)
