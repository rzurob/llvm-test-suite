...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryTKRInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : correct binary operators are used for a given TKR (generic interface)
!*
...
!*  DESCRIPTION
!*
!*  Define a type with procedures for binary operators associated via
...
module dtpUOpSimpleBinaryTKRInterfacemod
...
end module dtpUOpSimpleBinaryTKRInterfacemod

program dtpUOpSimpleBinaryTKRInterface
  use :: dtpUOpSimpleBinaryTKRInterfacemod
  implicit none
...
end program dtpUOpSimpleBinaryTKRInterface
