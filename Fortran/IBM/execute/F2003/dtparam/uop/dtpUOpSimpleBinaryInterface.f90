...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : correct binary operator functions are used for given type and kind (single operator, generic interface)
!*
...
module dtpUOpSimpleBinaryInterfacemod
...
end module dtpUOpSimpleBinaryInterfacemod


program dtpUOpSimpleBinaryInterface

  use dtpUOpSimpleBinaryInterfacemod
  implicit none
...
end program dtpUOpSimpleBinaryInterface
