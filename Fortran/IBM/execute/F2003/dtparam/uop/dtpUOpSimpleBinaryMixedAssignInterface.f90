...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryMixedAssignInterface
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : mixed result types, binary ops in assignment statements (generic interface)
!*
...
module dtpUOpSimpleBinaryMixedAssignInterfacemod
...
end module dtpUOpSimpleBinaryMixedAssignInterfacemod


program dtpUOpSimpleBinaryMixedAssignInterface

  use dtpUOpSimpleBinaryMixedAssignInterfacemod
  implicit none
  ...
  ! try variables:
  xk2c = xk2a+xk2b		! DK_2_TYPE
  print *, xk2c
  xk2c = xk2a-xk2b		! DK_2_TYPE
  print *, xk2c
  xk4c = xk4a+xk4b		! DK_4_TYPE
  print *, xk4c
  xk4c = xk4a-xk4b		! DK_4_TYPE
  print *, xk4c

  x2k22c = xk2a*xk2b		! D2K_2_2_TYPE
  print *, x2k22c
  x2k24c = xk2a*xk4b		! D2K_2_4_TYPE
  print *, x2k24c
  x2k42c = xk4a*xk2b		! D2K_4_2_TYPE
  print *, x2k42c
  x2k44c = xk4a*xk4b		! D2K_4_4_TYPE
  print *, x2k44c

  x2l2c = xk2a*xlb		! D2L_2_TYPE
  print *, x2l2c
  x2l4c = xk4a*xlb		! D2L_4_TYPE
  print *, x2l4c    !<-- line 10

  xlc = xla+xlb			! DL_TYPE
  print *, xlc
  xlc1 = xla-xlb			! DL_TYPE
  print *, xlc1

  x2l2c = xla*xk2b		! D2L_2_TYPE
  print *, x2l2c
  x2l4c = xla*xk4b		! D2L_4_TYPE
  print *, x2l4c

  x2k22c = x2k22a+x2k22b	! D2K_2_2_TYPE
  print *, x2k22c
  x2k24c = x2k24a+x2k24b	! D2K_2_4_TYPE
  print *, x2k24c
  x2k42c = x2k42a+x2k42b	! D2K_4_2_TYPE
  print *, x2k42c
  x2k44c = x2k44a+x2k44b	! D2K_4_4_TYPE
  print *, x2k44c

  xk2c = x2k22a/xk2b		! DK_2_TYPE
  print *, xk2c
  xk4c = x2k24a/xk2b		! DK_4_TYPE
  print *, xk4c     !<-- line 20
  xk4c = x2k42a/xk2b		! DK_4_TYPE
  print *, xk4c
  x2k22c = x2k44a/xk2b		! D2K_2_2_TYPE
  print *, x2k22c
  intc = x2k22a/xk4b		! INTEGER_TYPE
  print *, intc
  xk2c = x2k24a/xk4b		! DK_2_TYPE
  print *, xk2c
  xk2c = x2k42a/xk4b		! DK_2_TYPE
  print *, xk2c
  xk4c = x2k44a/xk4b		! DK_4_TYPE
  print *, xk4c

  x2l2c1 = x2l2a+x2l2b		! D2L_2_TYPE
  print *, x2l2c1
  x2l4c1 = x2l4a+x2l4b		! D2L_4_TYPE
  print *, x2l4c1
  x2l2c2 = x2l2a-x2l2b		! D2L_2_TYPE
  print *, x2l2c2
  x2l4c2 = x2l4a-x2l4b		! D2L_4_TYPE
  print *, x2l4c2   !<-- line 30

  xlc2 = x2l2a/xk2b		! DL_TYPE
  print *, xlc2
  xlc3 = x2l4a/xk4b		! DL_TYPE
  print *, xlc3
  xk2c = x2l2a/xlb		! DK_2_TYPE
  print *, xk2c
  xk4c = x2l4a/xlb		! DK_4_TYPE
  print *, xk4c

  ! try structure constructors:
  xk2c = dk(2)(54)+dk(2)(210)						! DK_2_TYPE
  print *, xk2c
  xk2c = dk(2)(169)-dk(2)(192)						! DK_2_TYPE
  print *, xk2c
  xk4c = dk(4)(26961)+dk(4)(31834)					! DK_4_TYPE
  print *, xk4c
  xk4c = dk(4)(26493)-dk(4)(25376)					! DK_4_TYPE
  print *, xk4c

  x2k22c = dk(2)(54)*dk(2)(92)						! D2K_2_2_TYPE
  print *, x2k22c
  x2k24c = dk(2)(22)*dk(4)(28644)					! D2K_2_4_TYPE
  print *, x2k24c       !<-- line 40
  x2k42c = dk(4)(32619)*dk(2)(45)					! D2K_4_2_TYPE
  print *, x2k42c
  x2k44c = dk(4)(7632)*dk(4)(28893)					! D2K_4_4_TYPE
  print *, x2k44c

  x2l2c = dk(2)(154)*dl(5)(['l','f','`','&','v'])			! D2L_2_TYPE
  print *, x2l2c
  x2l4c = dk(4)(2659)*dl(5)(['~','M','W','N','r'])			! D2L_4_TYPE
  print *, x2l4c

  xlc = dl(5)(['e','t','C','~','>'])+dl(5)(['7','F','j','m','l'])	! DL_TYPE
  print *, xlc
  xlc1 = dl(5)(['w','2','%','I','?'])-dl(5)(['a','w','q',')','I'])	! DL_TYPE
  print *, xlc1

  x2l2c = dl(5)(['@','|','p','q','S'])*dk(2)(174)			! D2L_2_TYPE
  print *, x2l2c
  x2l4c = dl(5)(['L','m','8','"','a'])*dk(4)(30725)			! D2L_4_TYPE
  print *, x2l4c

  x2k22c = d2k(2,2)(244,243)+d2k(2,2)(181,144)				! D2K_2_2_TYPE
  print *, x2k22c
  x2k24c = d2k(2,4)(75,19146)+d2k(2,4)(133,9658)			! D2K_2_4_TYPE
  print *, x2k24c       !<-- line 50
  x2k42c = d2k(4,2)(23268,208)+d2k(4,2)(23307,255)			! D2K_4_2_TYPE
  print *, x2k42c
  x2k44c = d2k(4,4)(23655,16800)+d2k(4,4)(4747,25770)			! D2K_4_4_TYPE
  print *, x2k44c

  xk2c = d2k(2,2)(121,206)/dk(2)(247)					! DK_2_TYPE
  print *, xk2c
  xk4c = d2k(2,4)(68,557)/dk(2)(25)					! DK_4_TYPE
  print *, xk4c
  xk4c = d2k(4,2)(4673,108)/dk(2)(255)					! DK_4_TYPE
  print *, xk4c
  x2k22c = d2k(4,4)(7805,11604)/dk(2)(81)				! D2K_2_2_TYPE
  print *, x2k22c
  intc = d2k(2,2)(47,44)/dk(4)(27175)					! INTEGER_TYPE
  print *, intc
  xk2c = d2k(2,4)(214,6160)/dk(4)(29934)				! DK_2_TYPE
  print *, xk2c
  xk2c = d2k(4,2)(24261,89)/dk(4)(7659)					! DK_2_TYPE
  print *, xk2c
  xk4c = d2k(4,4)(19279,539)/dk(4)(2303)				! DK_4_TYPE
  print *, xk4c     !<-- line 60
  ...
  xlc2 = d2l(2,9)(['#','n','1','%','`','<','j','w','Z'],152)/dk(2)(188)	! DL_TYPE
  print *, xlc2
  xlc3 = d2l(4,7)(['W',']','u','.','a','8','7'],26321)/dk(4)(28668)	! DL_TYPE
  print *, xlc3
...
end program dtpUOpSimpleBinaryMixedAssignInterface
