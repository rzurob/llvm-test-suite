...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleUnaryNamedInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : correct unary operator functions (in interface) are used for given type and kind (single named operator)
!*
...
!*  interface for unary named operators and verify that the correct function is invoked.
...
module dtpUOpSimpleUnaryNamedInterfacemod
...
end module dtpUOpSimpleUnaryNamedInterfacemod


program dtpUOpSimpleUnaryNamedInterface

  use dtpUOpSimpleUnaryNamedInterfacemod
  implicit none
...
end program dtpUOpSimpleUnaryNamedInterface
