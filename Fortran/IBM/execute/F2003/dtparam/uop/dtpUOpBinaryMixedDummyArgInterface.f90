...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpBinaryMixedDummyArgInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : mixed result types, binary ops appear as dummy arguments, more complex expressions (generic interface)
!*
...
module dtpUOpBinaryMixedDummyArgInterfacemod
...
contains
  ...
  integer function binarySlash2K224(this,that)
    class(d2k(2,2)), intent(in) :: this
    class(dk(4)), intent(in) :: that
    binarySlash2K224 = (int(this%ivar) * this%ivar2)
...
end module dtpUOpBinaryMixedDummyArgInterfacemod


program dtpUOpBinaryMixedDummyArgInterface

  use dtpUOpBinaryMixedDummyArgInterfacemod
  implicit none
...
end program dtpUOpBinaryMixedDummyArgInterface
