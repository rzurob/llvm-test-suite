...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleUnaryDummyArg
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : unary ops appearing as dummy arguments
!*
...
module dtpUOpSimpleUnaryDummyArgmod
  ...
  type dk (k)
     ...
     integer(k)    :: ivar
   contains
     generic :: operator(+) => unaryPlusK2, unaryPlusK4
     procedure, pass :: unaryPlusK2
     procedure, pass :: unaryPlusK4
     generic :: operator(-) => unaryMinusK2, unaryMinusK4
  ...
  type dl (l)
     ...
     character(1)  :: cvar(l)
   contains
     generic :: operator(+) => unaryPlusL
     procedure, pass :: unaryPlusL
     generic :: operator(-) => unaryMinusL
  ...
  type d2k (k,k2)
     ...
     integer(k2)   :: ivar2
   contains
     generic :: operator(+) => unaryPlus2K22, unaryPlus2K24, unaryPlus2K42, unaryPlus2K44
     procedure, pass :: unaryPlus2K22
     procedure, pass :: unaryPlus2K24
     procedure, pass :: unaryPlus2K42
     procedure, pass :: unaryPlus2K44
     generic :: operator(-) => unaryMinus2K22, unaryMinus2K24, unaryMinus2K42, unaryMinus2K44
  ...
  type d2l (k,l)
     ...
     integer(k)    :: ivar
   contains
     generic :: operator(+) => unaryPlus2L2, unaryPlus2L4
     procedure, pass :: unaryPlus2L2
     procedure, pass :: unaryPlus2L4
     generic :: operator(-) => unaryMinus2L2, unaryMinus2L4
...
end module dtpUOpSimpleUnaryDummyArgmod


program dtpUOpSimpleUnaryDummyArg

  use dtpUOpSimpleUnaryDummyArgmod
  implicit none
  ...
  call test(+xk2a, DK_2_TYPE)
  call test(+dk(2)(0), DK_2_TYPE)
  call test(-xk2b, DK_2_TYPE)
  call test(-dk(2)(0), DK_2_TYPE)

  call test(+xk4a, DK_4_TYPE)
  call test(+dk(4)(0), DK_4_TYPE)
  call test(-xk4b, DK_4_TYPE)
  call test(-dk(4)(0), DK_4_TYPE)

  call test(+xla, DL_TYPE)
  call test(+dl(4)(['d','e','f','g']), DL_TYPE)
  call test(-xlb, DL_TYPE)
  call test(-dl(6)(['d','e','f','g','h','i']), DL_TYPE)

  call test(+x2k22a, D2K_2_2_TYPE)
  call test(+d2k(2,2)(0,0), D2K_2_2_TYPE)
  call test(-x2k22b, D2K_2_2_TYPE)
  call test(-d2k(2,2)(0,0), D2K_2_2_TYPE)

  call test(+x2k24a, D2K_2_4_TYPE)
  call test(+d2k(2,4)(0,0), D2K_2_4_TYPE)
  call test(-x2k24b, D2K_2_4_TYPE)
  call test(-d2k(2,4)(0,0), D2K_2_4_TYPE)

  call test(+x2k42a, D2K_4_2_TYPE)
  call test(+d2k(4,2)(0,0), D2K_4_2_TYPE)
  call test(-x2k42b, D2K_4_2_TYPE)
  call test(-d2k(4,2)(0,0), D2K_4_2_TYPE)

  call test(+x2k44a, D2K_4_4_TYPE)
  call test(+d2k(4,4)(0,0), D2K_4_4_TYPE)
  call test(-x2k44b, D2K_4_4_TYPE)
  call test(-d2k(4,4)(0,0), D2K_4_4_TYPE)

  call test(+x2l2a, D2L_2_TYPE)
  call test(+d2l(2,8)(['z','y','x','w','v','u','t','s'],0), D2L_2_TYPE)
  call test(-x2l2b, D2L_2_TYPE)
  call test(-d2l(2,10)(['z','y','x','w','v','u','t','s','r','p'],0), D2L_2_TYPE)

  call test(+x2l4a, D2L_4_TYPE)
  call test(+d2l(4,6)(['q','p','o','n','m','l'],0), D2L_4_TYPE)
  call test(-x2l4b, D2L_4_TYPE)
  call test(-d2l(4,8)(['q','p','o','n','m','l','k','j'],0), D2L_4_TYPE)
...
end program dtpUOpSimpleUnaryDummyArg
