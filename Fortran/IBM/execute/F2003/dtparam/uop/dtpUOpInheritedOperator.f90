...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpInheritedOperator
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : operators defined in parent class
!*
...
!*  binary operators, as well as types derived from these (appropriately named
...
module dtpUOpInheritedOperatormod
...
end module dtpUOpInheritedOperatormod


program dtpUOpInheritedOperator

  use dtpUOpInheritedOperatormod
  implicit none
...
end program dtpUOpInheritedOperator
