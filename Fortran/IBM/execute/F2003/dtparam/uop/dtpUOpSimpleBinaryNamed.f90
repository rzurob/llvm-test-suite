...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryNamed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : correct binary operator functions are used for given type and kind (single named operator)
!*
...
module dtpUOpSimpleBinaryNamedmod
  ...
  type d2k (k,k2)
   ...
   contains
     ...
     generic :: operator(.subit.) => binaryMinus2K22, binaryMinus2K24, binaryMinus2K42, binaryMinus2K44
...
end module dtpUOpSimpleBinaryNamedmod


program dtpUOpSimpleBinaryNamed

  use dtpUOpSimpleBinaryNamedmod
  implicit none
    ...
    xk2c  = xk2a.addit.xk2a
    xk2a  = dk(2)(25).addit.dk(2)(26)
    xk2d  = xk2b.subit.xk2b
    xk2b  = dk(2)(27).subit.dk(2)(28)
    print *, xk2a, xk2b, xk2c, xk2d, dk(2)(29).addit.dk(2)(30), dk(2)(31).subit.dk(2)(32)

    xk4c  = xk4a.addit.xk4a
    xk4a  = dk(4)(33).addit.dk(4)(34)
    xk4d  = xk4b.subit.xk4b
    xk4b  = dk(4)(35).subit.dk(4)(36)
    print *, xk4a, xk4b, xk4c, xk4d, dk(4)(37).addit.dk(4)(38), dk(4)(39).subit.dk(4)(40)


    xlc  = xla.addit.xla
    xla  = dl(4)(['d','e','f','g']).addit.dl(4)(['d','e','f','g'])
    xld  = xlb.subit.xlb
    xlb  = dl(6)(['d','e','f','g','h','i']).subit.dl(6)(['d','e','f','g','h','i'])
    print *, xla, xlb, xlc, xld, dl(4)(['d','e','f','g']).addit.dl(4)(['d','e','f','g']), dl(6)(['d','e','f','g','h','i']).subit.dl(6)(['d','e','f','g','h','i'])


    x2k22c  = x2k22a.addit.x2k22a
    x2k22a  = d2k(2,2)(41,42).addit.d2k(2,2)(43,44)
    x2k22d  = x2k22b.subit.x2k22b
    x2k22b  = d2k(2,2)(45,46).subit.d2k(2,2)(47,48)
    print *, x2k22a, x2k22b, x2k22c, x2k22d, d2k(2,2)(49,50).addit.d2k(2,2)(51,52), d2k(2,2)(53,54).subit.d2k(2,2)(55,56)

    x2k24c  = x2k24a.addit.x2k24a
    x2k24a  = d2k(2,4)(57,58).addit.d2k(2,4)(59,60)
    x2k24d  = x2k24b.subit.x2k24b
    x2k24b  = d2k(2,4)(-60,-59).subit.d2k(2,4)(-58,-57)
    print *, x2k24a, x2k24b, x2k24c, x2k24d, d2k(2,4)(-56,-55).addit.d2k(2,4)(-54,-53), d2k(2,4)(-52,-51).subit.d2k(2,4)(-50,-49)

    x2k42c  = x2k42a.addit.x2k42a
    x2k42a  = d2k(4,2)(-48,-47).addit.d2k(4,2)(-46,-45)
    x2k42d  = x2k42b.subit.x2k42b
    x2k42b  = d2k(4,2)(-44,-43).subit.d2k(4,2)(-42,-41)
    print *, x2k42a, x2k42b, x2k42c, x2k42d, d2k(4,2)(-40,-39).addit.d2k(4,2)(-38,-37), d2k(4,2)(-36,-35).subit.d2k(4,2)(-34,-33)

    x2k44c  = x2k44a.addit.x2k44a
    x2k44a  = d2k(4,4)(-32,-31).addit.d2k(4,4)(-30,-29)
    x2k44d  = x2k44b.subit.x2k44b
    x2k44b  = d2k(4,4)(-28,-27).subit.d2k(4,4)(-26,-25)
    print *, x2k44a, x2k44b, x2k44c, x2k44d, d2k(4,4)(-24,-23).addit.d2k(4,4)(-22,-21), d2k(4,4)(-20,-19).subit.d2k(4,4)(-18,-17)


    x2l2c  = x2l2a.addit.x2l2a
    x2l2a  = d2l(2,8)(['z','y','x','w','v','u','t','s'],-16).addit.d2l(2,8)(['z','y','x','w','v','u','t','s'],-15)
    x2l2d  = x2l2b.subit.x2l2b
    x2l2b  = d2l(2,10)(['z','y','x','w','v','u','t','s','r','p'],-14).subit.d2l(2,10)(['z','y','x','w','v','u','t','s','r','p'],-13)
    print *, x2l2a, x2l2b, x2l2c, x2l2d, d2l(2,8)(['z','y','x','w','v','u','t','s'],-12).addit.d2l(2,8)(['z','y','x','w','v','u','t','s'],-11), d2l(2,10)(['z','y','x','w','v','u','t','s','r','p'],-10).subit.d2l(2,10)(['z','y','x','w','v','u','t','s','r','p'],-9)

    x2l4c  = x2l4a.addit.x2l4a
    x2l4a  = d2l(4,6)(['q','p','o','n','m','l'],-8).addit.d2l(4,6)(['q','p','o','n','m','l'],-7)
    x2l4d  = x2l4b.subit.x2l4b
    x2l4b  = d2l(4,8)(['q','p','o','n','m','l','k','j'],-6).subit.d2l(4,8)(['q','p','o','n','m','l','k','j'],-5)
    print *, x2l4a, x2l4b, x2l4c, x2l4d, d2l(4,6)(['q','p','o','n','m','l'],-4).addit.d2l(4,6)(['q','p','o','n','m','l'],-3), d2l(4,8)(['q','p','o','n','m','l','k','j'],-2).subit.d2l(4,8)(['q','p','o','n','m','l','k','j'],-1)


end program dtpUOpSimpleBinaryNamed
