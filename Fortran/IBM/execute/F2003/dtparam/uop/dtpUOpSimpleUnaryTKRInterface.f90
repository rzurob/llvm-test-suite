...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleUnaryTKRInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : correct unary operators are used for a given TKR (generic interface)
!*
...
module dtpUOpSimpleUnaryTKRInterfacemod
  ...
  interface operator(+)
    module procedure unaryPlusK2 ! R0
    module procedure unaryPlusK4 ! R0
    module procedure unaryPlusK4R1
    module procedure unaryPlusK4R2
    module procedure unaryPlus2K24 ! R0
    module procedure unaryPlus2K24R2
    module procedure unaryPlusL ! R0
    module procedure unaryPlusLR1
    module procedure unaryPlusLR2
    module procedure unaryPlus2L2 ! R0
    module procedure unaryPlus2L2R1
    module procedure unaryPlus2L4 ! R0
...
contains
  ...
  function unaryPlusL(arg)
    ...
    unaryPlusL = dl(arg%l+1)([arg%cvar, '@'])
  ...
  function unaryPlusLR2(arg)
    ...
    integer :: i, j
!    unaryPlusLR2 = reshape([((dl(arg%l+1)([arg(i,j)%cvar, achar(mod(83*i+89*j,96)+32)]), i=1,ubound(arg,1)), j=1,ubound(arg,2))],[size(arg,2),size(arg,1)])

    do j = 1, size(arg,2)
        do i = 1, size(arg,1)
            unaryPlusLR2(j,i)%cvar = [arg(i,j)%cvar, achar(mod(83*i+89*j,96)+32)]
        end do
    end do
  ...
  function unaryPlus2L2(arg)
    ...
    unaryPlus2L2 = d2l(2,arg%l+1)([arg%cvar, '%'],arg%ivar + 4096)
  ...
  function unaryPlus2L4(arg)
    ...
    unaryPlus2L4 = d2l(4,arg%l+1)([arg%cvar, '^'],arg%ivar + 8192)
  end function unaryPlus2L4

end module dtpUOpSimpleUnaryTKRInterfacemod


program dtpUOpSimpleUnaryTKRInterface

  use dtpUOpSimpleUnaryTKRInterfacemod
  implicit none
  ...
  print *, "unaryPlusK2 (R0)", dk(2)(xk2a%ivar+1), [integer::]
  print *, "unaryPlusK4 (R0)", dk(4)(xk4a%ivar+2), [integer::]
  print *, "unaryPlusK2 (R0)", dk(2)(1+1), [integer::]
  print *, "unaryPlusK4 (R0)", dk(4)(2+2), [integer::]
  ...
  print *, "unaryPlus2K24 (R0)", d2k(2,4)(x2k24a%ivar+32,x2k24a%ivar2+107), [integer::]
  print *, "unaryPlus2K24 (R0)", d2k(2,4)(21+32,31+107), [integer::]
  ...
  print *, "unaryPlus2L2 (R0)", d2l(2,x2l2a%l+1)([x2l2a%cvar,'%'],x2l2a%ivar+4096), [integer::]
  print *, "unaryPlus2L2R1", count([x2l2a%cvar, x2l2b%cvar] >= 'a'), [integer::]
  print *, "unaryPlus2L4 (R0)", d2l(4,x2l4a%l+1)([x2l4a%cvar,'^'],x2l4a%ivar+8192), [integer::]
...
end program dtpUOpSimpleUnaryTKRInterface
