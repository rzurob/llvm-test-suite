...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpUnaryDummyArgInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : several unary ops appearing as an expression as a dummy argument (generic interface)
!*
...
module dtpUOpUnaryDummyArgInterfacemod
...
end module dtpUOpUnaryDummyArgInterfacemod


program dtpUOpUnaryDummyArgInterface

  use dtpUOpUnaryDummyArgInterfacemod
  implicit none
...
end program dtpUOpUnaryDummyArgInterface
