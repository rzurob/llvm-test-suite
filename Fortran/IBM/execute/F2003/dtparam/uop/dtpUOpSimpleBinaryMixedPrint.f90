...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryMixedPrint
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : mixed result types, binary ops in print statements
!*
...
module dtpUOpSimpleBinaryMixedPrintmod
...
end module dtpUOpSimpleBinaryMixedPrintmod


program dtpUOpSimpleBinaryMixedPrint

  use dtpUOpSimpleBinaryMixedPrintmod
  implicit none
...
end program dtpUOpSimpleBinaryMixedPrint
