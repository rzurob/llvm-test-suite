...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryMixedAssign
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : mixed result types, binary ops in assignment statements
!*
...
module dtpUOpSimpleBinaryMixedAssignmod
...
end module dtpUOpSimpleBinaryMixedAssignmod


program dtpUOpSimpleBinaryMixedAssign

  use dtpUOpSimpleBinaryMixedAssignmod
  implicit none
  ...
  xlc1 = x2l2a/xk2b		! DL_TYPE
  print *, xlc1
  xlc2 = x2l4a/xk4b		! DL_TYPE
  print *, xlc2
  ...
  print *, xlc
  xlcc = dl(5)(['w','2','%','I','?'])-dl(5)(['a','w','q',')','I'])	! DL_TYPE
  print *, xlcc
  ...
  xlc1 = d2l(2,9)(['#','n','1','%','`','<','j','w','Z'],152)/dk(2)(188)	! DL_TYPE
  print *, xlc1
  xlc2 = d2l(4,7)(['W',']','u','.','a','8','7'],26321)/dk(4)(28668)	! DL_TYPE
  print *, xlc2
...
end program dtpUOpSimpleBinaryMixedAssign
