...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleUnary
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : correct unary operator functions are used for given type and kind (single operator)
!*
...
end module dtpUOpSimpleUnarymod


program dtpUOpSimpleUnary

  use dtpUOpSimpleUnarymod
  implicit none
