...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryMixedDummyArgNamed
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : mixed result types, binary ops appear as dummy arguments(named)
!*
...
!*  named binary operators and verify that the correct function is invoked and the
...
module dtpUOpSimpleBinaryMixedDummyArgNamedmod
  ...
  type dk (k)
     ...
     integer(k)    :: ivar
   contains
     generic :: operator(.addit.) => binaryPlusK2, binaryPlusK4
     procedure, pass :: binaryPlusK2   ! dk(2).addit.dk(2) => dk(2)
     procedure, pass :: binaryPlusK4   ! dk(4).addit.dk(4) => dk(4)
     generic :: operator(.subit.) => binaryMinusK2, binaryMinusK4
     procedure, pass :: binaryMinusK2  ! dk(2).subit.dk(2) => dk(2)
     procedure, pass :: binaryMinusK4  ! dk(4).subit.dk(4) => dk(4)
     generic :: operator(.merge.) => binaryStar2K22, binaryStar2K24, binaryStar2K42, binaryStar2K44, binaryStar2L2k, binaryStar2L4k
     procedure, pass :: binaryStar2K22 ! dk(2).merge.dk(2) => D2K(2,2)
     procedure, pass :: binaryStar2K24 ! dk(2).merge.dk(4) => D2K(2,4)
     procedure, pass :: binaryStar2K42 ! dk(4).merge.dk(2) => D2K(4,2)
     procedure, pass :: binaryStar2K44 ! dk(4).merge.dk(4) => D2K(4,4)
     procedure, pass :: binaryStar2L2K ! dk(2).merge.dl    => D2L(2)
     procedure, pass :: binaryStar2L4K ! dk(4).merge.dl    => D2L(4)
  end type dk
  ...
  type dl (l)
     ...
     character(1)  :: cvar(l)
   contains
     generic :: operator(.addit.) => binaryPlusL
     procedure, pass :: binaryPlusL   ! dl.addit.dl => dl
     generic :: operator(.subit.) => binaryMinusL
     procedure, pass :: binaryMinusL  ! dl.subit.dl => dl
     generic :: operator(.merge.) => binaryStar2L2, binaryStar2L4
     procedure, pass :: binaryStar2L2 ! dl.merge.dk(2) => D2L(2)
     procedure, pass :: binaryStar2L4 ! dl.merge.dk(4) => D2L(4)
  end type dl
  ...
  type d2k (k,k2)
     ...
     integer(k2)   :: ivar2
   contains
     generic :: operator(.addit.) => binaryPlus2K22, binaryPlus2K24, binaryPlus2K42, binaryPlus2K44
     procedure, pass :: binaryPlus2K22  ! d2k(2,2).addit.d2k(2,2) => d2k(2,2)
     procedure, pass :: binaryPlus2K24  ! d2k(2,4).addit.d2k(2,4) => d2k(2,4)
     procedure, pass :: binaryPlus2K42  ! d2k(4,2).addit.d2k(4,2) => d2k(4,2)
     procedure, pass :: binaryPlus2K44  ! d2k(4,4).addit.d2k(4,4) => d2k(4,4)
     generic :: operator(.split.) => binarySlash2K222, binarySlash2K242, binarySlash2K422, binarySlash2K442, &
                               binarySlash2K224, binarySlash2K244, binarySlash2K424, binarySlash2K444
     procedure, pass :: binarySlash2K222 ! d2k(2,2).split.dk(2) => dk(2)
     procedure, pass :: binarySlash2K242 ! d2k(2,4).split.dk(2) => dk(4)
     procedure, pass :: binarySlash2K422 ! d2k(4,2).split.dk(2) => dk(4)
     procedure, pass :: binarySlash2K442 ! d2k(4,4).split.dk(2) => d2k(2,2)
     procedure, pass :: binarySlash2K224 ! d2k(2,2).split.dk(4) => integer
     procedure, pass :: binarySlash2K244 ! d2k(2,4).split.dk(4) => dk(2)
     procedure, pass :: binarySlash2K424 ! d2k(4,2).split.dk(4) => dk(2)
     procedure, pass :: binarySlash2K444 ! d2k(4,4).split.dk(4) => dk(4)
  end type d2k
  ...
  type d2l (k,l)
     ...
     integer(k)    :: ivar
   contains
     generic :: operator(.addit.) => binaryPlus2L2, binaryPlus2L4
     procedure, pass :: binaryPlus2L2   ! d2l(2).addit.d2l(2) => d2l(2)
     procedure, pass :: binaryPlus2L4   ! d2l(4).addit.d2l(4) => d2l(4)
     generic :: operator(.subit.) => binaryMinus2L2, binaryMinus2L4
     procedure, pass :: binaryMinus2L2  ! d2l(2).subit.d2l(2) => d2l(2)
     procedure, pass :: binaryMinus2L4  ! d2l(4).subit.d2l(4) => d2l(4)
     generic :: operator(.split.) => binarySlashL2, binarySlashL4, binarySlashL2k, binarySlashL4k
     procedure, pass :: binarySlashL2   ! d2l(2).split.dk(2) => DL
     procedure, pass :: binarySlashL4   ! d2l(4).split.dk(4) => DL
     procedure, pass :: binarySlashL2k  ! d2l(2).split.dl    => DK(2)
     procedure, pass :: binarySlashL4k  ! d2l(4).split.dl    => DK(4)
  end type d2l
...
end module dtpUOpSimpleBinaryMixedDummyArgNamedmod


program dtpUOpSimpleBinaryMixedDummyArgNamed

  use dtpUOpSimpleBinaryMixedDummyArgNamedmod
  implicit none
...
end program dtpUOpSimpleBinaryMixedDummyArgNamed
