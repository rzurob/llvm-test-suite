...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpEntryInterface
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : operator associated with procedure defined as ENTRY (generic interface)
!*
...
!*  DESCRIPTION
!*
!*  Define several types with procedures, some defined using the ENTRY mechanism,
!*  and associate them with binary operators via generic interfaces, and verify
...
!*
!*  (derived from dtpUOpEntry)
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpUOpEntryInterfacemod
...
end module dtpUOpEntryInterfacemod


program dtpUOpEntryInterface

  use dtpUOpEntryInterfacemod
  implicit none
...
end program dtpUOpEntryInterface
