...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpPrecedence
!*  TEST CASE TITLE            :
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : correct pairings of operators and operands, given precedence (e.g., Ta+Tb*Tc yields plus(Ta,star(Tb,Tc))) - all same type
!*
...
!*  DESCRIPTION
!*
!*  Define two types with type-bound procedures and generic bindings for
!*  binary operators and verify correct precedence.
...
end module dtpUOpPrecedencemod


program dtpUOpPrecedence

  use dtpUOpPrecedencemod
  implicit none
