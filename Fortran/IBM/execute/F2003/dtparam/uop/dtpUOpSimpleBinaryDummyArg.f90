...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryDummyArg
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : binary ops appearing as dummy arguments
!*
...
!*  binary operators and verify that the correct function is invoked when the
!*  operation appears as a dummy argument.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpUOpSimpleBinaryDummyArgmod
...
end module dtpUOpSimpleBinaryDummyArgmod


program dtpUOpSimpleBinaryDummyArg

  use dtpUOpSimpleBinaryDummyArgmod
  implicit none
  ...
  call test(d2l(2,8)(['z','y','x','w','v','u','t','s'],-107)+d2l(2,8)(['z','y','x','w','v','u','t','s'],-107), D2L_2_TYPE)
  ...
  call test(d2l(4,6)(['q','p','o','n','m','l'],-106)+d2l(4,6)(['q','p','o','n','m','l'],-104), D2L_4_TYPE)
  call test(x2l4a-x2l4b, D2L_4_TYPE)
  call test(d2l(4,8)(['q','p','o','n','m','l','k','j'],-104)-d2l(4,8)(['q','p','o','n','m','l','k','j'],106), D2L_4_TYPE)
...
end program dtpUOpSimpleBinaryDummyArg
