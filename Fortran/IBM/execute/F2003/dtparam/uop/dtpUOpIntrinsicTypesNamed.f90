...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpIntrinsicTypesNamed
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : involvement of intrinsic types and named operators
!*
...
!*  DESCRIPTION
!*
!*  Define a type with type-bound procedures and generic bindings for
!*  named binary operators and verify correct associativity, including intrinsic types.
...
module dtpUOpIntrinsicTypesNamedmod
  ...
  type dk (k)
     ...
     integer(k)    :: ivar
   contains
     generic :: operator(.addit.) => binaryPlusK, binaryPlus
     procedure, pass :: binaryPlusK
     procedure, pass :: binaryPlus
     generic :: operator(.subit.) => binaryMinusK, binaryMinus
     procedure, pass :: binaryMinusK
     procedure, pass :: binaryMinus
     generic :: operator(.neg.) => unaryNegK
     procedure, pass :: unaryNegK
  end type dk
...
end module dtpUOpIntrinsicTypesNamedmod


program dtpUOpIntrinsicTypesNamed

  use dtpUOpIntrinsicTypesNamedmod
  implicit none
...
end program dtpUOpIntrinsicTypesNamed
