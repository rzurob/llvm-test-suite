...
!*
!*  SECONDARY FUNCTIONS TESTED : mixed result types, binary ops appear as dummy arguments (generic interface)
!*
...
module dtpUOpSimpleBinaryMixedDummyArgInterfacemod
...
end module dtpUOpSimpleBinaryMixedDummyArgInterfacemod


program dtpUOpSimpleBinaryMixedDummyArgInterface

  use dtpUOpSimpleBinaryMixedDummyArgInterfacemod
  implicit none
...
end program dtpUOpSimpleBinaryMixedDummyArgInterface
