...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleUnaryDummyArgInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : unary ops appearing as dummy arguments (generic interface)
!*
...
module dtpUOpSimpleUnaryDummyArgInterfacemod
...
end module dtpUOpSimpleUnaryDummyArgInterfacemod


program dtpUOpSimpleUnaryDummyArgInterface

  use dtpUOpSimpleUnaryDummyArgInterfacemod
  implicit none
  ...
  x2l4b  =  d2l(4,7)(['c','d','e','f','g','h','i'],-24576)
...
end program dtpUOpSimpleUnaryDummyArgInterface
