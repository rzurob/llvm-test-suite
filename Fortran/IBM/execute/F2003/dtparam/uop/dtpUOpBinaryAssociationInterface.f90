...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpBinaryAssociationInterface
!*  TEST CASE TITLE            :
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : correct association in expressions with repeated binary operations (left-to-right for all but **) (generic interface)
!*
...
!*  DESCRIPTION
!*
!*  Define several types with procedures associated via generic interfaces to
!*  binary operators and verify correct associativity (left-to-right for all but **).
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpUOpBinaryAssociationInterfacemod
  ...
  interface operator(*)
     module procedure binaryStar2K
     module procedure binaryStar2L
     module procedure binaryStarK
     module procedure binaryStarL
  end interface operator(*)

  interface operator(**)
     module procedure binaryPower2K
     module procedure binaryPower2L
     module procedure binaryPowerK
     module procedure binaryPowerL
  end interface operator(**)

  interface operator(+)
     module procedure binaryPlus2K
  ...
  interface operator(-)
     module procedure binaryMinus2K
  ...
  interface operator(/)
     module procedure binarySlash2K
     module procedure binarySlash2L
     module procedure binarySlashK
     module procedure binarySlashL
  end interface operator(/)
...
end module dtpUOpBinaryAssociationInterfacemod


program dtpUOpBinaryAssociationInterface

  use dtpUOpBinaryAssociationInterfacemod
  implicit none
...
end program dtpUOpBinaryAssociationInterface
