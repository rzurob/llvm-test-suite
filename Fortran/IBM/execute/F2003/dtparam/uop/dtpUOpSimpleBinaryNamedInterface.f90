...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryNamedInterface
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : correct binary operator functions are used for given type and kind (single named operator, generic interface)
!*
...
!*  generic interfaces, and verify that the correct function is invoked.
...
module dtpUOpSimpleBinaryNamedInterfacemod
...
end module dtpUOpSimpleBinaryNamedInterfacemod


program dtpUOpSimpleBinaryNamedInterface

  use dtpUOpSimpleBinaryNamedInterfacemod
  implicit none
...
end program dtpUOpSimpleBinaryNamedInterface
