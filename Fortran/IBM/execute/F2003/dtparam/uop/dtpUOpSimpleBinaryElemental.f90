...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryElemental
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : correct binary operators are used for a given TKR (elemental only)
!*
...
!*  DESCRIPTION
!*
!*  Define several types with typebound generic procedures for binary operators
!*  and verify that the correct function is invoked for a given TKR.
...
module dtpUOpSimpleBinaryElementalmod
  ...
  type d2k (k,k2)
     ...
     integer(k2)   :: ivar2
   contains
     generic :: operator(+) => binaryPlus2K24, binaryPlus2K42
...
end module dtpUOpSimpleBinaryElementalmod


program dtpUOpSimpleBinaryElemental

  use dtpUOpSimpleBinaryElementalmod
  implicit none
...
end program dtpUOpSimpleBinaryElemental
