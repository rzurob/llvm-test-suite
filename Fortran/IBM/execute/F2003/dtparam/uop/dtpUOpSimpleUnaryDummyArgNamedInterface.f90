...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleUnaryDummyArgNamedInterface
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : named unary ops appearing as dummy arguments (generic interface)
!*
...
!*  operation appears as a dummy argument (which allows us to check type at
!*  runtime more effectively).
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpUOpSimpleUnaryDummyArgNamedInterfacemod
...
end module dtpUOpSimpleUnaryDummyArgNamedInterfacemod


program dtpUOpSimpleUnaryDummyArgNamedInterface

  use dtpUOpSimpleUnaryDummyArgNamedInterfacemod
  implicit none
  ...
  call test(.pos.xk2a, DK_2_TYPE)
  call test(.pos.dk(2)(0), DK_2_TYPE)
  call test(.neg.xk2b, DK_2_TYPE)
  call test(.neg.dk(2)(0), DK_2_TYPE)

  call test(.pos.xk4a, DK_4_TYPE)
  call test(.pos.dk(4)(0), DK_4_TYPE)
  call test(.neg.xk4b, DK_4_TYPE)
  call test(.neg.dk(4)(0), DK_4_TYPE)

  call test(.pos.xla, DL_TYPE)
  call test(.pos.dl(4)(['d','e','f','g']), DL_TYPE)
  call test(.neg.xlb, DL_TYPE)
  call test(.neg.dl(6)(['d','e','f','g','h','i']), DL_TYPE)

  call test(.pos.x2k22a, D2K_2_2_TYPE)
  call test(.pos.d2k(2,2)(0,0), D2K_2_2_TYPE)
  call test(.neg.x2k22b, D2K_2_2_TYPE)
  call test(.neg.d2k(2,2)(0,0), D2K_2_2_TYPE)

  call test(.pos.x2k24a, D2K_2_4_TYPE)
  call test(.pos.d2k(2,4)(0,0), D2K_2_4_TYPE)
  call test(.neg.x2k24b, D2K_2_4_TYPE)
  call test(.neg.d2k(2,4)(0,0), D2K_2_4_TYPE)

  call test(.pos.x2k42a, D2K_4_2_TYPE)
  call test(.pos.d2k(4,2)(0,0), D2K_4_2_TYPE)
  call test(.neg.x2k42b, D2K_4_2_TYPE)
  call test(.neg.d2k(4,2)(0,0), D2K_4_2_TYPE)

  call test(.pos.x2k44a, D2K_4_4_TYPE)
  call test(.pos.d2k(4,4)(0,0), D2K_4_4_TYPE)
  call test(.neg.x2k44b, D2K_4_4_TYPE)
  call test(.neg.d2k(4,4)(0,0), D2K_4_4_TYPE)

  call test(.pos.x2l2a, D2L_2_TYPE)
  call test(.pos.d2l(2,8)(['z','y','x','w','v','u','t','s'],0), D2L_2_TYPE)
  call test(.neg.x2l2b, D2L_2_TYPE)
  call test(.neg.d2l(2,10)(['z','y','x','w','v','u','t','s','r','p'],0), D2L_2_TYPE)

  call test(.pos.x2l4a, D2L_4_TYPE)
  call test(.pos.d2l(4,6)(['q','p','o','n','m','l'],0), D2L_4_TYPE)
  call test(.neg.x2l4b, D2L_4_TYPE)
  call test(.neg.d2l(4,8)(['q','p','o','n','m','l','k','j'],0), D2L_4_TYPE)
...
end program dtpUOpSimpleUnaryDummyArgNamedInterface
