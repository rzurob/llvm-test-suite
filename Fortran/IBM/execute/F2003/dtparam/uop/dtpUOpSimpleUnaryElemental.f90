...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleUnaryElemental
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : correct unary operators are used for a given TKR (elemental)
!*
...
!*  unary operators and verify that the correct function is invoked for a given TKR.
...
module dtpUOpSimpleUnaryElementalmod
  ...
  type d2k (k,k2)
     ...
     integer(k2)   :: ivar2
   contains
     generic :: operator(+) => unaryPlus2K24, unaryPlus2K42
...
end module dtpUOpSimpleUnaryElementalmod


program dtpUOpSimpleUnaryElemental

  use dtpUOpSimpleUnaryElementalmod
  implicit none
  ...
  print *, "unaryPlus2K42 (R2)", +reshape([x2k42a, x2k42b, x2k42c, x2k42d, x2k42a, x2k42b],[3,2]), &
...
end program dtpUOpSimpleUnaryElemental
