...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUOpSimpleBinaryMixedDummyArg
!*
!*  DATE                       : 2009-02-11
!*
!*  PRIMARY FUNCTIONS TESTED   : User-Defined Operators
!*
!*  SECONDARY FUNCTIONS TESTED : mixed result types, binary ops appear as dummy arguments
!*
...
module dtpUOpSimpleBinaryMixedDummyArgmod
...
end module dtpUOpSimpleBinaryMixedDummyArgmod


program dtpUOpSimpleBinaryMixedDummyArg

  use dtpUOpSimpleBinaryMixedDummyArgmod
  implicit none
...
end program dtpUOpSimpleBinaryMixedDummyArg
