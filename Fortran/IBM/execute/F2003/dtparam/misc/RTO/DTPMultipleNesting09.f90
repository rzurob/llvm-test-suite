...
PROGRAM DTPMultipleNesting09
      ...
      ALLOCATE( upoly, SOURCE =  Child(4,3,4,6) ( 10, 20, 30, Base(4,13) ( 100, 200, 300 ) ) )
      SELECT TYPE ( upoly )
        CLASS IS (Child(4,*,4,*))
      ...
      ALLOCATE( upoly, SOURCE =  NextGen(4,8,4,4,4,2)( 1, 2, 3, Base(4,9) (10, 20, 30), &
...
END PROGRAM DTPMultipleNesting09
