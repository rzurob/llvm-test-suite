...
PROGRAM DTPMultipleNesting06
    ...
    IF ( TRIM(tgt2%C2) .NE. "G" ) ERROR STOP 82
    IF ( ANY(tgt2%F0 .NEQV. .False.) ) ERROR STOP 83
    IF ( ANY(tgt2%F1 .NEQV. .False.) ) ERROR STOP 84
    IF ( ANY(tgt2%F2 .NEQV. .False.) ) ERROR STOP 85
    ...
    IF ( TRIM(tgt2%C2) .NE. "M" ) ERROR STOP 98
    IF ( ANY(tgt2%F0 .NEQV. .True.) ) ERROR STOP 99
    IF ( ANY(tgt2%F1 .NEQV. .True.) ) ERROR STOP 100
    IF ( ANY(tgt2%F2 .NEQV. .True.) ) ERROR STOP 101
