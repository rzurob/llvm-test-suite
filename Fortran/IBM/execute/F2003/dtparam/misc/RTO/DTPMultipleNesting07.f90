...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : DTPMultipleNesting07
!*
      ...
      SUBROUTINE Select_type(Arg)
        ...
        SELECT TYPE ( Arg )
          ...
          CLASS IS (Child(4,*))
            ...
            IF ( SIZE(Arg%F0) .NE.  513 ) STOP 26 
            IF ( SIZE(Arg%F1) .NE. 1026 ) STOP 27 
    
            IF ( LBOUND(Arg%F0,1) .NE.  1 ) STOP 28 
            IF ( LBOUND(Arg%F1,1) .NE.  1 ) STOP 29 
    
            IF ( UBOUND(Arg%F0,1) .NE.  513 ) STOP 30 
            IF ( UBOUND(Arg%F1,1) .NE. 1026 ) STOP 31 
            ...
            ASSOCIATE ( p => Arg%cmp2 )
              ...
              SELECT TYPE ( p )
                 CLASS IS (Child(4,*))
                    ...
                    IF ( SIZE(p%F0) .NE.  513 ) STOP 58 
                    IF ( SIZE(p%F1) .NE. 1026 ) STOP 59 
    
                    IF ( LBOUND(p%F0,1) .NE.  1 ) STOP 60 
                    IF ( LBOUND(p%F1,1) .NE.  1 ) STOP 61 
    
                    IF ( UBOUND(p%F0,1) .NE.  513 ) STOP 62 
                    IF ( UBOUND(p%F1,1) .NE. 1026 ) STOP 63 
...
PROGRAM DTPMultipleNesting07
    ...
    IF ( ANY(tgt2%F0 .NEQV. .False.) ) STOP 82
    IF ( ANY(tgt2%F1 .NEQV. .False.) ) STOP 83
    ...
    IF ( ANY(tgt2%F0 .NEQV. .True.) ) STOP 98 
    IF ( ANY(tgt2%F1 .NEQV. .True.) ) STOP 99
