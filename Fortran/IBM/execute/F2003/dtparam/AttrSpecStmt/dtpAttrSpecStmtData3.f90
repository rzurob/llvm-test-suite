...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dtpAttrSpecStmtData3
!*
!*  DATE                       : Jun. 14, 2007
!*
...
!*  -- DATA statement
!*
!*  An array name, array section, or array element that appears in a DATA statement
!*  shall have had its array properties established by a previous specification statement
!*
!*  (ice)
!*
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE(DT2(1,3,4,5,8,7)) :: T2(N+1)

  INTEGER, PARAMETER :: M=N-1

  DATA t0(:)  / N*DT0(1,3)() /, t1(1) / DT1(1,3,4,5)([1,2,3,4,5]) / &
                               t1(2:N) / M*DT1(1,3,4,5)(DT0=DT0(1,3)(), &
                                         R=[1,2,3,4,5])/
  data t2(1:M)  / M*DT2(1,3,4,5,8,7)(     &
                                DT1=DT1(1,3,4,5)([1,2,3,4,5]),              &
                                  I=[1,2,3,4,5,6,7],             &
                                  C=CHAR([1,2,3,4,5,6,7]),       &
                                Ptr=NULL())                       /

  DATA                         t2(n) / 1*DT2(1,3,4,5,8,7)(        &
                                DT1=DT1(1,3,4,5)([1,2,3,4,5]),&
                                  I=[1,2,3,4,5,6,7],             &
                                  C=CHAR([1,2,3,4,5,6,7]),       &
                                Ptr=NULL())                      /
  ...
  DO I=1, N
    ...
    t2(1+n) = T2(I)%ModFun2()
    IF ( ANY( t2(1+n)%i .NE. [-1,-2,-3,-4,-5,-6,-7] ) ) STOP 14
    IF ( ANY( T2(1+n)%DT1%ModFun1() .NE. [(1,3),(4,5)] ) ) STOP 15
