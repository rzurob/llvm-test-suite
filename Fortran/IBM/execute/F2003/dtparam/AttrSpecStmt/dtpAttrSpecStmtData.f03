...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ANY( T2%I .NE. [1,2,3,4,5,6,7]       ) ) ERROR STOP 12
  IF ( ANY( T2%C .NE. CHAR([1,2,3,4,5,6,7]) ) ) ERROR STOP 13

  IArr = T2%ModFun2()
  IF ( ANY( IArr .NE. [-1,-2,-3,-4,-5,-6,-7] ) ) ERROR STOP 14
  IF ( ANY( T2%DT1%ModFun1() .NE. [(1,3),(4,5)] ) ) ERROR STOP 15
