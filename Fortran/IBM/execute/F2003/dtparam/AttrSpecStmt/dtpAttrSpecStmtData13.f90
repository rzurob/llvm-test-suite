...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ANY( S1(2,1)%R .NE. C11%R          ) ) ERROR STOP 21
  IF ( ANY( S1(3,2)%R .NE. C12%R          ) ) ERROR STOP 22
  IF ( ANY( S1(1,3)%R .NE. C13%R          ) ) ERROR STOP 23

  IF ( ANY( S2(3,1)%R .NE. C21%R          ) ) ERROR STOP 31
  IF ( ANY( S2(1,2)%R .NE. C22%R          ) ) ERROR STOP 32
  IF ( ANY( S2(2,3)%R .NE. C23%R          ) ) ERROR STOP 33

  IF ( ANY( S2(1,1)%I .NE. C21%I          ) ) ERROR STOP 41
  IF ( ANY( S2(2,2)%I .NE. C22%I          ) ) ERROR STOP 42
  IF ( ANY( S2(3,3)%I .NE. C23%I          ) ) ERROR STOP 43

  IF ( ANY( S2(3,1)%C .NE. C21%C          ) ) ERROR STOP 51
  IF ( ANY( S2(2,2)%C .NE. C22%C          ) ) ERROR STOP 52
  IF ( ANY( S2(1,3)%C .NE. C23%C          ) ) ERROR STOP 53
  ...
  DO J=1, N
    ...
    IF ( ANY( IArr(3,1)%I .NE. -C21%I   ) ) ERROR STOP 63
    IF ( ANY( IArr(1,2)%I .NE. -C22%I   ) ) ERROR STOP 64
    IF ( ANY( IArr(2,3)%I .NE. -C23%I   ) ) ERROR STOP 65
