...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dtpAttrSpecStmtData11
!*
!*  DATE                       : Jun. 21, 2007
!*
...
!*  -- DATA statement
!*
!*  Focus on init exp of structure constructor
!*
!*  (ice)
!*
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  PROGRAM dtpAttrSpecStmtData11
  USE M, ONLY:N, C0=>CT0,C1=>CT1,C2=>CT2,D0=>DT0,D1=>DT1,D2=>DT2
  ...
  DATA    ((S1(I,J),     J=1,N), I=1,N )   / NN *D1(S1%K0,C1%L0,T1%K1,C1%L1)  &
                                                   (DT0=D0(T0%K0,C0%L0)(),   &
                                                      R=[(I,I=1,5)]) /

  DATA    ((S2(I,J),     J=1,N), I=1,N )   / NN *D2(S2%K0,C0%L0,S2%K1,C1%L1,S2%K2,C2%L2)(          &
                                                    DT1=D1(S2%K0,C2%L0,S2%K1,C2%L1)(R=[(I,I=1,5)]),  &
                                                       I=[(I,I=1,7)],             &
                                                       C=CHAR([(I,I=1,7)]),       &
                                                     Ptr=NULL() )  /
  ...
  DO J=1, N
    ...
    IF ( ANY( S2(I,J)%R .NE. [1,2,3,4,5]           ) ) STOP 22
    ...
    IF ( ANY( S2(I,J)%ModFun1() .NE. [(1,3),(4,5)] ) ) STOP 27
