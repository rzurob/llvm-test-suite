...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dtpAttrSpecStmtData8
!*  TEST CASE TITLE            :
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : Jun. 20, 2007
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  DATA    ((T0(I,J), J=1,N), I=1,N )   / NN*CT0 /
  DATA    ((T1(I,J), J=1,N), I=1,N )   / NN*CT1 / 
  DATA    ((T2(I,J), J=1,N), I=1,N )   / NN*CT2 / 
