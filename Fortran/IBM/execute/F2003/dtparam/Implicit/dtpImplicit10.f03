...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  DO I=1, 97
    ...
    IF ( ANY (TT(I)%C         .NE. CHAR(0)    ) ) ERROR STOP 29

    IF ( SIZE( EF(I)%R )      .NE. T%L1         ) ERROR STOP 51
    IF ( EF(I)%R%KIND         .NE. T%K1         ) ERROR STOP 52
    IF ( ANY ( EF(I)%R        .NE. -T%K1      ) ) ERROR STOP 53
    IF ( SIZE( EF(I)%I )      .NE. T%L2         ) ERROR STOP 54
    IF ( EF(I)%I%KIND         .NE. T%K2         ) ERROR STOP 55
    IF ( ANY ( EF(I)%I        .NE. -T%K2      ) ) ERROR STOP 56
    IF ( SIZE( EF(I)%C )      .NE. T%L2         ) ERROR STOP 57
    IF ( EF(I)%C%LEN          .NE. T%L2         ) ERROR STOP 58
    IF ( ANY (EF(I)%C         .NE. CHAR(0)    ) ) ERROR STOP 59
  ...
  IF ( .NOT. ASSOCIATED(RA) ) ERROR STOP 91
  IF ( .NOT. ASSOCIATED(SA) ) ERROR STOP 92
  IF ( .NOT. ASSOCIATED(TA) ) ERROR STOP 93
