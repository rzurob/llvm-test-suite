...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (T%K        .NE. 2   )                 ERROR STOP 31
  IF (T%L        .NE. 1000 )                ERROR STOP 32
  IF (SIZE(T)    .NE. 1000 )                ERROR STOP 33
  IF (ANY (T%I   .NE. [(I,I=1000, 1,-1)] )) ERROR STOP 34
  ...
  IF (T%K        .NE. 1   )              ERROR STOP 11
  IF (T%L        .NE. 100 )              ERROR STOP 12
  IF (SIZE(T)    .NE. 100 )              ERROR STOP 13
  IF (ANY (T%I   .NE. [(I,I=1, 100 )] )) ERROR STOP 14
  ...
  IF (T%K        .NE. 2   )              ERROR STOP 21
  IF (T%L        .NE. 1000 )             ERROR STOP 22
  IF (SIZE(T)    .NE. 1000 )             ERROR STOP 23
  IF (ANY (T%I   .NE. [(I,I=1, 1000)] )) ERROR STOP 24
