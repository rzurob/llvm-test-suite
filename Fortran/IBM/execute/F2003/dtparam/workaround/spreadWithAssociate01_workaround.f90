...
program spreadWithAssociate01
  ...
  call associate1 (spread(second1%c1,1,5))
  call associate2 (spread(second1%first1,1,5))
  call associate3 (spread(second1%l1,1,5))

  temp = second1%first1%k1

  call associate4 (spread(temp,1,5))
  call associate5 (spread(second1,1,5))
  call associate6 (spread(second2,1,5))
  call associate7 (spread(second2,2,5))
  call associate8 (spread(second3,1,5))
  call associate9 (spread(second3,2,5))
  call associate10(spread(second3,3,5))
