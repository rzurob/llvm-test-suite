...
!*  TEST CASE TITLE            : variable selector of Derived Type with
...
PROGRAM allocatableComponent01
    ...
    call ASSOCIATE_replacer (container(5,2)(characters(5,2)(fiveLetterWords)))

    contains

    subroutine ASSOCIATE_replacer (m)
