...
program mergePolyComp01
   ...
   call associate1(merge(b1,b2,.true.))
   call associate2(merge(b1,b2,.false.))
   call associate3(merge([b1,b2],[b2,b1],.false.))
   call associate4(merge(b3,b2,.true.))
