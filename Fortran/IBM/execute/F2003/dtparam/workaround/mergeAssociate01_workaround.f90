...
program mergegAssociate01
   ...
   call associate1(merge(dtp1(1),dtp1(2),.true.))
   call associate2(merge(dtp1(1),dtp1(2),.false.))
   call associate3(merge(dtp1,dtp2,mask1))
   call associate4(merge(dtp1,dtp2,.not. mask1))
   call associate5(merge(dtp3,dtp4,mask2))
   call associate6(merge(dtp3,dtp4,.not. mask2))
   call associate7(merge(dtp5(1),dtp5(2),.true.))
   call associate8(merge(dtp5(1),dtp5(2),.false.))
   call associate9(merge(dtp5,dtp6,mask1))
   call associate10(merge(dtp5,dtp6,.not. mask1))
!   call associate11(merge(dtp7,dtp8,mask2))
!   call associate12(merge(dtp7,dtp8,.not. mask2))
   call associate13(merge(dtp9(1),dtp9(2),.true.))
   call associate14(merge(dtp9(1),dtp9(2),.false.))
   call associate15(merge(dtp9,dtp10,mask1))
   call associate16(merge(dtp9,dtp10,.not. mask1))
   call associate17(merge(dtp11,dtp12,mask2))
