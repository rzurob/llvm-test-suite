...
contains
   ...
   subroutine myread1(unit, stat, msg, a, b )
      type(base(3)), intent(inout)  :: a(2,*) ! tcx: (*)
      type(child(3)), intent(inout) :: b(2,2,*) ! tcx: (*)
      integer, intent(in)  :: unit
      integer, intent(out) :: stat
      character(*), intent(inout) :: msg
...
program dummyArg005l
   ...
   allocate( c2(4), source = reshape ( source = (/ c1, child(3)('xxx','xxx'), child(3)('xxx','xxx') /), shape = (/4/) ) ) ! tcx: (3) ! tcx: (3)
