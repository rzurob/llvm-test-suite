...
PROGRAM DTP_ACE_15
      ...
      b1 = [ Base(4,5) :: Base(4,5)(5) ]

      SELECT TYPE ( s => CreateNew( b1))
         TYPEIS (Base(4,*))
      ...
      b1 = [Base(4,10)([(I, I=1, 10)]), Base(4,10)([(2*I, I=1, 10)])]
      SELECT TYPE ( s => CreateNew(b1))
         TYPEIS (Base(4,*))
      ...
      c1 = [ Child(4,1,4,1):: Child(4,1,4,1) ([99], [Base(4,1) :: Base(4,1)(98)]) ]
      SELECT TYPE ( s =>  CreateNew( c1))
         TYPE IS (Child(4,*,4,*))
