...
program mergeDTComp03
   ...
   call associate1(merge(b1%type1,b1%type2,.true.))
   call associate2(merge(b1%type1,b1%type2,.false.))
   call associate3(merge(b1%type1%ca,str,.true.))
   call associate4(merge(b1%type1%ca,str,.false.))
   call associate5(merge(b1,b2,.true.))
   call associate6(merge(b1,b2,.false.))

   contains

!   associate1(x=>merge(b1%type1,b1%type2,.true.))
...
!   associate2(x=>merge(b1%type1,b1%type2,.true.))
...
!   associate3(x=>merge(b1%type1%ca,b1%cb,.true.))
...
!   associate4(x=>merge(b1%type1%ca,b1%cb,.false.))
