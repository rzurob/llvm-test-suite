...
!                                    We are in a 2D environmnet, dropping an object down at a certain height then we calculate few properties, (like speed,velocity,time)
!=======================================================================
! REVISION HISTORY
!                   MM/DD/YY :
!                       Init :
