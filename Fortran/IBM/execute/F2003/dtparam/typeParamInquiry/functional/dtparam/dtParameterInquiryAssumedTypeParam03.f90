...
module m
  ...
  if(lbound(t1%i1,1) /=t1%l1 .or. ubound(t1%i1,1) /=t1%l2)  error stop 18_4
  !--- defect 353958---!
  if(lbound(t1%i2,1) /=1 .or. ubound(t1%i2,1) /=0)          error stop 19_4
  ...
  if(lbound(t2%i1,1) /=1 .or. ubound(t2%i1,1) /=0)          error stop 28_4
  if(lbound(t2%i2,1) /=-6 .or. ubound(t2%i2,1) /=-3)        error stop 29_4
  ...
  if(lbound(t4%i2,1) /=1 .or. ubound(t4%i2,1) /=0)          error stop 49_4
