...
!*  This differs from dtpUseChain02 in that the utility module simply uses "string",
!*  but the main program now uses "string" under the pseudonym "zwirn".
!*
!* ============================================================================
...
program dtpUseChain03
  ...
  s4  = zwirn(8)('kangaroo')
  sl  = string_list(zwirn(7)('jumping'))
  allocate(sl%next)
  sl%next%datum = s4
  ...
  allocate(pos % next)
  pos % next % pos = [4,5,6]
  pos % next % details = string_list(zwirn(6)('wombat'))
