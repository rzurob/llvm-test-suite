...
!*  interchangeably.
!*  This differs from dtpUseChain05 in that one "USE" statement renames "ONLY"
!*  the types and another reintroduces all symbols without renaming.
!*
!* ============================================================================
...
program dtpUseChain06

  use base, only: zwirn => string, ordinal => number
  use utility
