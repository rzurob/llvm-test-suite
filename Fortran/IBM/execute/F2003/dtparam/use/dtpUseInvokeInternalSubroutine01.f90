...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUseInvokeInternalSubroutine01
!*  TEST CASE TITLE            : 
!*
...
program dtpUseInvokeInternalSubroutine01
  use dtpUseModule
  ...
  call intSub1
  call intSub2(tkl_45_1, tk_4_1, tl_5_1)
  print *, "end"
...
end program dtpUseInvokeInternalSubroutine01
