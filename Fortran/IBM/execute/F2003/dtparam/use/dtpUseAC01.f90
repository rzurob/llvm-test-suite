...
program dtpUseAC01
  ...
  print *, barr,   [ba, bb, bc]
  print *, d4arr,  [d4a, d4b, d4c]
  print *, d24arr, [d24a, d24b]
  print *, d343arr,[d343a, d343b, d343c]
  print *, d8arr,  [d8a, d8b, d8c]
  print *, d28arr, [d28a, d28b]
  print *, d383arr,[d383a, d383b, d383c]

  print *, [Base(37), Base(38), Base(39)]

  print *, [Derived(4)(42,45)]
  print *, [Derived2(4)(142 , 56, 1234)]
  print *, [Derived3(4,3)(11142, 11242, 15242, "this is a test")]

  print *, [Derived(4)(19, 17)]
  print *, [Derived2(4)(119, 29, 1293)]
  print *, [Derived3(4,3)(11119, 11942, 15242, "another test")]

  print *, [Derived(4)(1209, 1721)]
  print *, [Derived3(4,3)(1123119, 119244222, 152526242, "not yet done")]

  print *, [Derived(8)(82, 85)]
  print *, [Derived2(8)(182, 567324_8, 1238787)]
  print *, [Derived3(8,3)(11182897, 112821_8, 15282234, "wowee")]

  print *, [Derived(8)(89, 174571_8)]
  print *, [Derived2(8)(189, 293487_8, 1293656)]
  print *, [Derived3(8,3)(11889876, 119823_8, 15282345, "almost done.")]

  print *, [Derived(8)(353689, 17452771_8)]
  print *, [Derived3(8,3)(118898333, 1198228293_8, 1303132345, "done now.")]
