...
!*  correct value.
!*  This case differs from dtpUseInvokeModuleFunction01 in that the main program
...
program dtpUseInvokeModuleFunction02
...
end program dtpUseInvokeModuleFunction02
