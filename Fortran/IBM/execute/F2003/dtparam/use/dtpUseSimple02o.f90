...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUseSimple02o
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : reference only given module types in declarations
!*
...
!*  DESCRIPTION
!*
!*  An extension of the simple tests that uses ONLY classes defined in the module,
!*  as planned with the standard three tests already established:
...
!*
!*  This is test #2: module defined in a different file, but INCLUDEd in the program file
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

include 'dtpUseSimpleMod.f'

program dtpUseSimple02o

  use :: dtpUseSimpleMod, only: base, kDerived, lDerived, dtpKBase, dtpKDerived, dtpK2Derived, &
       dtpLBase, dtpLDerived, dtpL2Derived
  implicit none
