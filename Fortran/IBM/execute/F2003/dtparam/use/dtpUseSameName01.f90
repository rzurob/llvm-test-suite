...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUseSameName01
!*
!*  DATE                       : 2008-09-08
!*
...
end module dtpUseSameName01mod


program dtpUseSameName01
...
contains
  ...
  subroutine mytest1
    use :: dtpUseSameName01mod, only : parentClass => base
    use :: dtpUseSameName01mod, only : childClass  => derived
    implicit none
  ...
  subroutine mytest2(arg)
    use :: dtpUseSameName01mod, only : parentClass => base2
    use :: dtpUseSameName01mod, only : childClass  => derived2
    implicit none
    integer :: arg
