...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUseInvokeTypeBoundSubroutine01
!*  TEST CASE TITLE            :
!*
...
!*  DESCRIPTION
!*
!*  Invoke type-bound subroutines with no additional arguments and no renaming.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789


module dtpUseInvokeTypeBoundSubroutine01Mod
  ...
  type, extends(allbase), abstract :: tklbase
   contains
     procedure :: describe1 => describe_tklbase
  end type tklbase

  type, extends(allbase), abstract :: tkbase
   contains
     procedure :: describe1 => describe_tkbase
  end type tkbase

  type, extends(allbase), abstract :: tlbase
   contains
     procedure :: describe1 => describe_tlbase
  end type tlbase
...
contains
  ...
  subroutine describe_tklbase(this)
    class(tklbase), intent(in) :: this
    print *, "tklbase"
  end subroutine describe_tklbase

  subroutine describe_tlbase(this)
    class(tlbase), intent(in) :: this
    print *, "tlbase"
  end subroutine describe_tlbase

  subroutine describe_tkbase(this)
    class(tkbase), intent(in) :: this
    print *, "tkbase"
  end subroutine describe_tkbase
...
end module dtpUseInvokeTypeBoundSubroutine01Mod

program dtpUseInvokeTypeBoundSubroutine01

  use dtpUseInvokeTypeBoundSubroutine01Mod
  implicit none
...
end program dtpUseInvokeTypeBoundSubroutine01
