...
!*  This differs from dtpUseChain03 in that "string" and "zwirn" are used
!*  interchangeably in the main program.
!*
!* ============================================================================
