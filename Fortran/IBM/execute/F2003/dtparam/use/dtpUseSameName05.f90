...
!*  DESCRIPTION
!*
!*  Verify that two types which are known by the same name in two different
!*  contained contexts, but known by a different name in the host work correctly.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpUseSameName05Mod
...
end module dtpUseSameName05Mod


program dtpUseSameName05

  use :: dtpUseSameName05Mod, only: parentClass => derived
  use :: dtpUseSameName05Mod, only: childClass => base
  implicit none
...
contains
  ...
  subroutine mytest1
    use :: dtpUseSameName05mod, only : parentClass => base
    use :: dtpUseSameName05mod, only : childClass  => derived
    implicit none
  ...
  subroutine mytest2(arg1,arg2,arg3)
    use :: dtpUseSameName05mod, only : parentClass => base2
    use :: dtpUseSameName05mod, only : childClass  => derived2
    use :: dtpUseSameName05mod, only : pc => base
    use :: dtpUseSameName05mod, only : cc => derived
    implicit none
    type(pc) :: arg1
    type(cc(2)) :: arg2
    integer :: arg3
  ...
  subroutine mytest3(arg1,arg2,arg3,arg4)
    use :: dtpUseSameName05mod, only : parentClass => base
    use :: dtpUseSameName05mod, only : childClass  => derived
    use :: dtpUseSameName05mod, only : pc => base2
    use :: dtpUseSameName05mod, only : cc => derived2
    implicit none
    integer :: arg
