...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpUseInvokeExternalSubroutine03
!*
!*  DATE                       : 2008-08-25
!*
...
!*  This differs from dtpUseInvokeExternalSubroutine02 in that some symbols are
...
program dtpUseInvokeExternalSubroutine03
...
end program dtpUseInvokeExternalSubroutine03


subroutine extSub1
  use :: dtpUseModule, only: checker => tkl, check => tk, check_mod_4_1 => tk_mod_4_1, checker_mod_45_1 => tkl_mod_45_1, tl_mod_5_1, tl
...
subroutine extSub2(a1, a2, a3, a4, a5)
  use :: dtpUseModule, only: tkl, tk, tl
  type (tkl(4,*))              :: a1
  type (tk(4)), intent(in)     :: a2
  type (tl(*)), intent(inout)  :: a3
  type (tkl(2,*)), intent(out) :: a4
...
subroutine extSub3(a1, a2, a3)
  use :: dtpUseModule, only: tickle => tkl, tick => tk, tl
  class (tickle(2,*)) :: a1
  class (tick(2))    :: a2
  class (tl(*))    :: a3
