...
PROGRAM SpeExpHostAssociation03b
      ...
      SUBROUTINE Sub11(N)
        ...
        IF ( LEN(Obj%name) .NE. N ) ERROR STOP 13
      ...
      SUBROUTINE Sub12(N)
        ...
        IF ( Obj%l1 .NE. 2*N ) ERROR STOP 15
        IF ( SIZE(Obj%A1)  .NE. 2*N ) ERROR STOP 16
        IF ( LEN(Obj%name) .NE. 2*N ) ERROR STOP 17
      ...
      SUBROUTINE Sub13(N, M)
        ...
        IF ( Obj%k2 .NE.   N ) ERROR STOP 20
        IF ( Obj%l2 .NE. 2*M ) ERROR STOP 21
        IF ( SIZE(Obj%A1)  .NE. M ) ERROR STOP 22
        IF ( LEN(Obj%name) .NE. M ) ERROR STOP 23

        IF ( Obj%b1%k1 .NE.   N ) ERROR STOP 24
        IF ( Obj%b1%l1 .NE. 2*M ) ERROR STOP 25
        IF ( SIZE(Obj%b1%A1)  .NE. 2*M ) ERROR STOP 26
        IF ( LEN(Obj%b1%name) .NE. 2*M ) ERROR STOP 27
      ...
      SUBROUTINE Sub15(N, M, P)
        ...
        TYPE(Base(KIND(n1%c1%b1%I1),LEN(n1%c1%b1%name))) :: Obj(n1%c1%b1%I1)
         ...
         IF ( SIZE(Obj) .NE. P ) ERROR STOP 38
         DO I = 1, n1%c1%b1%I1
            IF ( Obj(I)%k1 .NE. N ) ERROR STOP 39
            IF ( Obj(I)%l1 .NE. M ) ERROR STOP 40
            IF ( SIZE(Obj(I)%A1)  .NE. M ) ERROR STOP 41
            IF ( LEN(Obj(I)%name) .NE. N ) ERROR STOP 42
         END DO
      ...
      SUBROUTINE Sub21(N, M)
        ...
        IF ( Obj%k1 .NE. N ) ERROR STOP 50
        IF ( Obj%l1 .NE. M ) ERROR STOP 51
      ...
      SUBROUTINE Sub22(N, M)
        ...
        IF ( Obj%k1 .NE. N ) ERROR STOP 54
        IF ( Obj%l1 .NE. M ) ERROR STOP 55
        IF ( SIZE(Obj%A1)  .NE. M ) ERROR STOP 56
        IF ( LEN(Obj%name) .NE. M ) ERROR STOP 57
      ...
      SUBROUTINE Sub23(N, M)
        ...
        IF ( Obj%l2 .NE. 2*M ) ERROR STOP 61
        IF ( SIZE(Obj%A1)  .NE. M ) ERROR STOP 62
        IF ( LEN(Obj%name) .NE. M ) ERROR STOP 63

        IF ( Obj%b1%k1 .NE.   N ) ERROR STOP 64
        IF ( Obj%b1%l1 .NE. 2*M ) ERROR STOP 65
        IF ( SIZE(Obj%b1%A1)  .NE. 2*M ) ERROR STOP 66
        IF ( LEN(Obj%b1%name) .NE. 2*M ) ERROR STOP 67
      ...
      SUBROUTINE Sub24(N, M, P)
        ...
        IF ( Obj%k1 .NE. N ) ERROR STOP 68
        IF ( Obj%l1 .NE. M ) ERROR STOP 69
        IF ( Obj%k2 .NE. N ) ERROR STOP 70
        IF ( Obj%l2 .NE. P ) ERROR STOP 71
        IF ( SIZE(Obj%A1)  .NE. M ) ERROR STOP 72
        IF ( LEN(Obj%name) .NE. M ) ERROR STOP 73

        IF ( Obj%b1%k1 .NE. N ) ERROR STOP 74
        IF ( Obj%b1%l1 .NE. P ) ERROR STOP 75
        IF ( SIZE(Obj%b1%A1)  .NE. P ) ERROR STOP 76
        IF ( LEN(Obj%b1%name) .NE. P ) ERROR STOP 77
      ...
      SUBROUTINE Sub25(N, M, P)
        ...
        IF ( SIZE(Obj) .NE. P ) ERROR STOP 78
        DO I = 1, m1%c1%b1%I1
           IF ( Obj(I)%k1 .NE. N ) ERROR STOP 79
           IF ( Obj(I)%l1 .NE. M ) ERROR STOP 80
           IF ( SIZE(Obj(I)%A1)  .NE. M ) ERROR STOP 81
           IF ( LEN(Obj(I)%name) .NE. M ) ERROR STOP 82
         END DO
