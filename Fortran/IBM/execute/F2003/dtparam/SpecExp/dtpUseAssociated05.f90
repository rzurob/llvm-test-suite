...
!* =====================================================================
!*
!*  TEST CASE NAME             : dtpUseAssociated05
...
!*                               specification-exprs is renamed (using the
!*                               USE Statement)
!*
...
PROGRAM dtpUseAssociated05
    ...
    DO i = 1, 10
        j = ((i - 1) * 12) + 1
        base2( i ) = tBase(base2%arrayDim1,base2%arrayDim2,base2%arrayKind)  &
...
END PROGRAM dtpUseAssociated05
...
SUBROUTINE DoubleUse( rc )
    ...
    TYPE(tBase(base2%arrayDim1,base2%arrayDim2,base2%arrayKind)),&
                                                    POINTER :: pBase( : )
    TYPE(tVariation2(base1%arrayDim1,base1%arrayDim2,base1%arrayKind,4))&
                                            :: variation2( base2%arrayDim1 )
    ...
    CONTAINS
        ...
        SUBROUTINE VerifyVariation1(var1, rc)
            TYPE(tVariation1(base1%arrayDim1,base1%arrayDim2,&
