...
PROGRAM SpecExpHostAssociation06
      ...
      IF ( TRIM(ptr%C1) .NE. TRIM(b1%C1) ) STOP 21
      ...
      SELECT TYPE ( ptr )
         TYPE IS (Child(4,*,4,*))
           ...
           IF ( ptr%I1 .NE. b1%I1 ) STOP 21
           IF ( ANY(ptr%A1   .NE.      b1%A1) ) STOP 21
           IF ( ANY(ptr%A2   .NE.    2*b1%A1) ) STOP 21
           IF ( TRIM(ptr%C1) .NE. TRIM(b1%C1) ) STOP 21
           IF ( TRIM(ptr%C2) .NE. TRIM(b1%C1) ) STOP 21
      ...
      FUNCTION foo12(this) Result(Res)
        ...
        ALLOCATE( Res )
        IF ( Res%k1 .NE. KIND(this%I1) ) STOP 14
        IF ( Res%l1 .NE. SIZE(this%A1) ) STOP 15
        IF ( Res%k2 .NE.       this%k1 ) STOP 16
        IF ( Res%l2 .NE.       this%l1 ) STOP 17
        IF ( SIZE(Res%A1) .NE. SIZE(this%A1) ) STOP 18
        ...
        IF ( .NOT. ASSOCIATED(Res%cmp1) ) STOP 22

        IF ( Res%cmp1%k1 .NE. this%k1 ) STOP 23
        IF ( Res%cmp1%l1 .NE. this%l1 ) STOP 24
        IF ( SIZE(Res%cmp1%A1) .NE. this%l1 ) STOP 25
        IF ( LEN(Res%cmp1%C1)  .NE. this%l1 ) STOP 26
      END FUNCTION foo12
      ...
      FUNCTION foo21(this) Result(Res)
        ...
        ALLOCATE( Res )
        IF ( Res%k1 .NE. this%k1 ) STOP 30
        IF ( Res%l1 .NE. this%l1 ) STOP 31
        IF ( SIZE(Res%A1) .NE.this%l1  ) STOP 32
        IF ( LEN(Res%C1)  .NE. this%l1 ) STOP 33
      ...
      FUNCTION foo22(this) Result(Res)
        ...
        ALLOCATE( Res )
        IF ( Res%k1 .NE. this%k1 ) STOP 34
        IF ( Res%l1 .NE. this%l1 ) STOP 35
        IF ( Res%k2 .NE. this%k2 ) STOP 36
        IF ( Res%l2 .NE. this%l2 ) STOP 37
        IF ( SIZE(Res%A1) .NE. this%l1 ) STOP 38
        IF ( LEN(Res%C1)  .NE. this%l1 ) STOP 39
        IF ( SIZE(Res%A2) .NE. this%l2 ) STOP 40
        IF ( LEN(Res%C2)  .NE. this%l2 ) STOP 41
        ...
        IF ( .NOT. ASSOCIATED(Res%cmp1) ) STOP 42
        IF ( Res%cmp1%k1 .NE. this%cmp1%k1 ) STOP 43
        IF ( Res%cmp1%l1 .NE. this%cmp1%l1 ) STOP 44
        IF ( SIZE(Res%cmp1%A1) .NE. this%cmp1%l1 ) STOP 45
        IF ( LEN(Res%cmp1%C1)  .NE. this%cmp1%l1 ) STOP 46
      END FUNCTION foo22
