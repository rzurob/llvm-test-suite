...
! ftcx_dtp -qk -ql -qnodefaultpv -qdeferredlp -qreuse=none /tstdev/F2003/kindArg/kindArg/kindArgUbound6.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE :: DT1(D5,N2,D6,D7)    ! (4,20,2,8)
    INTEGER, KIND                     :: D5,D6,D7
    INTEGER, LEN                      :: N2
    CLASS(DT(:,D6,D5,D7,D5)), POINTER :: Arr(:,:,:,:,:,:,:,:,:)
    CLASS(DT(:,D6,D5,D7,D5)), POINTER :: Arr0(:,:,:,:,:,:,:,:,:)
  END TYPE

  TYPE(DT1(4,20,2,8))          :: TT
  TYPE(DT(1,2,4,8,4))           :: T
