...
!*
!*  PROGRAMMER                 : Glen Mateer (derived from acetint59c
!*                               by David Forster)
...
!*                               assignment, including array sections
!*                               (characters)
...
end program acetint59cl


! Extensions to introduce derived type parameters:
! type: derived - added parameters (lderived_1) to invoke with (5)/declare with (*) - 1 changes
