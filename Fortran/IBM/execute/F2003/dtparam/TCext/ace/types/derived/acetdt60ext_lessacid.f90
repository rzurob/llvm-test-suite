...
! if (any(array /= [dt(4):: dt(4)(9**2), (dt(4)(i ** 2), i=1,8)])) error stop 3
  if (any(array /= [dt(4):: dt(4)(9**2), dt(4)(1 ** 2), dt(4)(2 ** 2), dt(4)(3 ** 2), dt(4)(4 ** 2), dt(4)(5 ** 2), dt(4)(6 ** 2), dt(4)(7 ** 2), dt(4)(8 ** 2)])) error stop 3
...
! if (any(array /= [dt(4):: (dt(4)(i), i=4,9), (dt(4)(i), i=1,3)])) error stop 4
  if (any(array /= [dt(4):: dt(4)(4), dt(4)(5), dt(4)(6), dt(4)(7), dt(4)(8), dt(4)(9), dt(4)(1), dt(4)(2), dt(4)(3)])) error stop 4
  array = [dt(4):: (dt(4)(i), i=1,9)]
...
! if (any(array /= [dt(4):: dt(4)(12), (dt(4)(i ** 2), i=1,8)])) error stop 8
  if (any(array /= [dt(4):: dt(4)(12), dt(4)(1 ** 2), dt(4)(2 ** 2), dt(4)(3 ** 2), dt(4)(4 ** 2), dt(4)(5 ** 2), dt(4)(6 ** 2), dt(4)(7 ** 2), dt(4)(8 ** 2)])) error stop 8
...
! if (any(array /= [dt(4):: (dt(4)(i), i=4,9), (dt(4)(0), i=1,3)])) error stop 9
  if (any(array /= [dt(4):: dt(4)(4), dt(4)(5), dt(4)(6), dt(4)(7), dt(4)(8), dt(4)(9), dt(4)(0), dt(4)(0), dt(4)(0)])) error stop 9
  array = [dt(4):: (dt(4)(i), i=1,9)]
