...
!*
!*  PROGRAMMER                 : Glen Mateer (derived from acetdt476akl_rb
...
!*  tested elsewhere.
!*
!*  NOTE:  This version is an implementation of acetdt476akl_rb without
!*         the ac-implied-do Construct.  Since there are a number of
!*         known issues with this Construct, this Test Case will
!*         work-around those issues.
!*
!*         Refer to Defect:  d345974 for further details.
!*
...
program acetdt476akl_rb_noacid
...
! Removal of the ac-implied-do from the next line will change the Test
! performed to be the same as the previous Test.  Refer to the NOTE in
...
! As above, this will be a duplicate of the previous Test.
...
! call test((/ pub(4,20):: (pub(4,20)(),i=4,1) /), PUB_TYPE, 1,0,0, 144_4)
  call test((/ pub(4,20):: /), PUB_TYPE, 1,0,0, 144_4)
! call test((/ pub(4,20):: (pub(4,20)(),i=1,4) /), PUB_TYPE, 1,4,4, 160_4)
  call test(&
    (/ pub(4,20):: pub(4,20)(), pub(4,20)(), pub(4,20)(), pub(4,20)() /),&
                                                    PUB_TYPE, 1,4,4, 160_4)
...
! call test([ base(20,4):: (base(20,4)(i),i=1,3) ], BASE_TYPE, 1, 3, 3, 240_4)
  call test([ base(20,4):: base(20,4)(1), base(20,4)(1), base(20,4)(1) ],&
                                                    BASE_TYPE, 1, 3, 3, 240_4)
  call test([ ext(20,4):: exItem1, exItem2, exItem3 ], EXT_TYPE, 1, 3, 3, 256_4)
! extarr = [ ext(20,4):: (ext(20,4)(e=i),i=1,3) ]
  extarr = [ ext(20,4):: ext(20,4)(e=1), ext(20,4)(e=2), ext(20,4)(e=3) ]
  allocate(al(1), source=[pub(4,20):: pub(4,20)()])
  call test(al, PUB_TYPE, 1, 1, 1, 272_4)

end program acetdt476akl_rb_noacid
