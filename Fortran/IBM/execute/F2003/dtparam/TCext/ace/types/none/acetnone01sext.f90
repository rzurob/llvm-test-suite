...
! ftcx_dtp -qnol /tstdev/F2003/ace/types/none/acetnone01s.f
...
!* =====================================================================
!*
!*  TEST CASE NAME             : acetnone01sext
!*
!*  PROGRAMMER                 : Glen Mateer (derived from acetnone01s
!*                               by David Forster)
!*  DATE                       : 2008-01-25 (original: 2006-07-27)
...
!*  This is a variant of acetnone1, using [] instead of (/ /).
!*
...
program acetnone01sext
  ...
  type (usertype(4))   :: ut(3)
  type (usertypeB(4))  :: utb(3)
  ...
  ut     = [ usertype(4)(1), usertype(4)(2), usertype(4)(3) ]
  utb    = [ usertypeB(4)(1), usertypeB(4)(2), usertypeB(4)(3) ]

end program acetnone01sext
