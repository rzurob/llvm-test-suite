...
! ftcx_dtp -qnol /tstdev/F2003/ace/types/intrinsics/acetint32l.f
...
!* =====================================================================
!*
!*  TEST CASE NAME             : acetint32lext
!*
!*  PROGRAMMER                 : Glen Mateer (derived from acetint32l
!*                               by David Forster)
...
end module acetint32lextmod


program acetint32lext

  use acetint32lextmod
  implicit none
