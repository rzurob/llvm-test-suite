...
! ftcx_dtp -ql -qnodeferredlp -qreuse=none /tstdev/F2003/ace/types/derived/acetdt02.f
...
!* =====================================================================
!*
!*  TEST CASE NAME             : acetdt02l
!*
!*  PROGRAMMER                 : Glen Mateer (derived from acetdt02
!*                               by David Forster)
...
!*  procedures with various dummy arguments (since they're not elemental, we
!*  can print every time we assign, and see clearly that things are working
!*  correctly).
!*
...
module acetdt02lmod
  ...
  type dt(l1,k1,k2,k3,k4,k5)    ! (20,4,4,4,4,4)
     integer, kind :: k1,k2,k3,k4,k5
     integer, len  :: l1
     integer(k1)   :: datum  = -1
     integer(k2)   :: tag    = -1
     integer(k3)   :: singleAssignWasInvoked = 0
     integer(k4)   :: arrayAssignWasInvoked  = 0
     integer(k5)   :: array2AssignWasInvoked = 0
   contains
...
contains
  ...
  subroutine dtAssignSingle(this, that)
    class (dt(*,4,4,4,4,4)), intent(inout) :: this
    class (dt(*,4,4,4,4,4)), intent(in) :: that
  ...
  function dtToString(this)
    class (dt(*,4,4,4,4,4)), intent(in) :: this
...
program acetdt02l
  ...
  use acetdt02lmod
  implicit none
  type (dt(20,4,4,4,4,4)) :: dt_1, dt_2
  type (dt(20,4,4,4,4,4)) :: dt_array_1(2), dt_array_2(2)

  type (dt(20,4,4,4,4,4)), target :: dt_t
  type (dt(20,4,4,4,4,4)), pointer :: dt_p
  type (dt(20,4,4,4,4,4)), allocatable :: dt_a
  ...
  print *, "";  print *, "Block 1:"
  dt_2 = dt(20,4,4,4,4,4)(30,7)		! should invoke single->single defined assignment
  ...
  dt_array_2 = (/ dt(20,4,4,4,4,4):: dt_1, dt_2 /)	! should invoke array->array defined assignment once, and not single->single or single->array
  dt_array_1 = (/ dt(20,4,4,4,4,4):: dt_array_2 /)	! should invoke array->array defined assignment once only, and not single->single or single->array
  ...
  dt_t = dt(20,4,4,4,4,4)(31,10)
  dt_p = dt(20,4,4,4,4,4)(32,11)
  dt_a = dt(20,4,4,4,4,4)(33,12)

  print *, "";  print *, "Block 5:"
  ! each of the following should invoke only array->array defined assignment - each once only
  dt_array_1 = (/ dt(20,4,4,4,4,4)(34,13), dt_p /)
  dt_array_2 = (/ dt(20,4,4,4,4,4)(tag=14,datum=35), dt_t /)
  dt_array_1 = (/ dt_t, dt_a /)
  dt_array_1 = (/ dt_array_1 /)
  dt_array_2 = (/ dt(20,4,4,4,4,4):: dt(20,4,4,4,4,4)(36,15), dt_t /)
  dt_array_1 = (/ dt(20,4,4,4,4,4):: dt_p, dt(20,4,4,4,4,4)(tag=16,datum=37) /)
  dt_array_2 = (/ dt(20,4,4,4,4,4):: dt(20,4,4,4,4,4)(38,17), dt_a /)
  dt_array_2 = (/ dt(20,4,4,4,4,4):: dt_array_2 /)

  print *, "";  print *, "End"

end program acetdt02l
