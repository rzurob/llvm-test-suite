...
! ftcx_dtp -qnol /tstdev/F2003/asynchIO/attribute/misc/asynchAttrAssocName04.f
! opt variations: -ql
...
PROGRAM asynchAttrAssocName04
    ...
    TYPE(tType(4)), DIMENSION( n ) :: thatType
    TYPE(tType(4)), DIMENSION( n ) :: thisType = (/ (tType(4)(i), i = 1, n) /)
