...
! ftcx_dtp -qnol -qreuse=self /tstdev/F2003/asynchIO/attribute/otherAttr/asynchValueAttr01.f
...
PROGRAM asynchValueAttr01
    ...
    TYPE(tPoint(4)), DIMENSION( 1000 ) :: ptList
    TYPE(tPoint(4)), DIMENSION( 1000 ) :: ptCheck
