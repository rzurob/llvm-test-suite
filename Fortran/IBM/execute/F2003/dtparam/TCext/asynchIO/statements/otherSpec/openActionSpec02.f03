...
! ftcx_dtp -ql -qreuse=none /tstdev/F2003/asynchIO/statements/otherSpec/openActionSpec02.f
...
MODULE mDerived1
    ...
    TYPE, EXTENDS(tBase) :: tDerived1(N2,K3,K4)    ! (20,4,4,20,4,4)
        INTEGER, KIND :: K3,K4
        INTEGER, LEN  :: N2
        INTEGER(K3)   :: derived1
        INTEGER(K4)   :: derived2
...
MODULE mDerived2
    ...
    TYPE, EXTENDS(tBase) :: tDerived2(N3,K5,K6)    ! (20,4,4,20,4,4)
        INTEGER, KIND :: K5,K6
        INTEGER, LEN  :: N3
        INTEGER(K5)   :: derived1
        INTEGER(K6)   :: derived2
...
PROGRAM openActionSpec02
    ...
    TYPE(tBase(20,4,4)), TARGET :: b1 = tBase(20,4,4)(1,10)
    TYPE(tDerived1(20,4,4,20,4,4)), TARGET :: d1 = tDerived1(20,4,4,20,4,4)(2,20, 200,100)
    TYPE(tDerived2(20,4,4,20,4,4)), TARGET :: d2 = tDerived2(20,4,4,20,4,4)(3,30, 300,150)
...
200 CONTINUE
    ...
    CONTAINS
        ...
        SUBROUTINE DumpClass(ioUnit, aID, varName, poly)
            ...
            CLASS(tBase(*,4,4)), INTENT(IN) :: poly
