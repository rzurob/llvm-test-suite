...
! ftcx_dtp -qk -ql -qdeferredlp /tstdev/F2003/mv_Alloc/ptrAssc/ulmt4allCmpToFm.f
...
!23456789012345678901234567890123456789012345678901234567890123456789012
    ...
    class(B(4,:)), target, allocatable :: y(:)
    ...
    allocate(y(2), source = (/ B(4,20)(b1=x1, p = t1), B(4,20)(b1=x2, p = t2 ) /) )
