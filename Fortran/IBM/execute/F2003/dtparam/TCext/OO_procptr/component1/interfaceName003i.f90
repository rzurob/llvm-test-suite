...
! ftcx_dtp -qk -ql -qnodeferredlp /tstdev/OO_procptr/component1/interfaceName003i.f
...
use m3
    ...
    print *, c2%pp2((/(Base(20,4)(i),i=1,10)/), c2%pp1)
    print *, shape(c2%pp2((/(Base(20,4)(i),i=1,10)/), c2%pp1))
end
