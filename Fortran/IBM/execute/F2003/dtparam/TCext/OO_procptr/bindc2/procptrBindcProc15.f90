...
! ftcx_dtp -qk -qnol /tstdev/OO_procptr/bindc2/procptrBindcProc15.f
...
program procptrBindcProc15

   use ISO_C_BINDING,ONLY : C_F_PROCPOINTER, C_FUNPTR, C_INT_FAST16_T, C_FUNLOC, C_ASSOCIATED, C_LOC, C_PTR
   ...
   type(dt(4)) :: dtype
   integer(C_INT_FAST16_T), target :: i
   type(C_PTR) :: j , res
   integer(C_INT_FAST16_T), pointer :: p, pp
...
end program procptrBindcProc15
