...
! ftcx_dtp -qk -qnol /tstdev/OO_procptr/bindc2/procptrBindcProc04.f
...
program procptrBindcProc04

   use ISO_C_BINDING,ONLY : C_F_PROCPOINTER, C_FUNPTR, C_LONG_LONG, C_FUNLOC, C_ASSOCIATED, C_LOC, C_PTR
   ...
   type(dt(4)) :: dtype
   integer(C_LONG_LONG), target :: i
   type(C_PTR) :: j , res
   integer(C_LONG_LONG), pointer :: p, pp
...
end program procptrBindcProc04
