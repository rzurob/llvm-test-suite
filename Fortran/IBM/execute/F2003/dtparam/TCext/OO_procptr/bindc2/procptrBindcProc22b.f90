...
!   j = C_LOC(i)
   ...
   if (.not.precision_R6(p,5.0q0)) error stop 17_4

   call C_F_POINTER(j,p)
   if ( ASSOCIATED(p,i) ) error stop 18_4
   if (.not.precision_R6(p,10.0q0)) error stop 19_4
   ...
   if (.not.precision_R6(p,5.0q0)) error stop 27_4

   call C_F_POINTER(j,p)
   if ( ASSOCIATED(p,i) ) error stop 28_4
   if (.not.precision_R6(p,10.0q0)) error stop 29_4
   if (.not.precision_R6(pp,5.0q0)) error stop 30_4

   call C_F_POINTER(res,pp)
   if ( ASSOCIATED(pp,i) ) error stop 31_4
   if (.not.precision_R6(pp,10.0q0)) error stop 32_4

end program procptrBindcProc22b
