...
! ftcx_dtp -qk -qnol /tstdev/OO_procptr/bindc2/procptrBindcProc02.f
...
program procptrBindcProc02

   use ISO_C_BINDING,ONLY : C_F_PROCPOINTER, C_FUNPTR, C_SHORT, C_FUNLOC, C_ASSOCIATED, C_LOC, C_PTR
...
end program procptrBindcProc02
