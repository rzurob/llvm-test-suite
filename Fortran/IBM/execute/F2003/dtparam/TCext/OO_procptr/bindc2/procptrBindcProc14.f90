...
! ftcx_dtp -qk -ql /tstdev/OO_procptr/bindc2/procptrBindcProc14.f
...
program procptrBindcProc14

   use ISO_C_BINDING,ONLY : C_F_PROCPOINTER, C_FUNPTR, C_INT_FAST8_T, C_FUNLOC, C_ASSOCIATED, C_LOC, C_PTR
   ...
   type(dt(4,20)) :: dtype
   integer(C_INT_FAST8_T), target :: i
   type(C_PTR) :: j , res
   integer(C_INT_FAST8_T), pointer :: p, pp
...
end program procptrBindcProc14
