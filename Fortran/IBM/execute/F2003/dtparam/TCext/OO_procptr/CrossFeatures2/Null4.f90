...
! ftcx_dtp -qnol /tstdev/OO_procptr/CrossFeatures2/Null4.f
! opt variations: -ql
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ASSOCIATED(W2%ProcPtr) )      STOP 4
  IF ( ASSOCIATED(W3(2)%ProcPtr))    STOP 43
  ...
  IF ( ASSOCIATED(Arg3(3)%ProcPtr))  STOP 33
