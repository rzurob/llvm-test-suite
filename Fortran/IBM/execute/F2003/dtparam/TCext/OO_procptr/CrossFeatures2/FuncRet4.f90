...
! ftcx_dtp -qck -qk -ql -qnodefaultpv -qdeferredlp -qreuse=self /tstdev/OO_procptr/CrossFeatures2/FuncRet4.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  PROGRAM FuncRet4
  USE M
  IMPLICIT TYPE(DT1(4,20,1,2,8,16))(P)
  ...
  TYPE(DT1(4,20,1,2,8,16))       :: ConstArr(10000)
  TYPE(DT(1,2,4,8,16,3)), TARGET :: Tar=Const

  ConstArr = DT1(4,20,1,2,8,16)(Const, Tar)
  ...
  CLASS(*)  :: Arg1(:)
  TYPE(DT1(4,*,1,2,8,16)) :: Arg2(:)

    DO I=1, SIZE(Arg1)
    SELECT TYPE(Arg1)
    CLASS IS (DT1(4,*,1,2,8,16))
