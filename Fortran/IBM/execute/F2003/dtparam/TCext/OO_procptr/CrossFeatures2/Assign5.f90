...
! ftcx_dtp -qk -ql -qdeferredlp /tstdev/OO_procptr/CrossFeatures2/Assign5.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  ALLOCATE(DT(4,20) :: V2(1023))
  V2 = ProcPtr2(DT(4,20)(Base=Base(4,20)(ProcPtr1), ProcPtr2=ModFun2 ))
  ALLOCATE(Base(4,20) :: V3(1023))
  V3 = ProcPtr1(Base(4,20)(ProcPtr1) )

  DO I=1, 1023
    IF (.NOT. Equal(V(I),  DT(4,20)(Base=Base(4,20)(ProcPtr1), ProcPtr2=ModFun2 )) ) STOP 11
    IF (.NOT. Equal(V1(I), Base(4,20)(ProcPtr1)) )                             STOP 12
    IF (.NOT. Equal(V2(I), DT(4,20)(Base=Base(4,20)(ProcPtr1), ProcPtr2=ModFun2 )) ) STOP 13
    IF (.NOT. Equal(V3(I), Base(4,20)(ProcPtr1)) )                             STOP 14
  END DO
