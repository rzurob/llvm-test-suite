...
! ftcx_dtp -qk -ql -qnodeferredlp /tstdev/OO_procptr/bindc1/functional/bindc013.f
...
module m
   ...
   type(base(4,20)) :: b1
   type(base(4,20)), allocatable, target :: b2
   type(base(4,20)), pointer :: b3

   logical :: precision_r4

   b1 = base(4,20)( 10.0_C_FLOAT, 11.0_C_FLOAT, 12.0_C_FLOAT, null(), null(), null() )
   allocate ( b2 )
   b2 = base(4,20)( 20.0_C_FLOAT, 21.0_C_FLOAT, 22.0_C_FLOAT, null(), null(), null() )
