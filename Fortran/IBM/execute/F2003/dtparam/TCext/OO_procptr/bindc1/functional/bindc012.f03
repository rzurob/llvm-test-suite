...
! ftcx_dtp -qk -ql -qnodeferredlp /tstdev/OO_procptr/bindc1/functional/bindc012.f
...
module m
   ...
   type(base(4,20)) :: b1
   type(base(4,20)), pointer :: b2
   type(base(4,20)), allocatable :: b3

   b1 = base(4,20)(10_C_INT, 100_C_INT, 1000_C_INT, printandreset)
   allocate ( b2, b3 )

   b2 = base(4,20)(20, 200, 2000, b1%pp )
   b3 = base(4,20)(30, 300, 3000, b2%pp )
