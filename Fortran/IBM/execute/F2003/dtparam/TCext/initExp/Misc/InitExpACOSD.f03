...
! ftcx_dtp -qk -qnol /tstdev/F2003/initExp/Misc/InitExpACOSD.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE(DT1(4)), PARAMETER :: Const(INT(ACOSD(0.5))) =   &
                          DT1(4)(C1=(/(CHAR(INT(ACOSD(0.5))), I=1,3)/), C=CHAR(INT(ACOSD(0.5))))
  ...
  TYPE(DT1(4)), PARAMETER :: Const(INT(ACOSD(0.5_8))) =   &
                          DT1(4)(C1=(/(CHAR(INT(ACOSD(0.5_8))), I=1,3)/), C=CHAR(INT(ACOSD(0.5_8))))
  ...
  TYPE(DT1(4)), PARAMETER :: Const(INT(ACOSD(0.5_16))) =   &
                          DT1(4)(C1=(/(CHAR(INT(ACOSD(0.5_16))), I=1,3)/), C=CHAR(INT(ACOSD(0.5_16))))
