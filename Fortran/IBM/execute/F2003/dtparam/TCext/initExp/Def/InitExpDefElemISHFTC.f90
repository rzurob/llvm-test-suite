...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ANY( I2  .NE. -128 ))     ERROR STOP 14
  IF ( KIND(I4) .NE. 4 )         ERROR STOP 15
  IF ( ANY( I4  .NE. -128 ))     ERROR STOP 16
  IF ( KIND(I8) .NE. 8 )         ERROR STOP 17
  IF ( ANY( I8  .NE. 1 ))        ERROR STOP 18


  IF ( ANY( T%Arr(1)%I  .NE. 1 ))        ERROR STOP 21
  IF ( ANY( T%Arr(2)%I  .NE. -128 ))     ERROR STOP 22
  IF ( ANY( T%Arr(3)%I  .NE. -128 ))     ERROR STOP 23
  IF ( ANY( T%Arr(4)%I  .NE. 1 ))        ERROR STOP 24
