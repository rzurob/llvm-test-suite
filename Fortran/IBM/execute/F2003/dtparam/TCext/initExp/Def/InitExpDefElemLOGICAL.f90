...
! ftcx_dtp -ql /tstdev/F2003/initExp/Def/InitExpDefElemLOGICAL.f
! opt variations: -qnol
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE :: DT0(N1,K1,K2,K3,K4)    ! (20,1,2,4,8)
    INTEGER, KIND :: K1,K2,K3,K4
    INTEGER, LEN  :: N1
    LOGICAL(KIND=K1) :: L1(SIZE(L))=L
    LOGICAL(KIND=K2) :: L2(SIZE(L))=L
    LOGICAL(KIND=K3) :: L4(SIZE(L))=L
    LOGICAL(KIND=K4) :: L8(SIZE(L))=L
  END TYPE

  TYPE (DT0(20,1,2,4,8)) :: T
  TYPE (DT0(20,1,2,4,8)) :: T1=DT0(20,1,2,4,8)(            &
  ...
  TYPE (DT0(20,1,2,4,8)) :: T2=DT0(20,1,2,4,8)(                              &
