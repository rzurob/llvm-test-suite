...
! ftcx_dtp -qreuse=self /tstdev/F2003/initExp/Def/InitExpDefElemMAX.f
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : InitExpDefElemMAX.f  
!*  TEST CASE TITLE            :
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : Apr. 12, 2006
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE :: DT0(K1,K2,K3,K4,K5,N1)    ! (1,2,4,8,16,128)
    ...
    CHARACTER(N1) :: Str(128) = C 
  END TYPE

  TYPE :: DT(K6,K7,K8,K9,K10,N2)    ! (1,2,4,8,16,128)
  ...
  TYPE (DT0(1,2,4,8,16,128)), PARAMETER  :: T=DT0(1,2,4,8,16,128)()

  TYPE (DT(1,2,4,8,16,128)) :: T1=DT(1,2,4,8,16,128)(                                                                      &
