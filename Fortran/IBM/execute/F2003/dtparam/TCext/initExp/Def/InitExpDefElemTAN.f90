...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF (ANY( ABS(T4%R41+1.557407737)    .GE. 1.E-6  ))    STOP 11
  IF (ANY( T4%R42                     .NE. r4P_Zero  )) STOP 12
  IF (ANY( T4%R43                     .NE. r4N_Zero  )) STOP 13
  IF (ANY( ABS(T4%R44-1.557407737)    .GE. 1.E-6  ))    STOP 14

  IF (ANY( ABS(T8%R81+1.557407737)    .GE. 1.E-6  ))    STOP 21
  IF (ANY( T8%R82                     .NE. r8P_Zero  )) STOP 22
  IF (ANY( T8%R83                     .NE. r8N_Zero  )) STOP 23
  IF (ANY( ABS(T8%R84-1.557407737)    .GE. 1.E-6  ))    STOP 24
