...
! ftcx_dtp -qnol -qreuse=self /tstdev/F2003/decimaledit/defaultIO/dcmlCharExprRW007.f
...
use m
    ...
    allocate (b1(10000), source=(/(base(8,4)(cmplx(i), i, mod(i,2) == 0), i=1, 10000)/))
