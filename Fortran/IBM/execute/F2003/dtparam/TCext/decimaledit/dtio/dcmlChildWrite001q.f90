...
! ftcx_dtp -ql -qdeferredlp /tstdev/F2003/decimaledit/dtio/dcmlChildWrite001q.f
...
!                               DTIO a namelist parent write involves
!                               list-directed write in child data transfer
!                               situation; XLF compiler will use a comma or
...
use m
    ...
    write (1, '(5DT)', decimal='cOmma', advance='no') b1(2::2)

    write (1, nml=nml1, decimal='COmma')
end
