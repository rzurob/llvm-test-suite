...
! ftcx_dtp -qk -ql /tstdev/F2003/decimaledit/dtio/dcmlChildWrite006.f
...
use m
    ...
    write (1, '(DT, DP, e15.6, dc)', advance='no') (base(4,20)(i*1.2), i*1.2, i=1, 10)

    write (1, '(dp, a, dt)') new_line('a')

    write (1, '(Dp, dt, dc, 2e15.6, 1x, dt)') &
            (base(4,20)(cmplx(i, i*2)), cmplx(i, i*2), base(4,20)(i*1.0), i=1, 10)
