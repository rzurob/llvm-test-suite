...
! ftcx_dtp -qnol /tstdev/F2003/allocEnh/basic/nonchar/allocatedLBoundDerived02.f
! opt variations: -ql
...
PROGRAM allocatedLBoundDerived02
    ...
    TYPE(tType(16)) :: tTypeStat( -1:0,0:1 ) =&
        RESHAPE((/ (tType(16)(CMPLX(-i,i)), i = 1, 4) /), (/ 2,2 /))

    TYPE(tType(16)), ALLOCATABLE :: tTypeAlloc( :,: )
