...
! ftcx_dtp -qnol -qreuse=base /tstdev/F2003/allocEnh/basic/nonchar/unallocatedArrayDerived01.f
...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : unallocatedArrayDerived01 - Basic Tests:
...
MODULE mDerived2
    ...
    TYPE, EXTENDS(tDerived) :: tDerived2    ! (4)
        INTEGER(K1) :: d2
    END TYPE tDerived2
...
MODULE mDerived3
    ...
    TYPE, EXTENDS(tDerived2) :: tDerived3    ! (4)
        INTEGER(K1) :: d3
    END TYPE tDerived3

    TYPE(tDerived3(4)) :: derived3Array( 3,3,3 ) =&
        RESHAPE((/ (tDerived3(4)((i - 1),i,(i + 1),(i * 2)), i = 1, 27) /),&
                                                                (/ 3,3,3 /))
...
MODULE mSubroutine
    ...
    TYPE(tDerived3(4)), ALLOCATABLE :: derived3ArrayAlloc( :,:,: )
