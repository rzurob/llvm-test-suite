...
! ftcx_dtp -qk -qnol -qnodefaultpv -qreuse=self /tstdev/F2003/allocEnh/argAssociation/dummyArg009.f
...
use m1
    ...
    !! test 3
    it = 100
    call assgnCo (co1, container(4)(base(4)(10, it)))
