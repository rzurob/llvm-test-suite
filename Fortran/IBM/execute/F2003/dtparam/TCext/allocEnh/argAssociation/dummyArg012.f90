...
! ftcx_dtp -ql -qdeferredlp /tstdev/F2003/allocEnh/argAssociation/dummyArg012.f
...
use m
    ...
    type(base(:,4)), pointer :: bptr1, bptr2(:)

    allocate (base(20,4) :: b1, b2, bptr1, bptr2(0:999))

    b1 = base(20,4)(null())

    b2 = base(20,4)(100)

    bptr1 = base(20,4)(1000)
