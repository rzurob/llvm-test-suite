...
! ftcx_dtp -qck -qk -ql -qnodefaultpv -qdeferredlp /tstdev/F2003/allocEnh/argAssociation/dummyArg008a.f
! opt variations: -qnock -qnok -qnol -qdefaultpv -qnodeferredlp
...
use, intrinsic :: iso_fortran_env, only : output_unit
    ...
    co2 = container(4,20,8)(child(20,8)([(cmplx(i,i-1), i=1,10)], str))

    call assgn (co1%data, co2%data)

    call co1%data%print(output_unit, '(10("(",f15.6, f15.6,") "), 10a)')

    call assgn (co1%data, base(20,8)([(1.2d0, 2.2d0), (3.2d0, 4.2d0)]))
