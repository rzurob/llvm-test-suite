...
! ftcx_dtp -ql -qdeferredlp -qreuse=base /tstdev/F2003/allocEnh/scalarExpr/varIsArrSectExprIsScalar03.f
...
MODULE mAlloc
    ...
    TYPE(tDerived(:,4)), ALLOCATABLE :: tAlloc( : )
...
PROGRAM varIsArrSectExprIsScalar03
    ...
    TYPE(tDerived(20,4)) :: scalarTDerived = tDerived(20,4)(NULL( ),10)
...
SUBROUTINE Alloc( )
    ...
    ALLOCATE(tAlloc( 10 ), SOURCE=[ (tDerived(20,4)((10 - i),i), i = 0, 9) ])
