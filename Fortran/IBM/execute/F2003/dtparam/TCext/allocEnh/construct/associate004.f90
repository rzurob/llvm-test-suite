...
! ftcx_dtp -qnol /tstdev/F2003/allocEnh/construct/associate004.f
! opt variations: -ql
...
module m
    ...
    abstract interface
        type(base(4)) function splitBaseData (b, num)
        import
...
use m
    ...
    allocate (b2, source=base(4)(split=splitBase))
...
use m
    ...
    fb = (/(base(4)(tempA(i)%data, b%split), i=1,num)/)
end function
