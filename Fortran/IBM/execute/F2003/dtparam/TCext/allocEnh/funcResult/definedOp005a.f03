...
!                               a simplified version of definedOp005
!*
!* ===================================================================
...
module m
    ...
    type(base(4)) function addB1B2Array (b1, b2)
        ...
        addB1B2Array = reshape((/(base(4)(null()), i=1, size(b1))/), &
            (/size(b1,1), size(b1,2), size(b1,3)/))
...
use m
    ...
    b1 = reshape((/(base(4)(i), i=-110, 129)/), (/6,8,5/))
