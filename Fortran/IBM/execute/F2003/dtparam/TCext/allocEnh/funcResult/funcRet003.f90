...
! ftcx_dtp -ql -qdeferredlp /tstdev/F2003/allocEnh/funcResult/funcRet003.f
...
module m
    ...
    function genBaseAlloc (q1, lb)
        ...
        type(base(:,16)), allocatable :: genBaseAlloc(:)

        real(16), allocatable :: q2(:)

        allocate(base(20,16) :: genBaseAlloc(lb:lb+size(q1)-1))
