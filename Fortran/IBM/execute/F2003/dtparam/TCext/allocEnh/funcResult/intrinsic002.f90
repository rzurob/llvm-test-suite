...
! ftcx_dtp -ql -qdeferredlp /tstdev/F2003/allocEnh/funcResult/intrinsic002.f
...
use m
    ...
    type(child(:,4)), allocatable :: c1(:,:), c2(:,:,:), c3(:,:,:,:)

    integer extendsB1

    character(:), pointer :: verifyStr

    allocate (base(20,4) :: b1(0:9, 0:19))
    ...
    c1 = reshape([(child(20,4)(i, 'test '//i2string(i)), i=1,100)], [10,10])
