...
! ftcx_dtp -qnol /tstdev/F2003/allocEnh/subObject/derivedTypePolyComp02.f
! opt variations: -ql
...
PROGRAM derivedTypePolyComp02
    ...
    TYPE(tType(4)) :: tB( 7 )
    TYPE(tType(4)) :: tC( 6 )
    TYPE(tType(4)), ALLOCATABLE :: tA( : )


    tB = [ tType(4)(1,5.0_4), tType(4)(3,10.0_16), tType(4)(2,15.0_8), tType(4)(4,20_2),&
            tType(4)(5,(25.0_16 , 30.0_16)), tType(4)(6,'A1B2C3D4E'), tType(4)(7,3) ]

    tB( 7 ) = tType(4)(7,tB( 3 ))

    tC = [ tType(4)(6,'abc'), tType(4)(4,123_2), tType(4)(2,7.8_8),&
           tType(4)(7,7), tType(4)(7,3), tType(4)(5,(12.3_16 , 45.6_16)) ]
