...
! ftcx_dtp -ql -qdeferredlp -qreuse=self /tstdev/F2003/allocEnh/subObject/derivedTypePolyComp03.f
...
PROGRAM derivedTypePolyComp03
    ...
    TYPE(tType(:,4)), ALLOCATABLE :: t


    t = tType(20,4)(10,1,[ (INT(i, 2), i = 1, 10) ])
    CALL Check(10, 10_4)

    t = tType(20,4)(10,2,[ (REAL(i, 8), i = 1, 10) ])
    CALL Check(10, 20_4)

    t = tType(20,4)(5,3,[ (CMPLX(i, 4), i = 1, 5) ])
    CALL Check(5, 30_4)

    t = tType(20,4)(5,4,[ (LOGICAL(.TRUE., 4), i = 1, 5) ])
    CALL Check(5, 40_4)

    t = tType(20,4)(5,5,[ (char5( i ), i = 1, 5) ])
    CALL Check(5, 50_4)
