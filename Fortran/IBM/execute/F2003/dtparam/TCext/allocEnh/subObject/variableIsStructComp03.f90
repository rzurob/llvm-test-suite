...
! ftcx_dtp -qk -qnol -qnodefaultpv -qreuse=self /tstdev/F2003/allocEnh/subObject/variableIsStructComp03.f
...
PROGRAM variableIsStructComp03
    ...
    TYPE :: t1(K1)    ! (4)
        INTEGER, KIND            :: K1
        COMPLEX(K1), ALLOCATABLE :: c
    END TYPE t1

    TYPE :: t2(K2)    ! (4)
        INTEGER, KIND             :: K2
        TYPE(t1(K2)), ALLOCATABLE :: a( : )
    END TYPE t2

    TYPE(t2(4)) :: t2_2
    TYPE(t2(4)) :: t2_10

    TYPE(t2(4)), TARGET :: t2_5

    TYPE(t2(4)), POINTER :: t2Ptr
    TYPE(t2(4)), ALLOCATABLE, TARGET :: t2a


    t2_2 = t2(4)([ (t1(4)((REAL( i ) / 10.)), i = 1, 2) ])
    t2_5 = t2(4)([ (t1(4)( -i ), i = 1, 5) ])
    t2_10 = t2(4)([ (t1(4)( i ), i = 0, 9) ])
