...
! ftcx_dtp -qk -ql -qdeferredlp /tstdev/F2003/allocEnh/subObject/derivedTypePolyComp01.f
...
PROGRAM derivedTypePolyComp01
    ...
    t = tType(4,20)((25.0_16 , 30.0_16))
    CALL Check(5, 50_4)

    t = tType(4,20)('abcdefghi')
    CALL Check(6, 60_4)
