...
! ftcx_dtp -qnol -qreuse=base /tstdev/F2003/allocEnh/subObject/variableIsArraySect01.f
...
PROGRAM variableIsArraySect01
    ...
    TYPE(tD(4)), ALLOCATABLE :: d1( : )
    TYPE(tD(4)), ALLOCATABLE :: d3( :,:,: )


    d1 = [ (tD(4)(-9,-9), i = 1, 3) ]
    d3 = RESHAPE([ (tD(4)(i,i), i = 26, 0, -1) ], [ 3,3,3 ])
