...
! ftcx_dtp -qnol /tstdev/F2003/allocEnh/refToVar/exprIsZeroLengthArraySection07.f
! opt variations: -ql
...
MODULE mDerived1
    ...
    TYPE, EXTENDS(tBase) :: tDerived1(K2)    ! (16,8)
        INTEGER, KIND :: K2
        REAL(K2)      :: derived1
    END TYPE tDerived1
...
MODULE mDerived2
    ...
    TYPE, EXTENDS(tDerived1) :: tDerived2(K3)    ! (16,8,4)
        INTEGER, KIND         :: K3
        REAL(K3), ALLOCATABLE :: derived2
    END TYPE tDerived2
...
MODULE mModule
    ...
    TYPE(tDerived2(16,8,4)), ALLOCATABLE :: d2Alloc( :,:,:,: )
...
SUBROUTINE AllocateIt( )
    ...
    DO i = 1, 10
        DO j = 1, 10
            DO k = 1, 10
                DO l = 1, 10
                    d2Alloc( l,k,j,i ) = tDerived2(16,8,4)(REAL(l,16),REAL(k,8),NULL())
