...
! ftcx_dtp -qk -ql -qnodeferredlp -qreuse=none /tstdev/OO_poly/point_assgn/fpAssgn022.f
! opt variations: -qck -qnok -qnol -qdeferredlp -qreuse=base
...
module m
    ...
    class (base(20,4)), pointer :: b1_m => null()
