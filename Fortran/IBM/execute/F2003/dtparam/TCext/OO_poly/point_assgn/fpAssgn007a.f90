...
! ftcx_dtp -qck -qk -ql -qdeferredlp -qreuse=base /tstdev/OO_poly/point_assgn/fpAssgn007a.f
...
module m
    ...
    type, extends(child) :: grandP    ! (4,20,1)
        integer(k1) :: id
...
use m
    ...
    type(base(4,20)), pointer :: b_ptr1
    type (child(4,20,1)), pointer :: c_ptr1
    type (grandP(4,20,1)), pointer :: g_ptr1

    class (base(4,:)), pointer :: b_ptr2
    class (child(4,:,1)), pointer :: c_ptr2
    class (grandP(4,:,1)), pointer :: g_ptr2
