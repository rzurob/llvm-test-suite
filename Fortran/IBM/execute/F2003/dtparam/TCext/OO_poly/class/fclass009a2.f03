...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/class/fclass009a2.f
! *********************************************************************
!*  ===================================================================
!*
!*  DATE                       : 01/24/2005
...
use m
    ...
    allocate (b1(2), source=(/child(4,1,20) (1, 'xlftest'), child(4,1,20)(10, 'team')/))
    allocate (b2(2), source=(/child(4,1,20) (100, 'team'), child(4,1,20) (20, 'member')/))
...
use m, only: base, child
    ...
    select type (b1)
        ...
        type is (child(4,1,*))
            allocate (child(4,1,20):: addB1B2(size(b1)))
