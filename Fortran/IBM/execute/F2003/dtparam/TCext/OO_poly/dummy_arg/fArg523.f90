...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/dummy_arg/fArg523.f
! SCCS ID Information
! *********************************************************************
! %START
! %MAIN: YES
...
use m
    ...
    allocate (b1, source=child(4,1,20)(100, 'b2 scalar'))
