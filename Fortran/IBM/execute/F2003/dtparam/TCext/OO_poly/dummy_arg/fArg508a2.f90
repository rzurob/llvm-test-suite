...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/dummy_arg/fArg508a2.f
!#######################################################################
! SCCS ID Information
! %W%, %I%
...
! %COMPOPTS: -qfree=f90
! %GROUP: fArg508a2.f
! %VERIFY: fArg508a2.out:fArg508a2.vf
! %STDIN:
! %STDOUT: fArg508a2.out
! %EXECARGS:
! %POSTCMD: 
! %END
! *********************************************************************
