...
! ftcx_dtp -ql -qdeferredlp -qreuse=self /tstdev/OO_poly/dummy_arg/fArg013a2.f
...
module m
    ...
    subroutine associateSeqPtr (s, x)
        ...
        type (seq1(:,4)), pointer, intent(out) :: s
