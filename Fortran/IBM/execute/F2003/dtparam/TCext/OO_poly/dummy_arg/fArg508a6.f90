...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/dummy_arg/fArg508a6.f
!#######################################################################
! SCCS ID Information
! %W%, %I%
...
! %COMPOPTS: -qfree=f90
! %GROUP: fArg508a6.f
! %VERIFY: fArg508a6.out:fArg508a6.vf
! %STDIN:
! %STDOUT: fArg508a6.out
! %EXECARGS:
! %POSTCMD: 
! %END
! *********************************************************************
...
!*  DRIVER STANZA              : xlf95
!*
!*  DESCRIPTION                : argument association (INTENT(OUT) for default
!                               initializations; use the unlimited poly
!                               explicit-shape array dummy arg and the array
!                               section for the actual-arg)
!*
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
