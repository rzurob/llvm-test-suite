...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/dummy_arg/fArg041a.f
!#######################################################################
! SCCS ID Information
! %W%, %I%
...
use m
    ...
    allocate (b1(10), source=(/(base(4)(i*10), i=1,10)/))
    ...
    call printX ((/base(4)(1), base(4)(2), base(4)(3)/))
end
