...
! ftcx_dtp -qk -qnol -qreuse=base /tstdev/OO_poly/selectType/Quotes/SltArrFuncULPolyAlloc.f
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : SltArrFuncULAlloc
!*  TEST CASE TITLE            : 
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : Jan. 19, 2005
...
!*  DESCRIPTION
!*     
!*   The selector is an unlimited allocatable  array pointer from function call
!*  
!*    (ICE-298416)
!*
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  PROGRAM SltArrFuncULPolyAlloc
  USE M
  IMPLICIT NONE
  TYPE(Child(4)), TARGET :: V(2,2)
