...
! ftcx_dtp -qk -ql -qreuse=base /tstdev/OO_poly/selectType/Quotes/SltArrFuncAlloc.f
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : SltArrFuncAlloc
!*  TEST CASE TITLE            : 
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : Jan. 17, 2005
...
!234567890123456789012345678901234567890123456789012345678901234567890
 ...
 MODULE M
  ...
  SELECT TYPE (Fun)
  TYPE IS (Child(4,*))
    Fun = Fun(SubScript(1), SubScript(2))
  END SELECT
  END FUNCTION
  END
