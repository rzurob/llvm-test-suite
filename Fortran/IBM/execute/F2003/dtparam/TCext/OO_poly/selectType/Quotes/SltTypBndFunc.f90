...
! ftcx_dtp -qk -qnol -qnodefaultpv -qreuse=base /tstdev/OO_poly/selectType/Quotes/SltTypBndFunc.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  USE M
  IMPLICIT NONE
  TYPE(Child(4)), TARGET :: V

  SELECT TYPE ( As => V%ReturnObj(V) )
    CLASS IS (Zero(4))
      SELECT TYPE (As)
        TYPE IS (Child(4))
