...
! ftcx_dtp -qk -qnol -qreuse=base /tstdev/OO_poly/selectType/Quotes/SltArrHostDummy.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  ALLOCATE(V(3,3), SOURCE=Child(4)(BaseId=-1, ChildId=-2))
