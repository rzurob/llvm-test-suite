...
! ftcx_dtp -qnol /tstdev/OO_poly/selectType/Quotes/Optional.f
! opt variations: -ql
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  INTEGER(1), TARGET   :: Int(2:3,3:4)=8_1
  INTEGER(1), POINTER  :: IntPtr(:,:)
  COMPLEX(8), TARGET   :: Cplx(2:3,3:4)=(-8.0_8, 8.0_8)
  COMPLEX(8), POINTER  :: CplxPtr(:,:)
  REAL(16),   TARGET   :: R(2:3,3:4)=3
  REAL(16),   POINTER  :: RPtr(:,:)
  LOGICAL(4), TARGET   :: L(2:3,3:4)=.true._8
  LOGICAL(4), POINTER  :: LPtr(:,:)
  CHARACTER(2049), TARGET  :: C(2:3,3:4)
  CHARACTER(2049), POINTER :: CPtr(:,:)
  CHARACTER(2049)          :: Str
  TYPE(DT(4)),   TARGET   :: DTV(2:3,3:4)
