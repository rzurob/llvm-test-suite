...
! ftcx_dtp -qk -ql -qnodeferredlp -qreuse=base /tstdev/OO_poly/selectType/Quotes/SltFuncHostArrPolyAlloc.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  PROGRAM SltFuncHostArrPolyAlloc
  USE M
  IMPLICIT NONE
  CLASS(Child(4,20)), ALLOCATABLE :: V(:,:)
  ...
  SUBROUTINE Sub(Arg)
  CLASS(Child(4,*)),OPTIONAL, ALLOCATABLE :: Arg(:, :)
