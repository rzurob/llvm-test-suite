...
! ftcx_dtp -qk -ql -qreuse=base /tstdev/OO_poly/selectType/Quotes/SltArrVec.f
...
!*  DESCRIPTION
!*
!*   The selector is a poly array with vector subscript
!*    (Seg Fault: 297839)
!*
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE(Child(4,20)), TARGET :: Arr(2:20, 2:20, 2:20)
  TYPE(Test(4,20)) :: V
    ...
    CLASS DEFAULT
      ...
      SELECT TYPE (V)
        TYPE IS (Child(4,*))
          ...
          IF ( ANY (UBOUND(V)     .NE. (/18, 18, 18/) ) ) ERROR STOP 31
