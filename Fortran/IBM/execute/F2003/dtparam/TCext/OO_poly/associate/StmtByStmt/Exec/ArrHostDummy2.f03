...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/ArrHostDummy2.f
! *********************************************************************
!*  ===================================================================
!*
!*  DATE                       : Feb 16, 2005
...
!*    Selector is a ploy assumed shape  dummy array
!*    ()
!*
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  CALL SWAP(V(1::2)%Child, V(2::2)%Child )

  IF ( ANY(V(1::2)%Child%BaseID  .NE. 0) ) ERROR STOP 20
  IF ( ANY(V(1::2)%Child%ChildID .NE. 0) ) ERROR STOP 21
  IF ( ANY(V(2::2)%Child%BaseID  .NE. 1) ) ERROR STOP 22
  IF ( ANY(V(2::2)%Child%ChildID .NE. 2) ) ERROR STOP 23
