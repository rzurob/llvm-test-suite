...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/AttrTargetArrPtr.f
! *********************************************************************
! %START
! %MAIN: YES
! %PRECMD:
! %COMPOPTS: -qfree=f90
! %GROUP:  AttrTargetArrPtr.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : AttrTargetArrPtr
!*
!*  DATE                       : Feb 22, 2005
!*
...
!*  DESCRIPTION
!*
!*   The selector has the pointer attribute
!*
!*    ()
!*
