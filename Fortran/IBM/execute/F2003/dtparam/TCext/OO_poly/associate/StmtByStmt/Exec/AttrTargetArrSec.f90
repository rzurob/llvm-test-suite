...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/AttrTargetArrSec.f
! *********************************************************************
! %START
! %MAIN: YES
! %PRECMD: 
! %COMPOPTS: -qfree=f90 
! %GROUP:  AttrTargetArrSec.f  
! %VERIFY:  
! %STDIN:
! %STDOUT: 
! %EXECARGS:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : AttrTargetArrSec
!*  TEST CASE TITLE            : 
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : Feb 22, 2005
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  USE M
  TYPE (Child(4,20)),   TARGET :: W(3:8)=Child(4,20)(BaseID=-1, ChildID=-2)
