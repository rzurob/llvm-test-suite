...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/AttrOptionalArrAlloc.f
! *********************************************************************
! %START
! %MAIN: YES
! %PRECMD:
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  ALLOCATE(child(4,20) :: Arg(I:J))
  Arg(::2) = Child(4,20)(BaseID=-1, ChildID=-2)
  Arg(4::2)= Child(4,20)(BaseID=-0, ChildID=-0)
