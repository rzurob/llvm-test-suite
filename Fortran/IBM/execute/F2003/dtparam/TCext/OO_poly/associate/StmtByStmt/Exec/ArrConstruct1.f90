...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  call ASSOCIATE1 ( RESHAPE( (/(Child(4,20) &
         (BaseArr=RESHAPE((/Base(4,20)(i)/), (/1,1/)),       &
         ZeroPtr=NULL(), BaseId=i, ChildId=-i), i=1,4)/), (/2,2/)))
