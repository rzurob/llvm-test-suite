...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/ArrFuncSec.f
! *********************************************************************
!*  ===================================================================
!*
!*  DATE                       : Nov. 02, 2004
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IMPLICIT NONE
  INTEGER :: i
  TYPE (Child(4,1,1023)) :: Arr(5,5)=Child(4,1,1023)(ChildID=-2, BaseID=-1)
