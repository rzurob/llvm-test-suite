...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/ArrHostDummy1.f
! *********************************************************************
!*  ===================================================================
!*
!*  DATE                       : Feb 16, 2005
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  IF ( ANY(V(1::2)%BaseID  .NE. 0) ) ERROR STOP 20
  IF ( ANY(V(1::2)%ChildID .NE. 0) ) ERROR STOP 21
  IF ( ANY(V(2::2)%BaseID  .NE. 1) ) ERROR STOP 22
  IF ( ANY(V(2::2)%ChildID .NE. 2) ) ERROR STOP 23

  CONTAINS

  SUBROUTINE SWAP(Arr1, Arr2)
  TYPE(Child(4,*)), INTENT(INOUT) :: Arr1(:), Arr2(:)
