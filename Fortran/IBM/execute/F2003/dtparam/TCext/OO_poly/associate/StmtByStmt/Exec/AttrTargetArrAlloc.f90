...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/AttrTargetArrAlloc.f
! *********************************************************************
! %START
! %MAIN: YES
! %PRECMD: 
! %COMPOPTS: -qfree=f90 
! %GROUP:  AttrTargetArrAlloc.f  
! %VERIFY:  
! %STDIN:
! %STDOUT: 
! %EXECARGS:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : AttrTargetArrAlloc 
!*  TEST CASE TITLE            : 
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : Feb 22, 2005
...
!*  DESCRIPTION
!*    
!*   The selector has the targeti and allocatable attribute  
!*   
!*    () 
!*
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  USE M
  TYPE (Child(4,:)),ALLOCATABLE,  TARGET :: W(:)
