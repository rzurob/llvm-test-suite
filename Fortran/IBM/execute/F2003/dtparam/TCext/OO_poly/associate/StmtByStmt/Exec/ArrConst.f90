...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/associate/StmtByStmt/Exec/ArrConst.f
! *********************************************************************
! %START
! %MAIN: YES
! %PRECMD:
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE(Child(4)), PARAMETER  :: U(2,2) = Child(4)()
