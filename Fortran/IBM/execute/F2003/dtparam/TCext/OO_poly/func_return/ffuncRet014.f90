...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/func_return/ffuncRet014.f
! SCCS ID Information
! *********************************************************************
!*  ===================================================================
!*
...
module m
    ...
    class (base(8)) function makeBasePtr (b)
        pointer makeBasePtr
        class (base(8)), intent(in) :: b
    ...
    class (base(8)) function makeChildPtr (b)
        pointer makeChildPtr
        class (child(8,1,*)), intent(in) :: b

        allocate (makeChildPtr, source=child(8,1,20)(b%ids))
    ...
    subroutine printData (d)
        class (base(8)), pointer, intent(in) :: d
