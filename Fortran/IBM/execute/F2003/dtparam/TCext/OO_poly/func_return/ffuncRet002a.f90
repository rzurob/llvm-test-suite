...
! ftcx_dtp -qck -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/func_return/ffuncRet002a.f
! SCCS ID Information
! *********************************************************************
! %START
! %MAIN: YES
! %PRECMD: rm -f *.mod
! %COMPOPTS: -qfree=f90
! %GROUP: ffuncRet002a.f
! %VERIFY: ffuncRet002a.out:ffuncRet002a.vf
! %STDIN:
! %STDOUT: ffuncRet002a.out
! %EXECARGS:
! %POSTCMD:
! %END
! *********************************************************************
...
use m
    ...
    b1 => replicateBase (child(4,1,20) (1, 'b1_pointer'))
