...
! ftcx_dtp -ql -qreuse=none /tstdev/OO_poly/intrinsics/unpack/argAssociation006.f
...
use m
    ...
    subroutine sub1(arg1, arg2)
        ...
        select type(name1=>unpack(arg1(3:9), reshape((/.FALSE.,.TRUE., &
         .TRUE.,.FALSE.,.TRUE.,.FALSE./),(/2,3/)), arg2))
            type is (Child(*,4,*,4))
                print *, name1
                print *, shape(name1)
            class default
