...
! ftcx_dtp -qk -qnol -qnodefaultpv -qreuse=self /tstdev/OO_poly/intrinsics/typeQuery/ptrAssignment001.f
...
module m
    ...
    type, extends(Base) :: Child(k2,n1)    ! (4,4,10)
        integer, kind :: k2
        integer, len  :: n1
        character(n1) :: c = "abc"
    end type
