...
! ftcx_dtp -qnock -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/intrinsics/eoshift/structureComponent001.f
!=======================================================================
...
use m
    ...
    associate(name1=>eoshift(c1%b1, 4, c1%b1(18)))
    ...
    associate(name1=>eoshift(c1%b2, (/-1,2,-3,1,-2/), c1%b2(:,3), 2))
