...
! ftcx_dtp -qk -qnol -qnodefaultpv -qreuse=base /tstdev/OO_poly/intrinsics/transpose/associate003.f
...
use m
    ...
    allocate(u1(2,3,4,2), SOURCE=reshape((/(Base(4)(i),i=1,48)/), &
     (/2,3,4,2/)))
    allocate(b1, SOURCE=Base1(4)(reshape((/(Base(4)(i),i=-1,-72,-1)/), &
     (/4,6,3/))))
