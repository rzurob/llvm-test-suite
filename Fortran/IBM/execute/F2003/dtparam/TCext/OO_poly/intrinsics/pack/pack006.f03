...
! ftcx_dtp -ql -qreuse=base /tstdev/OO_poly/intrinsics/pack/pack006.f
...
use m
    ...
    allocate(e1, SOURCE=Child(20,4)(1,-1))
    allocate(e2, SOURCE=Child(20,4)(2,-2))
    allocate(e3, SOURCE=Child(20,4)(3,-3))

    allocate(a1(2,3), SOURCE=reshape((/e1,e2,e3,e1,e2,e3/),(/2,3/)))

    allocate(v1(7), SOURCE=(/(Child(20,4)(i,-i),i=11,17)/))
    ...
    select type(name1=>a1)
        type is (Child(*,4))
            associate(name2=>pack(name1, MOD(name1%i,2)==1, v1))
                if(.NOT. same_type_as(name2, Child(20,4)(1,1))) error stop 2_4
                print *, name2
            end associate
        class default
            error stop 3_4
