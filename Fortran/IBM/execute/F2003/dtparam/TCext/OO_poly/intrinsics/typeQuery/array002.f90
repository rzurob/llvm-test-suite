...
! ftcx_dtp -qk -qnol -qreuse=base /tstdev/OO_poly/intrinsics/typeQuery/array002.f
...
use m
    ...
    allocate(Child(4,10)::mold2(5,6))
    allocate(Base(4)::mold3(3,5,8))
    allocate(Base(4)::b2(2,3,10))
    allocate(Child(4,10)::b3(6,9))
