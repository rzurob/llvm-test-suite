...
! ftcx_dtp -qnock -qnok -ql -qreuse=none -qdeferredlp /tstdev/OO_poly/intrinsics/null/typeQuery002.f
!=======================================================================
...
use m
    ...
    allocate(Child(20,4,4)::b1)
    allocate(b2, SOURCE=Child(20,4,4)(1,2))
    allocate(b3(3,8), SOURCE=reshape((/(Child(20,4,4)(i,-i),i=1,24)/),(/3,8/)))
