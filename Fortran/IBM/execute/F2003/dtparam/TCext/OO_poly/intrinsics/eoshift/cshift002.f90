...
! ftcx_dtp -qnock -qnok -ql -qreuse=self -qdefaultpv -qdeferredlp /tstdev/OO_poly/intrinsics/eoshift/cshift002.f
!=======================================================================
...
use m
    ...
    select type(name1=>cshift(eoshift(c1,(/-2,1/), &
     (/Child(20,4,4)(11,-11),Child(20,4,4)(12,-12)/)), (/-1,2,3,-4/), 2))
        type is (Child(*,4,4))
            print *, name1
            print *, size(name1)
            print *, shape(name1)
