...
! ftcx_dtp -qnol -qnodefaultpv -qreuse=base /tstdev/OO_poly/intrinsics/transfer/argAssociation010.f
...
use m
    ...
    class(Base1(4,4)), allocatable :: b1(:,:)
    ...
    subroutine sub1(arg1, arg2)
        ...
        class(Base1(4,4)), allocatable :: arg2(:,:)
