...
! ftcx_dtp -qk -qnol -qreuse=base /tstdev/OO_poly/intrinsics/reshape/reshape015.f
...
! %COMPOPTS: -qfree=f90
! %GROUP: reshape015.f
! %VERIFY: reshape015.out:reshape015.vf
! %STDIN:
! %STDOUT: reshape015.out
! %EXECARGS:
! %POSTCMD:
! %END
! *********************************************************************
...
use m
    ...
    allocate(b2(2), SOURCE = (/Base(4)(-1),Base(4)(-2)/))
