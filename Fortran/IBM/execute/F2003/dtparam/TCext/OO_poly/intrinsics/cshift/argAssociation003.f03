...
! ftcx_dtp -qnock -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/intrinsics/cshift/argAssociation003.f
!=======================================================================
...
module m
    ...
    subroutine sub1(arg1, arg2, arg3, arg4, arg5)
        ...
        select type(name1=>cshift(arg1, -4))
            type is (Base(4))
                print *, name1
            class default
                error stop 1_4
        ...
        select type(name1=>cshift(arg3, 3, 1))
            type is (Child(4))
                print *, name1
                print *, shape(name1)
            class default
        ...
        select type(name1=>cshift(arg4, (/1,2/)))
            type is (Child(4))
                print *, name1
                print *, shape(name1)
            class default
        ...
        select type(name1=>cshift(arg5, reshape((/1,-2,3,-4,5,-6/), &
         (/3,2/)), 3))
            type is (Base(4))
                print *, name1
                print *, size(name1)
