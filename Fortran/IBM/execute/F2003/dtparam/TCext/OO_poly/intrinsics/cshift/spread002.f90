...
! ftcx_dtp -qnock -qk -ql -qreuse=all -qdeferredlp /tstdev/OO_poly/intrinsics/cshift/spread002.f
!=======================================================================
...
use m
    ...
    select type(name1=>spread(cshift(c1,(/-2,3/)), 3, 2))
        type is (Child(4,*))
            print *, name1
            print *, size(name1)
            print *, shape(name1)
    ...
    select type(name1=>spread(cshift(b1, -5), 1, 2))
        type is (Base(4,*))
            print *, name1
            print *, size(name1)
            print *, shape(name1)
