...
! ftcx_dtp -qck -qk -ql /tstdev/OO_poly/allocate/falloc005a10_1.f
! SCCS ID Information
! *********************************************************************
! %START
! %MAIN: YES
! %PRECMD: rm -f *.mod
! %COMPOPTS: -qfree=f90
! %GROUP: falloc005a10_1.f
! %VERIFY: falloc005a10_1.out:falloc005a10_1.vf
! %STDIN:
! %STDOUT: falloc005a10_1.out
! %EXECARGS:
! %POSTCMD:
! %END
! *********************************************************************
