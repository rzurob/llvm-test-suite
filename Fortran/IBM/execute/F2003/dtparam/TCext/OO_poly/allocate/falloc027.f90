...
! ftcx_dtp -qck -qk -ql /tstdev/OO_poly/allocate/falloc027.f
!#######################################################################
! SCCS ID Information
! %W%, %I%
...
program falloc027
use m
    class (base(4)), pointer :: b1_ptr, b2_ptr(:), b3_ptr(:)
    type (base(4)), target :: b1, b2(10), b3(2,2)

    type (base(4)), pointer :: b11_ptr, b21_ptr, b31_ptr(:)
