...
! ftcx_dtp -qck -qk -ql /tstdev/OO_poly/allocate/falloc019.f
! *********************************************************************
!*  ===================================================================
!*
!*  DATE                       : 09/10/2004
...
use iso_c_binding
    ...
    type (seq1(2,8)), pointer :: s1, s2(:)
    type (bType), pointer :: b1, b2(:)


    !! test the sequence type
    allocate (s1, source=seq1(2,8)(10, 1, -10))
    ...
    allocate (s2(-1:0), source=(/seq1(2,8)(1,i3=1), seq1(2,8)(10,10,10)/))
