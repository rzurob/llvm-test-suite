...
! ftcx_dtp -qnol /tstdev/F2003/generic/operator/functional/genericOperatorArray004.f
! opt variations: -ql
...
program genericOperatorArray004
   ...
   class(base(4)), allocatable :: c1, c11(:)

   allocate ( c1,     source = base(4) (100) )
   allocate ( c11(4), source = (/ base(4) (10),  &
                                  base(4) (20),  &
                                  base(4) (30), base(4)(40)   /) )
