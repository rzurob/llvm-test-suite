...
! ftcx_dtp -ql -qdeferredlp /tstdev/F2003/generic/operator/functional/genericOperatorArray006.f
...
!*
!*  DESCRIPTION                : Operator: operators with array components
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program genericOperatorArray006
   use m
