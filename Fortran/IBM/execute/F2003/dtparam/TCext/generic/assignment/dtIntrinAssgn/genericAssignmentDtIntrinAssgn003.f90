...
! ftcx_dtp -qck -ql -qnodefaultpv -qdeferredlp -qreuse=self /tstdev/F2003/generic/assignment/dtIntrinAssgn/genericAssignmentDtIntrinAssgn003.f
...
module m
   ...
   type base(n3,k3,k4)    ! (20,4,1)
      integer, kind             :: k3,k4
      integer, len              :: n3
      integer(k3), pointer      :: x => null()
      type(com1(:,k3)), pointer :: c1
      type(com2(k4,:)), pointer :: c2
   end type
...
program genericAssignmentDtIntrinAssgn003
   ...
   type(base(20,4,1)) :: b1
   type(base(20,4,1)), allocatable :: b2
   type(base(20,4,1)), pointer :: b3

   type(com1(20,4)), target :: c1 = com1(20,4)(2006)
   type(com2(1,3)), target :: c2 = com2(1,3)('ibm')
   integer, target :: i1 = 1001

   b1 = base(20,4,1)( null(), c1, c2 )
   print *, associated(b1%x), b1%c1, b1%c2

   allocate ( b2 )
   b2 = base(20,4,1) ( i1, b1%c1, c2 )
