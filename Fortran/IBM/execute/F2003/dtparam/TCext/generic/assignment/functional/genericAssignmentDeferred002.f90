...
! ftcx_dtp -qk -ql -qdeferredlp /tstdev/F2003/generic/assignment/functional/genericAssignmentDeferred002.f
...
program genericAssignmentDeferred002
   ...
   type(child(20,4,4,20)) :: c1

   allocate ( b1, source = child(20,4,4,20) ( 100 ) )
