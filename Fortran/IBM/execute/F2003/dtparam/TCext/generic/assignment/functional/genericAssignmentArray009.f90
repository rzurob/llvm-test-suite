...
! ftcx_dtp -ql -qnodeferredlp -qreuse=base /tstdev/F2003/generic/assignment/functional/genericAssignmentArray009.f
...
!*                                           and child type contains another overridding tb
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program genericAssignmentArray009
   use m

   class(base(20,4)), allocatable :: b1, b2(:), b3(:,:)
   class(child(20,4)), pointer :: c1, c2(:), c3(:,:)
