...
! ftcx_dtp -ql -qnodeferredlp -qreuse=none /tstdev/F2003/generic/assignment/functional/genericAssignmentArray006.f
...
program genericAssignmentArray006
   use m

   class(base(20,4)), allocatable :: b1, b2(:), b3(:,:)
   class(child(20,4,20,4)), pointer :: c1, c2(:), c3(:,:)
