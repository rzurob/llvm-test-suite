...
! ftcx_dtp -qdeferredlp /tstdev/F2003/generic/genericName/functional/genericGenericNameSpecExpr002.f
...
module m
   ...
   contains
      ...
      subroutine sub ( dtv, c )
         ...
         character(len=puregetl(dtv)), intent(in) :: c
