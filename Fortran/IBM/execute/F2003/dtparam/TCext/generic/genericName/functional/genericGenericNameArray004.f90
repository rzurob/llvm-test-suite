...
! ftcx_dtp -qck -qdeferredlp /tstdev/F2003/generic/genericName/functional/genericGenericNameArray004.f
...
!*
!*  DESCRIPTION                : generic-name: generic tb containing polymorphic explicit shape array of
...
module m
   ...
   subroutine print_b_b2darray ( a, b )
      class(base(1,*)), intent(in) :: a(2,2), b
...
program genericGenericNameArray004
   use m
