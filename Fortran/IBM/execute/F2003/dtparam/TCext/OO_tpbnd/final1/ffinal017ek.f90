...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal017ek.f
!*  TEST CASE NAME             : type-bound procedure ffinal017ek
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal017e by Catherine Sun)
...
module m
    ...
    type, extends(base) :: child 
       type(base(kbase_1)), pointer :: dt_b ! tcx: (4)
    contains
       final :: finalizeChild 
    end type
