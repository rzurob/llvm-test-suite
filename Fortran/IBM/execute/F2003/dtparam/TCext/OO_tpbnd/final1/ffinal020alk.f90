...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal020alk.f
!*  TEST CASE NAME             : type-bound procedure ffinal020alk
!*
...
contains
   ...
   subroutine example()
      ...
      type(base(3)) :: dt1 ! tcx: (3)

      allocate(child(3,32)::dt0) ! tcx: child(3,32)
      deallocate(dt0)
...
! type: base - added parameters (lbase) to invoke with (3) / declare with (*) - 2 changes
! type: child - added parameters (kchild) to invoke with (3,32) / declare with (*,32) - 2 changes
