...
!23456789012345678901234567890123456789012345678901234567890123456789012
   ...
   module mod
      ...
      type(t2(4,0)), save  :: b(3) ! tcx: (4,0)
      type(t3(4,0)), save  :: c(2, 2) ! tcx: (4,0)
...
! type: t2 - added parameters (lt2) to invoke with (4,0) / declare with (4,*) - 2 changes
! type: t3 - added parameters (lt3) to invoke with (4,0) / declare with (4,*) - 2 changes
