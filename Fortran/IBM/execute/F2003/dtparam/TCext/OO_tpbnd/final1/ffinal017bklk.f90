...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal017bklk.f
!*  TEST CASE NAME             : type-bound procedure ffinal017bklk
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal017b by Catherine Sun)
...
subroutine sub()
    use m
    type(child(4,:,4)), pointer :: t_c1 ! tcx: (4,:,4)
    allocate(child(4,0,4)::t_c1) ! tcx: child(4,0,4)
    deallocate(t_c1)
end subroutine
...
! type: child - added parameters (kchild) to invoke with (4,0,4) / declare with (4,*,4) - 2 changes
