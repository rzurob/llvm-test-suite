...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal021ckl.f
!*  TEST CASE NAME             : type-bound procedure ffinal021ckl
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal021c by Catherine Sun)
...
! type: child - added parameters (lchild) to invoke with (4,3) / declare with (4,*) - 3 changes
