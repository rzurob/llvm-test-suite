...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal024gkl1.f
!*  TEST CASE NAME             : type-bound procedure ffinal024gkl1
!*
...
use m1
   type dt (kdt_1,ldt_1) ! kdt_1,ldt_1=4,7
      ...
      type(child(kdt_1,ldt_1)), pointer :: dt_c  ! tcx: (kdt_1,ldt_1)
   end type
end module
...
use m2, only : dt
   class(base(4)), intent(inout) :: arg1 ! tcx: (4)
   class(dt(4,7)), allocatable  :: t1(:)   ! tcx: (4,7)
   allocate(t1(2))
