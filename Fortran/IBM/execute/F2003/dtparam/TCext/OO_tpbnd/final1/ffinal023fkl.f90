...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal023fkl.f
!*  TEST CASE NAME             : type-bound procedure ffinal023fkl
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal023f by Catherine Sun)
...
use m1, only : child
    integer, intent(in) :: arg1, arg2
    class(child(4,:)), pointer  :: dt1(:, :)  ! tcx: (4,:)
    allocate(child(4,3)::dt1(2,2)) ! tcx: child(4,3)
    deallocate(dt1)
end subroutine 
