...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal017ckkl.f
!*  TEST CASE NAME             : type-bound procedure ffinal017ckkl
!*
...
subroutine sub()
    ...
    allocate(child(4,4,0)::t_c1(2)) ! tcx: child(4,4,0)
    deallocate(t_c1)
end subroutine
...
! type: child - added parameters (lchild) to invoke with (4,4,0) / declare with (4,4,*) - 2 changes
