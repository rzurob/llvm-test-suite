...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal023bkl.f
!*  TEST CASE NAME             : type-bound procedure ffinal023bkl
!*
...
use m1, only : child
    ...
    allocate(child(4,1)::dt1) ! tcx: child(4,1)
    deallocate(dt1)
end subroutine
...
! type: child - added parameters (lchild) to invoke with (4,1) / declare with (4,*) - 2 changes
