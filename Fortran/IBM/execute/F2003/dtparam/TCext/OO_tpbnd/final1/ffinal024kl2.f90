...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal024kl2.f
!*  TEST CASE NAME             : type-bound procedure ffinal024kl2
!*
...
module m2
use m1
   type dt (kdt_1,ldt_1) ! kdt_1,ldt_1=4,0
      integer, kind :: kdt_1
      integer, len :: ldt_1
...
! type: dt - added parameters (kdt_1,ldt_1) to invoke with (4,0) / declare with (4,*) - 1 changes
