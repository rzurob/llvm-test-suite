...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal024dkk3.f
!*  TEST CASE NAME             : type-bound procedure ffinal024dkk3
!*
...
use m1
   type dt (kdt_1,kdt_2,kdt_3) ! kdt_1,kdt_2,kdt_3=4,4,4
      ...
      type(child(kdt_2,kdt_3)), allocatable :: dt_c  ! tcx: (kdt_2,kdt_3)
   end type
end module
...
use m2, only : dt
   class(base(4)), intent(inout) :: arg1 ! tcx: (4)
   class(dt(4,4,4)), pointer  :: t1(:, :)   ! tcx: (4,4,4)
   allocate(t1(2,2))
   deallocate(t1)
end subroutine 
