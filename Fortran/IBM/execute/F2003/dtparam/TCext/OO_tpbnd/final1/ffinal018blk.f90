...
!*  TEST CASE NAME             : type-bound procedure ffinal018blk
!*
...
!23456789012345678901234567890123456789012345678901234567890123456789012
   ...
   allocate(t2(0,1)::x(1,3)) ! tcx: t2(0,1)
   deallocate(x)
   end subroutine 
...
! type: t2 - added parameters (kt2) to invoke with (0,1) / declare with (*,1) - 2 changes
