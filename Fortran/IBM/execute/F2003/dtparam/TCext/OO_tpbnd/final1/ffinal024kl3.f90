...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal024kl3.f
!*  TEST CASE NAME             : type-bound procedure ffinal024kl3
!*
...
module m2
use m1
   type dt (kdt_1,kdt_2,ldt_1) ! kdt_1,kdt_2,ldt_1=4,4,0
      integer, kind :: kdt_1,kdt_2
      integer, len :: ldt_1
      type(base(kdt_1)) ::  dt_b  ! tcx: (kdt_1)
      type(child(kdt_2,ldt_1)) :: dt_c  ! tcx: (kdt_2,ldt_1)
   end type
end module
...
! type: dt - added parameters (kdt_1,kdt_2,ldt_1) to invoke with (4,4,0) / declare with (4,4,*) - 1 changes
