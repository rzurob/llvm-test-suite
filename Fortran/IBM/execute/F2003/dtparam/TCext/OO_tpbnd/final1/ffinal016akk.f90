...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal016akk.f
!*  TEST CASE NAME             : type-bound procedure ffinal016akk
!*
...
!23456789012345678901234567890123456789012345678901234567890123456789012
   ...
   module mod
      ...
      type, extends(t1) :: t2 (kt2_1) ! kt2_1=4
         integer, kind :: kt2_1
         real(kt2_1), pointer :: p2 
      contains
         final :: finalize_t2
      end type

      type, extends(t2) :: t3
         real(kt2_1), pointer :: p3 
      contains
         final :: finalize_t3
      end type 

      type(t1(4)), allocatable :: dt1  ! tcx: (4)
      type(t2(4,4)), allocatable :: dt2  ! tcx: (4,4)
      type(t3(4,4)), allocatable :: dt3   ! tcx: (4,4)
...
! type: t3 - added parameters () to invoke with (4,4) / declare with (4,4) - 2 changes
