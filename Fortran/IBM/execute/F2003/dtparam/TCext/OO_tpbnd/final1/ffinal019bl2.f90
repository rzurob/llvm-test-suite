...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal019bl2.f
!*  TEST CASE NAME             : type-bound procedure ffinal019bl2
!*
...
! type: child - added parameters (lchild) to invoke with (1) / declare with (*) - 2 changes
