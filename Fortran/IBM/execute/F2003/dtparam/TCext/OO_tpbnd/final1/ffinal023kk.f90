...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal023kk.f
!*  TEST CASE NAME             : type-bound procedure ffinal023kk
!*
...
! type: child - added parameters (kchild) to invoke with (4,8) / declare with (4,8) - 5 changes
