...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal021akl.f
!*  TEST CASE NAME             : type-bound procedure ffinal021akl
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal021a by Catherine Sun)
...
use m
    ...
    type(child(4,1)), static :: dt2 ! tcx: (4,1)
...
! type: child - added parameters (lchild) to invoke with (4,1) / declare with (4,*) - 3 changes
