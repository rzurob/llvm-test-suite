...
!*  TEST CASE NAME             : type-bound procedure ffinal018bkl
!*
...
!23456789012345678901234567890123456789012345678901234567890123456789012
   ...
   allocate(t2(1,0)::x(1,3)) ! tcx: t2(1,0)
   deallocate(x)
   end subroutine 
...
! type: t2 - added parameters (lt2) to invoke with (1,0) / declare with (1,*) - 2 changes
