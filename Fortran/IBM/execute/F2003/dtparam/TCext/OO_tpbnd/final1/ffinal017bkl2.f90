...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal017bkl2.f
!*  TEST CASE NAME             : type-bound procedure ffinal017bkl2
!*
...
subroutine sub()
    ...
    allocate(child(4,0)::t_c1) ! tcx: child(4,0)
    deallocate(t_c1)
end subroutine
...
! type: parent - added parameters () to invoke with (4) / declare with (4) - 0 changes
