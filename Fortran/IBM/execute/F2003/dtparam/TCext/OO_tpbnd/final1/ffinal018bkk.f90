...
!*  TEST CASE NAME             : type-bound procedure ffinal018bkk
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal018b by Catherine Sun)
...
!23456789012345678901234567890123456789012345678901234567890123456789012
   ...
   contains
      ...
      subroutine finalize_t2(x)
         type(t2(1,1)), intent(inout) :: x(1,3) ! tcx: (1,1)
         print *, "finalize_t2"
      end subroutine
   end module
   ...
   subroutine sub()
   use mod
   type(t2(1,1)), allocatable :: x(:,:) ! tcx: (1,1)
   allocate(x(1,3))
   deallocate(x)
   end subroutine 
...
! type: t2 - added parameters (kt2) to invoke with (1,1) / declare with (1,1) - 2 changes
