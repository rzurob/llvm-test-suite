...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal020akk.f
!*  TEST CASE NAME             : type-bound procedure ffinal020akk
!*
...
module m1
   ...
   type(child(32,32)), allocatable :: dt0  ! tcx: (32,32)

contains
   subroutine finalChild(arg1)
      type(child(32,32)),intent(inout) :: arg1 ! tcx: (32,32)
      private :: arg1
      print *, "finalizeChild"
   end subroutine
...
! type: child - added parameters (kchild) to invoke with (32,32) / declare with (32,32) - 2 changes
