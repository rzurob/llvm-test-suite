...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal015aakkk.f
!*  TEST CASE NAME             : type-bound procedure ffinal015aakkk
!*
...
!23456789012345678901234567890123456789012345678901234567890123456789012
   ...
   module mod
      ...
      type(t2(4,4)), save  :: b(3) ! tcx: (4,4)
      type(t3(4,4)), save  :: c(2, 2)
...
! type: t2 - added parameters (kt2) to invoke with (4,4) / declare with (4,4) - 2 changes
! type: t2 - added parameters (kt3) to invoke with (4,4) / declare with (4,4) - 2 changes
