...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal017bkk.f
!*  TEST CASE NAME             : type-bound procedure ffinal017bkk
!*
...
! type: child - added parameters () to invoke with (4,4) / declare with (4,4) - 2 changes
