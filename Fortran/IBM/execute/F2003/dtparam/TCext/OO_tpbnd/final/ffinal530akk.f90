...
module m
    ...
    type container (kcontainer_1,kcontainer_2) ! kcontainer_1,kcontainer_2=4,4
       integer, kind :: kcontainer_1,kcontainer_2
        class (base(kcontainer_1)), allocatable :: data1 ! tcx: (kcontainer_1)
        class (base(kcontainer_2)), allocatable :: data2(:) ! tcx: (kcontainer_1)
    end type
...
program ffinal530akk
use m
    type (container(4,4)) :: co1, co2 ! tcx: (4,4)
...
! type: container - added parameters (kcontainer_1,kcontainer_2) to invoke with (4,4) / declare with (4,4) - 1 changes
