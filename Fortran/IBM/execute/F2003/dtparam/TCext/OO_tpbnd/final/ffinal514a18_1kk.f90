...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal514a18_1kk
!*
...
program ffinal514a18_1kk
use m
use m1, only: child
use m2
    type (child(4,4)), target :: c1 ! tcx: (4,4)
...
use m1, only : child
    ...
    type (child(4,4)), pointer :: temp ! tcx: (4,4)
...
! type: child - added parameters (kchild_1) to invoke with (4,4) / declare with (4,4) - 3 changes
