...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal014a3kk
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal014a3 by Jim Xia)
...
program ffinal014a3kk
use m
    class (*), pointer :: x1, x2(:)
    class (*), allocatable :: x3, x4(:)

    allocate (child(4,4) :: x1, x3, x2(2), x4(3)) ! tcx: (4,4)
