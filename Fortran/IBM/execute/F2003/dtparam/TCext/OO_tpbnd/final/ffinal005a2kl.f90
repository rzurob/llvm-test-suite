...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal005a2kl
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal005a2 by Jim Xia)
...
module m
    ...
    type container (kcontainer_1,lcontainer_1) ! kcontainer_1,lcontainer_1=8,0
       ...
       integer, len :: lcontainer_1
        ...
        type (A(lcontainer_1)) a1 ! tcx: (lcontainer_1)
...
program ffinal005a2kl
use m
    class (container(8,:)), pointer :: co1 ! tcx: (8,:)

    allocate (container(8,0)::co1) ! tcx: container(8,0)
...
! type: container - added parameters (kcontainer_1,lcontainer_1) to invoke with (8,0) / declare with (8,*) - 1 changes
