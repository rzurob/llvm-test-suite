...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal005a1k
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal005a1 by Jim Xia)
...
module m
    ...
    subroutine nullifyLine (l)
        type (lineSegment(4)), intent(inout) :: l(:) ! tcx: (4)

        print *, 'in the finalization for lineSegment'
    end subroutine
end module

program ffinal005a1k
use m
...
! type: lineSegment - added parameters (klineSegment_1) to invoke with (4) / declare with (4) - 3 changes
