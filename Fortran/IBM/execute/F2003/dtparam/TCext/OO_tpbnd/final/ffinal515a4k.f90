...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal515a4k
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal515a4 by Jim Xia)
...
use m
    ...
    print *, isAssociated (dataType(4)(data = b1)) ! tcx: (4)
