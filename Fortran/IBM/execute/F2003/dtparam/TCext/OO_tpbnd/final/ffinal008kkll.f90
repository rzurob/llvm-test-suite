...
program ffinal008kkll
use m
    class (base), pointer :: b1, b2(:)

    allocate (gen3(4,20,0):: b1, b2(0:1)) ! tcx: (4,20,0)
...
! type: gen3 - added parameters (lGen3) to invoke with (4,20,0) / declare with (4,*,*) - 2 changes
