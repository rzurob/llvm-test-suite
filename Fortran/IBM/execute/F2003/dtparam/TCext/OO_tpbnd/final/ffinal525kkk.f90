...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal525kkk
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal525 by Jim Xia)
...
module m
    ...
    type, extends(base) :: child (kchild_1,kchild_2) ! kchild_1,kchild_2=4,4
       integer, kind :: kchild_1,kchild_2
        type (dataType(kchild_1)) :: data1 ! tcx: (kchild_1)
        class (dataType(kchild_2)), allocatable :: data2 ! tcx: (kchild_1)
    end type
...
! type: child - added parameters (kchild_1,kchild_2) to invoke with (4,4,4) / declare with (4,4,4) - 2 changes
