...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal529a1kl
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal529a1 by Jim Xia)
...
program ffinal529a1kl
use m
    class (container(4)), pointer :: co1 ! tcx: (4)
    ...
    allocate (child(4,20) :: co1%data) ! tcx: (4,20)
