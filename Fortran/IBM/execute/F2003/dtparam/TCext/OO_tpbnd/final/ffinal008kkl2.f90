...
module m
    ...
    type base (kBase,lBase) ! kBase,lBase=4,20
       integer, kind :: kBase
       integer, len :: lBase
...
! type: base - added parameters (kBase,lBase) to invoke with (4,20) / declare with (4,*) - 1 changes
! type: child - added parameters () to invoke with (4,20) / declare with (4,*) - 2 changes
