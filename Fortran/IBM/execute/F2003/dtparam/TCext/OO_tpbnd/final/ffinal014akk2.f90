...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal014akk2
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal014a by Jim Xia)
...
module m
    ...
    subroutine finalizeChild (c)
        type (child(4)) :: c ! tcx: (4)
        print *, 'finalizeChild', c%id
    end subroutine
end module

program ffinal014akk2
use m
...
! type: child - added parameters (kChild) to invoke with (4) / declare with (4) - 2 changes
