...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal515a2kl
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal515a2 by Jim Xia)
...
use m
    ...
    select case (b1 == base(4) (100)) ! tcx: (4)
        case (.true.)
            print *, 'success'
        case (.false.)
            error stop 2_4
