...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : ffinal514a11kl
!*
!*  PROGRAMMER                 : David Forster (derived from ffinal514a11 by Jim Xia)
...
!    where (c1 == makeData (30, 'c1_static')) c1%id = -30
    call makeTheMask (makeData (30, 'c1_static'))
    where (mask) c1%id = -30
    ...
    subroutine makeTheMask (d)
        type(child(4,*)), intent(in) :: d
