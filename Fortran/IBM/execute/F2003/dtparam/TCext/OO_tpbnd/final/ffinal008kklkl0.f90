...
!*  ===================================================================
!*
!*  TEST CASE NAME             : ffinal008kklkl0
!*
...
module m
    ...
    type base (kBase,lBase) ! kBase,lBase=4,0
       integer, kind :: kBase
       integer, len :: lBase
...
program ffinal008kklkl0
use m
    class (base(4,:)), pointer :: b1, b2(:) ! tcx: (4,:)

    allocate (gen3(4,0,20):: b1, b2(0:1)) ! tcx: (4,0,20)
...
! type: base - added parameters (kBase,lBase) to invoke with (4,0) / declare with (4,*) - 1 changes
! type: child - added parameters (lchild_1) to invoke with (4,0,20) / declare with (4,*,*) - 2 changes
! type: gen3 - added parameters () to invoke with (4,0,20,) / declare with (4,*,*,) - 2 changes
