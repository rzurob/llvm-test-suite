...
! ftcx_dtp -qnol /tstdev/OO_tpbnd/specific/ftpbnd511a.f
! opt variations: -ql
...
module m
    ...
    type (single(4)), pointer, protected :: globalData => null()

    contains

    type (single(4)) function getSingleObj ()
...
program ftpbnd511a
use m
    class (single(4)), pointer :: s1_ptr, s2_ptr
