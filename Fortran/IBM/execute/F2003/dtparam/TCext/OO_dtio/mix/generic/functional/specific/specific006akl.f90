...
!*  ===================================================================
!*
!*  TEST CASE NAME             : specific006akl
!*
!*  PROGRAMMER                 : David Forster (derived from specific006a by Robert Ma)
...
!*                                 - Specific Binding
!*                                    - specific binding referring to a external procedure, for both parent and child types (array variables)
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program specific006akl
   ...
   open ( 1, file = 'specific006akl.1', form='formatted', access='sequential' )
