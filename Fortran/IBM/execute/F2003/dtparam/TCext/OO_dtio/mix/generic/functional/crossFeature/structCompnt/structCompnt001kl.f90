...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structCompnt001kl
!*
!*  PROGRAMMER                 : David Forster (derived from structCompnt001 by Robert Ma)
...
program structCompnt001kl
   ...
   open ( 1, file = 'structCompnt001kl.1', form='formatted', access='sequential' )
