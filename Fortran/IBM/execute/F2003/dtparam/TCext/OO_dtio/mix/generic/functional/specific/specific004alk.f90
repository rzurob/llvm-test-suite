...
!*  ===================================================================
!*
!*  TEST CASE NAME             : specific004alk
!*
!*  PROGRAMMER                 : David Forster (derived from specific004a by Robert Ma)
...
program specific004alk
   ...
   allocate ( g1(2), source = (/ gen3(3,4)( 'Abc', 2001, 2002 ), gen3(3,4)( 'Def', 2003, 2004 ) /) ) ! tcx: (3,4) ! tcx: (3,4)

   open ( 1, file = 'specific004alk.1', form='formatted', access='sequential' )
   ...
   allocate ( c1(2), source = (/ gen3(3,4)( 'Abc', 2001, 2002 ), gen3(3,4)( 'Def', 2003, 2004 ) /) ) ! tcx: (3,4) ! tcx: (3,4)
   ...
   allocate ( b1(2), source = (/ gen3(3,4)( 'Abc', 2001, 2002 ), gen3(3,4)( 'Def', 2003, 2004 ) /) ) ! tcx: (3,4) ! tcx: (3,4)
   ...
   allocate   (gen3(3,4):: g1(2) ) ! tcx: gen3(3,4)
   ...
   allocate ( gen3(3,4) :: c1(2) ) ! tcx: (3,4)
