...
!*  ===================================================================
!*
!*  TEST CASE NAME             : specific008lkk
!*
!*  PROGRAMMER                 : David Forster (derived from specific008 by Robert Ma)
...
program specific008lkk
   ...
   allocate ( b3, source = gen3(3,4,4) ('ghi', 1002, 1003) ) ! tcx: (3,4,4)
   allocate ( c1, source = child(3,4)('ABC', 2001) ) ! tcx: (3,4)
   allocate ( c2, source = gen3(3,4,4) ('DEF', 2002, 2003) ) ! tcx: (3,4,4)
   allocate ( g1, source = gen3(3,4,4) ('GHI', 3001, 3002) ) ! tcx: (3,4,4)

   open ( 1, file = 'specific008lkk.1', form='formatted', access='sequential' )
   ...
   allocate ( gen3(3,4,4) :: b3, c2, g1 ) ! tcx: (3,4,4)
