...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar003allk
!*
!*  PROGRAMMER                 : David Forster (derived from scalar003a by Robert Ma)
...
program scalar003allk
   ...
   open ( 1, file = 'scalar003allk.1', form='unformatted', access='sequential' )
