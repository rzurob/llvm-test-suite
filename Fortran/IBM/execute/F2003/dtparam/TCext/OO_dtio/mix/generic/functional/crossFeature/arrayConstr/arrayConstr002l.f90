!*  ===================================================================
!*
!*  TEST CASE NAME             : arrayConstr002l
!*
...
program arrayConstr002l
   use m

   integer :: stat
   character(200) :: msg

   open ( 1, file = 'arrayConstr002l.1', form='formatted', access='sequential' )
   ...
   write ( 1, "(3(DT(3,5,3)))", iostat = stat, iomsg = msg )    (/ ( gen3(3,4)('FTN',2003,'GRT'),i=4,6 ) /) ! tcx: (3,4)
