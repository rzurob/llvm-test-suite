...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar007akk
!*
!*  PROGRAMMER                 : David Forster (derived from scalar007a by Robert Ma)
...
!*                               adaptation: exposed kinds; inherited kind
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
module m
   ...
   type, extends(base) :: child
      type(data(kbase_1)), allocatable :: s2(:) ! tcx: (8)
      contains
   ...
   contains
      ...
      subroutine writec (dtv, unit, iostat, iomsg)
         class(child(8)), intent(in) :: dtv ! tcx: (8)
         integer, intent(in) :: unit
         integer, intent(out) :: iostat
         character(*), intent(inout) :: iomsg
      ...
      subroutine readc (dtv, unit, iostat, iomsg)
         class(child(8)), intent(inout) :: dtv ! tcx: (8)
         integer, intent(in) :: unit
         integer, intent(out) :: iostat
         character(*), intent(inout) :: iomsg
...
program scalar007akk
   ...
   open ( 1, file = 'scalar007akk.1', form='unformatted', access='sequential' )

   allocate ( b1, source = base(8) (data(8)(101)) ) ! tcx: (8) ! tcx: (8)
   allocate ( b2, source = child(8)(data(8)(201), (/ data(8)(20001), data(8)(20002), data(8)(20003) /) ) ) ! tcx: (8) ! tcx: (8) ! tcx: (8) ! tcx: (8) ! tcx: (8)
   ...
   allocate ( b2, source = child(8)(data(8)(),(/(data(8)(),i=1,3)/)) ) ! tcx: (8) ! tcx: (8) ! tcx: (8)
...
! type: child - added parameters () to invoke with (8) / declare with (8) - 5 changes
