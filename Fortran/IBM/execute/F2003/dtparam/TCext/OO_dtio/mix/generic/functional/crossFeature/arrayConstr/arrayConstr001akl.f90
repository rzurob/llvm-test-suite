...
!*  ===================================================================
!*
!*  TEST CASE NAME             : arrayConstr001akl
!*
!*  PROGRAMMER                 : David Forster (derived from arrayConstr001a by Robert Ma)
!*  DATE                       : 2007-08-01 (original: 04/26/2005)
...
program arrayConstr001akl
   ...
   open ( 1, file = 'arrayConstr001akl.1', form='unformatted', access='sequential' )

   write ( 1, iostat = stat, iomsg = msg )            (/ base(3)(), base(3)(), base(3)() /) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   if ( ( stat /= 0 ) .or. ( msg /= 'dtiowriteb' ) ) error stop 101_4

   write ( 1, iostat = stat, iomsg = msg )          (/ ( child(3,3)(),i=1,3 ) /) ! tcx: (3,3)
   if ( ( stat /= 0 ) .or. ( msg /= 'dtiowritec' ) ) error stop 2_4

   write ( 1, iostat = stat, iomsg = msg )        (/ ( gen3(3,3,3)(),i=4,6 ) /) ! tcx: (3,3,3)
   ...
   write ( 1, iostat = stat, iomsg = msg )        (/ ( child(3,3)('IBM','ibm'), i=1,3 ) /) ! tcx: (3,3)
   if ( ( stat /= 0 ) .or. ( msg /= 'dtiowritec' ) ) error stop 5_4

   write ( 1, iostat = stat, iomsg = msg )            (/ ( gen3(3,3,3)('FTN','ftn','GRT'),i=4,6 ) /) ! tcx: (3,3,3)
...
! type: child - added parameters (lc) to invoke with (3,3) / declare with (*,*) - 3 changes
! type: gen3 - added parameters (lg) to invoke with (3,3,3) / declare with (*,*,*) - 3 changes
