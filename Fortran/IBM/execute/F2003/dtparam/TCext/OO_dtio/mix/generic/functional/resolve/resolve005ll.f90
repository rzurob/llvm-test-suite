...
!*  ===================================================================
!*
!*  TEST CASE NAME             : resolve005ll
!*
!*  PROGRAMMER                 : David Forster (derived from resolve005 by Robert Ma)
...
program resolve005ll
   ...
   open ( 1, file = 'resolve005ll.1', form='formatted', access='sequential' )
