...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structConstr001lk
!*
...
program structConstr001lk
   use m

   integer :: stat
   character(200) :: msg

   open ( 1, file = 'structConstr001lk.1', form='formatted', access='sequential' )
   ...
   write ( 1, "(DT(3,4,3))", iostat = stat, iomsg = msg )    gen3(3,4)() ! tcx: (3,4)
