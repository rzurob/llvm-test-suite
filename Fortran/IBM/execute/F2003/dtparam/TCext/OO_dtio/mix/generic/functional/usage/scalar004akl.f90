...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar004akl
!*
!*  PROGRAMMER                 : David Forster (derived from scalar004a by Robert Ma)
...
program scalar004akl
   ...
   open ( 1, file = 'scalar004akl.1', form='unformatted', access='sequential' )
