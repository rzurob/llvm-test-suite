...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structConstr002akl
!*
!*  PROGRAMMER                 : David Forster (derived from structConstr002a by Robert Ma)
...
module m
   ...
   type, extends(child) :: gen3 (lgen31) ! lgen31=3
      integer, len :: lgen31
      character(lgen31), allocatable :: s
      contains
...
program structConstr002akl
   ...
   open ( 1, file = 'structConstr002akl.1', form='unformatted', access='sequential' )
...
! type: gen3 - added parameters (lgen31) to invoke with (3,4,3) / declare with (*,4,*) - 4 changes
