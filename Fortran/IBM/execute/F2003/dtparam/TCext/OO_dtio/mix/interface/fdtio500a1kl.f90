...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : fdtio500a1kl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtio500a1 by Jim Xia)
...
use m
    ...
    open (1, file='fdtio500a1kl.data', form='unformatted')
