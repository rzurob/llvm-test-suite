...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar006ll
!*
!*  PROGRAMMER                 : David Forster (derived from scalar006 by Robert Ma)
...
!*                                    with formatted I/O
!*                               adaptation: superfluous lengths
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program scalar006ll
   ...
   open ( 1, file = 'scalar006ll.1', form='formatted', access='sequential' )
