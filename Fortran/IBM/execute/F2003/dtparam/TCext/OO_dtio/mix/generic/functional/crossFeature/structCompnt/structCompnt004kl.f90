...
!*                                    -  non-polymorphic structure array component with formatted i/o
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program structCompnt004kl
   ...
   write ( 1, "(5(DT(3)))", iostat = stat, iomsg = msg )     cc1%b1, cc1%b2
   if ( ( stat /= 0 ) .or. ( msg /= 'dtiowriteb' ) )         error stop 1_4

   write ( 1, "(6(DT(4)))", iostat = stat, iomsg = msg )     cc2%b1, cc2%b2
   ...
   read ( 1, "(5(DT(3)))", iostat = stat, iomsg = msg )      cc1%b1, cc1%b2
   ...
   read ( 1, "(6(DT(4)))", iostat = stat, iomsg = msg )      cc2%b1, cc2%b2
