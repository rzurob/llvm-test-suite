...
!*  ===================================================================
!*
!*  TEST CASE NAME             : array006kk
!*
!*  PROGRAMMER                 : David Forster (derived from array006 by Robert Ma)
...
program array006kk
   ...
   open ( 1, file = 'array006kk.1', form='formatted', access='sequential' )

   allocate ( b1(3) )
   allocate ( child(4,2) :: b2(2,2) ) ! tcx: (4,2)
