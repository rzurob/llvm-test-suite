...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar005akl
!*
!*  PROGRAMMER                 : David Forster (derived from scalar005a by Robert Ma)
...
program scalar005akl
   ...
   open ( 1, file = 'scalar005akl.1', form='unformatted', access='sequential' )
