...
program associate001akl
   ...
   open ( 1, file = 'associate001akl.1', form='unformatted', access='stream' )
...
! type: gen3 - added parameters () to invoke with (3,4) / declare with (*,4)! type: base - added parameters (lb) to invoke with (3) / declare with (*) - 10 changes
