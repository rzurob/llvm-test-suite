...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structCompnt005akl
!*
!*  PROGRAMMER                 : David Forster (derived from structCompnt005a by Robert Ma)
...
program structCompnt005akl
   ...
   open ( 1, file = 'structCompnt005akl.1', form='unformatted', access='sequential' )
