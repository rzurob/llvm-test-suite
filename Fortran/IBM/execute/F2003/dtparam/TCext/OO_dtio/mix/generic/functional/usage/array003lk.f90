...
module m
   ...
   type :: container (kcontainter_1) ! kcontainter_1=4
      integer, kind :: kcontainter_1
      integer(kcontainter_1) :: i
...
program array003lk
   ...
   open ( 1, file = 'array003lk.1', form='formatted', access='sequential' )
   ...
   b2  = reshape( source = (/ container(4)(201, child(3)('ABC','abc')), container(4)(202, child(3)('DEF','def')), container(4)(203, child(3)('GHI','ghi')), container(4)(204, child(3)('JKL','jkl')) /), & ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (4) ! tcx: (4) ! tcx: (4) ! tcx: (4)
                                         shape = (/ 2,2 /) )
   ...
   b2 = container(4)(-999,child(3)()) ! tcx: (3) ! tcx: (4)
...
! type: container - added parameters (kcontainter_1) to invoke with (4) / declare with (4) - 12 changes
