...
!*  ===================================================================
!*
!*  TEST CASE NAME             : specific007kl
!*
!*  PROGRAMMER                 : David Forster (derived from specific007 by Robert Ma)
...
program specific007kl
   ...
   open ( 1, file = 'specific007kl.1', form='formatted', access='sequential' )
...
! type: child - added parameters (kchild_1) to invoke with (4) / declare with (4) - 9 changes
! type: base - added parameters (lbase_1) to invoke with (3) / declare with (*) - 4 changes
