...
!*  ===================================================================
!*
!*  TEST CASE NAME             : multipleBinding002kl
!*
!*  PROGRAMMER                 : David Forster (derived from multipleBinding002 by Robert Ma)
...
program multipleBinding002kl
   ...
   open ( 1, file = 'multipleBinding002kl.1', form='formatted', access='sequential' )
   open ( 2, file = 'multipleBinding002kl.2', form='unformatted', access='stream' )
