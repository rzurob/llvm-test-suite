...
program structConstr003lkl
   ...
   open ( 1, file = 'structConstr003lkl.1', form='formatted', access='sequential' )
   ...
   write ( 1, "(DT(3,5,4))", iostat = stat, iomsg = msg )    gen3(3,4,3)('ghi') ! tcx: (3,4,3)
