...
module m
   ...
   type, abstract :: base (lbase_1) ! lbase_1=3
      ...
      contains
         procedure(wbinf), deferred, pass :: mywrite
         procedure(rbinf), deferred, pass :: myread
         generic :: write(unformatted) => mywrite
         generic :: read(unformatted)  => myread
   end type
   ...
   type, extends(base) :: child (kchild_1) ! kchild_1=4
      ...
      contains
         procedure, non_overridable, pass :: mywrite
         procedure, non_overridable, pass :: myread
   end type
...
program specific011lk
   ...
   allocate ( b2, source = gen3(3,4) ( 'def', 1002, 1003 ) ) ! tcx: (3,4)
   allocate ( c1, source = child(3,4) ( 'ghi', 1004 ) ) ! tcx: (3,4)
   allocate ( c2, source = gen3(3,4) ( 'jkl', 1005, 1006 ) ) ! tcx: (3,4)
   allocate ( g1, source = gen3(3,4) ( 'mno', 1007, 1008 ) ) ! tcx: (3,4)
   ...
   allocate ( gen3(3,4)  :: b2, c2, g1 ) ! tcx: (3,4)
