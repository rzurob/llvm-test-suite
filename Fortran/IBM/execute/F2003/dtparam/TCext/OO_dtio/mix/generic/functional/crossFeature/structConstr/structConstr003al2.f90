!*  ===================================================================
!*
!*  TEST CASE NAME             : structConstr003al2
!*
...
module m
   ...
   type, extends(child) :: gen3
      character(lchild1), pointer :: s => null()
      contains
...
program structConstr003al2
   ...
   open ( 1, file = 'structConstr003al2.1', form='unformatted', access='sequential' )
   ...
   write ( 1, iostat = stat, iomsg = msg )    gen3(3,3)('ghi') ! tcx: (3,3)
   ...
   write ( 1, iostat = stat, iomsg = msg )      gen3(3,3)('mno', bbb, zoo ) ! tcx: (3,3)
   if ( ( stat /= 0 ) .or. ( msg /= 'dtiowriteg' ) )         error stop 5_4

   write ( 1, iostat = stat, iomsg = msg )    ( child(3,3) (zoo,aaa), gen3(3,3)('cat',bbb, zoo),i=-1,1 ) ! tcx: (3,3) ! tcx: (3,3)
...
! type: gen3 - added parameters () to invoke with (3,3) / declare with (*,*) - 4 changes
