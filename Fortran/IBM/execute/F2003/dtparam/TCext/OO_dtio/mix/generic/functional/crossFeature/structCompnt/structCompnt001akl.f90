...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structCompnt001akl
!*
!*  PROGRAMMER                 : David Forster (derived from structCompnt001a by Robert Ma)
...
program structCompnt001akl
   ...
   open ( 1, file = 'structCompnt001akl.1', form='unformatted', access='sequential' )

   allocate ( g1, source = gen3(3,4,3)('def', 100002, 'ghi') ) ! tcx: (3,4,3)
   ...
   deallocate ( g1 )
   allocate (gen3(3,4,3):: g1 ) ! tcx: gen3(3,4,3)
...
! type: gen3 - added parameters (lgen31) to invoke with (3,4,3) / declare with (*,4,*) - 2 changes
