...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structConstr001akl
!*
!*  PROGRAMMER                 : David Forster (derived from structConstr001a by Robert Ma)
...
program structConstr001akl
   ...
   type(gen3(3,4,3))  :: g1 ! tcx: (3,4,3)

   open ( 1, file = 'structConstr001akl.1', form='unformatted', access='sequential' )
   ...
   write ( 1, iostat = stat, iomsg = msg )        gen3(3,4,3)() ! tcx: (3,4,3)
   ...
   write ( 1, iostat = stat, iomsg = msg )        gen3(3,4,3)('ghi',10002,'jkl') ! tcx: (3,4,3)
...
! type: gen3 - added parameters (lgen31) to invoke with (3,4,3) / declare with (*,4,*) - 5 changes
