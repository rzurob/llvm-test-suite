...
!*  ===================================================================
!*
!*  TEST CASE NAME             : array006akl
!*
!*  PROGRAMMER                 : David Forster (derived from array006a by Robert Ma)
...
program array006akl
   ...
   open ( 1, file = 'array006akl.1', form='unformatted', access='sequential' )
   ...
   if ( ( stat /= 0 ) .or. ( msg /= 'dtiowriteb' ) .or. ( idx /= 4 ) ) error stop 101_4
