...
!*  ===================================================================
!*
!*  TEST CASE NAME             : extend001lk
!*
!*  PROGRAMMER                 : David Forster (derived from extend001 by Robert Ma)
...
!*                               adaptation: exposed kind, length; inherited kind
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program extend001lk
   ...
   type ( gen3(3,4) )  :: g2 = gen3(3,4)  ( 'dEf', 302, 312 ) ! tcx: (3,4) ! tcx: (3,4)
   ...
   open ( 101, file = 'extend001lk.1', form='formatted', access='sequential' )

   allocate ( b1, source = base(3) ('abc') ) ! tcx: (3)
   allocate ( c1, source = child(3,4)('ABC', 201 ) ) ! tcx: (3,4)
   allocate ( g1, source = gen3(3,4) ('aBc', 301, 311  ) ) ! tcx: (3,4)
   ...
   allocate ( c1, source = gen3(3,4) ( 'gHi', 303, 313 ) ) ! tcx: (3,4)
   ...
   allocate ( b1, source = gen3(3,4) ( 'GHI', 304, 314 ) ) ! tcx: (3,4)
...
! type: gen3 - added parameters () to invoke with (3,4) / declare with (*,4) - 7 changes
