...
!*  ===================================================================
!*
!*  TEST CASE NAME             : specific004lk
!*
!*  PROGRAMMER                 : David Forster (derived from specific004 by Robert Ma)
...
program specific004lk
   ...
   open ( 1, file = 'specific004lk.1', form='formatted', access='sequential' )
   ...
   allocate ( c1, source = gen3(3,4)  ( 'mno', 3003, 3004 ) ) ! tcx: (3,4)
   ...
   allocate ( b1, source = gen3(3,4) ( 'pqr', 3005, 3006 ) ) ! tcx: (3,4)
   write ( 1, "(DT)", iostat = stat, iomsg = msg )  b1
...
! type: gen3 - added parameters () to invoke with (3,4) / declare with (*,4) - 10 changes
