...
!*  ===================================================================
!*
!*  TEST CASE NAME             : resolve005al
!*
!*  PROGRAMMER                 : David Forster (derived from resolve005a by Robert Ma)
...
!*                                        - for unformatted I/O, inside generic dtio procedure define a dtio interface and invoke
...
program resolve005al
   ...
   open ( 1, file = 'resolve005al.1', form='unformatted', access='sequential' )
