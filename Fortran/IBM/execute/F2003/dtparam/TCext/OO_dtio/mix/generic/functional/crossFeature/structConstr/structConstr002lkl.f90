...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structConstr002lkl
!*
!*  PROGRAMMER                 : David Forster (derived from structConstr002 by Robert Ma)
...
program structConstr002lkl
   use m

   integer :: stat
   character(200) :: msg

   open ( 1, file = 'structConstr002lkl.1', form='formatted', access='sequential' )
