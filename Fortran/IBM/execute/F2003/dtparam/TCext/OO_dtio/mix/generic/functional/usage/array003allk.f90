...
!*                               adaptation: superfluous kind, exposed lengths
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program array003allk
   ...
   open ( 1, file = 'array003allk.1', form='unformatted', access='sequential' )
   ...
   b2 = reshape( source = (/ container(4)(201, child(3,3)('ABC','abc')), container(4)(202, child(3,3)('DEF','def')), & ! tcx: (3,3) ! tcx: (3,3) ! tcx: (4) ! tcx: (4)
                             container(4)(203, child(3,3)('GHI','ghi')), container(4)(204, child(3,3)('JKL','jkl')) /), shape = (/ 2,2 /) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (4) ! tcx: (4)
...
! type: container - added parameters () to invoke with () / declare with () - 12 changes
