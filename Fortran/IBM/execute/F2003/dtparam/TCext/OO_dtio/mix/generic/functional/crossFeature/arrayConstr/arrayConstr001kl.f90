...
program arrayConstr001kl
   ...
   write ( 1, "(3(DT(3,4,3)))", iostat = stat, iomsg = msg )        (/ ( gen3(3,4,3)(),i=4,6 ) /) ! tcx: (3,4,3)
   ...
   write ( 1, "(3(DT(4,4,4)))", iostat = stat, iomsg = msg )            (/ ( gen3(3,4,3)('FTN',2003,'GRT'),i=4,6 ) /) ! tcx: (3,4,3)
...
! type: gen3 - added parameters (lg) to invoke with (3,4,3) / declare with (*,4,*) - 3 changes
