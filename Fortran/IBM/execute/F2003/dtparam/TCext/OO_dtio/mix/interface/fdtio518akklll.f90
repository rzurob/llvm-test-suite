...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : fdtio518akklll
!*
!*  PROGRAMMER                 : David Forster (derived from fdtio518a by Jim Xia)
...
module n
use m
    type dataType (kdataType_1,kdataType_2,ldataType_1,ldataType_2,ldataType_3) ! kdataType_1,kdataType_2,ldataType_1,ldataType_2,ldataType_3=4,4,0,1,2
...
program fdtio518akklll
use m
use n
    type (dataType(4,4,0,1,2)) :: d1(2) ! tcx: (4,4,0,1,2)
...
! type: dataType - added parameters (kdataType_1,kdataType_2,ldataType_1,ldataType_2,ldataType_3) to invoke with (4,4,0,1,2) / declare with (4,4,*,*,*) - 1 changes
