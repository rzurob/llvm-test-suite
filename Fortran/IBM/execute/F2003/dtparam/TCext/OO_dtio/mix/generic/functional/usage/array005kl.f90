...
!*
!*  PROGRAMMER                 : David Forster (derived from array005 by Robert Ma)
...
!*                                    with formatted I/O with io-implied-do
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
program array005kl
   ...
   write ( 1, "(4(DT))", iostat = stat, iomsg = msg )         (c1(1,i),c1(2,i),i=1,2)
   ...
   read ( 1,  "(3(1X,DT))", iostat = stat, iomsg = msg )      (b1(j), j = 3,1,-1)
   if ( ( stat /= 0 ) .or. ( msg /= 'dtioreadb' ) )           error stop 3_4
   if ( ( b1(1)%c /= 'ghi' ) .or. &
        ( b1(2)%c /= 'def' ) .or. &
        ( b1(3)%c /= 'abc' ) )                                error stop 4_4

   read ( 1, "(4(DT))", iostat = stat, iomsg = msg )          (c1(1,i),c1(2,i),i=1,2)
