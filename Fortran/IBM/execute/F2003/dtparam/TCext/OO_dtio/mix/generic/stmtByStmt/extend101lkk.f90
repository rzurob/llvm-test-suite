...
!*  ===================================================================
!*
!*  TEST CASE NAME             : extend101lkk
!*
!*  PROGRAMMER                 : David Forster (derived from extend101 by Robert Ma)
...
program extend101lkk
   ...
   type ( gen3(3,4,4) )  :: g2 = gen3(3,4,4)  () ! tcx: (3,4,4) ! tcx: (3,4,4)
   ...
   open ( 101, file = 'extend101lkk.1', form='formatted', access='sequential' )

   allocate ( b1, source = base(3) () ) ! tcx: (3)
   allocate ( c1, source = child(3,4)() ) ! tcx: (3,4)
   allocate ( g1, source = gen3(3,4,4) ( ) ) ! tcx: (3,4,4)
...
! type: gen3 - added parameters (kgen3_1) to invoke with (3,4,4) / declare with (*,4,4) - 8 changes
