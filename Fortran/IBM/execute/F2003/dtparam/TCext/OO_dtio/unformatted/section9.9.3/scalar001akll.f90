...
program scalar001akll
   ...
   open ( u1%get(), file = 'scalar001akll.data', form='unformatted', access='sequential' )   !<- open a external file with unit #2
...
! type: base - added parameters (lbase) to invoke with (0) / declare with (*) - 9 changes
