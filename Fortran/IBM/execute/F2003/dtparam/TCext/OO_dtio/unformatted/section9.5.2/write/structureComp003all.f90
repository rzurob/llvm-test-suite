...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structureComp003all
!*
!*  PROGRAMMER                 : David Forster (derived from structureComp003a by Robert Ma)
...
program structureComp003all
   ...
   allocate ( b11(3), source = (/ container(3)( b1=child(3)('abc','ABC'), b2=child(3)('def','DEF') ),  & ! tcx: (3) ! tcx: (3) ! tcx: (3)
                                  container(3)( b1=child(3)('ghi','GHI'), b2=child(3)('jkl','JKL') ),  &  ! tcx: (3) ! tcx: (3) ! tcx: (3)
                                  container(3)( b1=child(3)('mno','MNO'), b2=child(3)('pqr','PQR') )   /) ) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   
   allocate ( b12(2,2), source = reshape ( source = (/ container(3)( b1=child(3)('abc','ABC'), b2=child(3)('def','DEF') ),      & ! tcx: (3) ! tcx: (3) ! tcx: (3)
                                                       container(3)( b1=child(3)('ghi','GHI'), b2=child(3)('jkl','JKL') ),      &  ! tcx: (3) ! tcx: (3) ! tcx: (3)
                                                       container(3)( b1=child(3)('mno','MNO'), b2=child(3)('pqr','PQR') ),      &  ! tcx: (3) ! tcx: (3) ! tcx: (3)
                                                       container(3)( b1=child(3)('stu','STU'), b2=child(3)('vwx','VWX') )   /), & ! tcx: (3) ! tcx: (3) ! tcx: (3)
                                                       shape = (/2,2/) ) )
   
   b13 = (/ container(3)( b1=child(3)('abc','ABC'), b2=child(3)('def','DEF') ),  & ! tcx: (3) ! tcx: (3) ! tcx: (3)
            container(3)( b1=child(3)('ghi','GHI'), b2=child(3)('jkl','JKL') ),  &  ! tcx: (3) ! tcx: (3) ! tcx: (3)
            container(3)( b1=child(3)('mno','MNO'), b2=child(3)('pqr','PQR') )   /) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   
   open (unit = 1, file ='structureComp003all.data', form='unformatted', access='stream')
...
! type: child - added parameters () to invoke with (3) / declare with (*) - 23 changes
