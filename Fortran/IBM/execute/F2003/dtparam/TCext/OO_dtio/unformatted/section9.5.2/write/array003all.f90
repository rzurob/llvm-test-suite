...
program array003all
   ...
   allocate ( base(0) :: b1(2), b2(2,2) ) ! tcx: (0)
   ...
   open (unit = 1, file ='array003all.data', form='unformatted', access='sequential')
...
! type: base - added parameters (lbase) to invoke with (0) / declare with (*) - 7 changes
