...
program structureComp003lll
   ...
   allocate ( b11, source = container(3)( b2=child(3,3)('def','ghi'), b1=child(3,3)('abc','def') ) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
   allocate ( b12, source = container(3)( b2=child(3,3)('DEF','EFG'), b1=child(3,3)('ABC','DEF') ) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
   b13 = container(3)( b2=child(3,3)('JKL','MNO'), b1=child(3,3)('GHI','JKL') ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
   
   open (unit = 1, file ='structureComp003lll.data', form='unformatted', access='direct', recl=30)
   ...
   write (1, iostat=stat, iomsg=msg, rec=3 )             container(3)( b2=child(3,3)('jkl','mno'), b1=child(3,3)('ghi','jkl') )  !<- write 'ghijklZjklmnoZY' to file ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
