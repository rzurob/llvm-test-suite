...
!*  ===================================================================
!*
!*  TEST CASE NAME             : pos001l
!*
!*  PROGRAMMER                 : David Forster (derived from pos001 by Robert Ma)
...
program pos001l
   ...
   open ( 1, file = 'pos001l.data', form='unformatted', access='stream' )
