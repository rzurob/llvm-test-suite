...
!*  ===================================================================
!*
!*  TEST CASE NAME             : exist001l
!*
!*  PROGRAMMER                 : David Forster (derived from exist001 by Robert Ma)
...
program exist001l
   ...
   if ( doExist(myunit) /= 'exist' )   error stop 101_4   !<- unit 2 exists
   
   if ( doExist(-10)     /= 'DNE' )     error stop 2_4   !<- unit -10 does not exist
   
   open (myunit, file='exist001l.data', form='unformatted', access='direct', recl=3 )
