...
!*  ===================================================================
!*
!*  TEST CASE NAME             : form001l
!*
!*  PROGRAMMER                 : David Forster (derived from form001 by Robert Ma)
...
program form001l
   ...
   if ( getForm(myunit1) /= 'aUNDEFINED' ) error stop 1_4
   if ( getForm(myunit2) /= 'aUNDEFINED' ) error stop 2_4
   if ( getForm(myunit3) /= 'aUNDEFINED' ) error stop 3_4
   
   open (myunit1, file='form001l.1', form='unformatted')
   open (myunit2, file='form001l.2', access='direct', recl=3)
   open (myunit3, file='form001l.3', form='unformatted', access='stream' )
