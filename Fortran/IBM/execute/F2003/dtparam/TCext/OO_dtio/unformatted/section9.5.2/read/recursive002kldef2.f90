...
!*  ===================================================================
!*
!*  TEST CASE NAME             : recursive002kldef2
!*
...
module m
   ...
   type :: base (lbase_1) ! lbase_1=3
      integer, len :: lbase_1
      class(base(lbase_1)), pointer :: next => null() ! tcx: (:)
...
program recursive002kldef2
   ...
   open (1, file = 'recursive002kldef2.1', form='unformatted', access='sequential' )
