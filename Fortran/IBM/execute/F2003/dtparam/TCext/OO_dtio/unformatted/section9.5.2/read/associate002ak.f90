...
program associate002ak
   ...
   allocate ( base(4) :: b1(2,2), b2(3) ) ! tcx: (4)
   ...
   open (unit = 1, file ='associate002ak.data', form='unformatted', access='sequential')
...
! type: base - added parameters (kbase) to invoke with (4) / declare with (4) - 16 changes
