...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structureComp003ll
!*
...
program structureComp003ll
   ...
   allocate ( b11, source = container(3)( b2=child(3)('xxx','xxx'), b1=child(3)('xxx','xxx') ) ) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   allocate ( b12, source = container(3)( b2=child(3)('xxx','xxx'), b1=child(3)('xxx','xxx') ) ) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   b13 = container(3)( b2=child(3)('xxx','xxx'), b1=child(3)('xxx','xxx') ) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   
   open (unit = 1, file ='structureComp003ll.data', form='unformatted', access='direct', recl= 20)
