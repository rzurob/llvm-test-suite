...
!*  ===================================================================
!*
!*  TEST CASE NAME             : zerosized002all
!*
...
use m
   ...
   allocate (emptybase(0):: e1(2,2), e2(5) ) ! tcx: emptybase(0)
   allocate (nonemptybase(1):: n1(0), n2(0,0) ) ! tcx: nonemptybase(1)

   open(1, file='zerosized002all.data', access='sequential', form='unformatted')
...
! type: emptybase - added parameters (leb) to invoke with (0) / declare with (*) - 5 changes
