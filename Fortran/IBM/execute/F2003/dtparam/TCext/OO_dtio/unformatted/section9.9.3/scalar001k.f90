...
program scalar001k
   ...
   allocate ( b1, source = base(4)(x=1.0,y=2.0) ) ! tcx: (4)
   allocate ( b2, source = base(4)(x=3.0,y=4.0) ) ! tcx: (4)
   b3       =    base(4)(5.0, 6.0) ! tcx: (4)

   ! I/O operations

   open ( u1%get(), file = 'scalar001k.data', form='unformatted', access='sequential' )   !<- open a external file with unit #2
