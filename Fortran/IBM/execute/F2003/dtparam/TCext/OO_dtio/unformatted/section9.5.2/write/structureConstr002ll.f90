...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structureConstr002ll
!*
...
program structureConstr002ll
   ...
   open (unit = 1, file ='structureConstr002ll.data', form='unformatted', access='sequential')
   
   ! I/O operations
   
   write (1, iostat=stat, iomsg=msg )      child(3,4)(c1='ibm',c2='xlfo' ) ! tcx: (3,4)
...
! type: child - added parameters (lchild_1) to invoke with (3,4) / declare with (*,*) - 3 changes
