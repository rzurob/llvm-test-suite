...
program stream001k
   ...
   allocate ( b1, source = child(4)(x=1.0,y=2.0) ) ! tcx: (4)
   allocate ( b2, source = child(4)(x=3.0,y=4.0) ) ! tcx: (4)
   ...
   open ( u1%get(), file = 'stream001k.data', form='unformatted', access='stream' )   !<- open a external file with unit #2
