...
!*  ===================================================================
!*
!*  TEST CASE NAME             : recursive002lkk
!*
...
program recursive002lkk
   ...
   open (1, file = 'recursive002lkk.1', form='unformatted', access='stream' )
...
! type: linkedlist - added parameters (ll) to invoke with (1) / declare with (1) - 3 changes
