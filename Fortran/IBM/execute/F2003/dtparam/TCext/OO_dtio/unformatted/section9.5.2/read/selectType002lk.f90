...
program selectType002lk
   ...
   allocate ( b2, source = child(3)() ) ! tcx: (3)
   allocate ( b3, source = gen3(3,4) () ) ! tcx: (3,4)

   allocate ( c1, source = child(3)() ) ! tcx: (3)
   allocate ( c2, source = gen3(3,4)() ) ! tcx: (3,4)

   allocate ( g1, source = gen3(3,4)() ) ! tcx: (3,4)
   allocate ( g2, source = gen3(3,4)() ) ! tcx: (3,4)
...
! type: gen3 - added parameters (kgen3_1) to invoke with (3,4) / declare with (*,4) - 9 changes
