...
program array001al
   ...
   allocate ( b1(4), source = (/ child(3)('xxx','XXX'), child(3)('xxx','XXX'), child(3)('xxx','XXX'), child(3)('xxx','XXX') /) ) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   allocate ( b2(2,2), source = reshape (source = (/ child(3)('XXX','xxx'), child(3)('XXX','xxx'), child(3)('XXX','xxx'), child(3)('XXX','xxx')  /), shape=(/2,2/) ) ) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   allocate ( b3(4), source = (/ child(3)('xxx', 'XXX'), child(3)('xxx', 'XXX'), child(3)('xxx', 'XXX'), child(3)('xxx','XXX') /) ) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   allocate ( b4(2,2), source = reshape (source = (/ child(3)('xxx', 'xxx'), child(3)('xxx','xxx'), child(3)('xxx', 'xxx'), child(3)('xxx','xxx')  /), shape=(/2,2/) ) ) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3)
...
! type: child - added parameters () to invoke with (3) / declare with (*) - 20 changes
