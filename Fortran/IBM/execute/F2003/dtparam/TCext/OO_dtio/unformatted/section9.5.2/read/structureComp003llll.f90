...
program structureComp003llll
   ...
   type (container(3,3))               :: b13 ! tcx: (3,3)
   integer :: stat
   character(200) :: msg
   
   ! allocation of variables
   allocate ( b11, source = container(3,3)( b2=child(3,3)('xxx','xxx'), b1=child(3,3)('xxx','xxx') ) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3,3)
   allocate ( b12, source = container(3,3)( b2=child(3,3)('xxx','xxx'), b1=child(3,3)('xxx','xxx') ) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3,3)
   b13 = container(3,3)( b2=child(3,3)('xxx','xxx'), b1=child(3,3)('xxx','xxx') ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3,3)
   
   open (unit = 1, file ='structureComp003llll.data', form='unformatted', access='direct', recl= 20)
...
! type: container - added parameters (lcontainer_1,lcontainer_2) to invoke with (3,3) / declare with (*,*) - 8 changes
