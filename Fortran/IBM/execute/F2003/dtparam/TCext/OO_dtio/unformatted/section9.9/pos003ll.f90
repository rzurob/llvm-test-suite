...
program pos003ll
   ...
   allocate ( b1, source = child(0,0)() ) ! tcx: (0,0)
   allocate ( b2, source = child(0,0)() ) ! tcx: (0,0)
   
   ! I/O operations
   
   
   open ( 1, file = 'pos003ll.data', form='unformatted', access='stream' )
...
! type: child - added parameters (lchild) to invoke with (0,0) / declare with (*,*) - 4 changes
