...
!*  ===================================================================
!*
!*  TEST CASE NAME             : nextrec001l
!*
!*  PROGRAMMER                 : David Forster (derived from nextrec001 by Robert Ma)
!*  DATE                       : 2007-10-01 (original: 11/08/2004)
...
program nextrec001l
   ...
   if ( getNextrec(myunit1) /= -999999 )        error stop 101_4
   ...
   open (myunit1, file='nextrec001l.1', form='unformatted')
   open (myunit2, access='direct', recl=3)                     !<- by default, this will open file named fort.1
   open (myunit3, file='nextrec001l.3', form='unformatted', access='stream' )
   ...
   if ( getNextrecByFile('nextrec001l.1') /= -999999 )   error stop 10_4  !<- not connected for direct access 
   if ( getNextrecByFile('fort.2') /= 1 )               error stop 11_4  !<- initially file should have pos 1
   if ( getNextrecByFile('nextrec001l.3') /= -999999 )   error stop 12_4  !<- not connected for direct access 
