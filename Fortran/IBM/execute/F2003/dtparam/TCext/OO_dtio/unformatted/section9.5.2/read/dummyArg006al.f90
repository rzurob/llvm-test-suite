...
program dummyArg006al
   ...
   allocate(child(3):: c1, c2 ) ! tcx: child(3)

   cc1 = 'ABCabcdef'
   cc2 = 'DEFghijkl'

   open (unit = 1, file ='dummyArg006al.data', form='unformatted', access='sequential')
...
! type: child - added parameters () to invoke with (3) / declare with (lbase_1) - 5 changes
