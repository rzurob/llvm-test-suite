...
program scalar002klk
   ...
   allocate ( b2, source = child(4,8,3,8,2)(x=3,y=4.0,z='ftn', a=5, b=6.0, c=(7.0,8.0)) ) ! tcx: (4,8,3,8,2)
   allocate (base(4,8,3):: b3, b4 ) ! tcx: base(4,8,3)
   
   ! I/O operations   
   
   open ( u1%get(), file = 'scalar002klk.data', form='unformatted', access='sequential' )   !<- open a external file with unit #2
...
! type: child - added parameters (kchild_1,kchild_2) to invoke with (4,8,3,8,2) / declare with (4,8,*,8,2) - 4 changes
