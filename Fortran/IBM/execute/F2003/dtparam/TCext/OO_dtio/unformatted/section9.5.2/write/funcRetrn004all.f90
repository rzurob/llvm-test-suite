...
!*  ===================================================================
!*
!*  TEST CASE NAME             : funcRetrn004all
!*
...
contains
   ...
   function getNewChild(c)
      type(child(3,3)) :: getNewChild(3) ! tcx: (3,3)
      character(6) :: c
...
program funcRetrn004all
   ...
   open (unit = 1, file ='funcRetrn004all.data', form='unformatted', access='sequential')
...
function getNewChildAlloc(c)
   ...
   type(child(:,:)), allocatable :: getNewChildAlloc(:) ! tcx: (:,:)
   character(6) :: c
   allocate(getNewChildAlloc(2), source = (/ child(3,3)(c(1:3),c(4:6)), child(3,3)(c(4:6),c(1:3)) /) ) ! tcx: (3,3) ! tcx: (3,3)
 end function


! Extensions to introduce derived type parameters:
! type: base - added parameters (lbase_1) to invoke with (3) / declare with (*) - 9 changes
! type: child - added parameters (lchild_1) to invoke with (3,3) / declare with (*,*) - 7 changes
