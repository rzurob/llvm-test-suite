...
!*
!*  PROGRAMMER                 : David Forster (derived from structureComp002 by Robert Ma)
...
! type: container - added parameters (kcontainer_1) to invoke with (4) / declare with (4) - 6 changes
