...
module m1
   ...
   type, extends(base) :: child (lchild_1) ! lchild_1=2
      integer, len :: lchild_1
      character(lchild_1) :: c1 = ''
   end type

end module


program pointer001a1ll
   use m1
   ...
   allocate ( b3(4),   source = (/ child(2,2)('ab','AB'), child(2,2)('cd','CD'), child(2,2)('ef','EF'), child(2,2)('gh','GH') /)) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2)
   allocate ( b4(2,2), source = reshape( source = (/ child(2,2)('ij','IJ'), child(2,2)('kl','KL'), child(2,2)('mn','MN'), child(2,2)('op','OP') /), shape=(/2,2/) ) ) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2)
   allocate ( b5(4),   source = (/ child(2,2)('AB','ab'), child(2,2)('CD','cd'), child(2,2)('EF','ef'), child(2,2)('GH','gh') /)) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2)
   allocate ( b6(2,2), source = reshape( source = (/ child(2,2)('IJ','ij'), child(2,2)('KL','kl'), child(2,2)('MN','mn'), child(2,2)('OP','op') /), shape=(/2,2/) ) ) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2) ! tcx: (2,2)


   open (unit = 1, file ='pointer001a1ll.data', form='unformatted', access='sequential')
...
! type: child - added parameters (lchild_1) to invoke with (2,2) / declare with (*,*) - 19 changes
