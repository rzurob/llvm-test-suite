...
program pos002lk
   ...
   allocate ( b2, source = gen3(3,4)( 'def', 102 ) ) ! tcx: (3,4)
   allocate ( b3, source = gen3(3,4)( 'ghi', 103 ) ) ! tcx: (3,4)
   allocate ( b4(2,2), source = reshape ( source=(/ b2, b3, b2, b3 /), shape=(/2,2/) ) )

   ! I/O operations

   open ( 1, file = 'pos002lk.data', form='unformatted', access='stream' )
