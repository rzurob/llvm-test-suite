...
!*  ===================================================================
!*
!*  TEST CASE NAME             : funcRetrn003all
!*
...
program funcRetrn003all
   ...
   allocate(b3(4:5), source = (/ child(3,3)('mno','pqr'), child(3,3)('stu','vwx') /)) ! tcx: (3,3) ! tcx: (3,3)

   open (unit = 1, file ='funcRetrn003all.data', form='unformatted', access='sequential')
