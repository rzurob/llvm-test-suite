...
program selectType002allk
   ...
   allocate ( b2(3)   , source = (/ child(3,3)('abc','def'), child(3,3)(), child(3,3)('ghi', 'jkl') /) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3,3)
   allocate ( b3(2,2) , source = reshape( source = (/ gen3(3,3,4) ('ABC','DEF', 101 ),   & ! tcx: (3,3,4)
   gen3(3,3,4) ('GHI','JKL', 102 ), gen3(3,3,4) ('MNO','PQR', 103 ), gen3(3,3,4) ('STU','VWX', 104 ) /), shape = (/2,2/) ) ) ! tcx: (3,3,4) ! tcx: (3,3,4) ! tcx: (3,3,4)

   allocate ( c1(2), source = (/ child(3,3)('ABC','DEF'), child(3,3)('GHI', 'JKL') /) ) ! tcx: (3,3) ! tcx: (3,3)
   allocate ( c2(2,2), source = reshape( source = (/ gen3(3,3,4) ('abc','def', 201 ),   & ! tcx: (3,3,4)
   gen3(3,3,4) ('ghi','jkl', 202 ), gen3(3,3,4) ('mno','pqr', 203 ), gen3(3,3,4) ('stu','vwx', 204 ) /), shape = (/2,2/) ) ) ! tcx: (3,3,4) ! tcx: (3,3,4) ! tcx: (3,3,4)

   allocate ( g1(2), source = (/ gen3(3,3,4)('ABc','DEf', 301), gen3(3,3,4)('GHi','JKl', 302) /)) ! tcx: (3,3,4) ! tcx: (3,3,4)
...
! type: gen3 - added parameters (kgen3_1) to invoke with (3,3,4) / declare with (*,*,4) - 12 changes
