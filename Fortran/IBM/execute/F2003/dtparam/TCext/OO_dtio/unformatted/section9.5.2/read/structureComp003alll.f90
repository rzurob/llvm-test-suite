...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structureComp003alll
!*
...
program structureComp003alll
   ...
   allocate ( b11(3), source = (/ container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') ),  & ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
                                  container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') ),  &  ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
                                  container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') )   /) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
   
   allocate ( b12(2,2), source = reshape ( source = (/ container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') ),      & ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
                                                       container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') ),      &  ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
                                                       container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') ),      &  ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
                                                       container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') )   /), & ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
                                                       shape = (/2,2/) ) )
   
   b13 = (/ container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') ),  & ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
            container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') ),  &  ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
            container(3)( b1=child(3,3)('xxx','xxx'), b2=child(3,3)('xxx','xxx') )   /) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3)
