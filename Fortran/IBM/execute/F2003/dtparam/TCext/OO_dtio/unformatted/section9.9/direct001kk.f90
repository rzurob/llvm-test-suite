...
!*  ===================================================================
!*
!*  TEST CASE NAME             : direct001kk
!*
!*  PROGRAMMER                 : David Forster (derived from direct001 by Robert Ma)
...
program direct001kk
   ...
   open ( u1%get(), file = 'direct001kk.data', form='unformatted', access='direct', recl= iolength1)   !<- open a external file with unit #2
