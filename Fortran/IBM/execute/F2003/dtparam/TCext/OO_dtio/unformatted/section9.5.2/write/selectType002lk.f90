...
program selectType002lk
   ...
   allocate ( b3, source = gen3(3,4) ('jkl','mno', 101 ) ) ! tcx: (3,4)

   allocate ( c1, source = child(3)('ABC', 'DEF') ) ! tcx: (3)
   allocate ( c2, source = gen3(3,4)('GHI', 'JKL', 201 ) ) ! tcx: (3,4)

   allocate ( g1, source = gen3(3,4)('ABc','DEf', 301) ) ! tcx: (3,4)
   allocate ( g2, source = gen3(3,4)('GHi','JKl', 302) ) ! tcx: (3,4)

   open (unit = 1, file ='selectType002lk.data', form='unformatted', access='sequential')
...
! type: gen3 - added parameters (kgen3_1) to invoke with (3,4) / declare with (*,4) - 7 changes
