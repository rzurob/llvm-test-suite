...
!*  TEST CASE NAME             : end001kk
!*
!*  PROGRAMMER                 : David Forster (derived from end001k by David Forster (derived from end001 by Robert Ma))
!*  DATE                       : 2007-09-10 (original: 2007-09-10 (original: 11/08/2004))
...
!*
!*  DRIVER STANZA              : xlf2003 (original: xlf2003 (original: xlf95))
!*
...
program end001kk
   ...
   open (unit = 1, file ='end001kk.1', form='unformatted', access='sequential')
   open (unit = 3, file ='end001kk.3', form='unformatted', access='stream')   
