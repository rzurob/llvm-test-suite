...
program array002kl
   ...
   open (1, file = 'array002kl.1', form='unformatted', access='sequential' )

   allocate(base(4,3,2)::b1(2), b2(3), b4(2,2)) ! tcx: base(4,3,2)
...
! type: base - added parameters (kbase_1,lbase_1,lbase_2) to invoke with (4,3,2) / declare with (4,*,*) - 6 changes
