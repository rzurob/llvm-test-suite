...
program array001al
   ...
   allocate ( b1(4), source = (/ child(3)('abc','ABC'), child(3)('def','DEF'), child(3)('ghi','GHI'), child(3)('jkl','JKL') /) ) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   ...
   allocate ( b3(4), source = (/ child(3)('mno', 'MNO'), child(3)('pqr', 'PQR'), child(3)('stu', 'STU'), child(3)('vwx','VWX') /) ) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   allocate ( b4(2,2), source = reshape (source = (/ child(3)('MNO', 'mno'), child(3)('PQR','pqr'), child(3)('STU', 'stu'), child(3)('VWX','vwx')  /), shape=(/2,2/) ) ) ! tcx: (3) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   
   open (unit = 1, file ='array001al.data', form='unformatted', recl=50, access='direct')
...
! type: child - added parameters () to invoke with (3) / declare with (*) - 19 changes
