...
!*  ===================================================================
!*
!*  TEST CASE NAME             : recl001l
!*
!*  PROGRAMMER                 : David Forster (derived from recl001 by Robert Ma)
...
program recl001l
   ...
   allocate (base(3)::b1,b2,b3) ! tcx: base(3)
   ...
   open (myunit1, file='recl001l.1', form='unformatted', access='sequential'     )
   open (myunit2, file='recl001l.2', form='unformatted', access='direct', recl=3 )
   
   if ( getRecl(myunit1) /= 2147483639 )          error stop 101_4
   if ( getRecl('recl001l.2') /= 3 )               error stop 2_4
