...
program selectType001l
   ...
   allocate ( b1, source = child(3)('xxx', 'xxx') ) ! tcx: (3)
   allocate ( b2, source = child(3)('xxx','xxx') ) ! tcx: (3)
   allocate ( b3, source = base(3)('xxx') ) ! tcx: (3)

   open (unit = 1, file ='selectType001l.data', form='unformatted', access='direct', recl = 6)
