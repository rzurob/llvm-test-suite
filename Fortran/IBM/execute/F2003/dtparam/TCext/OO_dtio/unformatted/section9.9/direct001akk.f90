...
!*  ===================================================================
!*
!*  TEST CASE NAME             : direct001akk
!*
!*  PROGRAMMER                 : David Forster (derived from direct001a by Robert Ma)
!*  DATE                       : 2007-09-20 (original: 11/08/2004)
...
program direct001akk
   ...
   open ( u1%get(), file = 'direct001akk.data', form='unformatted')   !<- open a external file with unit #2 (default is sequential access)
