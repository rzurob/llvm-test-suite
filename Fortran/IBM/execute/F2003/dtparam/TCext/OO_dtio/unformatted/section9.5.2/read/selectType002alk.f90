...
!*  ===================================================================
!*
!*  TEST CASE NAME             : selectType002alk
!*
...
program selectType002alk
   ...
   allocate ( b2(3)   , source = (/ child(3)(), child(3)(), child(3)() /) ) ! tcx: (3) ! tcx: (3) ! tcx: (3)
   allocate ( b3(2,2) , source = reshape( source = (/ gen3(3,4)(), gen3(3,4)(), gen3(3,4)(), gen3(3,4)() /), shape = (/2,2/) ) ) ! tcx: (3,4) ! tcx: (3,4) ! tcx: (3,4) ! tcx: (3,4)

   allocate ( c1(2), source = (/ child(3)(), child(3)() /) ) ! tcx: (3) ! tcx: (3)
   allocate ( c2(2,2), source = reshape( source = (/ gen3(3,4)(), gen3(3,4)(), gen3(3,4)(), gen3(3,4)() /), shape = (/2,2/) ) ) ! tcx: (3,4) ! tcx: (3,4) ! tcx: (3,4) ! tcx: (3,4)

   allocate ( g1(2), source = (/ gen3(3,4)(), gen3(3,4)() /)) ! tcx: (3,4) ! tcx: (3,4)
...
! type: child - added parameters () to invoke with (3) / declare with (*) - 9 changes
! type: gen3 - added parameters (kgen3_1) to invoke with (3,4) / declare with (*,4) - 14 changes
