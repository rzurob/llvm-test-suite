...
program dummyArg001all
   ...
   open (unit = 1, file ='dummyArg001all.data', form='unformatted', access='sequential')
   ...
   allocate ( b2, source = child(3,3) ('uvw','xyz') ) ! tcx: (3,3)
