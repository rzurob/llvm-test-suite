...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg003ll
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg003 by Robert Ma)
...
program dummyArg003ll
   ...
   allocate ( b2, source = child(3,3)('ABC', 'DEF') ) ! tcx: (3,3)
   allocate ( b3, source = base(3)('def') ) ! tcx: (3)
   b4 =(/ base(3)('ABC'), base(3)('DEF') , base(3)('GHI') /) ! tcx: (3) ! tcx: (3) ! tcx: (3)

   open (unit = 1, file ='dummyArg003ll.data', form='unformatted', access='direct', recl=15)
