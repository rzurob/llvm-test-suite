...
module m
   ...
   type, extends(mydata) :: mysuperdata (kmysuperdata_1) ! kmysuperdata_1=4
      ...
      integer(kmysuperdata_1) ::  i2 = -9999
   end type
...
program array002bkl
   ...
   open (1, file = 'array002bkl.1', form='unformatted', access='sequential' )
...
! type: mysuperdata - added parameters (kmysuperdata_1) to invoke with (4,4) / declare with (4,4) - 14 changes
