...
!*  ===================================================================
!*
!*  TEST CASE NAME             : stream001akk
!*
!*  PROGRAMMER                 : David Forster (derived from stream001a by Robert Ma)
...
program stream001akk
   ...
   allocate ( b1(2), source = (/ child(4,4)(x=1.0,y=2.0), child(4,4)(x=1.0,y=2.0) /) ) ! tcx: (4,4) ! tcx: (4,4)
   allocate ( b2(0), source = (/ (child(4,4)(1.0,2.0), i=1, 0) /) ) ! tcx: (4,4)
   ...
   open ( u1%get(), file = 'stream001akk.data', form='unformatted', access='direct', recl=16 )   !<- open a external file with unit #2
   ...
   deallocate (b2)
   allocate( b2(2), source = (/ (child(4,4)(0.0,0.0), i=1, 2) /)  ) ! tcx: (4,4)
...
! type: child - added parameters (kchild_1) to invoke with (4,4) / declare with (4,4) - 6 changes
