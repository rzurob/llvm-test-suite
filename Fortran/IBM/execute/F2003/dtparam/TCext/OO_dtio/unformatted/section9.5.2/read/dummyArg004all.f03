...
program dummyArg004all
   ...
   allocate ( b1(2), source = (/ child(3,3)('xxx','xxx'), child(3,3)('xxx','xxx') /) ) ! tcx: (3,3) ! tcx: (3,3)
   allocate ( b2(1,3), source = reshape ( source = (/ child(3,3)('xxx','xxx'), child(3,3)('xxx','xxx') , child(3,3)('xxx','xxx') /), shape=(/1,3/)) ) ! tcx: (3,3) ! tcx: (3,3) ! tcx: (3,3)
