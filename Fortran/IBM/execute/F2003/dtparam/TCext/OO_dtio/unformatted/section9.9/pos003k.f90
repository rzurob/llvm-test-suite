...
program pos003k
   ...
   allocate ( b1, source = child(1)() ) ! tcx: (1)
   allocate ( b2, source = child(1)() ) ! tcx: (1)
   
   ! I/O operations
   
   
   open ( 1, file = 'pos003k.data', form='unformatted', access='stream' )
...
! type: child - added parameters () to invoke with (1) / declare with (1) - 4 changes
