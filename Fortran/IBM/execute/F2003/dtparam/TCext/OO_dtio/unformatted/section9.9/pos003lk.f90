...
program pos003lk
   ...
   allocate ( b1, source = child(0,1)() ) ! tcx: (0,1)
   allocate ( b2, source = child(0,1)() ) ! tcx: (0,1)
   
   ! I/O operations
   
   
   open ( 1, file = 'pos003lk.data', form='unformatted', access='stream' )
...
! type: child - added parameters (kchild) to invoke with (0,1) / declare with (*,1) - 4 changes
