...
program associate002al
   ...
   allocate ( base(0) :: b1(2,2), b2(3) ) ! tcx: (0)
   ...
   open (unit = 1, file ='associate002al.data', form='unformatted', access='sequential')
...
! type: base - added parameters (lbase) to invoke with () / declare with (0) - 16 changes
! type: base - added parameters (lbase) to invoke with (0) / declare with (*) - 16 changes
