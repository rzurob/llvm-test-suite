...
program pos003kl
   ...
   allocate ( b1, source = child(1,0)() ) ! tcx: (1,0)
   allocate ( b2, source = child(1,0)() ) ! tcx: (1,0)
   
   ! I/O operations
   
   
   open ( 1, file = 'pos003kl.data', form='unformatted', access='stream' )
...
! type: child - added parameters (lchild) to invoke with (1,0) / declare with (1,*) - 4 changes
