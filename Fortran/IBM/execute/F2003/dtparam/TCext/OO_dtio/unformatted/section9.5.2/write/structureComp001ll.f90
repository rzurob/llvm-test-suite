...
!*
!*  PROGRAMMER                 : David Forster (derived from structureComp001 by Robert Ma)
...
module m1
   ...
   type container (lcontainer_1) ! lcontainer_1=3
      ...
      class(base(lcontainer_1)), pointer     :: b1 ! tcx: (:)
      class(base(lcontainer_1)), allocatable :: b2 ! tcx: (:)
   end type   
...
program structureComp001ll
   ...
   write (1, iostat=stat, iomsg=msg )             container(3)( b2=base(3)('jkl'), b1=d1 )  !<- write 'ghiZjklZY' to file ! tcx: (3) ! tcx: (3)
