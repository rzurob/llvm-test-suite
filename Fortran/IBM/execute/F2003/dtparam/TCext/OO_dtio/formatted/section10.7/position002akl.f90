...
!*  ===================================================================
!*
!*  TEST CASE NAME             : position002akl
!*
!*  PROGRAMMER                 : David Forster (derived from position002a by Robert Ma)
...
program position002akl
   ...
   open (unit = 1, file ='position002akl.1', form='formatted', access='stream')
...
10 format ( 3X,A3 )
   ...
   write (unit, "(T1,A3,TR3,A3)", iostat = iostat )     dtv%c1, dtv%c3   !<- try TR editor
