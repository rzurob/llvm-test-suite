...
!*  ===================================================================
!*
!*  TEST CASE NAME             : input106kl
!*
!*  PROGRAMMER                 : David Forster (derived from input106 by Robert Ma)
...
program input106kl
   ...
   allocate(base(4,3):: b1(3)) ! tcx: base(4,3)
   allocate(child(4,3,4,3) :: b2(2,1), c1(2,3)) ! tcx: (4,3,4,3)
   allocate(gen3(4,3,4,3,3,3)  :: c2(4), g1(2,2,2)) ! tcx: (4,3,4,3,3,3)

   open (1, file='input106kl.1', form='formatted', access='sequential', blank='zero' )
