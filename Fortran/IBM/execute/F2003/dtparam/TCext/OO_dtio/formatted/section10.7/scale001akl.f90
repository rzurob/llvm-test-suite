...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scale001akl
!*
!*  PROGRAMMER                 : David Forster (derived from scale001a by Robert Ma)
...
program scale001akl
   ...
   open ( 1, file = 'scale001akl.1', form='formatted', access='sequential' )
   ...
   allocate (base(4,2):: f1, f2(2,2), f3, f4(2)) ! tcx: base(4,2)
...
! type: base - added parameters (kb,lb) to invoke with (4,2) / declare with (4,*) - 13 changes
