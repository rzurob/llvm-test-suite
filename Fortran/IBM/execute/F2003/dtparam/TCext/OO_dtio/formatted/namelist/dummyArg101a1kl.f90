...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg101a1kl
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg101a1 by Robert Ma)
...
contains
   ...
   subroutine readBase(dtv,lb,ub)
      ...
      class(base(*)), intent(inout) :: dtv(lb:ub) ! tcx: (*)
      integer :: stat
      character(200) :: msg
...
program dummyArg101a1kl
   ...
   open (unit, file = 'dummyArg101a1kl.1', form='formatted', access='stream' )

   allocate( child(3,4) :: b1(2:4) ) ! tcx: (3,4)
   allocate( child(3,4) :: b2(3:5) ) ! tcx: (3,4)
   allocate( child(3,4) :: b4(4:6) ) ! tcx: child(3,4)
