...
!*  ===================================================================
!*
!*  TEST CASE NAME             : sign003kl
!*
!*  PROGRAMMER                 : David Forster (derived from sign003 by Robert Ma)
...
program sign003kl
   ...
   open ( 1, file = 'sign003kl.1', form='formatted', access='sequential' )
   ...
   allocate (f2(2,2), source = reshape (source=(/ base(4,2)( (/333,444/),  (/5.55,6.66/), (/ (77.7, 88.8), (99.9, 11.1) /) ),  & ! tcx: (4,2)
                                                  ...
                                                  base(4,2)( (/999,111/), (/2.22,3.33/), (/ (44.4, 55.5), (99.9, 55.5) /) )   & ! tcx: (4,2)
                                                /),shape=(/2,2/)) )
