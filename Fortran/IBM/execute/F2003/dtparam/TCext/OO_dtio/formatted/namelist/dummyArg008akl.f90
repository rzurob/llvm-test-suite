...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg008akl
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg008a by Robert Ma)
...
program dummyArg008akl
   ...
   open (1, file = 'dummyArg008akl.1', form='formatted', access='stream' )

   allocate(b1, source = base(3)(c='abc') ) ! tcx: (3)
   allocate(b2, source = base(3)(c='jkl') ) ! tcx: (3)
