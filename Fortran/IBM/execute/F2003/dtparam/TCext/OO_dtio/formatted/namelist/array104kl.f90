...
!*
!*  PROGRAMMER                 : David Forster (derived from array104 by Robert Ma)
...
program array104kl
   ...
   allocate ( b1(4), source = (/ base(4,3)(), base(4,3)(), base(4,3)(), base(4,3)() /) )
   allocate ( b2(4), source = (/ base(4,3)(), base(4,3)(), base(4,3)(), base(4,3)() /) )
