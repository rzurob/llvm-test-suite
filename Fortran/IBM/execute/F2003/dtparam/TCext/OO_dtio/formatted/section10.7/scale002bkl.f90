...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scale002bkl
!*
!*  PROGRAMMER                 : David Forster (derived from scale002b by Robert Ma)
...
!*                                        input field has exponent on ES and EN editors
!*                                        
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
...
program scale002bkl
   ...
   open ( 1, file = 'scale002bkl.1', form='formatted', access='sequential' )
...
use m1, only: base
   ...
   read ( unit, iostat = iostat, fmt = '(1X,1P,EN8.4,-1P,1X,EN8.4 )')       dtv%r1(1), dtv%r1(2)       !<- P has effect on 
   if ( iostat /= 0 ) error stop 12_4
   read ( unit, iostat = iostat, fmt = '(2P,1X,ES8.4,-3P,1X,ES8.4,0P,1X,EN8.4,1P,1X,ES8.4 )')   dtv%c1(1), dtv%c1(2)
