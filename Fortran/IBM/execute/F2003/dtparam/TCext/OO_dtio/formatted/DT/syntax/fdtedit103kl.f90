...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fdtedit103kl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtedit103 by Robert Ma)
...
use m
   ...
   open (1, file = 'fdtedit103kl.1', form='formatted', access='sequential' )
