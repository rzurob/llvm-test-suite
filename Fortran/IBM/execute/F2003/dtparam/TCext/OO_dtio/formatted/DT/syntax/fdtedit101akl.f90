...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fdtedit101akl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtedit101a by Robert Ma)
...
!*                                        With no char-literal-constant and no v_list present (runtime format)
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
use m
   ...
   integer :: stat
   character(150) :: msg
   character(4)  :: format = '(DT)'

   open (1, file = 'fdtedit101akl.1', form='formatted', access='sequential' )
   ...
   read ( 1,  format, iostat = stat, iomsg = msg )   b2
