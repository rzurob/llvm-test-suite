...
!*
!*  PROGRAMMER                 : David Forster (derived from array101 by Robert Ma)
...
use m
   ...
   type(base(4))              :: b3(4) = (/ base(4)(), base(4)(), base(4)(), base(4)() /)

   integer :: stat
   character(150) :: msg
   character(30) :: fmt = "(DT)"

   open (1, file = 'array101kl.1', form='formatted', access='sequential' )
