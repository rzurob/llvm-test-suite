...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg001a3kl
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg001a3 by Robert Ma)
...
contains
   ...
   subroutine writeBase1(dtv, unit)
      class(base(*)), intent(in), allocatable :: dtv(:) ! tcx: (*)
      integer, intent(in) :: unit
   ...
   subroutine writeBase(dtv, unit)
      class(base(:)), intent(in), pointer :: dtv(:) ! tcx: (*)
      integer, intent(in) :: unit
...
program dummyArg001a3kl
   ...
   class(base(3)), allocatable  :: b3(:) ! tcx: (:)
   class(base(:)), pointer      :: b4(:) ! tcx: (:)

   open (1, file = 'dummyArg001a3kl.1', form='formatted', access='stream' )
   ...
   allocate(b3(2), source = (/ base(3)(c='mno'), base(3)(c='pqr') /) ) ! tcx: (3) ! tcx: (3)
