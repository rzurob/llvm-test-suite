...
!*  ===================================================================
!*
!*  TEST CASE NAME             : structCompnt102kl
!*
!*  PROGRAMMER                 : David Forster (derived from structCompnt102 by Robert Ma)
...
module m
   ...
   type container1 (lc1)
      integer, len :: lc1
      class(base(lc1)), allocatable :: b1
   end type

   type container2 (lc2a,lc2b)
      integer, len :: lc2a,lc2b
      class(child(lc2a,lc2b)), pointer    :: b2
   end type
...
use m
   ...
   open (1, file = 'structCompnt102kl.1', form='formatted', access='sequential' )
   idx =1
