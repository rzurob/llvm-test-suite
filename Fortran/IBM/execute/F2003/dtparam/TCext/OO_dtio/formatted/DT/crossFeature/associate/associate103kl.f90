...
!*  ===================================================================
!*
!*  TEST CASE NAME             : associate103kl
!*
!*  PROGRAMMER                 : David Forster (derived from associate103 by Robert Ma)
...
use m
   ...
   open (1, file = 'associate103kl.1', form='formatted', access='stream' )
   ...
   allocate ( u1, source = child(4,4)(201.0, 202.0) )
   allocate ( u2, source = base(4) (203.0) )
