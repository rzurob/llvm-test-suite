...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar109akl
!*
!*  PROGRAMMER                 : David Forster (derived from scalar109a by Robert Ma)
...
use m
   ...
   open (1, file = 'scalar109akl.1', form='formatted', access='sequential' )

   allocate ( u1, source = base(4)(cdata(4,4)(-999,-999), -999) )
   allocate ( u2, source = base(4)(data(4)(-999), -999) )
