...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fdtedit109bkl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtedit109b by Robert Ma)
...
use m
   ...
   type(base(4)), allocatable   :: b5
   class(child(4,4)), allocatable :: c1
   class(child(4,4)), pointer     :: c2
   type(child(4,4))               :: c3
   type(child(4,4)), pointer      :: c4
   type(child(4,4)), allocatable  :: c5
   ...
   b3 = base(4)( 104 )
   allocate ( b4, source = base(4)( 105 ) )
   allocate ( b5, source = base(4)( 106 ) )

   allocate ( c1, source = child(4,4)( 201, 202 ) )
   allocate ( c2, source = child(4,4)( 203, 204 ) )
   c3 = child(4,4)( 205, 206 )
   allocate ( c4, source = child(4,4)( 207, 208 ) )
   allocate ( c5, source = child(4,4)( 209, 210 ) )

   open (1, file = 'fdtedit109bkl.1', form='formatted', access='sequential' )
