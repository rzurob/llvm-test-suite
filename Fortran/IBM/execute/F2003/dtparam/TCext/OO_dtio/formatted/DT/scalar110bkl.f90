...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar110bkl
!*
!*  PROGRAMMER                 : David Forster (derived from scalar110b by Robert Ma)
...
use m
   ...
   open (1, file = 'scalar110bkl.1', form='formatted', access='sequential' )

   allocate ( b1, source = base(4)((/ data(4)(-999), data(4)(-999) /) , -999) )
   allocate ( b2, source = base(4)((/ data(4)(-999), data(4)(-999) /) , -999) )
   b3 = base(4)((/ data(4)(-999), data(4)(-999), data(4)(-999)         /) , -999)
