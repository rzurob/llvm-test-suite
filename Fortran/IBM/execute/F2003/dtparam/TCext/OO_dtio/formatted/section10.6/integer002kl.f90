...
!*  ===================================================================
!*
!*  TEST CASE NAME             : integer002kl
!*
!*  PROGRAMMER                 : David Forster (derived from integer002 by Robert Ma)
...
program integer002kl
   ...
   open (unit = 1, file ='integer002kl.1', form='formatted', access='sequential')
   open (unit = 2, file ='integer002kl.2', form='formatted', access='stream' )   
