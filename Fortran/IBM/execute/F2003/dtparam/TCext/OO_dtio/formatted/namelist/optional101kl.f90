...
!*  ===================================================================
!*
!*  TEST CASE NAME             : optional101kl
!*
!*  PROGRAMMER                 : David Forster (derived from optional101 by Robert Ma)
...
contains
   ...
   subroutine read(unit, b1, b2)
      ...
      class(base(4)), intent(inout), optional :: b1 ! tcx: (4)
      class(base(4)), intent(inout), optional :: b2 ! tcx: (4)
      namelist /nml1/ b1
      namelist /nml2/ b2
...
program optional101kl
   ...
   open (1, file = 'optional101kl.1', form='formatted', access='stream' )
...
contains
   ...
   subroutine read1(unit, b1, b2)
      ...
      class(base(4)), intent(inout), optional, allocatable :: b1 ! tcx: (4)
      class(base(4)), intent(inout), optional, pointer     :: b2 ! tcx: (4)
      namelist /nml1/ b1
      namelist /nml2/ b2
      namelist /nml12/ b1, b2
...
! type: base - added parameters (kb) to invoke with (4) / declare with (4) - 8 changes
