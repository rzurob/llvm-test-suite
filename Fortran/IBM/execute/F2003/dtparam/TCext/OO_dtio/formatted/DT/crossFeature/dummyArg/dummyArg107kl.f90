...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg107kl
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg107 by Robert Ma)
...
use m
   ...
   open (1, file = 'dummyArg107kl.1', form='formatted', access='sequential' )
