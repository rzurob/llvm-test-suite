...
!*  ===================================================================
!*
!*  TEST CASE NAME             : position002ckl
!*
!*  PROGRAMMER                 : David Forster (derived from position002c by Robert Ma)
...
10 format ( A3 )
   ...
   read (unit, "(3X,A3)", iostat = iostat )            dtv%c3
   if (iostat /= 0 )   error stop 8_4 
   read (unit, "(TL6,A3,3X)", iostat = iostat )        dtv%c2   
...
10 format ( 3X,A3 )
   ...
   write (unit, "(TL6,A3,3X,A3)", iostat = iostat )         dtv%c1, dtv%c3
