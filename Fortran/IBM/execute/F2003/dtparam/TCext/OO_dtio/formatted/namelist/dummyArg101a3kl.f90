...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg101a3kl
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg101a3 by Robert Ma)
...
program dummyArg101a3kl
   ...
   class(base(3)), pointer      :: b4(:) ! tcx: (:)

   open (1, file = 'dummyArg101a3kl.1', form='formatted', access='stream' )

   allocate( child(3,4) :: b1(2) ) ! tcx: (3,4)
   allocate( child(3,4) :: b2(2) ) ! tcx: (3,4)
   allocate( base(3) :: b3(2) )
   allocate( child(3,4) :: b4(4) ) ! tcx: (3,4)
