...
!*  ===================================================================
!*
!*  TEST CASE NAME             : array101dkl
!*
!*  PROGRAMMER                 : David Forster (derived from array101d by Robert Ma)
...
program array101dkl
   ...
   open (1, file = 'array101dkl.1', form='formatted', access='sequential' )
   ...
   allocate ( data(4) :: b3(1,2)%u, b3(2,2)%u )
