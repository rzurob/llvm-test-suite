...
use m
   ...
   type(base(0))              :: b3 = base(0)(c='')

   integer :: stat
   character(150) :: msg
   character(30) :: fmt = "(DT)"

   open (1, file = 'scalar011kl.1', form='formatted', access='sequential' )

   allocate ( b1, source = base(0)(c='') )
   allocate ( b2, source = base(0)(c='') )
