...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar101akl
!*
!*  PROGRAMMER                 : David Forster (derived from scalar101a by Robert Ma)
...
program scalar101akl
   ...
   type(base(3)), allocatable  :: b4 ! tcx: (:)
   type(base(3)), pointer      :: b5 ! tcx: (:)

   namelist /nml/ b1, b2, b3, b4, b5
   open (1, file = 'scalar101akl.1', form='formatted', access='sequential', status='old', BLANK='NULL' )
