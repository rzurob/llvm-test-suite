...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fdtedit110kl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtedit110 by Robert Ma)
...
use m
   ...
   open (1, file = 'fdtedit110kl.1', form='formatted', access='sequential' )
