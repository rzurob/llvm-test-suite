...
!*  ===================================================================
!*
!*  TEST CASE NAME             : selectType001kl
!*
...
!*                                        Select-Type Constructor: Polymorphic Scalar Entities
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
!*
...
use m
   ...
   open (1, file = 'selectType001kl.1', form='formatted', access='sequential' )
   ...
   select type ( c2 )
      class default
         write ( 1, "(DT'_c2'(7,2,9,4))", iostat = stat, iomsg = msg ) c2
