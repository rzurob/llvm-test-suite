...
!*  ===================================================================
!*
!*  TEST CASE NAME             : integer001kl
!*
!*  PROGRAMMER                 : David Forster (derived from integer001 by Robert Ma)
...
program integer001kl
   ...
   allocate (f2, source = fourintegers(1,2,4,8)(HUGE(f2%c1),HUGE(f2%c2),HUGE(f2%c3),HUGE(f2%c4)))          !<- with maximum values ! tcx: (1,2,4,8)
   ...
   open (unit = 1, file ='integer001kl.1', form='formatted', access='sequential')
   open (unit = 2, file ='integer001kl.2', form='formatted', access='stream' )   
