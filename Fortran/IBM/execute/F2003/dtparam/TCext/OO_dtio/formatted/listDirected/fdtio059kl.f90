...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : fdtio059kl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtio059 by Jim Xia)
!*  DATE                       : 2007-06-20 (original: 01/12/2005)
...
module m
    type base (lb)
       integer, len :: lb
        character(lb), pointer :: data(:) => null()
    end type
