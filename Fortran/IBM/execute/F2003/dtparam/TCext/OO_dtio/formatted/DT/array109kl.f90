...
!*  ===================================================================
!*
!*  TEST CASE NAME             : array109kl
!*
!*  PROGRAMMER                 : David Forster (derived from array109 by Robert Ma)
...
use m
   ...
   open (1, file = 'array109kl.1', form='formatted', access='sequential' )

   allocate( base(4) :: u1(3) )
   allocate( base(4) :: u2 )
