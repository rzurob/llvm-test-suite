...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg008kl
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg008 by Robert Ma)
...
program dummyArg008kl
   ...
   open (1, file = 'dummyArg008kl.1', form='formatted', access='stream' )

   allocate(b1, source = base(3)(c='abc')     ) ! tcx: (3)
   allocate(b2, source = child(3,4)(c='jkl',i=1) ) ! tcx: (3,4)
