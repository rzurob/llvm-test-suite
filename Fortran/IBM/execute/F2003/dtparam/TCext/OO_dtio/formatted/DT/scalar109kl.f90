...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scalar109kl
!*
!*  PROGRAMMER                 : David Forster (derived from scalar109 by Robert Ma)
...
use m
   ...
   open (1, file = 'scalar109kl.1', form='formatted', access='sequential' )

   allocate( u1, source = base(4)(-999,null()))
   allocate( u2, source = base(4)(-999,null()))
