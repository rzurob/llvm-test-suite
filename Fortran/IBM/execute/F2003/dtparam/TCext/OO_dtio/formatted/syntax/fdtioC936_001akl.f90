...
!*  =================================================================== 
!*
!*  TEST CASE NAME             : fdtioC936_001akl
!*
!*  PROGRAMMER                 : David Forster (derived from fdtioC936_001a by Jim Xia)
!*  DATE                       : 2007-07-23 (original: 11/5/2004)
...
! type: base - added parameters (kb,lb) to invoke with (4,200) / declare with (4,*) - 7 changes
