...
!*  ===================================================================
!*
!*  TEST CASE NAME             : scale002akl
!*
!*  PROGRAMMER                 : David Forster (derived from scale002a by Robert Ma)
...
!*                                        Inside DTIO, P editor does not have effect if the input field has exponent on D and E editors
!*                                        
!*  KEYWORD(S)                 :
!*  TARGET(S)                  :
!* ===================================================================
...
program scale002akl
   ...
   open ( 1, file = 'scale002akl.1', form='formatted', access='sequential' )
...
use m1, only: base
   ...
   read ( unit, iostat = iostat, fmt = '(1X,1P,E8.4,-1P,1X,D8.4 )')       dtv%r1(1), dtv%r1(2)       !<- P has effect on 
   if ( iostat /= 0 ) error stop 12_4
   read ( unit, iostat = iostat, fmt = '(2P,1X,E8.4,-3P,1X,D8.4,0P,1X,D8.4,1P,1X,E8.4 )')   dtv%c1(1), dtv%c1(2)
