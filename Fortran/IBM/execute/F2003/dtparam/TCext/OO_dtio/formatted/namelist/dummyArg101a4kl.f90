...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dummyArg101a4kl
!*
!*  PROGRAMMER                 : David Forster (derived from dummyArg101a4 by Robert Ma)
...
program dummyArg101a4kl
   ...
   open (unit, file = 'dummyArg101a4kl.1', form='formatted', access='sequential' )
