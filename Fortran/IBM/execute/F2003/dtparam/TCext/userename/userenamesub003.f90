...
! ftcx_dtp -ql -qdeferredlp -qreuse=self /tstdev/F2003/userename/userenamesub003.f
...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : userenamesub003.f
!*
