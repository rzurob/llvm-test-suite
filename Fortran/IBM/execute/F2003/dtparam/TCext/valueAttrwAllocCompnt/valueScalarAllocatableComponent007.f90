...
! ftcx_dtp -qk -qnol -qnodefaultpv -qreuse=self -qreuse=base /tstdev/F2003/valueAttrwAllocCompnt/valueScalarAllocatableComponent007.f
...
program valueScalarAllocatableComponent007
   ...
   allocate ( b1, source = child(4) (inner(4)(200), cinner(4)(1111111,1111111) ) )
   call foo ( b1 )

   ! b1 is undefined

   allocate ( b1, source = child(4) (cinner(4) (3000, 4000), inner(4)(111111) ) )
