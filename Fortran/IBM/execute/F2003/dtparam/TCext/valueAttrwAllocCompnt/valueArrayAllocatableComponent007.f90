...
! ftcx_dtp -qk -qnol -qnodefaultpv -qreuse=self -qreuse=base /tstdev/F2003/valueAttrwAllocCompnt/valueArrayAllocatableComponent007.f
...
program valueArrayAllocatableComponent007
   ...
   allocate ( b1, source = base(4) ( (/ inner(4)(100), inner(4)(200), inner(4)(300) /) ) )
   call foo ( b1 )

   ! b1 is undefined

   allocate ( b1, source = base(4) ( (/ cinner(4) (1000, 2000 ), cinner(4) (1001, 2001 ), cinner(4) (1002, 2002 ) /) ) )

   call foo ( b1 )

   ! b1 is undefined

   allocate ( b1, source = child(4) ( (/ inner(4)(201), inner(4)(202), inner(4)(203), inner(4)(204) /), (/ cinner(4)(1111111,1111111) /) ) )
   call foo ( b1 )

   ! b1 is undefined

   allocate ( b1, source = child(4) ( (/ cinner(4) (3000, 4000), cinner(4) (3001, 4001) /),(/  inner(4)(111111) /) ) )
