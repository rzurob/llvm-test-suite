...
! ftcx_dtp -qck /tstdev/F2003/mxminAll/var/mxminVal/mxminvalVarArgSub1.f
...
!* ===================================================================
  ...
  module ArgSub3
     type dt_array(k1,n1)    ! (1,3)
       integer, kind                           :: k1
       integer, len                            :: n1
       character(kind=k1,len=n1), dimension(5) :: b = max("zzz", "kkk")
     end type   
 
     contains
        subroutine sub2(arg1, arg2)
           type(dt_array(1,3)) :: dt_arg 
  ...
  program mxminvalVarArgSub1
    ...
    type dt_init(k2,n2)    ! (1,3)
      integer, kind             :: k2
      integer, len              :: n2
      sequence
      character(kind=k2,len=n2) :: c(4) = min("sss", "ccc", "hhh")
    end type
