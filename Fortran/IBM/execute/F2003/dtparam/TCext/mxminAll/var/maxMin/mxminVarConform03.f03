...
! ftcx_dtp /tstdev/F2003/mxminAll/var/maxMin/mxminVarConform03.f
! opt variations: -qreuse=self
...
!* ===================================================================
  ...
  program mxminVarConform03
     ...
     type dt(k1,n1,k2,n2)    ! (1,3,1,8)
        integer, kind             :: k1,k2
        integer, len              :: n1,n2
        character(kind=k1,len=n1)    x, x3(12), y3(12)
        character(kind=k2,len=n2)    y(2,4)
     end type
