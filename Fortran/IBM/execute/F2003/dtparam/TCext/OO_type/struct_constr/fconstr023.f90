...
! ftcx_dtp -qck -qk -ql /tstdev/OO_type/struct_constr/fconstr023.f
!#######################################################################
! SCCS ID Information
! %W%, %I%
...
module m
    ...
    type (point(4)) :: p1_m = point(4) (x = (/0, 0/))
    type (point(4)) :: p2_m = point(4) (1)
end module
...
use m
    ...
    type (point(4)) :: p3_m = point(4) (x = (/1, 0/))

    type (point3D(4,4)) :: p3d1_m = point3D(4,4) (z = 0.0, x = (/1, 2/))
    type (point3D(4,4)) :: p3d2_m = point3D(4,4) ((/0.0, 1.0/), z = 1.0)
end module
...
use m1
    ...
    type (point(4)) :: p2_1 = point(4) (1)
    type (point(4)) :: p2_2 = point(4) (x = 10)

    type (point3D(4,4)) :: p3_1 = point3D(4,4) (z = 0, point = point(4)(x=2))
    type (point3D(4,4)) :: p3_2 = point3D(4,4) (z = 1, x = 1)

    type (colorPoint3D(4,4,1)) :: p3c_1 = colorPoint3D(4,4,1) (point = point(4)((/5.0, 4.0/)), &
                    color = 1, z = 0.0)

    ! two conversions is done for the following statement
    type (colorPoint3D(4,4,1)) :: p3c_2 = colorPoint3D(4,4,1) (x = (1.0, 2.0), color = 2, &
                    z = 1.0)
