...
use m
    ...
    call associate1 (x = container1(4)(b1), y = container1(4) (b1(-1:0)))

    !! test type container2
    allocate (c2(0:5), source=(/(gen3(4,1,20,4,20)(i, 'c2_of_6', i*1.1d0), i=0,5)/))

    call associate2 (container2(4,1,20) (c2(::2)))

    contains

!    associate (x => container1(4)(b1), y => container1(4) (b1(-1:0)))
    subroutine associate1 (x, y)
        type(container1(4)), intent(in) :: x,y
...
!    associate (x => container2(4,1,20) (c2(::2)))
    subroutine associate2 (x)
        type(container2(4,1,*)), intent(in) :: x
