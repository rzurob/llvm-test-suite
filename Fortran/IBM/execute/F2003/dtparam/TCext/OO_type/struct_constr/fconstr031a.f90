...
! ftcx_dtp -qck -qk -ql /tstdev/OO_type/struct_constr/fconstr031a.f
! SCCS ID Information
! *********************************************************************
! %START
! %MAIN: YES
...
use m
    ...
    type(base(4,4)) :: b1 = base(4,4) (null(), null())
    type (base(4,4)) :: b2 = base(4,4) (mask=null(), data=null())
    ...
    b1 = base(4,4) (data = reshape(i1, (/10/)), mask =reshape(l1,(/2,5/)))

    b2 = base(4,4) (mask = l2, data = reshape (i1(1:1, 2:5), (/4/)))
