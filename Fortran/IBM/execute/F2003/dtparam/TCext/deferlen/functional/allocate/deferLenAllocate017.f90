...
! ftcx_dtp -qck -qk -ql /tstdev/F2003/deferlen/functional/allocate/deferLenAllocate017.f
...
program deferLenAllocate017
   ...
   allocate ( b1, source = base(4,20)( (/ 'ABC', 'DEF', 'GHI', 'JKL' /) ) )
