...
! ftcx_dtp -qck -qdeferredlp /tstdev/F2003/dataPtrAssgn/CrossFeatures/dataPtrTar.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE(DT(4,1,1)),     TARGET  :: Arr(100, 2)
  TYPE(DT(4,1,:)),     POINTER :: Ptr(:,:)
  TYPE(DT(4,1,1))              :: Arr1(10,10)
...
! IF (.NOT. ASSOCIATED(Ptr, Arr(::2, 2:2)))            ERROR STOP 21
  ...
  IF (ANY( UBOUND(Ptr) .NE. (/ 9, 4 /)))               ERROR STOP 23
  ...
  IF (ANY( SHAPE(Ptr)  .NE. (/100, 0 /)))              ERROR STOP 33

  I = -1
  Ptr(0:9, 0:I) => Arr(I, 0:I)
  IF ( ASSOCIATED(Ptr, Arr(0:I, 0:I)))                 ERROR STOP 41
  IF (ANY( LBOUND(Ptr) .NE. (/ 0, 1 /)))               ERROR STOP 42
  IF (ANY( SHAPE(Ptr)  .NE. (/ 10, 0 /)))              ERROR STOP 43
