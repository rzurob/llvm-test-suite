...
! ftcx_dtp -qck /tstdev/F2003/dataPtrAssgn/Basic/dataPtrC717_1.f
! opt variations: -qnock

!*********************************************************************
!*  ===================================================================
!*
!*  TEST CASE NAME             :  dataPtrC717_1.f
!*
!*  DATE                       : Feb. 2, 2006
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE :: DT(K1,N1)    ! (1,3)
    INTEGER, KIND             :: K1
    INTEGER, LEN              :: N1
    CHARACTER(kind=K1,len=N1) :: C="123"
  END TYPE
  ...
  ALLOCATE(Ptr(0:2), SOURCE=(/DT(1,3)("123"),DT(1,3)("213"),DT(1,3)("312")/))
