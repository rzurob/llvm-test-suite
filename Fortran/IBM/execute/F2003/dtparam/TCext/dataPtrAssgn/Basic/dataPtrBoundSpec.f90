...
! ftcx_dtp -qk -ql -qnodefaultpv -qdeferredlp -qreuse=self /tstdev/F2003/dataPtrAssgn/Basic/dataPtrBoundSpec.f
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  TYPE :: DT(K2,N2)    ! (4,20)
    INTEGER, KIND            :: K2
    INTEGER, LEN             :: N2
    TYPE(DT0(K2,:)), POINTER :: IPtr1(:), IPtr2(:,:)
  END TYPE

  INTEGER, TARGET  :: I

  TYPE(DT0(4,20)), TARGET  :: I1Arr(I2Min:I2Max)=(/(DT0(4,20)(),I=I2Min, I2Max)/)
  TYPE(DT0(4,20)), TARGET  :: I2Arr(I1Min:-1, I1Max) =  &
                      &  RESHAPE((/(DT0(4,20)(),I=1, I1Max*(I1Max+1))/), (/I1Max+1, I1Max+0/))
