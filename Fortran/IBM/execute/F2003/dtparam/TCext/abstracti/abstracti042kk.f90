...
!* ======================================================================
!*
!*  TEST CASE NAME             : abstracti042kk
!*
!*  PROGRAMMER                 : Glen Mateer (derived from abstracti042
...
module m
  ...
  type dt (kdt_1,kdt_2) ! kdt_1,kdt_2=2,4
...
program abstracti042kk

  use m

  type(dt(2,4)) :: dta ! tcx: (2,4)
...
! type: dt - added parameters (kdt_1,kdt_2) to invoke with (2,4) / declare with (2,4) - 1 changes
