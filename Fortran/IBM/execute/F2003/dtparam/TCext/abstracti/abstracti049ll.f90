...
module m
  ...
  type dt (ldt_1,ldt_2) ! ldt_1,ldt_2=7,5
    integer, len :: ldt_1,ldt_2
...
! type: dt - added parameters (ldt_1,ldt_2) to invoke with (7,5) / declare with (*,*) - 7 changes
