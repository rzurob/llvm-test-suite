...
! ftcx_dtp -qk -qnol -qdefaultpv -qreuse=self -qreuse=base /tstdev/F2003/abstracti/functional/abstracti013.f
...
program abstracti013k_dpv_ra
use m1
    type (triangle(4)), save :: t1
    class (shape(4)), allocatable :: s1

    t1 = triangle(4) ((/point(4)(1,1),point(4)(2,2), point(4)(3.0,1)/))
