...
!*  ===================================================================
!*
!*  TEST CASE NAME             : abstracti008l
!*
!*  PROGRAMMER                 : Glen Mateer (derived from abstracti008 by Alberto Alvarez-Mesquida)
!*  DATE                       : 2007-10-15 (original: 02/20/2006)
...
program abstracti008l
   ...
   allocate ( b1, source = child(3) ( (/'a','b','c'/), (/'A','B','C'/) ) ) ! tcx: (3)
   allocate ( b2, source = child(3) ( (/'d','e','f'/), (/'D','E','F'/) ) ) ! tcx: (3)
...
! type: child - added parameters (lchild_1) to invoke with (3) / declare with (*) - 6 changes
