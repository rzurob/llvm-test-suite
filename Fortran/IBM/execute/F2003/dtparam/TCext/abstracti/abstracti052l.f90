...
module m
  ...
  type, abstract :: dt (ldt_1) ! ldt_1=7
     integer, len :: ldt_1
  contains
...
! type: dt - added parameters (ldt_1) to invoke with (7) / declare with (7)/(*) - 2 changes
! type: dtt - added parameters () to invoke with (7) / declare with (7)/(*) - 7 changes
