...
!* =====================================================================
!*
!*  TEST CASE NAME             : abstracti051kk
!*
!*  PROGRAMMER                 : Glen Mateer (derived from abstracti051
...
module m
  ...
  type, abstract :: dt (kdt_1) ! kdt_1=8
     integer, kind :: kdt_1
  contains
...
module m1
  ...
  type, extends(dt) :: dtt (kdtt_1) ! kdtt_1=4
     integer, kind :: kdtt_1
...
! type: dt - added parameters (kdt_1) to invoke with (8) / declare with (8) - 2 changes
! type: dtt - added parameters (kdtt_1) to invoke with (8,4) / declare with (8,4) - 9 changes
