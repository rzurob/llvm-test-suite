...
module m
  ...
  type, abstract :: dt (ldt_1) ! ldt_1=3
     integer, len :: ldt_1
  contains
...
! type: dt - added parameters (ldt_1) to invoke with (3) / declare with (*) - 0 changes
! type: dtt - added parameters (kdtt_1) to invoke with (3,4) / declare with (*,4) - 2 changes
