...
!*  ===================================================================
!*
!* TEST CASE NAME              : dtParamDummyValue08b.f
!*
!*  DATE                       : July 10, 2008
!*
!*  DESCRIPTION:
...
!*  Passing the DT component of a DT as an actual argument
!*
!* ===================================================================
!23456789012345678901234567890123456789012345678901234567890123456789012
  ...
  CONTAINS
  SUBROUTINE Sub1(T2)
    TYPE(DT2(4, 6)), VALUE :: T2

    IF ((T2%i2.ne.22).or.(T2%ch2.ne.'defghi').or.(T2%i2%KIND.ne.4).or.(T2%ch2%LEN.ne.6)) THEN
      print *, T2%i2, T2%ch2
      print *, T2%i2%KIND, T2%ch2%LEN
      STOP 1
    END IF
    ...
    IF ((T2%i2.ne.88).or.(T2%ch2.ne.'rstuvw').or.(T2%i2%KIND.ne.4).or.(T2%ch2%LEN.ne.6)) THEN
      print *, T2%i2, T2%ch2
      print *, T2%i2%KIND, T2%ch2%LEN
      STOP 1
    END IF
