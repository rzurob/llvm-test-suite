...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  DO I = M, N
    ...
    IF ( P2(I)%K1%KIND          .NE.   4          ) STOP 23
    IF ( P2(I)%L1%KIND          .NE.   4          ) STOP 24
    ...
    IF ( P3(I)%K1%KIND          .NE.   4          ) STOP 43
    IF ( P3(I)%L1%KIND          .NE.   4          ) STOP 44
    IF ( P3(I)%K1               .NE.   1          ) STOP 45
    IF ( P3(I)%L1               .NE.   1          ) STOP 46
    IF ( P3(I)%I%KIND           .NE.   1          ) STOP 47
