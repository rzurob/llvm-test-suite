...
!*  ===================================================================
!*
!*  TEST CASE NAME             : dtpObjDecAttr24
!*  TEST CASE TITLE            :
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : May. 31, 2007
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  CLASS(DT1(1,*, 4,*)), TARGET, INTENT(IN)  :: Arg(:) 
  CLASS(DT1(1,:, 4,:)), POINTER             :: ModFun1(:) 
    ModFun1 => Arg 
  END FUNCTION 

  FUNCTION ModFun2(Arg)
  CLASS(Dt2(1,3,4,*,8,7)), TARGET, INTENT(IN)  :: Arg(:) 
  CLASS(Dt2(1,3,4,5,8,7)), POINTER             :: ModFun2(:) 
    ModFun2 => Arg 
  END FUNCTION 

  END MODULE

  PROGRAM dtpObjDecAttr24
  USE M
  IMPLICIT NONE

  INTEGER :: N = 113, I
  PROCEDURE(ModFun0), POINTER :: Ptr0
  ...
  IF ( ASSOCIATED(Ptr01, Tar0) ) STOP 11
  ...
  IF ( ASSOCIATED(Ptr02, Tar0) ) STOP 21
