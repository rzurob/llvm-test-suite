...
!*  ===================================================================
!*
!*  TEST CASE NAME             : F2003/dtparam/ArraySections/arrsec_1_11.f
!*  DATE                       : Jul. 09, 2008
...
!*  - Dummy args declared as assumed size array (instead of arrsec_1_1.f's
!*    assumed shape)
!*
...
contains
    ...
    subroutine sub1(str,ub,dta)
        ...
        integer :: ub
        type(base(K,*)) :: dta(*)
        call sub1_doit(str,ub,dta)
    end subroutine

    subroutine sub1_doit(str,ub,dta)
        character(*) :: str
        integer :: ub
        type(base(K,*)) :: dta(*)
    ...
    subroutine sub2(ub,dta)
        integer :: ub
        type(base(K,*)) :: dta(11:*)
        call sub2_doit(ub,dta(11:ub))
    end subroutine

    subroutine sub2_doit(ub,dta)
        integer :: ub
