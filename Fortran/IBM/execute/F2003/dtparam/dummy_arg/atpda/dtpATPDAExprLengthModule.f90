...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDAExprLengthModule
!*
!*  DATE                       : 2008-10-15
!*
...
module dtpATPDAExprLengthModulemod
...
end module dtpATPDAExprLengthModulemod


program dtpATPDAExprLengthModule

  use dtpATPDAExprLengthModulemod
  implicit none
  type (dtChars(5)) :: dc5
...
end program dtpATPDAExprLengthModule
