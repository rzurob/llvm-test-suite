...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDASimpleLengthModule
!*
!*  DATE                       : 2008-10-15
!*
...
module dtpATPDASimpleLengthModulemod
...
end module dtpATPDASimpleLengthModulemod


program dtpATPDASimpleLengthModule

  use dtpATPDASimpleLengthModulemod
  implicit none
  type (dt(3)) :: d3
  type (dtChars(5)) :: dc5
...
end program dtpATPDASimpleLengthModule
