...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDAExprLengthContentInternal
!*
!*  DATE                       : 2008-10-15
!*
...
!*  (Otherwise, this is the same as dtpATPDASimpleLengthContentInternal.)
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module dtpATPDAExprLengthContentInternalmod
...
end module dtpATPDAExprLengthContentInternalmod


program dtpATPDAExprLengthContentInternal

  use dtpATPDAExprLengthContentInternalmod
  implicit none
  type (dtChars(5)) :: dc5
  type (dtChars(1)) :: dc1
...
end program dtpATPDAExprLengthContentInternal
