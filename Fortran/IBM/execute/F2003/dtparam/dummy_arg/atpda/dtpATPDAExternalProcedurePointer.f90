...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDAExternalProcedurePointer
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : procedure pointers
!*
...
!*  DESCRIPTION
!*
!*  Invoke external procedures via pointers on SEQUENCE types.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789


program dtpATPDAExternalProcedurePointer
  ...
  interface
     ...
     integer function dtFun(o,expect)
       import :: dt
       type (dt(*)) :: o
       integer, intent(in) :: expect
     end function dtFun
     subroutine dtSub(o,expect)
       import :: dt
       type (dt(*)) :: o
       integer, intent(in) :: expect
...
end program dtpATPDAExternalProcedurePointer
