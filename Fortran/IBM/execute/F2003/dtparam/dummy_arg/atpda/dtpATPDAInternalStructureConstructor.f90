...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDAInternalStructureConstructor
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : internal procedures applied to structure constructors
!*
...
!*  DESCRIPTION
!*
!*  Pass the results of structure constructors to internal procedures using assumed type parameters.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program dtpATPDAInternalStructureConstructor
  ...
  call sub2(dtChars(5)('aeiouy','zyxwvuts','abcdefghijk','pqr'), 5)
  call sub2(dtChars(1)('qrs','lmno','kjih','gfe'), 1)

  call sub3(dtIntArray(9)([(i+100,i=1,9)], [(i,i=1,7)], [(81-i,i=1,81)], [(i*2,i=1,0)]), 9)
  call sub3(dtIntArray(2)([(2**(i+20),i=1,2)], [(i,i=1,0)], [(i**3,i=1,4)], [(i*2,i=1,2)]), 2)
...
end program dtpATPDAInternalStructureConstructor
