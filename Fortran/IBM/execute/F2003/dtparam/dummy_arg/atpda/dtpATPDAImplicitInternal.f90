...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDAImplicitInternal
!*  TEST CASE TITLE            : 
!*
...
!*
!*  SECONDARY FUNCTIONS TESTED : implicit declaration of DTP and especially assumed type parameter variables
!*
...
!*  DESCRIPTION
!*
!*  Declare types in internal procedures and use implicit statements to declare
...
module dtpATPDAImplicitInternalMod
  type dt(l)
     integer, len :: l
     sequence
  end type dt
...
end module dtpATPDAImplicitInternalMod



program dtpATPDAImplicitInternal

  use :: dtpATPDAImplicitInternalMod
  ...
  wdc5  = dtChars(5)('aeiouy','zyxwvuts','abcdefghijk','pqr')
  xdc1  = dtChars(1)('qrs',   'lmno',    'kjih',       'gfe')
  ydia9 = dtIntArray(9)([(i+100,i=1,9)], [(i,i=1,7)], [(81-i,i=1,81)], [(i*2,i=1,0)])
  zdia2 = dtIntArray(2)([(2**(i+20),i=1,2)], [(i,i=1,0)], [(i**3,i=1,4)], [(i*2,i=1,2)])
  ierrorCount = 0
...
end program dtpATPDAImplicitInternal
