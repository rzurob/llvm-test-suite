...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDASimpleLengthContentInternal
!*  TEST CASE TITLE            : 
!*
...
module dtpATPDASimpleLengthContentInternalmod
...
end module dtpATPDASimpleLengthContentInternalmod


program dtpATPDASimpleLengthContentInternal

  use dtpATPDASimpleLengthContentInternalmod
  implicit none
  type (dtChars(5)) :: dc5
  type (dtChars(1)) :: dc1
...
end program dtpATPDASimpleLengthContentInternal
