...
!*  ============================================================================
!*
!*  TEST CASE NAME             : dtpATPDADclExternalSequenceUseExternal
!*
!*  DATE                       : 2008-10-15
!*
!*  PRIMARY FUNCTIONS TESTED   : Assumed type parameters and dummy arguments
!*
!*  SECONDARY FUNCTIONS TESTED : declare and use sequence types in external procedures
!*
...
!*  DESCRIPTION
!*
!*  Declare SEQUENCE types in external procedures and use them in invocations of other external
!*  procedures.  This differs from dtpATPDADclExternalUseInternal in that SEQUENCE types are used,
!*  and the instances are used by multiple routines.  This is also a test of common blocks.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789


program dtpATPDADclExternalSequenceUseExternal
...
end program dtpATPDADclExternalSequenceUseExternal
...
block data dtpATPDADclExternalSequenceUseExternalDataBlock
  ...
  common /err/ errorCount
  common /dttest/ dt99, dt0
  common /dctest/ dc5, dc1
  common /diatest/ dia9, dia2

  data dc5 /dtChars(5)('aeiouy','zyxwvuts','abcdefghijk','pqr')/
  data dc1 /dtChars(1)('qrs',   'lmno',    'kjih',       'gfe')/
  data dia9/dtIntArray(9)([(i+100,i=1,9)], [(i,i=1,7)], [(81-i,i=1,81)], [(i*2,i=1,0)])/
  data dia2/dtIntArray(2)([(2**(i+20),i=1,2)], [(i,i=1,0)], [(i**3,i=1,4)], [(i*2,i=1,2)])/
  data errorCount /0/

end block data dtpATPDADclExternalSequenceUseExternalDataBlock
