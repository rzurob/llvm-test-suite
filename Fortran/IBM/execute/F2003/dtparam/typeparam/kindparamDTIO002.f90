...
!                               init-expr.: generic type bound DTIO
!*
!* ===================================================================
...
module m
    type base (k)
        ...
        generic :: write(formatted) => formattedWriteBase4, formattedWriteBase8
        procedure, private :: formattedWriteBase4
        procedure, private :: formattedWriteBase8
    end type
