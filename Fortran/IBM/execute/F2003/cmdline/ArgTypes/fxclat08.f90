...
! %START
! %MAIN: YES
! %PRECMD: export CmdLine="fxclat08 -- $ \#\#"
! %COMPOPTS:  -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: $TR_SRC/cmdline.sh fxclat08
! %END
! *********************************************************************
!*  ===================================================================
!*
...
!*
!*  DESCRIPTION                : Command line procedure arguments are pointer components of
!*                             : derived type defined in a module pointing allocatable objects,
!*                             : and call command line procedures from an internal subprogram
!*
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      character(2049)              :: CmdLine = 'fxclat08 -- $ \\#\\#'
      integer                      :: CmdCount, i
