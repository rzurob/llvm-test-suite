...
! %START
! %MAIN: YES
! %PRECMD: export CmdLine="fxclpl50 1 a"
...
! %STDOUT:
! %EXECARGS:
! %POSTCMD: $TR_SRC/cmdline.sh fxclpl50
! %END
! *********************************************************************
!*  ===================================================================
...
!*                             : in parallel region with workshare directive 
!*                         
!*  
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      BLOCK DATA 
        ...
        DATA CmdLine /"fxclpl50 1 a"/, NAME /'CmdLine   '/, TRIM_NAME /.true./
      ...
      INTERFACE 
        ...
        PURE LOGICAL FUNCTION SF_GET_CMD()
        END FUNCTION
        ...
        PURE LOGICAL FUNCTION SF_GET_ENV_VAR()
        END FUNCTION
