...
! %START
! %MAIN: YES
! %PRECMD: export CmdLine="fxclpl48 [A] [B] [C] [D[ ]E] ]O["
...
! %STDOUT:
! %EXECARGS:
! %POSTCMD: $TR_SRC/cmdline.sh fxclpl48
! %END
! *********************************************************************
!*  ===================================================================
...
!*                             : in parallel region in an internal sub with workshare directive 
!*                         
!* 
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      BLOCK DATA 
        ...
        DATA CmdLine /"fxclpl48 [A] [B] [C] [D[ ]E] ]O["/,NAME /'CmdLine    '/, TRIM_NAME /.true./
