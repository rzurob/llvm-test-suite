...
! %START
! %MAIN: YES
! %PRECMD: export CmdLine="fxclms08 ____"; export _=_ __=_ ___=_ ____=_ _____=_
! %COMPOPTS:  -qfree=f90 
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: $TR_SRC/cmdline.sh fxclms08; unset __ ___ ____ _____ 
! %END
! *********************************************************************
!*  ===================================================================
