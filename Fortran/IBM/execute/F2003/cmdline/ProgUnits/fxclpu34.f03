...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      integer          :: LENGTH  /123/
      character(2049)  :: CmdLine /'fxclpu34 1 a 2'/
      integer          :: CmdCOunt /3/
      ...
      INTEGER ENT_M_COMMAND_ARGUMENT_COUNT
      INTEGER ENT1_M_COMMAND_ARGUMENT_COUNT
      ...
      ENT_M_COMMAND_ARGUMENT_COUNT = ENT1_M_COMMAND_ARGUMENT_COUNT()
      RETURN

      ENTRY ENT1_M_COMMAND_ARGUMENT_COUNT
      ...
      CALL ENT1_M_GET_COMMAND
      RETURN

      ENTRY ENT1_M_GET_COMMAND
      ...
      CALL ENT1_M_GET_COMMAND_ARGUMENT
      RETURN

      ENTRY ENT1_M_GET_COMMAND_ARGUMENT
      ...
      CALL ENT1_M_GET_ENVIRONMENT_VARIABLE
      RETURN

      ENTRY ENT1_M_GET_ENVIRONMENT_VARIABLE
      ...
      DO i = 1, 5
        ...
        Junk = ENT_M_COMMAND_ARGUMENT_COUNT()
