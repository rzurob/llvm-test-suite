...
! %START
! %MAIN: YES
! %PRECMD: export CmdLine="fxclpu29 ----- ===== \{\}"
! %COMPOPTS:  -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: $TR_SRC/cmdline.sh fxclpu29
! %END
! *********************************************************************
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxclpu29.f
!*
!*  DATE                       : Oct. 1, 2003
!*
...
!*                             : of module subroutines which are called from internal
!*                             : subroutine of other modules
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      integer          :: LENGTH  /123/
      character(2049)  :: CmdLine /'fxclpu29 ----- ===== \\{\\}'/
      integer          :: CmdCOunt /3/
