...
! %START
! %MAIN: YES
! %PRECMD: export CmdLine="fxclpu07 MMMMMM, NNNNNN, ..."
! %COMPOPTS:  -qfree=f90  
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: $TR_SRC/cmdline.sh fxclpu07
! %END
! *********************************************************************
!*  ===================================================================
...
!234567890123456789012345678901234567890123456789012345678901234567890
      ...
      DATA (CmdLine(i), i = 1, 3)    /3*'fxclpu07 MMMMMM, NNNNNN, ...'/
