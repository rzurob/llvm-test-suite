...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtyla40
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
!! Test 3
   ...
   if ( dta%var_a /= 5.0e0 .or. dtc%var_a /= 5.0e0 ) error stop 68
   if ( (dta%var_b .neqv. .false.) .or. (dtc%var_b .neqv. .false.) ) error stop 70
   if ( dta%var_c /= 13.0q0 .or. dtc%var_c /= 13.0q0 ) error stop 72
   if ( dta%var_d /= 17.0d0 .or. dtc%var_d /= 17.0d0 ) error stop 74
   if ( dta%var_e /= 21.0e0 .or. dtc%var_e /= 21.0e0 ) error stop 76
   if ( (dta%var_f .neqv. .false.) .or. (dtc%var_f .neqv. .false.) ) error stop 78
   if ( dta%var_g /= 29.0d0 .or. dtc%var_g /= 29.0d0 ) error stop 80
   if ( (dta%var_h /= 'B') .or. (dtc%var_h /= 'B') ) error stop 82

   if ( dta%vdt2%var_a /= 6.0d0 .or. dtc%vdt2%var_a /= 6.0d0 ) error stop 84
   if ( (dta%vdt2%var_b .neqv. .false.) .or. (dtc%vdt2%var_b .neqv. .false.) ) error stop 86
   if ( dta%vdt2%var_c /= 14.0d0 .or. dtc%vdt2%var_c /= 14.0d0 ) error stop 88
   if ( (dta%vdt2%var_d /= 'B') .or. (dtc%vdt2%var_d /= 'B') ) error stop 90
   if ( dta%vdt2%var_e /= 22.0q0 .or. dtc%vdt2%var_e /= 22.0q0 ) error stop 92
   if ( dta%vdt2%var_f /= 26.0e0 .or. dtc%vdt2%var_f /= 26.0e0 ) error stop 94
   if ( (dta%vdt2%var_g .neqv. .false.) .or. (dtc%vdt2%var_g .neqv. .false.) ) error stop 96
   if ( dta%vdt2%var_h /= 34.0e0 .or. dtc%vdt2%var_h /= 34.0e0 ) error stop 98

   if ( (dta%vdt2%vdt1%var_a .neqv. .false.) .or. &
                              (dtc%vdt2%vdt1%var_a .neqv. .false.) ) error stop 100
   if ( dta%vdt2%vdt1%var_b /= 11.0d0 .or. &
                              dtc%vdt2%vdt1%var_b /= 11.0d0 ) error stop 102
   if ( (dta%vdt2%vdt1%var_c /= 'B') .or. &
                              (dtc%vdt2%vdt1%var_c /= 'B') ) error stop 104
   if ( dta%vdt2%vdt1%var_d /= 19.0e0 .or. &
                              dtc%vdt2%vdt1%var_d /= 19.0e0 ) error stop 106
   if ( dta%vdt2%vdt1%var_e /= 23.0q0 .or. &
                              dtc%vdt2%vdt1%var_e /= 23.0q0 ) error stop 108
   if ( dta%vdt2%vdt1%var_f /= 27.0d0 .or. &
                              dtc%vdt2%vdt1%var_f /= 27.0d0 ) error stop 110
   if ( (dta%vdt2%vdt1%var_g .neqv. .false.) .or. &
                              (dtc%vdt2%vdt1%var_g .neqv. .false.) ) error stop 112
   if ( dta%vdt2%vdt1%var_h /= 35.0e0 .or. &
                              dtc%vdt2%vdt1%var_h /= 35.0e0 ) error stop 114
...
!! Test 4
   ...
   if ( dta%var_a /= 5.0e0 .or. dtd%var_a /= 5.0e0 ) error stop 116
   if ( (dta%var_b .neqv. .false.) .or. (dtd%var_b .neqv. .false.) ) error stop 118
   if ( dta%var_c /= 13.0q0 .or. dtd%var_c /= 13.0q0 ) error stop 120
   if ( dta%var_d /= 17.0d0 .or. dtd%var_d /= 17.0d0 ) error stop 122
   if ( dta%var_e /= 21.0e0 .or. dtd%var_e /= 21.0e0 ) error stop 124
   if ( (dta%var_f .neqv. .false.) .or. (dtd%var_f .neqv. .false.) ) error stop 126
   if ( dta%var_g /= 29.0d0 .or. dtd%var_g /= 29.0d0 ) error stop 128
   if ( (dta%var_h /= 'B') .or. (dtd%var_h /= 'B') ) error stop 130

   if ( dta%vdt2%var_a /= 6.0d0 .or. dtd%vdt2%var_a /= 6.0d0 ) error stop 132
   if ( (dta%vdt2%var_b .neqv. .false.) .or. (dtd%vdt2%var_b .neqv. .false.) ) error stop 134
   if ( dta%vdt2%var_c /= 14.0d0 .or. dtd%vdt2%var_c /= 14.0d0 ) error stop 136
   if ( (dta%vdt2%var_d /= 'B') .or. (dtd%vdt2%var_d /= 'B') ) error stop 138
   if ( dta%vdt2%var_e /= 22.0q0 .or. dtd%vdt2%var_e /= 22.0q0 ) error stop 140
   if ( dta%vdt2%var_f /= 26.0e0 .or. dtd%vdt2%var_f /= 26.0e0 ) error stop 142
   if ( (dta%vdt2%var_g .neqv. .false.) .or. (dtd%vdt2%var_g .neqv. .false.) ) error stop 144
   if ( dta%vdt2%var_h /= 34.0e0 .or. dtd%vdt2%var_h /= 34.0e0 ) error stop 146

   if ( (dta%vdt2%vdt1%var_a .neqv. .false.) .or. &
                              (dtd%vdt2%vdt1%var_a .neqv. .false.) ) error stop 148
   if ( dta%vdt2%vdt1%var_b /= 11.0d0 .or. &
                              dtd%vdt2%vdt1%var_b /= 11.0d0 ) error stop 150
   if ( (dta%vdt2%vdt1%var_c /= 'B') .or. &
                              (dtd%vdt2%vdt1%var_c /= 'B') ) error stop 152
   if ( dta%vdt2%vdt1%var_d /= 19.0e0 .or. &
                              dtd%vdt2%vdt1%var_d /= 19.0e0 ) error stop 154
   if ( dta%vdt2%vdt1%var_e /= 23.0q0 .or. &
                              dtd%vdt2%vdt1%var_e /= 23.0q0 ) error stop 156
   if ( dta%vdt2%vdt1%var_f /= 27.0d0 .or. &
                              dtd%vdt2%vdt1%var_f /= 27.0d0 ) error stop 158
   if ( (dta%vdt2%vdt1%var_g .neqv. .false.) .or. &
                              (dtd%vdt2%vdt1%var_g .neqv. .false.) ) error stop 160
   if ( dta%vdt2%vdt1%var_h /= 35.0e0 .or. &
                              dtd%vdt2%vdt1%var_h /= 35.0e0 ) error stop 162
...
function fun4(dtu)
   ...
   if ( dtu%var_a /= 4.0e0 .or. dtu%vdt2%var_a /= 4.0d0 .or. &
                            (dtu%vdt2%vdt1%var_a .neqv. .true.) ) error stop 196
   if ( (dtu%var_b .neqv. .true.) .or. (dtu%vdt2%var_b .neqv. .true.) .or. &
                            dtu%vdt2%vdt1%var_b /= 8.0d0 ) error stop 198
   if ( dtu%var_c /= 12.0q0 .or. dtu%vdt2%var_c /= 12.0d0 .or. &
                             (dtu%vdt2%vdt1%var_c /= 'A') ) error stop 200
   if ( dtu%var_d /= 16.0d0 .or. (dtu%vdt2%var_d /= 'A') .or. &
                             dtu%vdt2%vdt1%var_d /= 16.0e0 ) error stop 202
   if ( dtu%var_e /= 20.0e0 .or. dtu%vdt2%var_e /= 20.0q0 .or. &
                             dtu%vdt2%vdt1%var_e /= 20.0q0 ) error stop 204
   if ( (dtu%var_f .neqv. .true.) .or. dtu%vdt2%var_f /= 24.0e0 .or. &
                             dtu%vdt2%vdt1%var_f /= 24.0d0 ) error stop 206
   if ( dtu%var_g /= 28.0d0 .or. (dtu%vdt2%var_g .neqv. .true.) .or. &
                             (dtu%vdt2%vdt1%var_g .neqv. .true.) ) error stop 208
   if ( (dtu%var_h /= 'A') .or. dtu%vdt2%var_h /= 32.0e0 .or. &
                             dtu%vdt2%vdt1%var_h /= 32.0e0 ) error stop 210
