   ...
   for ( k = 0; k < DIM2*DIM1; k++ ) {
    for ( i = 0; i < DIM1; i++ ) {
     for ( j = 0; j < DIM2; j++ ) {
      ...
      if ( (dta+k)->vdt2[j][i].vdt1[j][i].var_g[i][j] != 1 ) exit(65);
   ...
   for ( k = 0; k < DIM2*DIM1; k++ ) {
    for ( i = 0; i < DIM1; i++ ) {
     for ( j = 0; j < DIM2; j++ ) {
      ...
      if ( (dtb+k)->vdt2[j][i].vdt1[j][i].var_g[i][j] != 1 ) exit(113);
