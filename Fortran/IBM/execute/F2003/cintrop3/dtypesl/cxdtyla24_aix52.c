    ...
    for ( l = 0; l < DIM1; l++ ) {
     for ( i = 0; i < DIM1; i++ ) {
      for ( j = 0; j < DIM2; j++ ) {
       ...
       if ( dta[k][l].vdt2[j][i].vdt1[j][i].var_g[i][j] != 1 ) exit(65);
    ...
    for ( l = 0; l < DIM1; l++ ) {
     for ( i = 0; i < DIM1; i++ ) {
      for ( j = 0; j < DIM2; j++ ) {
       ...
       if ( dtb[k][l].var_b[i][j] != 1 ) exit(71);
       ...
       if ( dtb[k][l].vdt2[j][i].var_g[i][j] != 1 ) exit(97);
       if ( dtb[k][l].vdt2[j][i].var_h[i][j] != (float)(2*(i*DIM2+j+9)+6) ) exit(99);

       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_a[i][j] != 1 ) exit(101);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_b[i][j] != (double)(2*(i*DIM2+j+3)) ) exit(103);
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_c[i][j] != 'B' ) exit(105);
       ...
       if ( dtb[k][l].vdt2[j][i].vdt1[j][i].var_g[i][j] != 1 ) exit(113);
