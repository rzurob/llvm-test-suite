...
DT2 *fun4(DT2 *dtx, DT2 *dty) {
   ...
   if ( dtx->var_a != 4.0f || dtx->vdt1.var_a != 1 ) exit(69);
   if ( dtx->var_b != 1 || dtx->vdt1.var_b != 8 ) exit(71);
   if ( dtx->var_c != 12.0l || dtx->vdt1.var_c != 'A' ) exit(73);
   if ( dtx->var_d != 16.0 || dtx->vdt1.var_d != 16 ) exit(75);
   if ( dtx->var_e != 20.0f || dtx->vdt1.var_e != 20 ) exit(77);
   if ( dtx->var_f != 1 || dtx->vdt1.var_f != 24 ) exit(79);
   if ( dtx->var_g != 28.0 || dtx->vdt1.var_g != 1 ) exit(81);
   if ( dtx->var_h != 'A' || dtx->vdt1.var_h != 32 ) exit(83);
