...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtyla37
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
!! Test 3
   ...
   if ( dta%var_a /= 5.0e0 .or. dta%vdt2%var_a /= 6.0d0 .or. &
                            (dta%vdt2%vdt1%var_a .neqv. .false.) ) error stop 36

   if ( (dta%var_b .neqv. .false.) .or. (dta%vdt2%var_b .neqv. .false.) .or. &
                            dta%vdt2%vdt1%var_b /= 11.0d0 ) error stop 38

   if ( dta%var_c /= 13.0q0 .or. dta%vdt2%var_c /= 14.0d0 .or. &
                             (dta%vdt2%vdt1%var_c /= 'B') ) error stop 40

   if ( dta%var_d /= 17.0d0 .or. (dta%vdt2%var_d /= 'B') .or. &
   ...
   if ( (dta%var_f .neqv. .false.) .or. dta%vdt2%var_f /= 26.0e0 .or. &
                             dta%vdt2%vdt1%var_f /= 27.0d0 ) error stop 46

   if ( dta%var_g /= 29.0d0 .or. (dta%vdt2%var_g .neqv. .false.) .or. &
                             (dta%vdt2%vdt1%var_g .neqv. .false.) ) error stop 48

   if ( (dta%var_h /= 'B') .or. dta%vdt2%var_h /= 34.0e0 .or. &
...
subroutine sub1()
   ...
   if ( dta%var_a /= 2.0e0 .or. dta%vdt2%var_a /= 2.0d0 .or. & 
                          (dta%vdt2%vdt1%var_a .neqv. .true.) ) error stop 52
   ...
   if ( dta%var_c /= 6.0q0 .or. dta%vdt2%var_c /= 6.0d0 .or. &
                          (dta%vdt2%vdt1%var_c /= 'A') ) error stop 56
...
subroutine sub3(dtu)
   ...
   if ( dtu%var_a /= 4.0e0 .or. dtu%vdt2%var_a /= 4.0d0 .or. &
                            (dtu%vdt2%vdt1%var_a .neqv. .true.) ) error stop 68
   ...
   if ( dtu%var_c /= 12.0q0 .or. dtu%vdt2%var_c /= 12.0d0 .or. &
                             (dtu%vdt2%vdt1%var_c /= 'A') ) error stop 72
   ...
   if ( dtu%var_g /= 28.0d0 .or. (dtu%vdt2%var_g .neqv. .true.) .or. &
                             (dtu%vdt2%vdt1%var_g .neqv. .true.) ) error stop 80
