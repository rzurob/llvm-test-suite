...
int main() {
   ...
   DT3 dt0 = {2.0f,0,6.0l,8.0,10.0f,0,14.0,'A',
             {{0,4.0,'A',8.0f,10.0l,12.0,0,16.0f},
             2.0,0,6.0,'A',10.0l,12.0f,0,16.0f}};
   ...
   if ( dta.var_a != 3.0f || dta.vdt2.var_a != 4.0 ||
                          dta.vdt2.vdt1.var_a != 1 ) exit(21);

   if ( dta.var_b != 1 || dta.vdt2.var_b != 1 ||
                          dta.vdt2.vdt1.var_b != 7.0 ) exit(23);

   if ( dta.var_c != 7.0l || dta.vdt2.var_c != 8.0 ||
                          dta.vdt2.vdt1.var_c != 'B' ) exit(25);

   if ( dta.var_d != 9.0 || dta.vdt2.var_d != 'B' ||
                          dta.vdt2.vdt1.var_d != 11.0f ) exit(27);

   if ( dta.var_e != 11.0f || dta.vdt2.var_e != 12.0l ||
                           dta.vdt2.vdt1.var_e != 13.0l ) exit(29);

   if ( dta.var_f != 1 || dta.vdt2.var_f != 14.0f ||
                           dta.vdt2.vdt1.var_f != 15.0 ) exit(31);

   if ( dta.var_g != 15.0 || dta.vdt2.var_g != 1 ||
                           dta.vdt2.vdt1.var_g != 1 ) exit(33);

   if ( dta.var_h != 'B' || dta.vdt2.var_h != 18.0f ||
   ...
   if ( dta.var_a != 2.0f || dta.vdt2.var_a != 2.0 ||
                          dta.vdt2.vdt1.var_a != 0 ) exit(37);

   if ( dta.var_b != 0 || dta.vdt2.var_b != 0 ||
                          dta.vdt2.vdt1.var_b != 4.0 ) exit(39);

   if ( dta.var_c != 6.0l || dta.vdt2.var_c != 6.0 ||
                          dta.vdt2.vdt1.var_c != 'A' ) exit(41);

   if ( dta.var_d != 8.0 || dta.vdt2.var_d != 'A' ||
                          dta.vdt2.vdt1.var_d != 8.0f ) exit(43);

   if ( dta.var_e != 10.0f || dta.vdt2.var_e != 10.0l ||
                           dta.vdt2.vdt1.var_e != 10.0l ) exit(45);

   if ( dta.var_f != 0 || dta.vdt2.var_f != 12.0f ||
                           dta.vdt2.vdt1.var_f != 12.0 ) exit(47);

   if ( dta.var_g != 14.0 || dta.vdt2.var_g != 0 ||
                           dta.vdt2.vdt1.var_g != 0 ) exit(49);

   if ( dta.var_h != 'A' || dta.vdt2.var_h != 16.0f ||
   ...
   if ( dtb.var_b != 1 || dtb.vdt2.var_b != 1 ||
                          dtb.vdt2.vdt1.var_b != 11.0 ) exit(55);

   if ( dtb.var_c != 13.0l || dtb.vdt2.var_c != 14.0 ||
                           dtb.vdt2.vdt1.var_c != 'B' ) exit(57);

   if ( dtb.var_d != 17.0 || dtb.vdt2.var_d != 'B' ||
                           dtb.vdt2.vdt1.var_d != 19.0f ) exit(59);

   if ( dtb.var_e != 21.0f || dtb.vdt2.var_e != 22.0l ||
                           dtb.vdt2.vdt1.var_e != 23.0l ) exit(61);

   if ( dtb.var_f != 1 || dtb.vdt2.var_f != 26.0f ||
                           dtb.vdt2.vdt1.var_f != 27.0 ) exit(63);

   if ( dtb.var_g != 29.0 || dtb.vdt2.var_g != 1 ||
                           dtb.vdt2.vdt1.var_g != 1 ) exit(65);

   if ( dtb.var_h != 'B' || dtb.vdt2.var_h != 34.0f ||
