...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtylb38
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 1
   ...
   if ( dta%var_a /= 3.0e0 .or. dta%vdt2%var_a /= 4.0d0 .or. &
                            (dta%vdt2%vdt1%var_a .neqv. .false.) ) error stop 52
