...
#define PROGNAME bddiag01t
#define COMPTYPE type(nbcdt)
#define USESTATEMENT 
#define DT_DECLARATION type nbcdt; integer(4) a; end type
#include "bddiag01.ft"
