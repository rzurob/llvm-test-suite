...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtyra36a
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
!! Test 3
   ...
   if ( dtb%var_d /= 17.0d0 .or. dtb%vdt2%var_d /= 18 .or. &
   ...
   if ( dtb%var_f /= 25 .or. dtb%vdt2%var_f /= 26.0e0 .or. &
                             dtb%vdt2%vdt1%var_f /= 27.0d0 ) error stop 62

   if ( dtb%var_g /= 29.0d0 .or. dtb%vdt2%var_g /= 30 .or. &
                             dtb%vdt2%vdt1%var_g /= 31 ) error stop 64

   if ( dtb%var_h /= 33 .or. dtb%vdt2%var_h /= 34.0e0 .or. &
                             dtb%vdt2%vdt1%var_h /= 35.0e0 ) error stop 66

end program fxdtyra36a
