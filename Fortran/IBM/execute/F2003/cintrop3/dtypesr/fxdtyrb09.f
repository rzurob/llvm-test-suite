...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtyb00.presh fxdtyrb09 cxdtyra09
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 1
   ...
   if ( dta%vdt1%var_b /= 6.0d0 .or. dtb%vdt1%var_b /= 6.0d0 ) error stop 38
   if ( dta%vdt1%var_c /= 8 .or. dtb%vdt1%var_c /= 8 ) error stop 40
   if ( dta%vdt1%var_d /= 10.0e0 .or. dtb%vdt1%var_d /= 10.0e0 ) error stop 42
   if ( dta%vdt1%var_e /= 12.0q0 .or. dtb%vdt1%var_e /= 12.0q0 ) error stop 44
   if ( dta%vdt1%var_f /= 14.0d0 .or. dtb%vdt1%var_f /= 14.0d0 ) error stop 46
   if ( dta%vdt1%var_g /= 16 .or. dtb%vdt1%var_g /= 16 ) error stop 48
   if ( dta%vdt1%var_h /= 18.0e0 .or. dtb%vdt1%var_h /= 18.0e0 ) error stop 50
...
!! Test 2
   ...
   if ( dta%vdt1%var_b /= 4.0d0 .or. dtb%vdt1%var_b /= 6.0d0 ) error stop 70
   if ( dta%vdt1%var_c /= 6 .or. dtb%vdt1%var_c /= 8 ) error stop 72
   if ( dta%vdt1%var_d /= 8.0e0 .or. dtb%vdt1%var_d /= 10.0e0 ) error stop 74
   if ( dta%vdt1%var_e /= 10.0q0 .or. dtb%vdt1%var_e /= 12.0q0 ) error stop 76
   if ( dta%vdt1%var_f /= 12.0d0 .or. dtb%vdt1%var_f /= 14.0d0 ) error stop 78
   if ( dta%vdt1%var_g /= 14 .or. dtb%vdt1%var_g /= 16 ) error stop 80
   if ( dta%vdt1%var_h /= 16.0e0 .or. dtb%vdt1%var_h /= 18.0e0 ) error stop 82
...
!! Test 3
   ...
   if ( dtb%vdt1%var_b /= 10.0d0 .or. dtc%vdt1%var_b /= 10.0d0 ) error stop 102
   if ( dtb%vdt1%var_c /= 14 .or. dtc%vdt1%var_c /= 14 ) error stop 104
   if ( dtb%vdt1%var_d /= 18.0e0 .or. dtc%vdt1%var_d /= 18.0e0 ) error stop 106
   if ( dtb%vdt1%var_e /= 22.0q0 .or. dtc%vdt1%var_e /= 22.0q0 ) error stop 108
   if ( dtb%vdt1%var_f /= 26.0d0 .or. dtc%vdt1%var_f /= 26.0d0 ) error stop 110
   if ( dtb%vdt1%var_g /= 30 .or. dtc%vdt1%var_g /= 30 ) error stop 112
   if ( dtb%vdt1%var_h /= 34.0e0 .or. dtc%vdt1%var_h /= 34.0e0 ) error stop 114
...
!! Test 4
   ...
   if ( dtb%vdt1%var_b /= 10.0d0 .or. dtd%vdt1%var_b /= 10.0d0 ) error stop 134
   if ( dtb%vdt1%var_c /= 14 .or. dtd%vdt1%var_c /= 14 ) error stop 136
   if ( dtb%vdt1%var_d /= 18.0e0 .or. dtd%vdt1%var_d /= 18.0e0 ) error stop 138
   if ( dtb%vdt1%var_e /= 22.0q0 .or. dtd%vdt1%var_e /= 22.0q0 ) error stop 140
   if ( dtb%vdt1%var_f /= 26.0d0 .or. dtd%vdt1%var_f /= 26.0d0 ) error stop 142
   if ( dtb%vdt1%var_g /= 30 .or. dtd%vdt1%var_g /= 30 ) error stop 144
   if ( dtb%vdt1%var_h /= 34.0e0 .or. dtd%vdt1%var_h /= 34.0e0 ) error stop 146

end program fxdtyrb09
