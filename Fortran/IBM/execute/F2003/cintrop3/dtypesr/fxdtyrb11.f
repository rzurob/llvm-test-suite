...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtyb00.presh fxdtyrb11 cxdtyra11
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
function fun4(dtx,dty) bind(c)
   ...
   if ( dtx%var_a /= 4.0e0 .or. dtx%vdt1%var_a /= 4 ) error stop 68
   if ( dtx%var_b /= 8 .or. dtx%vdt1%var_b /= 8.0d0 ) error stop 70
   if ( dtx%var_c /= 12.0q0 .or. dtx%vdt1%var_c /= 12 ) error stop 72
   if ( dtx%var_d /= 16.0d0 .or. dtx%vdt1%var_d /= 16.0e0 ) error stop 74
   if ( dtx%var_e /= 20.0e0 .or. dtx%vdt1%var_e /= 20.0q0 ) error stop 76
   if ( dtx%var_f /= 24 .or. dtx%vdt1%var_f /= 24.0d0 ) error stop 78
   if ( dtx%var_g /= 28.0d0 .or. dtx%vdt1%var_g /= 28 ) error stop 80
   if ( dtx%var_h /= 32 .or. dtx%vdt1%var_h /= 32.0e0 ) error stop 82
   ...
   dtz%vdt1%var_b = dtx%vdt1%var_b + 2.0d0
   dtz%vdt1%var_c = dtx%vdt1%var_c + 2
   dtz%vdt1%var_d = dtx%vdt1%var_d + 2.0e0
   dtz%vdt1%var_e = dtx%vdt1%var_e + 2.0q0
   dtz%vdt1%var_f = dtx%vdt1%var_f + 2.0d0
   dtz%vdt1%var_g = dtx%vdt1%var_g + 2
   dtz%vdt1%var_h = dtx%vdt1%var_h + 2.0e0
