...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtyc00.presh fxdtycc07 cxdtycc07
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
function fun4(dtx,dty) bind(c)
   ...
   if ( dtx%var_b /= 8 .or. dtx%vdt2%var_b /= 8 .or. &
                            dtx%vdt2%vdt1%var_b /= (8.0d0,8.0d0) ) error stop 70
   if ( dtx%var_c /= (12.0q0,12.0q0) .or. dtx%vdt2%var_c /= (12.0d0,12.0d0) .or. &
                             dtx%vdt2%vdt1%var_c /= 12 ) error stop 72
   if ( dtx%var_d /= (16.0d0,16.0d0) .or. dtx%vdt2%var_d /= 16 .or. &
                             dtx%vdt2%vdt1%var_d /= (16.0e0,16.0e0) ) error stop 74
   if ( dtx%var_e /= (20.0e0,20.0e0) .or. dtx%vdt2%var_e /= (20.0q0,20.0q0) .or. &
                             dtx%vdt2%vdt1%var_e /= (20.0q0,20.0q0) ) error stop 76
   if ( dtx%var_f /= 24 .or. dtx%vdt2%var_f /= (24.0e0,24.0e0) .or. &
                             dtx%vdt2%vdt1%var_f /= (24.0d0,24.0d0) ) error stop 78
   if ( dtx%var_g /= (28.0d0,28.0d0) .or. dtx%vdt2%var_g /= 28 .or. &
                             dtx%vdt2%vdt1%var_g /= 28 ) error stop 80
   if ( dtx%var_h /= 32 .or. dtx%vdt2%var_h /= (32.0e0,32.0e0) .or. &
                             dtx%vdt2%vdt1%var_h /= (32.0e0,32.0e0) ) error stop 82
   ...
   dtz%vdt2%var_a = dtx%vdt2%var_a + (2.0d0,2.0d0)
   dtz%vdt2%var_b = dtx%vdt2%var_b + 2
   dtz%vdt2%var_c = dtx%vdt2%var_c + (2.0d0,2.0d0)
   dtz%vdt2%var_d = dtx%vdt2%var_d + 2
   dtz%vdt2%var_e = dtx%vdt2%var_e + (2.0q0,2.0q0)
   dtz%vdt2%var_f = dtx%vdt2%var_f + (2.0e0,2.0e0)
   dtz%vdt2%var_g = dtx%vdt2%var_g + 2
   dtz%vdt2%var_h = dtx%vdt2%var_h + (2.0e0,2.0e0)

   dtz%vdt2%vdt1%var_a = dtx%vdt2%vdt1%var_a + 3
   dtz%vdt2%vdt1%var_b = dtx%vdt2%vdt1%var_b + (3.0d0,3.0d0)
   dtz%vdt2%vdt1%var_c = dtx%vdt2%vdt1%var_c + 3
   dtz%vdt2%vdt1%var_d = dtx%vdt2%vdt1%var_d + (3.0e0,3.0e0)
   dtz%vdt2%vdt1%var_e = dtx%vdt2%vdt1%var_e + (3.0q0,3.0q0)
   dtz%vdt2%vdt1%var_f = dtx%vdt2%vdt1%var_f + (3.0d0,3.0d0)
   dtz%vdt2%vdt1%var_g = dtx%vdt2%vdt1%var_g + 3
   dtz%vdt2%vdt1%var_h = dtx%vdt2%vdt1%var_h + (3.0e0,3.0e0)
