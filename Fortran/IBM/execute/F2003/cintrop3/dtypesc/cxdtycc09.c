...
#ifdef CMPLX
   if ( dtx->var_a != 4.0f+I*4.0f || dtx->vdt1.var_a != 4 ) exit(69);
#else
   if ( dtx->var_a != createcomplexf(4.0f,4.0f) || dtx->vdt1.var_a != 4 ) exit(69);
#endif
#ifdef CMPLX
   if ( dtx->var_b != 8 || dtx->vdt1.var_b != 8.0+I*8.0 ) exit(71);
#else
   if ( dtx->var_b != 8 || dtx->vdt1.var_b != createcomplex(8.0,8.0) ) exit(71);
#endif
#ifdef CMPLX
   if ( dtx->var_c != 12.0l+I*12.0l || dtx->vdt1.var_c != 12 ) exit(73);
#else
   if ( dtx->var_c != createcomplexl(12.0l,12.0l) || dtx->vdt1.var_c != 12 ) exit(73);
#endif
#ifdef CMPLX
   if ( dtx->var_d != 16.0+I*16.0 || dtx->vdt1.var_d != 16.0f+I*16.0f ) exit(75);
#else
   if ( dtx->var_d != createcomplex(16.0,16.0) || dtx->vdt1.var_d != createcomplexf(16.0f,16.0f) ) exit(75);
#endif
#ifdef CMPLX
   if ( dtx->var_e != 20.0f+I*20.0f || dtx->vdt1.var_e != 20.0l+I*20.0l ) exit(77);
#else
   if ( dtx->var_e != createcomplexf(20.0f,20.0f) || dtx->vdt1.var_e != createcomplexl(20.0l,20.0l) ) exit(77);
#endif
#ifdef CMPLX
   if ( dtx->var_f != 24 || dtx->vdt1.var_f != 24.0+I*24.0 ) exit(79);
#else
   if ( dtx->var_f != 24 || dtx->vdt1.var_f != createcomplex(24.0,24.0) ) exit(79);
#endif
#ifdef CMPLX
   if ( dtx->var_g != 28.0+I*28.0 || dtx->vdt1.var_g != 28 ) exit(81);
#else
   if ( dtx->var_g != createcomplex(28.0,28.0) || dtx->vdt1.var_g != 28 ) exit(81);
#endif
#ifdef CMPLX
   if ( dtx->var_h != 32 || dtx->vdt1.var_h != 32.0f+I*32.0f ) exit(83);
#else
   if ( dtx->var_h != 32 || dtx->vdt1.var_h != createcomplexf(32.0f,32.0f) ) exit(83);
#endif
...
#ifdef CMPLX
   dtz->vdt1.var_b = dtx->vdt1.var_b + 2.0+I*2.0;
#else
   dtz->vdt1.var_b = dtx->vdt1.var_b + createcomplex(2.0,2.0);
#endif
   dtz->vdt1.var_c = dtx->vdt1.var_c + 2;
#ifdef CMPLX
   dtz->vdt1.var_d = dtx->vdt1.var_d + 2.0f+I*2.0f;
#else
   dtz->vdt1.var_d = dtx->vdt1.var_d + createcomplexf(2.0f,2.0f);
#endif
#ifdef CMPLX
   dtz->vdt1.var_e = dtx->vdt1.var_e + 2.0l+I*2.0l;
#else
   dtz->vdt1.var_e = dtx->vdt1.var_e + createcomplexl(2.0l,2.0l);
#endif
#ifdef CMPLX
   dtz->vdt1.var_f = dtx->vdt1.var_f + 2.0+I*2.0;
#else
   dtz->vdt1.var_f = dtx->vdt1.var_f + createcomplex(2.0,2.0);
#endif
   dtz->vdt1.var_g = dtx->vdt1.var_g + 2;
#ifdef CMPLX
   dtz->vdt1.var_h = dtx->vdt1.var_h + 2.0f+I*2.0f;
#else
   dtz->vdt1.var_h = dtx->vdt1.var_h + createcomplexf(2.0f,2.0f);
#endif
