...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtycd37
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 3
   ...
   if ( dta%var_b /= 9 .or. dta%vdt2%var_b /= 10 .or. &
                            dta%vdt2%vdt1%var_b /= (11.0d0,11.0d0) ) error stop 38
   ...
   if ( dta%var_d /= (17.0d0,17.0d0) .or. dta%vdt2%var_d /= 18 .or. &
                             dta%vdt2%vdt1%var_d /= (19.0e0,19.0e0) ) error stop 42

   if ( dta%var_e /= (21.0e0,21.0e0) .or. dta%vdt2%var_e /= (22.0q0,22.0q0) .or. &
                             dta%vdt2%vdt1%var_e /= (23.0q0,23.0q0) ) error stop 44

   if ( dta%var_f /= 25 .or. dta%vdt2%var_f /= (26.0e0,26.0e0) .or. &
                             dta%vdt2%vdt1%var_f /= (27.0d0,27.0d0) ) error stop 46
   ...
   if ( dta%var_h /= 33 .or. dta%vdt2%var_h /= (34.0e0,34.0e0) .or. &
                             dta%vdt2%vdt1%var_h /= (35.0e0,35.0e0) ) error stop 50
...
subroutine sub1()
   ...
   if ( dta%var_b /= 4 .or. dta%vdt2%var_b /= 4 .or. &
                          dta%vdt2%vdt1%var_b /= (4.0d0,4.0d0) ) error stop 54
   ...
   if ( dta%var_d /= (8.0d0,8.0d0) .or. dta%vdt2%var_d /= 8 .or. &
                          dta%vdt2%vdt1%var_d /= (8.0e0,8.0e0) ) error stop 58
   if ( dta%var_e /= (10.0e0,10.0e0) .or. dta%vdt2%var_e /= (10.0q0,10.0q0) .or. &
                           dta%vdt2%vdt1%var_e /= (10.0q0,10.0q0) ) error stop 60
   if ( dta%var_f /= 12 .or. dta%vdt2%var_f /= (12.0e0,12.0e0) .or. &
                           dta%vdt2%vdt1%var_f /= (12.0d0,12.0d0) ) error stop 62
   if ( dta%var_g /= (14.0d0,14.0d0) .or. dta%vdt2%var_g /= 14 .or. &
                           dta%vdt2%vdt1%var_h /= (16.0e0,16.0e0) ) error stop 64
   if ( dta%var_h /= 16 .or. dta%vdt2%var_h /= (16.0e0,16.0e0) .or. &
                           dta%vdt2%vdt1%var_h /= (16.0e0,16.0e0) ) error stop 66
...
subroutine sub3(dtu)
   ...
   if ( dtu%var_b /= 8 .or. dtu%vdt2%var_b /= 8 .or. &
                            dtu%vdt2%vdt1%var_b /= (8.0d0,8.0d0) ) error stop 70
   ...
   if ( dtu%var_d /= (16.0d0,16.0d0) .or. dtu%vdt2%var_d /= 16 .or. &
                             dtu%vdt2%vdt1%var_d /= (16.0e0,16.0e0) ) error stop 74

   if ( dtu%var_e /= (20.0e0,20.0e0) .or. dtu%vdt2%var_e /= (20.0q0,20.0q0) .or. &
                             dtu%vdt2%vdt1%var_e /= (20.0q0,20.0q0) ) error stop 76

   if ( dtu%var_f /= 24 .or. dtu%vdt2%var_f /= (24.0e0,24.0e0) .or. &
                             dtu%vdt2%vdt1%var_f /= (24.0d0,24.0d0) ) error stop 78
   ...
   if ( dtu%var_h /= 32 .or. dtu%vdt2%var_h /= (32.0e0,32.0e0) .or. &
                             dtu%vdt2%vdt1%var_h /= (32.0e0,32.0e0) ) error stop 82
