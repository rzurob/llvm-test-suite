...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtycd38
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
!! Test 3
   ...
   if ( dta%var_a /= (5.0e0,5.0e0) .or. dta%vdt2%var_a /= (6.0d0,6.0d0) .or. &
                            dta%vdt2%vdt1%var_a /= 7 ) error stop 68

   if ( dta%var_b /= 9 .or. dta%vdt2%var_b /= 10 .or. &
                            dta%vdt2%vdt1%var_b /= (11.0d0,11.0d0) ) error stop 70

   if ( dta%var_c /= (13.0q0,13.0q0) .or. dta%vdt2%var_c /= (14.0d0,14.0d0) .or. &
                             dta%vdt2%vdt1%var_c /= 15 ) error stop 72

   if ( dta%var_d /= (17.0d0,17.0d0) .or. dta%vdt2%var_d /= 18 .or. &
                             dta%vdt2%vdt1%var_d /= (19.0e0,19.0e0) ) error stop 74

   if ( dta%var_e /= (21.0e0,21.0e0) .or. dta%vdt2%var_e /= (22.0q0,22.0q0) .or. &
                             dta%vdt2%vdt1%var_e /= (23.0q0,23.0q0) ) error stop 76

   if ( dta%var_f /= 25 .or. dta%vdt2%var_f /= (26.0e0,26.0e0) .or. &
                             dta%vdt2%vdt1%var_f /= (27.0d0,27.0d0) ) error stop 78

   if ( dta%var_g /= (29.0d0,29.0d0) .or. dta%vdt2%var_g /= 30 .or. &
                             dta%vdt2%vdt1%var_g /= 31 ) error stop 80

   if ( dta%var_h /= 33 .or. dta%vdt2%var_h /= (34.0e0,34.0e0) .or. &
                             dta%vdt2%vdt1%var_h /= (35.0e0,35.0e0) ) error stop 82

end program fxdtycd38
