...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtycd39a
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
program fxdtycd39a
   ...
   type(dt3) :: dt0 = dt3(dt2((2.0d0,2.0d0),4,(6.0d0,6.0d0),8,(10.0q0,10.0q0),(12.0e0,12.0e0),14,(16.0e0,16.0e0), &
                      dt1(2,(4.0d0,4.0d0),6,(8.0e0,8.0e0),(10.0q0,10.0q0),(12.0d0,12.0d0),14,(16.0e0,16.0e0))), &
                      (2.0e0,2.0e0),4,(6.0q0,6.0q0),(8.0d0,8.0d0),(10.0e0,10.0e0),12,(14.0d0,14.0d0),16)
...
!! Test 2
   ...
   if ( dta%var_a /= (2.0e0,2.0e0) .or. dtb%var_a /= (3.0e0,3.0e0) ) error stop 68
   if ( dta%var_b /= 4 .or. dtb%var_b /= 5 ) error stop 70
   if ( dta%var_c /= (6.0q0,6.0q0) .or. dtb%var_c /= (7.0q0,7.0q0) ) error stop 72
   if ( dta%var_d /= (8.0d0,8.0d0) .or. dtb%var_d /= (9.0d0,9.0d0) ) error stop 74
   if ( dta%var_e /= (10.0e0,10.0e0) .or. dtb%var_e /= (11.0e0,11.0e0) ) error stop 76
   if ( dta%var_f /= 12 .or. dtb%var_f /= 13 ) error stop 78
   if ( dta%var_g /= (14.0d0,14.0d0) .or. dtb%var_g /= (15.0d0,15.0d0) ) error stop 80
   if ( dta%var_h /= 16 .or. dtb%var_h /= 17 ) error stop 82

   if ( dta%vdt2%var_a /= (2.0d0,2.0d0) .or. dtb%vdt2%var_a /= (4.0d0,4.0d0) ) error stop 84
   if ( dta%vdt2%var_b /= 4 .or. dtb%vdt2%var_b /= 6 ) error stop 86
   if ( dta%vdt2%var_c /= (6.0d0,6.0d0) .or. dtb%vdt2%var_c /= (8.0d0,8.0d0) ) error stop 88
   if ( dta%vdt2%var_d /= 8 .or. dtb%vdt2%var_d /= 10 ) error stop 90
   if ( dta%vdt2%var_e /= (10.0q0,10.0q0) .or. dtb%vdt2%var_e /= (12.0q0,12.0q0) ) error stop 92
   if ( dta%vdt2%var_f /= (12.0e0,12.0e0) .or. dtb%vdt2%var_f /= (14.0e0,14.0e0) ) error stop 94
   if ( dta%vdt2%var_g /= 14 .or. dtb%vdt2%var_g /= 16 ) error stop 96
   if ( dta%vdt2%var_h /= (16.0e0,16.0e0) .or. dtb%vdt2%var_h /= (18.0e0,18.0e0) ) error stop 98

   if ( dta%vdt2%vdt1%var_a /= 2 .or. &
                               dtb%vdt2%vdt1%var_a /= 5 ) error stop 100
   if ( dta%vdt2%vdt1%var_b /= (4.0d0,4.0d0) .or. &
                               dtb%vdt2%vdt1%var_b /= (7.0d0,7.0d0) ) error stop 102
   if ( dta%vdt2%vdt1%var_c /= 6 .or. &
                               dtb%vdt2%vdt1%var_c /= 9 ) error stop 104
   if ( dta%vdt2%vdt1%var_d /= (8.0e0,8.0e0) .or. &
                               dtb%vdt2%vdt1%var_d /= (11.0e0,11.0e0) ) error stop 106
   if ( dta%vdt2%vdt1%var_e /= (10.0q0,10.0q0) .or. &
                               dtb%vdt2%vdt1%var_e /= (13.0q0,13.0q0) ) error stop 108
   if ( dta%vdt2%vdt1%var_f /= (12.0d0,12.0d0) .or. &
                               dtb%vdt2%vdt1%var_f /= (15.0d0,15.0d0) ) error stop 110
   if ( dta%vdt2%vdt1%var_g /= 14 .or. &
                               dtb%vdt2%vdt1%var_g /= 17 ) error stop 112
   if ( dta%vdt2%vdt1%var_h /= (16.0e0,16.0e0) .or. &
                               dtb%vdt2%vdt1%var_h /= (19.0e0,19.0e0) ) error stop 114
...
!! Test 3
   ...
   if ( dtb%var_a /= (5.0e0,5.0e0) .or. dtc%var_a /= (5.0e0,5.0e0) ) error stop 116
   if ( dtb%var_b /= 9 .or. dtc%var_b /= 9 ) error stop 118
   if ( dtb%var_c /= (13.0q0,13.0q0) .or. dtc%var_c /= (13.0q0,13.0q0) ) error stop 120
   if ( dtb%var_d /= (17.0d0,17.0d0) .or. dtc%var_d /= (17.0d0,17.0d0) ) error stop 122
   if ( dtb%var_e /= (21.0e0,21.0e0) .or. dtc%var_e /= (21.0e0,21.0e0) ) error stop 124
   if ( dtb%var_f /= 25 .or. dtc%var_f /= 25 ) error stop 126
   if ( dtb%var_g /= (29.0d0,29.0d0) .or. dtc%var_g /= (29.0d0,29.0d0) ) error stop 128
   if ( dtb%var_h /= 33 .or. dtc%var_h /= 33 ) error stop 130

   if ( dtb%vdt2%var_a /= (6.0d0,6.0d0) .or. dtc%vdt2%var_a /= (6.0d0,6.0d0) ) error stop 132
   if ( dtb%vdt2%var_b /= 10 .or. dtc%vdt2%var_b /= 10 ) error stop 134
   if ( dtb%vdt2%var_c /= (14.0d0,14.0d0) .or. dtc%vdt2%var_c /= (14.0d0,14.0d0) ) error stop 136
   if ( dtb%vdt2%var_d /= 18 .or. dtc%vdt2%var_d /= 18 ) error stop 138
   if ( dtb%vdt2%var_e /= (22.0q0,22.0q0) .or. dtc%vdt2%var_e /= (22.0q0,22.0q0) ) error stop 140
   if ( dtb%vdt2%var_f /= (26.0e0,26.0e0) .or. dtc%vdt2%var_f /= (26.0e0,26.0e0) ) error stop 142
   if ( dtb%vdt2%var_g /= 30 .or. dtc%vdt2%var_g /= 30 ) error stop 144
   if ( dtb%vdt2%var_h /= (34.0e0,34.0e0) .or. dtc%vdt2%var_h /= (34.0e0,34.0e0) ) error stop 146

   if ( dtb%vdt2%vdt1%var_a /= 7 .or. &
                              dtc%vdt2%vdt1%var_a /= 7 ) error stop 148
   if ( dtb%vdt2%vdt1%var_b /= (11.0d0,11.0d0) .or. &
                              dtc%vdt2%vdt1%var_b /= (11.0d0,11.0d0) ) error stop 150
   if ( dtb%vdt2%vdt1%var_c /= 15 .or. &
                              dtc%vdt2%vdt1%var_c /= 15 ) error stop 152
   if ( dtb%vdt2%vdt1%var_d /= (19.0e0,19.0e0) .or. &
                              dtc%vdt2%vdt1%var_d /= (19.0e0,19.0e0) ) error stop 154
   if ( dtb%vdt2%vdt1%var_e /= (23.0q0,23.0q0) .or. &
                              dtc%vdt2%vdt1%var_e /= (23.0q0,23.0q0) ) error stop 156
   if ( dtb%vdt2%vdt1%var_f /= (27.0d0,27.0d0) .or. &
                              dtc%vdt2%vdt1%var_f /= (27.0d0,27.0d0) ) error stop 158
   if ( dtb%vdt2%vdt1%var_g /= 31 .or. &
                              dtc%vdt2%vdt1%var_g /= 31 ) error stop 160
   if ( dtb%vdt2%vdt1%var_h /= (35.0e0,35.0e0) .or. &
                              dtc%vdt2%vdt1%var_h /= (35.0e0,35.0e0) ) error stop 162
...
!! Test 4
   ...
   if ( dtb%var_a /= (5.0e0,5.0e0) .or. dtd%var_a /= (5.0e0,5.0e0) ) error stop 164
   if ( dtb%var_b /= 9 .or. dtd%var_b /= 9 ) error stop 166
   if ( dtb%var_c /= (13.0q0,13.0q0) .or. dtd%var_c /= (13.0q0,13.0q0) ) error stop 168
   if ( dtb%var_d /= (17.0d0,17.0d0) .or. dtd%var_d /= (17.0d0,17.0d0) ) error stop 170
   if ( dtb%var_e /= (21.0e0,21.0e0) .or. dtd%var_e /= (21.0e0,21.0e0) ) error stop 172
   if ( dtb%var_f /= 25 .or. dtd%var_f /= 25 ) error stop 174
   if ( dtb%var_g /= (29.0d0,29.0d0) .or. dtd%var_g /= (29.0d0,29.0d0) ) error stop 176
   if ( dtb%var_h /= 33 .or. dtd%var_h /= 33 ) error stop 178

   if ( dtb%vdt2%var_a /= (6.0d0,6.0d0) .or. dtd%vdt2%var_a /= (6.0d0,6.0d0) ) error stop 180
   if ( dtb%vdt2%var_b /= 10 .or. dtd%vdt2%var_b /= 10 ) error stop 182
   if ( dtb%vdt2%var_c /= (14.0d0,14.0d0) .or. dtd%vdt2%var_c /= (14.0d0,14.0d0) ) error stop 184
   if ( dtb%vdt2%var_d /= 18 .or. dtd%vdt2%var_d /= 18 ) error stop 186
   if ( dtb%vdt2%var_e /= (22.0q0,22.0q0) .or. dtd%vdt2%var_e /= (22.0q0,22.0q0) ) error stop 188
   if ( dtb%vdt2%var_f /= (26.0e0,26.0e0) .or. dtd%vdt2%var_f /= (26.0e0,26.0e0) ) error stop 190
   if ( dtb%vdt2%var_g /= 30 .or. dtd%vdt2%var_g /= 30 ) error stop 192
   if ( dtb%vdt2%var_h /= (34.0e0,34.0e0) .or. dtd%vdt2%var_h /= (34.0e0,34.0e0) ) error stop 194

   if ( dtb%vdt2%vdt1%var_a /= 7 .or. &
                              dtd%vdt2%vdt1%var_a /= 7 ) error stop 196
   if ( dtb%vdt2%vdt1%var_b /= (11.0d0,11.0d0) .or. &
                              dtd%vdt2%vdt1%var_b /= (11.0d0,11.0d0) ) error stop 198
   if ( dtb%vdt2%vdt1%var_c /= 15 .or. &
                              dtd%vdt2%vdt1%var_c /= 15 ) error stop 200
   if ( dtb%vdt2%vdt1%var_d /= (19.0e0,19.0e0) .or. &
                              dtd%vdt2%vdt1%var_d /= (19.0e0,19.0e0) ) error stop 202
   if ( dtb%vdt2%vdt1%var_e /= (23.0q0,23.0q0) .or. &
                              dtd%vdt2%vdt1%var_e /= (23.0q0,23.0q0) ) error stop 204
   if ( dtb%vdt2%vdt1%var_f /= (27.0d0,27.0d0) .or. &
                              dtd%vdt2%vdt1%var_f /= (27.0d0,27.0d0) ) error stop 206
   if ( dtb%vdt2%vdt1%var_g /= 31 .or. &
                              dtd%vdt2%vdt1%var_g /= 31 ) error stop 208
   if ( dtb%vdt2%vdt1%var_h /= (35.0e0,35.0e0) .or. &
                              dtd%vdt2%vdt1%var_h /= (35.0e0,35.0e0) ) error stop 210

end program fxdtycd39a
...
function fun1(dtk) bind(c)
   ...
   if ( dtk%var_a /= (2.0e0,2.0e0) .or. dtk%vdt2%var_a /= (2.0d0,2.0d0) .or. &
                          dtk%vdt2%vdt1%var_a /= 2 ) error stop 212
   if ( dtk%var_b /= 4 .or. dtk%vdt2%var_b /= 4 .or. &
                          dtk%vdt2%vdt1%var_b /= (4.0d0,4.0d0) ) error stop 214
   if ( dtk%var_c /= (6.0q0,6.0q0) .or. dtk%vdt2%var_c /= (6.0d0,6.0d0) .or. &
                          dtk%vdt2%vdt1%var_c /= 6 ) error stop 216
   if ( dtk%var_d /= (8.0d0,8.0d0) .or. dtk%vdt2%var_d /= 8 .or. &
                          dtk%vdt2%vdt1%var_d /= (8.0e0,8.0e0) ) error stop 218
   if ( dtk%var_e /= (10.0e0,10.0e0) .or. dtk%vdt2%var_e /= (10.0q0,10.0q0) .or. &
                           dtk%vdt2%vdt1%var_e /= (10.0q0,10.0q0) ) error stop 220
   if ( dtk%var_f /= 12 .or. dtk%vdt2%var_f /= (12.0e0,12.0e0) .or. &
                           dtk%vdt2%vdt1%var_f /= (12.0d0,12.0d0) ) error stop 222
   if ( dtk%var_g /= (14.0d0,14.0d0) .or. dtk%vdt2%var_g /= 14 .or. &
                           dtk%vdt2%vdt1%var_h /= (16.0e0,16.0e0) ) error stop 224
   if ( dtk%var_h /= 16 .or. dtk%vdt2%var_h /= (16.0e0,16.0e0) .or. &
                           dtk%vdt2%vdt1%var_h /= (16.0e0,16.0e0) ) error stop 226
...
function fun2(dtk) bind(c)
   ...
   if ( dtk%var_a /= (2.0e0,2.0e0) .or. dtk%vdt2%var_a /= (2.0d0,2.0d0) .or. &
                          dtk%vdt2%vdt1%var_a /= 2 ) error stop 228
   if ( dtk%var_b /= 4 .or. dtk%vdt2%var_b /= 4 .or. &
                          dtk%vdt2%vdt1%var_b /= (4.0d0,4.0d0) ) error stop 230
   if ( dtk%var_c /= (6.0q0,6.0q0) .or. dtk%vdt2%var_c /= (6.0d0,6.0d0) .or. &
                          dtk%vdt2%vdt1%var_c /= 6 ) error stop 232
   if ( dtk%var_d /= (8.0d0,8.0d0) .or. dtk%vdt2%var_d /= 8 .or. &
                          dtk%vdt2%vdt1%var_d /= (8.0e0,8.0e0) ) error stop 234
   if ( dtk%var_e /= (10.0e0,10.0e0) .or. dtk%vdt2%var_e /= (10.0q0,10.0q0) .or. &
                           dtk%vdt2%vdt1%var_e /= (10.0q0,10.0q0) ) error stop 236
   if ( dtk%var_f /= 12 .or. dtk%vdt2%var_f /= (12.0e0,12.0e0) .or. &
                           dtk%vdt2%vdt1%var_f /= (12.0d0,12.0d0) ) error stop 238
   if ( dtk%var_g /= (14.0d0,14.0d0) .or. dtk%vdt2%var_g /= 14 .or. &
                           dtk%vdt2%vdt1%var_h /= (16.0e0,16.0e0) ) error stop 240
   if ( dtk%var_h /= 16 .or. dtk%vdt2%var_h /= (16.0e0,16.0e0) .or. &
                           dtk%vdt2%vdt1%var_h /= (16.0e0,16.0e0) ) error stop 242
...
function fun3(dtu,dty) bind(c)
   ...
   if ( dtu%var_b /= 8 .or. dtu%vdt2%var_b /= 8 .or. & 
                            dtu%vdt2%vdt1%var_b /= (8.0d0,8.0d0) ) error stop 246
   ...
   if ( dtu%var_d /= (16.0d0,16.0d0) .or. dtu%vdt2%var_d /= 16 .or. &
                             dtu%vdt2%vdt1%var_d /= (16.0e0,16.0e0) ) error stop 250
   if ( dtu%var_e /= (20.0e0,20.0e0) .or. dtu%vdt2%var_e /= (20.0q0,20.0q0) .or. &
                             dtu%vdt2%vdt1%var_e /= (20.0q0,20.0q0) ) error stop 252
   if ( dtu%var_f /= 24 .or. dtu%vdt2%var_f /= (24.0e0,24.0e0) .or. &
                             dtu%vdt2%vdt1%var_f /= (24.0d0,24.0d0) ) error stop 254
   if ( dtu%var_g /= (28.0d0,28.0d0) .or. dtu%vdt2%var_g /= 28 .or. &
                             dtu%vdt2%vdt1%var_g /= 28 ) error stop 256
   if ( dtu%var_h /= 32 .or. dtu%vdt2%var_h /= (32.0e0,32.0e0) .or. &
                             dtu%vdt2%vdt1%var_h /= (32.0e0,32.0e0) ) error stop 258
...
function fun4(dtu,dty) bind(c)
   ...
   if ( dtu%var_a /= (4.0e0,4.0e0) .or. dtu%vdt2%var_a /= (4.0d0,4.0d0) .or. &
                            dtu%vdt2%vdt1%var_a /= 4 ) error stop 260
   if ( dtu%var_b /= 8 .or. dtu%vdt2%var_b /= 8 .or. &
                            dtu%vdt2%vdt1%var_b /= (8.0d0,8.0d0) ) error stop 262
   if ( dtu%var_c /= (12.0q0,12.0q0) .or. dtu%vdt2%var_c /= (12.0d0,12.0d0) .or. &
                             dtu%vdt2%vdt1%var_c /= 12 ) error stop 264
   if ( dtu%var_d /= (16.0d0,16.0d0) .or. dtu%vdt2%var_d /= 16 .or. &
                             dtu%vdt2%vdt1%var_d /= (16.0e0,16.0e0) ) error stop 266
   if ( dtu%var_e /= (20.0e0,20.0e0) .or. dtu%vdt2%var_e /= (20.0q0,20.0q0) .or. &
                             dtu%vdt2%vdt1%var_e /= (20.0q0,20.0q0) ) error stop 268
   if ( dtu%var_f /= 24 .or. dtu%vdt2%var_f /= (24.0e0,24.0e0) .or. &
                             dtu%vdt2%vdt1%var_f /= (24.0d0,24.0d0) ) error stop 270
   if ( dtu%var_g /= (28.0d0,28.0d0) .or. dtu%vdt2%var_g /= 28 .or. &
                             dtu%vdt2%vdt1%var_g /= 28 ) error stop 272
   if ( dtu%var_h /= 32 .or. dtu%vdt2%var_h /= (32.0e0,32.0e0) .or. &
                             dtu%vdt2%vdt1%var_h /= (32.0e0,32.0e0) ) error stop 274
