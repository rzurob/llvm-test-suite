...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtyia39a
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
function fun2(dtk) bind(c)
   ...
   if ( dtk%var_b /= 4 .or. dtk%vdt2%var_b /= 4 .or. &
                          dtk%vdt2%vdt1%var_b /= 4 ) error stop 230
   if ( dtk%var_c /= 6 .or. dtk%vdt2%var_c /= 6 .or. &
                          dtk%vdt2%vdt1%var_c /= 6 ) error stop 232
   if ( dtk%var_d /= 8 .or. dtk%vdt2%var_d /= 8 .or. &
                          dtk%vdt2%vdt1%var_d /= 8 ) error stop 234
   if ( dtk%var_e /= 10 .or. dtk%vdt2%var_e /= 10 .or. &
                           dtk%vdt2%vdt1%var_e /= 10 ) error stop 236
   if ( dtk%var_f /= 12 .or. dtk%vdt2%var_f /= 12 .or. &
                           dtk%vdt2%vdt1%var_f /= 12 ) error stop 238
   if ( dtk%var_g /= 14 .or. dtk%vdt2%var_g /= 14 .or. &
                           dtk%vdt2%vdt1%var_h /= 16 ) error stop 240
   if ( dtk%var_h /= 16 .or. dtk%vdt2%var_h /= 16 .or. &
                           dtk%vdt2%vdt1%var_h /= 16 ) error stop 242
...
function fun4(dtu,dty) bind(c)
   ...
   if ( dtu%var_b /= 8 .or. dtu%vdt2%var_b /= 8 .or. &
                            dtu%vdt2%vdt1%var_b /= 8 ) error stop 262
   if ( dtu%var_c /= 12 .or. dtu%vdt2%var_c /= 12 .or. &
                             dtu%vdt2%vdt1%var_c /= 12 ) error stop 264
   if ( dtu%var_d /= 16 .or. dtu%vdt2%var_d /= 16 .or. &
                             dtu%vdt2%vdt1%var_d /= 16 ) error stop 266
   if ( dtu%var_e /= 20 .or. dtu%vdt2%var_e /= 20 .or. &
                             dtu%vdt2%vdt1%var_e /= 20 ) error stop 268
   if ( dtu%var_f /= 24 .or. dtu%vdt2%var_f /= 24 .or. &
                             dtu%vdt2%vdt1%var_f /= 24 ) error stop 270
   if ( dtu%var_g /= 28 .or. dtu%vdt2%var_g /= 28 .or. &
                             dtu%vdt2%vdt1%var_g /= 28 ) error stop 272
   if ( dtu%var_h /= 32 .or. dtu%vdt2%var_h /= 32 .or. &
                             dtu%vdt2%vdt1%var_h /= 32 ) error stop 274
