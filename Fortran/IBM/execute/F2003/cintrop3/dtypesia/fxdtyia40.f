...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/scrdtya01.presh fxdtyia40
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!! Test 3
   ...
   if ( dta%var_a /= 5 .or. dtc%var_a /= 5 ) error stop 68
   if ( dta%var_b /= 9 .or. dtc%var_b /= 9 ) error stop 70
   if ( dta%var_c /= 13 .or. dtc%var_c /= 13 ) error stop 72
   if ( dta%var_d /= 17 .or. dtc%var_d /= 17 ) error stop 74
   if ( dta%var_e /= 21 .or. dtc%var_e /= 21 ) error stop 76
   if ( dta%var_f /= 25 .or. dtc%var_f /= 25 ) error stop 78
   if ( dta%var_g /= 29 .or. dtc%var_g /= 29 ) error stop 80
   if ( dta%var_h /= 33 .or. dtc%var_h /= 33 ) error stop 82

   if ( dta%vdt2%var_a /= 6 .or. dtc%vdt2%var_a /= 6 ) error stop 84
   if ( dta%vdt2%var_b /= 10 .or. dtc%vdt2%var_b /= 10 ) error stop 86
   if ( dta%vdt2%var_c /= 14 .or. dtc%vdt2%var_c /= 14 ) error stop 88
   if ( dta%vdt2%var_d /= 18 .or. dtc%vdt2%var_d /= 18 ) error stop 90
   if ( dta%vdt2%var_e /= 22 .or. dtc%vdt2%var_e /= 22 ) error stop 92
   if ( dta%vdt2%var_f /= 26 .or. dtc%vdt2%var_f /= 26 ) error stop 94
   if ( dta%vdt2%var_g /= 30 .or. dtc%vdt2%var_g /= 30 ) error stop 96
   if ( dta%vdt2%var_h /= 34 .or. dtc%vdt2%var_h /= 34 ) error stop 98

   if ( dta%vdt2%vdt1%var_a /= 7 .or. &
                              dtc%vdt2%vdt1%var_a /= 7 ) error stop 100
   if ( dta%vdt2%vdt1%var_b /= 11 .or. &
                              dtc%vdt2%vdt1%var_b /= 11 ) error stop 102
   if ( dta%vdt2%vdt1%var_c /= 15 .or. &
                              dtc%vdt2%vdt1%var_c /= 15 ) error stop 104
   if ( dta%vdt2%vdt1%var_d /= 19 .or. &
                              dtc%vdt2%vdt1%var_d /= 19 ) error stop 106
   if ( dta%vdt2%vdt1%var_e /= 23 .or. &
                              dtc%vdt2%vdt1%var_e /= 23 ) error stop 108
   if ( dta%vdt2%vdt1%var_f /= 27 .or. &
                              dtc%vdt2%vdt1%var_f /= 27 ) error stop 110
   if ( dta%vdt2%vdt1%var_g /= 31 .or. &
                              dtc%vdt2%vdt1%var_g /= 31 ) error stop 112
   if ( dta%vdt2%vdt1%var_h /= 35 .or. &
                              dtc%vdt2%vdt1%var_h /= 35 ) error stop 114
...
!! Test 4
   ...
   if ( dta%var_a /= 5 .or. dtd%var_a /= 5 ) error stop 116
   if ( dta%var_b /= 9 .or. dtd%var_b /= 9 ) error stop 118
   if ( dta%var_c /= 13 .or. dtd%var_c /= 13 ) error stop 120
   if ( dta%var_d /= 17 .or. dtd%var_d /= 17 ) error stop 122
   if ( dta%var_e /= 21 .or. dtd%var_e /= 21 ) error stop 124
   if ( dta%var_f /= 25 .or. dtd%var_f /= 25 ) error stop 126
   if ( dta%var_g /= 29 .or. dtd%var_g /= 29 ) error stop 128
   if ( dta%var_h /= 33 .or. dtd%var_h /= 33 ) error stop 130

   if ( dta%vdt2%var_a /= 6 .or. dtd%vdt2%var_a /= 6 ) error stop 132
   if ( dta%vdt2%var_b /= 10 .or. dtd%vdt2%var_b /= 10 ) error stop 134
   if ( dta%vdt2%var_c /= 14 .or. dtd%vdt2%var_c /= 14 ) error stop 136
   if ( dta%vdt2%var_d /= 18 .or. dtd%vdt2%var_d /= 18 ) error stop 138
   if ( dta%vdt2%var_e /= 22 .or. dtd%vdt2%var_e /= 22 ) error stop 140
   if ( dta%vdt2%var_f /= 26 .or. dtd%vdt2%var_f /= 26 ) error stop 142
   if ( dta%vdt2%var_g /= 30 .or. dtd%vdt2%var_g /= 30 ) error stop 144
   if ( dta%vdt2%var_h /= 34 .or. dtd%vdt2%var_h /= 34 ) error stop 146

   if ( dta%vdt2%vdt1%var_a /= 7 .or. &
                              dtd%vdt2%vdt1%var_a /= 7 ) error stop 148
   if ( dta%vdt2%vdt1%var_b /= 11 .or. &
                              dtd%vdt2%vdt1%var_b /= 11 ) error stop 150
   if ( dta%vdt2%vdt1%var_c /= 15 .or. &
                              dtd%vdt2%vdt1%var_c /= 15 ) error stop 152
   if ( dta%vdt2%vdt1%var_d /= 19 .or. &
                              dtd%vdt2%vdt1%var_d /= 19 ) error stop 154
   if ( dta%vdt2%vdt1%var_e /= 23 .or. &
                              dtd%vdt2%vdt1%var_e /= 23 ) error stop 156
   if ( dta%vdt2%vdt1%var_f /= 27 .or. &
                              dtd%vdt2%vdt1%var_f /= 27 ) error stop 158
   if ( dta%vdt2%vdt1%var_g /= 31 .or. &
                              dtd%vdt2%vdt1%var_g /= 31 ) error stop 160
   if ( dta%vdt2%vdt1%var_h /= 35 .or. &
                              dtd%vdt2%vdt1%var_h /= 35 ) error stop 162
...
function fun4(dtu)
   ...
   if ( dtu%var_b /= 8 .or. dtu%vdt2%var_b /= 8 .or. &
                            dtu%vdt2%vdt1%var_b /= 8 ) error stop 198
   if ( dtu%var_c /= 12 .or. dtu%vdt2%var_c /= 12 .or. &
                             dtu%vdt2%vdt1%var_c /= 12 ) error stop 200
   if ( dtu%var_d /= 16 .or. dtu%vdt2%var_d /= 16 .or. &
                             dtu%vdt2%vdt1%var_d /= 16 ) error stop 202
   if ( dtu%var_e /= 20 .or. dtu%vdt2%var_e /= 20 .or. &
                             dtu%vdt2%vdt1%var_e /= 20 ) error stop 204
   if ( dtu%var_f /= 24 .or. dtu%vdt2%var_f /= 24 .or. &
                             dtu%vdt2%vdt1%var_f /= 24 ) error stop 206
   if ( dtu%var_g /= 28 .or. dtu%vdt2%var_g /= 28 .or. &
                             dtu%vdt2%vdt1%var_g /= 28 ) error stop 208
   if ( dtu%var_h /= 32 .or. dtu%vdt2%var_h /= 32 .or. &
                             dtu%vdt2%vdt1%var_h /= 32 ) error stop 210
