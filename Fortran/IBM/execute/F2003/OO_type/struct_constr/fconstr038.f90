...
module m
    type base
        integer*4 :: id
        integer*4, pointer :: data1 => null()
        logical*4, allocatable :: data2(:)
    end type
...
module m1
use m
    type (base) :: b1_m = base(1, data2=null())
    type (child) :: c1_m = child (2, data2=null(), name = 'c1_m')
end module
...
use m1
    ...
    c1_m = child (i1, i_ptr, i_allo, char)
end subroutine
