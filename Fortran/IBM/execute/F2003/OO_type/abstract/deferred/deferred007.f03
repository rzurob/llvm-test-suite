...
module n
   ...
   contains
      ...
      class(base) function makechild(dtv)
      ...
      function makegen3(dtv) result(makechild)
         ...
         class(base), allocatable :: makechild(:)
...
program deferred007
   ...
   allocate ( b1(3), source = (/ child(1,11) , child(2,22) , child(3,33) /) )
   b2 => b1
   ...
   allocate ( b1(3), source = (/ gen3(1,11,111), gen3(1,11,111), gen3(6,66,666) /) )
