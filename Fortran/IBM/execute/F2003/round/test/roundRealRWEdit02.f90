...
!* ===================================================================
  ...
  program roundRealRWEdit02
    ...
    open(unit, access="direct", form="formatted", recl=34, status="scratch")
    ...
    do i = 7, 12
       write(unit,'(RN, f16.14, f16.14)', rec=i) w3, w4
    end do
