...
!* ===================================================================
  ...
  program roundX4WriteEdit02 
    ...
    open(unit, file='roundX4WriteEdit02.out', action='write', round="down")

    w1 = (1.250058651, -1.250058651)
    w2 = (3.141592653589, 2.718281828459)

    write(unit, '(1x,RU, 2f10.5, 1x, 2f15.6)', round="zero") w1, w2
    ...
    open(unit, file='roundX4WriteEdit02.out', action='write', round="up")

    write(unit, '(1x,RD, 2f10.5, 1x, 2f15.6)', round="zero") w1, w2
    ...
    write(unit, '(1x,RZ,2f10.5, 1x, 2f15.6)', round="up") w1, w2
    ...
    write(unit, '(1x,RN,2f10.5, 1x, 2f15.6)', round="zero") w1, w2
    ...
    open(unit, file='roundX4WriteEdit02.out', action='write',           &
      & round="up")

    write(unit, '(1x, RC, 2f10.5, 1x, 2f15.6)', round="zero") w1, w2
    ...
    write(unit, '(1x,RP, 2f10.5, 1x, 2f15.6)', round="up") w1, w2
