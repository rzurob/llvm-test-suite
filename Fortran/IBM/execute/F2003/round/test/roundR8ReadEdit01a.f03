...
!* ===================================================================
  ...
  program roundR8ReadEdit01a
    ...
    read(unit_r, '(RU,f14.13, f15.13)', round="up",iostat=ios) rd1, rd2
    ...
    read(unit_r, '(RD,e14.13, e15.13)', round='down',iostat=ios) rd1, rd2
    ...
    read(unit_r, '(RZ, g14.13, g15.13)',round='zero', iostat=ios) rd1, rd2
    ...
    read(unit_r, '(RN,en14.13, en15.13)', round='nearest',iostat=ios) rd1, rd2
    ...
    read(unit_r, '(RP, es14.13, es15.13)', round='processor_defined',  &
        & iostat=ios) rd1, rd2
    ...
    read(unit_r, '(RC, f14.13, f15.13)', round='compatible',            &
        & iostat=ios) rd1, rd2
  ...
  end program roundR8ReadEdit01a
