...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : roundspecifier019
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  80 format(rn,en13.6)
  90 format(rc,en12.6)
  100 format(rc,en13.6)
  110 format(rp,en12.6)
  120 format(rp,en13.6)
  
  !write formatting
  130 format(ru,en12.5)
  140 format(ru,en13.5)
  150 format(rd,en12.5)
  160 format(rd,en13.5)
  170 format(rz,en12.5)
  180 format(rz,en13.5)
  190 format(rn,en12.5)
  200 format(rn,en13.5)
  210 format(rc,en12.5)
  220 format(rc,en13.5)
  230 format(rp,en12.5)
  240 format(rp,en13.5)
  
  open(2, file='roundspecifier019.out', ROUND='up')
  ...
  round_mode_read='(ru,en12.6)'
  round_mode_write='(ru,en12.5)'
  ...
  round_mode_read='(ru,en13.6)'
  round_mode_write='(ru,en13.5)'
  ...
  round_mode_read='(rd,en12.6)'
  round_mode_write='(rd,en12.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rd,en13.6)'
  round_mode_write='(rd,en13.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rz,en12.6)'
  round_mode_write='(rz,en12.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rz,en13.6)'
  round_mode_write='(rz,en13.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rn,en12.6)'
  round_mode_write='(rn,en12.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rn,en13.6)'
  round_mode_write='(rn,en13.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rc,en12.6)'
  round_mode_write='(rc,en12.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rc,en13.6)'
  round_mode_write='(rc,en13.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rp,en12.6)'
  round_mode_write='(rp,en12.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rp,en13.6)'
  round_mode_write='(rp,en13.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
