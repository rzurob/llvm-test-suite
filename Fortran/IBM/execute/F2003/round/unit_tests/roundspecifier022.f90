...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : roundspecifier022
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  write_num1=6.45279031275468
  write_num2=6.45279031275462
  write_num3=-6.45279031275468
  write_num4=-6.45279031275462
  ...
  80 format(rn,f17.14)
  90 format(rc,f16.14)
  100 format(rc,f17.14)
  110 format(rp,f16.14)
  120 format(rp,f17.14)
  
  !write formatting
  130 format(ru,f16.13)
  140 format(ru,f17.13)
  150 format(rd,f16.13)
  160 format(rd,f17.13)
  170 format(rz,f16.13)
  180 format(rz,f17.13)
  190 format(rn,f16.13)
  200 format(rn,f17.13)
  210 format(rc,f16.13)
  220 format(rc,f17.13)
  230 format(rp,f16.13)
  240 format(rp,f17.13)
  
  open(2, file='roundspecifier022.out', ROUND='up')
  ...
  round_mode_read='(ru,f16.14)'
  round_mode_write='(ru,f16.13)'
  ...
  round_mode_read='(ru,f17.14)'
  round_mode_write='(ru,f17.13)'
  ...
  round_mode_read='(rd,f16.14)'
  round_mode_write='(rd,f16.13)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rd,f17.14)'
  round_mode_write='(rd,f17.13)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rz,f16.14)'
  round_mode_write='(rz,f16.13)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rz,f17.14)'
  round_mode_write='(rz,f17.13)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rn,f16.14)'
  round_mode_write='(rn,f16.13)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rn,f17.14)'
  round_mode_write='(rn,f17.13)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rc,f16.14)'
  round_mode_write='(rc,f16.13)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rc,f17.14)'
  round_mode_write='(rc,f17.13)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rp,f16.14)'
  round_mode_write='(rp,f16.13)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rp,f17.14)'
  round_mode_write='(rp,f17.13)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
