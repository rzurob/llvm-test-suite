...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : roundspecifier027
!*
...
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  character(25) :: round_mode_read, round_mode_write
  ...
  80 format(rn,2f10.6)
  90 format(rc,2f9.6)
  100 format(rc,2f10.6)
  110 format(rp,2f9.6)
  120 format(rp,2f10.6)
  
  !write formatting
  130 format(ru,2f9.5)
  140 format(ru,2f10.5)
  150 format(rd,2f9.5)
  160 format(rd,2f10.5)
  170 format(rz,2f9.5)
  180 format(rz,2f10.5)
  190 format(rn,2f9.5)
  200 format(rn,2f10.5)
  210 format(rc,2f9.5)
  220 format(rc,2f10.5)
  230 format(rp,2f9.5)
  240 format(rp,2f10.5)
  
  open(2, file='roundspecifier027.out', ROUND='up')
  ...
  round_mode_read='(ru,2f9.6)'
  round_mode_write='(ru,2f9.5)'
  ...
  round_mode_read='(ru,2f10.6)'
  round_mode_write='(ru,2f10.5)'
  ...
  round_mode_read='(rd,2f9.6)'
  round_mode_write='(rd,2f9.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rd,2f10.6)'
  round_mode_write='(rd,2f10.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rz,2f9.6)'
  round_mode_write='(rz,2f9.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rz,2f10.6)'
  round_mode_write='(rz,2f10.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rn,2f9.6)'
  round_mode_write='(rn,2f9.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rn,2f10.6)'
  round_mode_write='(rn,2f10.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rc,2f9.6)'
  round_mode_write='(rc,2f9.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rc,2f10.6)'
  round_mode_write='(rc,2f10.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
  ...
  round_mode_read='(rp,2f9.6)'
  round_mode_write='(rp,2f9.5)'
  write(2,round_mode_write) write_num1
  read(3,round_mode_read) read_num1
  ...
  round_mode_read='(rp,2f10.6)'
  round_mode_write='(rp,2f10.5)'
  write(2,round_mode_write) write_num3
  read(3,round_mode_read) read_num3
