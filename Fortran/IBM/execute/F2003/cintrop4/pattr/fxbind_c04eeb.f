...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/run.sh fxbind_c04eeb  cxbind_c03eeb
! %COMPOPTS: 
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!* ===================================================================
!*
!* TEST CASE TITLE              : fxbind_c04eeb.f
...
!*   - Both primary entry point and the alternate
...
contains
  ...
  function fn_real16 (a, b) bind(c)
    real(16), intent(inout) :: a
    real(16), intent(inout) :: b
    real(16)             :: fn_real16
    real(16)             :: ent_real16
    fn_real16 = a * b
    a = a + 1.0d0
    b = b + 1.0d0
    return
    entry ent_real16 (a, b) bind(c)
    a = a + 1.0d0
    b = b + 1.0d0
    ent_real16 = a + b
    return
  end function fn_real16
  ...
  function fn_realval16 (a, b) bind(c)
    real(16), value :: a
    real(16), value :: b
    real(16)             :: fn_realval16
    real(16)             :: ent_realval16
    a = a +1.0d0
    b = b +1.0d0
    fn_realval16 = a * b
    return
    entry ent_realval16 (a, b) bind(c)
    a = a +1.0d0
    b = b +1.0d0
    ent_realval16 = a + b
    return
  end function fn_realval16
