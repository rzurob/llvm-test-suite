! *********************************************************************
! SCCS ID Information
! cinterop/pattr/fxbind_c04aac.f, xlftest.cinterop, tstdev.cinterop, 1.1
! Extract Date/Time: 04/04/02 13:40:03
! Checkin Date/Time: 04/03/23 17:32:27
! *********************************************************************
!**********************************************************************
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/run.sh fxbind_c04aac  cxbind_c04aac
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!* ===================================================================
!*
!* TEST CASE TITLE              : fxbind_c04aac.f
