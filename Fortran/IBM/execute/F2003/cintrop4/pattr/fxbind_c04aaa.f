...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/run.sh fxbind_c04aaa  cxbind_c04aaa
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!* ===================================================================
!*
!* TEST CASE TITLE              : fxbind_c04aaa.f
...
!*                                the BIND specification in Module.
...
!*     is declared with the BIND attribute in module.
...
program fxbind_c04aaa
  ...
  integer*1 ai1_ref /5/, bi1_ref /10/, res1_ref
  integer*1 ai1_val /5/, bi1_val /10/, res1_val
