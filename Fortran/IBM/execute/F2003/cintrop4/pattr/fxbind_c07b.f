...
! %START
! %MAIN: YES
! %PRECMD: EXEC_REP=1; $TR_SRC/fxbindc.sh fxbind_c07b bind_c07a
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*                                character(1), with value attrivute.
!*                                Using module
...
module m
   ...
   interface 
       subroutine extsub_int(i1, i2, i4, i8, i81) 
           integer*1, value :: i1
           integer*2, value :: i2
           integer*4, value :: i4
           integer*8, value :: i8
       ...
       subroutine extsub_real(r4, r8, r161) 
           real*4, value  ::  r4
           real*8, value  ::  r8
           real*8 r161
       end subroutine extsub_real

       subroutine extsub_log(l1, l11) 
           logical*1, value :: l1
           logical*1 l11
       end subroutine extsub_log

       subroutine extsub_comp(co8, co16, co81, co161) 
           complex*8, value  ::  co8
       ...
       subroutine extsub_char(ch1, ch11) 
...
!**********************************************************
   ...
   real*8  ar16 /600.0/, br16 /600.0/, r161, r162
