...
! %START
! %MAIN: YES
! %PRECMD: EXEC_REP=1; $TR_SRC/fxbindc.sh fxbind_c13k bind_c01b
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*
!* DESCRIPTION                  : Test: BINC(C) attribute with pointer
!*                                derive type which consists of 
!*                                different 
!*                                intrinsic data type  
...
program fxbind_c01b
   ...
   interface
       subroutine extsub_der(der) bind(c) 
        ...
        type(der_bind), pointer ::  der_type
        type(der_bind), target :: tder_type, d_t
...
!**********************************************************
           ...
           tder_type%x8 = (3.0,4.0)
           tder_type%x16 = (5.0D0,6.0D0)
