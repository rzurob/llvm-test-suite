...
! %START
! %MAIN: YES
! %PRECMD: EXEC_REP=1; $TR_SRC/fxbindc.sh fxbind_c13i bind_c01b
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*                                derived type which consists of 
!*                                different 
!*                                intrinsic data type  
...
program fxbind_c01b
   ...
   interface
       subroutine extsub_der(der) bind(c) 
        ...
        type(der_bind), allocatable ::  der_type, d_t
        allocate (der_type, d_t)
