...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/run.sh fxbind_c06aca  cxbind_c06aca
! %COMPOPTS: -qintsize=8
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!* ===================================================================
!*
!* TEST CASE TITLE              : fxbind_c06aca.f
