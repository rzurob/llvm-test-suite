...
! %START
! %MAIN: YES
! %PRECMD: $TR_SRC/run.sh fxbind_c06abb  cxbind_c06abb
...
!* ===================================================================
!*
!* TEST CASE TITLE              : fxbind_c06abb.f
...
program fxbind_c06aab
  ...
  real ai4_ref /5.0e0/, bi4_ref /10.0e0/, res4_ref
  real ai4_val /5.0e0/, bi4_val /10.0e0/, res4_val
