...
long double _Complex        blk_cmplx_long_double_complex_a;
long double _Complex        blk_cmplx_long_double_complex_b;
long double _Complex        blk_cmplx_long_double_complex_c;
long double _Complex        blk_cmplx_long_double_complex_d;
...
* --------------------------------------------------------------*/
        ...
        r_cmplx_long_double_complex_a  =  creall( blk_cmplx_long_double_complex_a);
        r_cmplx_long_double_complex_b  =  creall( blk_cmplx_long_double_complex_b);
        r_cmplx_long_double_complex_c  =  creall( blk_cmplx_long_double_complex_c);
        r_cmplx_long_double_complex_d  =  creall( blk_cmplx_long_double_complex_d);
        ...
        i_cmplx_long_double_complex_a  =  cimagl( blk_cmplx_long_double_complex_a);
        i_cmplx_long_double_complex_b  =  cimagl( blk_cmplx_long_double_complex_b);
        i_cmplx_long_double_complex_c  =  cimagl( blk_cmplx_long_double_complex_c);
        i_cmplx_long_double_complex_d  =  cimagl( blk_cmplx_long_double_complex_d);
...
* --------------------------------------------------------------*/
	...
	// Create COMPLEX from REAL and IMAGINARY part
        ...
        blk_cmplx_long_double_complex_a  = createcomplexl( r_cmplx_long_double_complex_a,i_cmplx_long_double_complex_a );
        blk_cmplx_long_double_complex_b  = createcomplexl( r_cmplx_long_double_complex_b,i_cmplx_long_double_complex_b );
        blk_cmplx_long_double_complex_c  = createcomplexl( r_cmplx_long_double_complex_c,i_cmplx_long_double_complex_c );
        blk_cmplx_long_double_complex_d  = createcomplexl( r_cmplx_long_double_complex_d,i_cmplx_long_double_complex_d );
