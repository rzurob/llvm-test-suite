...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_cmplx.sh fxcmn_blk401a cxcmn_blk401a
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk401a fxcmn_blk401a.out
! %END
!**********************************************************************
!*  ===================================================================
...
!*                               inside of common blocks are interoperable with C struct variables.
!*
