...
struct {
        ...
        long double _Complex        cmplx_32a;
        long double _Complex        cmplx_32b;
        long double _Complex        cmplx_32c;
        long double _Complex        cmplx_32d;
...
* --------------------------------------------------------------*/
        ...
        r_cmplx_32a  =  creall( blk_cmplx.cmplx_32a);
        r_cmplx_32b  =  creall( blk_cmplx.cmplx_32b);
        r_cmplx_32c  =  creall( blk_cmplx.cmplx_32c);
        r_cmplx_32d  =  creall( blk_cmplx.cmplx_32d);
        ...
        i_cmplx_32a  =  cimagl( blk_cmplx.cmplx_32a);
        i_cmplx_32b  =  cimagl( blk_cmplx.cmplx_32b);
        i_cmplx_32c  =  cimagl( blk_cmplx.cmplx_32c);
        i_cmplx_32d  =  cimagl( blk_cmplx.cmplx_32d);
...
* --------------------------------------------------------------*/
	...
	// Create COMPLEX from REAL and IMAGINARY part
        ...
        blk_cmplx.cmplx_32a  = createcomplexl( r_cmplx_32a, i_cmplx_32a );
        blk_cmplx.cmplx_32b  = createcomplexl( r_cmplx_32b, i_cmplx_32b );
        blk_cmplx.cmplx_32c  = createcomplexl( r_cmplx_32c, i_cmplx_32c );
        blk_cmplx.cmplx_32d  = createcomplexl( r_cmplx_32d, i_cmplx_32d );
...
//        blk_cmplx.cmplx_long_double_complex_a  = createcomplex( r_cmplx_long_double_complex_a,i_cmplx_long_double_complex_a );
//        blk_cmplx.cmplx_long_double_complex_b  = createcomplex( r_cmplx_long_double_complex_b,i_cmplx_long_double_complex_b );
//        blk_cmplx.cmplx_long_double_complex_c  = createcomplex( r_cmplx_long_double_complex_c,i_cmplx_long_double_complex_c );
//        blk_cmplx.cmplx_long_double_complex_d  = createcomplex( r_cmplx_long_double_complex_d,i_cmplx_long_double_complex_d );
