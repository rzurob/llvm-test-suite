...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk402 cxcmn_blk402
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk402 fxcmn_blk402.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
       ...
       common /blk_cmplx_32a/                                 cmplx_32a
       common /blk_cmplx_32b/                                 cmplx_32b
       common /blk_cmplx_32c/                                 cmplx_32c
       common /blk_cmplx_32d/                                 cmplx_32d
