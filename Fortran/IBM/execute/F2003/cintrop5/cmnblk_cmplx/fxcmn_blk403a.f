...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_cmplx.sh fxcmn_blk403a cxcmn_blk402a
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk403a fxcmn_blk403a.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*
!*                               Similar to fxcmn_blk403.f, but this testcase will
...
! ----------------------------------------------------------------------------
       ...
       common /blk_cmplx_8a/                                  cmplx_8a		&
        ...
        ,   /blk_cmplx_LONG_DOUBLE_COMPLEX_a/               cmplx_LONG_DOUBLE_COMPLEX_a &
        ,   /blk_cmplx_LONG_DOUBLE_COMPLEX_b/               cmplx_LONG_DOUBLE_COMPLEX_b &
        ,   /blk_cmplx_LONG_DOUBLE_COMPLEX_c/               cmplx_LONG_DOUBLE_COMPLEX_c &
        ,   /blk_cmplx_LONG_DOUBLE_COMPLEX_d/               cmplx_LONG_DOUBLE_COMPLEX_d
...
! ----------------------------------------------------------------------------
        ...
        if ( .not. precision_x32 ( cmplx_LONG_DOUBLE_COMPLEX_a , ( 1234300.119Q0 ,1234300.119Q0 ) ))      error stop 80
        if ( .not. precision_x32 ( cmplx_LONG_DOUBLE_COMPLEX_b , ( -1234300.119Q0 ,-1234300.119Q0 ) ))    error stop 81
        if ( .not. precision_x32 ( cmplx_LONG_DOUBLE_COMPLEX_c , ( 12341000.01Q0 ,-12341000.01Q0 ) ))     error stop 82
        if ( .not. precision_x32 ( cmplx_LONG_DOUBLE_COMPLEX_d , ( -12341000.01Q0 ,12341000.01Q0 ) ))     error stop 83
