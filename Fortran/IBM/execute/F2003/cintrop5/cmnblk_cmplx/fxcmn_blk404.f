...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk404 cxcmn_blk404
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk404 fxcmn_blk404.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
	...
	!**  C-code must be compiled with xlc -qlongdouble for complex*32
        complex(kind=b'10000')          		cmplx_32a(3)
        complex(kind=INT((12.4e0_8,6.5e0_8))+4 )     	cmplx_32b(3)
        complex(16)  					cmplx_32c(3)
        complex*32     					cmplx_32d(3)
...
! ----------------------------------------------------------------------------
      ...
      do i = 1, 3
        ...
        if ( .not. precision_x32 ( cmplx_32a(i)              , ( 1.797693Q0,  1.797693Q0) )) error stop 7
        if ( .not. precision_x32 ( cmplx_32b(i)              , ( 1.797693Q0, -1.797693Q0) )) error stop 7
        if ( .not. precision_x32 ( cmplx_32c(i)              , (-2.225073Q0, -1.797693Q0) )) error stop 7
        if ( .not. precision_x32 ( cmplx_32d(i)              , ( 1.797693Q0, -2.225073Q0) )) error stop 7
...
print *, cmplx_8a
      ...
      do i = 1, 3
        ...
        if ( .not. precision_x32 ( cmplx_32a(i)              , (  987654321300.11998Q0  , 987654321300.11998Q0 ) ))     error stop 68
        if ( .not. precision_x32 ( cmplx_32b(i)              , ( -987654321300.11998Q0  ,-987654321300.11998Q0 ) ))     error stop 69
        if ( .not. precision_x32 ( cmplx_32c(i)              , (  9876543211000.00998Q0  ,-9876543211000.00998Q0 ) ))   error stop 70
        if ( .not. precision_x32 ( cmplx_32d(i)              , ( -9876543211000.00998Q0  , 9876543211000.00998Q0 ) ))   error stop 71
