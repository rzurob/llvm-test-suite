...
struct {
        ...
        long double _Complex        cmplx_32a[3];
        long double _Complex        cmplx_32b[3];
        long double _Complex        cmplx_32c[3];
        long double _Complex        cmplx_32d[3];
...
void csub_cmplx(){
        ...
        long double    r_cmplx_32a[3];
        long double    r_cmplx_32b[3];
        long double    r_cmplx_32c[3];
        long double    r_cmplx_32d[3];
        ...
        long double    i_cmplx_32a[3];
        long double    i_cmplx_32b[3];
        long double    i_cmplx_32c[3];
        long double    i_cmplx_32d[3];
...
* --------------------------------------------------------------*/
     ...
     for ( k = 0; k < 3; k++ ) {
        ...
        r_cmplx_32a[k]  =  creall( blk_cmplx.cmplx_32a[k]);
        r_cmplx_32b[k]  =  creall( blk_cmplx.cmplx_32b[k]);
        r_cmplx_32c[k]  =  creall( blk_cmplx.cmplx_32c[k]);
        r_cmplx_32d[k]  =  creall( blk_cmplx.cmplx_32d[k]);
        ...
        i_cmplx_32a[k]  =  cimagl( blk_cmplx.cmplx_32a[k]);
        i_cmplx_32b[k]  =  cimagl( blk_cmplx.cmplx_32b[k]);
        i_cmplx_32c[k]  =  cimagl( blk_cmplx.cmplx_32c[k]);
        i_cmplx_32d[k]  =  cimagl( blk_cmplx.cmplx_32d[k]);
	...
	// Verify REAL part of COMPLEX
        ...
        if ( precision_ldbl( r_cmplx_32a[k]               ,  1.797693l  )  !=  1 ) exit (18);
        if ( precision_ldbl( r_cmplx_32b[k]               ,  1.797693l  )  !=  1 ) exit (19);
        if ( precision_ldbl( r_cmplx_32c[k]               , -2.225073l  )  !=  1 ) exit (20);
        if ( precision_ldbl( r_cmplx_32d[k]               ,  1.797693l  )  !=  1 ) exit (21);
        ...
        if ( precision_dbl( r_cmplx_double_complex_a[k]   ,  1.797693 )  	!=  1 ) exit (26);
        if ( precision_dbl( r_cmplx_double_complex_b[k]   ,  1.797693 )  	!=  1 ) exit (27);
        if ( precision_dbl( r_cmplx_double_complex_c[k]   , -2.225073 )  	!=  1 ) exit (28);
        if ( precision_dbl( r_cmplx_double_complex_d[k]   ,  1.797693 )  	!=  1 ) exit (29);
	...
	// Verify IMAGINARY part of COMPLEX
        ...
        if ( precision_ldbl( i_cmplx_32a[k]               ,  1.797693l  )  !=  1 ) exit (38);
        if ( precision_ldbl( i_cmplx_32b[k]               , -1.797693l  )  !=  1 ) exit (39);
        if ( precision_ldbl( i_cmplx_32c[k]               , -1.797693l  )  !=  1 ) exit (40);
        if ( precision_ldbl( i_cmplx_32d[k]               , -2.225073l  )  !=  1 ) exit (41);
...
* --------------------------------------------------------------*/
     ...
     for ( k = 0; k < 3; k++ ) {
        ...
        r_cmplx_32a[k]  =  987654321300.11998l;
        r_cmplx_32b[k]  = -987654321300.11998l;
        r_cmplx_32c[k]  =  9876543211000.00998l;
        r_cmplx_32d[k]  = -9876543211000.00998l;
        ...
        i_cmplx_32a[k]  =  987654321300.11998l;
        i_cmplx_32b[k]  = -987654321300.11998l;
        i_cmplx_32c[k]  = -9876543211000.00998l;
        i_cmplx_32d[k]  =  9876543211000.00998l;
	...
	// Create COMPLEX from REAL and IMAGINARY part
        ...
        blk_cmplx.cmplx_32a[k]  = createcomplexl( r_cmplx_32a[k], i_cmplx_32a[k] );
        blk_cmplx.cmplx_32b[k]  = createcomplexl( r_cmplx_32b[k], i_cmplx_32b[k] );
        blk_cmplx.cmplx_32c[k]  = createcomplexl( r_cmplx_32c[k], i_cmplx_32c[k] );
        blk_cmplx.cmplx_32d[k]  = createcomplexl( r_cmplx_32d[k], i_cmplx_32d[k] );
...
//        blk_cmplx.cmplx_long_double_complex_a[k]  = createcomplex( r_cmplx_long_double_complex_a[k],i_cmplx_long_double_complex_a[k] );
//        blk_cmplx.cmplx_long_double_complex_b[k]  = createcomplex( r_cmplx_long_double_complex_b[k],i_cmplx_long_double_complex_b[k] );
//        blk_cmplx.cmplx_long_double_complex_c[k]  = createcomplex( r_cmplx_long_double_complex_c[k],i_cmplx_long_double_complex_c[k] );
//        blk_cmplx.cmplx_long_double_complex_d[k]  = createcomplex( r_cmplx_long_double_complex_d[k],i_cmplx_long_double_complex_d[k] );
...
* --------------------------------------------------------------*/
     ...
     for ( k = 0; k < 3; k++ ) {
        ...
        if ( precision_ldbl( r_cmplx_32a[k],     987654321300.11998l  )    !=  1 ) exit (52);
        if ( precision_ldbl( r_cmplx_32b[k],    -987654321300.11998l  )    !=  1 ) exit (52);
        if ( precision_ldbl( r_cmplx_32c[k],     9876543211000.00998l )    !=  1 ) exit (52);
        if ( precision_ldbl( r_cmplx_32d[k],    -9876543211000.00998l )    !=  1 ) exit (52);
        ...
        if ( precision_dbl( r_cmplx_double_complex_a[k],  1234300.11911 )  !=  1 ) exit (54);
        if ( precision_dbl( r_cmplx_double_complex_b[k], -1234300.11911 )  !=  1 ) exit (54);
        if ( precision_dbl( r_cmplx_double_complex_c[k],  12341000.00911 ) !=  1 ) exit (54);
        if ( precision_dbl( r_cmplx_double_complex_d[k], -12341000.00911 ) !=  1 ) exit (54);
    
//        if ( precision_dbl( r_cmplx_long_double_complex_a[k],   1234300.119 )      !=  1 ) exit (70);
//        if ( precision_dbl( r_cmplx_long_double_complex_b[k],   -1234300.119 )      !=  1 ) exit (70);
//        if ( precision_dbl( r_cmplx_long_double_complex_c[k],   12341000.01 )      !=  1 ) exit (70);
//        if ( precision_dbl( r_cmplx_long_double_complex_d[k],   -12341000.01 )      !=  1 ) exit (70);
        ...
        if ( precision_ldbl( i_cmplx_32a[k],      987654321300.11998l )    !=  1 ) exit (57);
        if ( precision_ldbl( i_cmplx_32b[k],     -987654321300.11998l )    !=  1 ) exit (57);
        if ( precision_ldbl( i_cmplx_32c[k],     -9876543211000.00998l )   !=  1 ) exit (57);
        if ( precision_ldbl( i_cmplx_32d[k],      9876543211000.00998l )   !=  1 ) exit (57);
        ...
        if ( precision_dbl( i_cmplx_double_complex_a[k],    1234300.11911 )  !=  1 ) exit (59);
        if ( precision_dbl( i_cmplx_double_complex_b[k],    -1234300.11911 ) !=  1 ) exit (59);
        if ( precision_dbl( i_cmplx_double_complex_c[k],    -12341000.00911 ) !=  1 ) exit (59);
        if ( precision_dbl( i_cmplx_double_complex_d[k],    12341000.00911 )  !=  1 ) exit (59);
