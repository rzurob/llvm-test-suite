...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk509 cxcmn_blk509
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk509.o cxcmn_blk509.o fxcmn_blk509
! %END
!**********************************************************************
!*  ===================================================================
...
program fxcmn_blk509
	...
	logical precision_r4, precision_r8, precision_r16
        ...
        real (16  )                             	:: real_s16a(3)
        real (kind=b'10000')                    	:: real_s16b(3)
        real (kind=MIN(16,19))                  	:: real_s16c(3)
        real (kind=o'20')                       	:: real_s16d(3)
