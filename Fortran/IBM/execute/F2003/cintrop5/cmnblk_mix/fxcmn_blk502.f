...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk502 cxcmn_blk502
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk502.o cxcmn_blk502.o fxcmn_blk502
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*
!*				 Test:  BIND(C) statement with binding label in main program
!*
!* ===================================================================
!*  REVISION HISTORY
