...
! ----------------------------------------------------------------------------
       	...
       	if ( int_d(5) .ne. 2100000009 )                          error stop 155
       	if ( int_d(4) .ne. -50 )                                 error stop 156
       	if ( int_d(3) .ne. -0 )                                  error stop 157
       	if ( int_d(2) .ne. 99 )                                  error stop 158
       	if ( int_d(1) .ne. -2100000001 )                         error stop 159

       	if ( .not. precision_r4( real_d(5),     3.402823E+37  )) error stop 160
       	if ( .not. precision_r4( real_d(4),     -0.0000009 )   ) error stop 161
       	...
       	if ( char_d(4)   .ne.    ','     )                       error stop 168
       	if ( char_d(5)   .ne.    ' '     )                       error stop 169
       	if ( char_d(6)   .ne.    'I'     )                       error stop 170
       	if ( char_d(7)   .ne.    '\''    )                       error stop 171
       	if ( char_d(8)   .ne.    "m"     )                       error stop 172
       	if ( char_d(9)   .ne.    ' '     )                       error stop 173
       	if ( char_d(10)  .ne.    'a'     )                       error stop 174
       	if ( char_d(11)  .ne.    ' '     )                       error stop 175
       	if ( char_d(12)  .ne.    'd'     )                       error stop 176
       	if ( char_d(13)  .ne.    'o'     )                       error stop 177
       	if ( char_d(14)  .ne.    'g'     )                       error stop 178
       	if ( char_d(15)  .ne.    '!'     )                       error stop 179
       	if ( char_d(16)  .ne.    '\n'    )                       error stop 180
