...
long double                     blk_r_c_long_double_s8a[5];
long double                     blk_r_c_long_double_s8b[5];
long double                     blk_r_c_long_double_s8c[5];
...
for ( i = 0; i < 5; i++ ) {
        ...
        if ( precision_flt( blk_r_c_float_s4a[0]      ,  3.402823e+38f  ) !=  1 ) exit (150);
        if ( precision_flt( blk_r_c_float_s4a[1]      , -1.175494e-38f  ) !=  1 ) exit (151);
        if ( precision_flt( blk_r_c_float_s4a[2]      ,  0.0f  
     ) !=  1 ) exit (152);
        if ( precision_flt( blk_r_c_float_s4a[3]      ,  1.175494e-38f  ) !=  1 ) exit (153);
        if ( precision_flt( blk_r_c_float_s4a[4]      , -3.402823e+38f  ) !=  1 ) exit (154);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_flt( blk_r_c_float_s4b[i]   ,  1.175494e-38f  ) !=  1 ) exit (155+i);
        }

        for ( i = 0; i < 5; i++ ) {
           if ( precision_flt( blk_r_c_float_s4c[i]   , -3.402823e+38f  ) !=  1 ) exit (160+i);
        }

        for ( i = 0; i < 5; i++ ) {
           if ( precision_dbl( blk_r_c_double_s8a[i]   , 1.797693e+308  ) !=  1 ) exit (165+i);
        }

        if ( precision_dbl( blk_r_c_double_s8b[0]     ,  1.797693e+308  ) !=  1 ) exit (170);
        if ( precision_dbl( blk_r_c_double_s8b[1]     , -2.225073e-308  ) !=  1 ) exit (171);
        if ( precision_dbl( blk_r_c_double_s8b[2]     ,  0.0e0 
     ) !=  1 ) exit (172);
        if ( precision_dbl( blk_r_c_double_s8b[3]     ,  2.225073e-308  ) !=  1 ) exit (173);
        if ( precision_dbl( blk_r_c_double_s8b[4]     , -1.797693e+308  ) !=  1 ) exit (174);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_dbl( blk_r_c_double_s8c[i]  , -1.797693e+308  ) !=  1 ) exit (175+i);
        }

        if ( precision_ldbl( blk_r_c_long_double_s8a[0]           ,  1.797693e+308L )  !=  1 ) exit (180);
        if ( precision_ldbl( blk_r_c_long_double_s8a[1]           , -2.004168e-292L )  !=  1 ) exit (181);
        if ( precision_ldbl( blk_r_c_long_double_s8a[2]           ,  0.0e0L         )  !=  1 ) exit (182);
        if ( precision_ldbl( blk_r_c_long_double_s8a[3]           ,  2.004168e-292L )  !=  1 ) exit (183);
        if ( precision_ldbl( blk_r_c_long_double_s8a[4]           , -1.797693e+308L )  !=  1 ) exit (184);

        if ( precision_ldbl( blk_r_c_long_double_s8b[0]           ,  1.797693e+308L )  !=  1 ) exit (185);
        if ( precision_ldbl( blk_r_c_long_double_s8b[1]           , -2.004168e-292L )  !=  1 ) exit (186);
        if ( precision_ldbl( blk_r_c_long_double_s8b[2]           ,  0.0e0L         )  !=  1 ) exit (187);
        if ( precision_ldbl( blk_r_c_long_double_s8b[3]           ,  2.004168e-292L )  !=  1 ) exit (188);
        if ( precision_ldbl( blk_r_c_long_double_s8b[4]           , -1.797693e+308L )  !=  1 ) exit (189);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_ldbl( blk_r_c_long_double_s8c[i]        , -1.797693e+308L )  !=  1 ) exit (190+i);
        }
...
* --------------------------------------------------------------*/
        ...
        blk_r_c_long_double_s8a[4]           =  1.797693e+308L;
        blk_r_c_long_double_s8a[3]           = -2.004168e-292L;
        blk_r_c_long_double_s8a[2]           =  0.0e0L        ;
        blk_r_c_long_double_s8a[1]           =  2.004168e-292L;
        blk_r_c_long_double_s8a[0]           = -1.797693e+308L;

        blk_r_c_long_double_s8b[4]           =  1.797693e+308L;
        blk_r_c_long_double_s8b[3]           = -2.004168e-292L;
        blk_r_c_long_double_s8b[2]           =  0.0e0L        ;
        blk_r_c_long_double_s8b[1]           =  2.004168e-292L;
        blk_r_c_long_double_s8b[0]           = -1.797693e+308L;

        for ( i = 0; i < 5; i++) {
           blk_r_c_long_double_s8c[i]        = 1.797693e+308L;
        }
...
* --------------------------------------------------------------*/
        ...
        if ( precision_ldbl( blk_r_c_long_double_s8a[4]           ,  1.797693e+308L )  !=  1 ) exit (212);
        if ( precision_ldbl( blk_r_c_long_double_s8a[3]           , -2.004168e-292L )  !=  1 ) exit (212);
        if ( precision_ldbl( blk_r_c_long_double_s8a[2]           ,  0.0e0L         )  !=  1 ) exit (212);
        if ( precision_ldbl( blk_r_c_long_double_s8a[1]           ,  2.004168e-292L )  !=  1 ) exit (212);
        if ( precision_ldbl( blk_r_c_long_double_s8a[0]           , -1.797693e+308L )  !=  1 ) exit (212);

        if ( precision_ldbl( blk_r_c_long_double_s8b[4]           ,  1.797693e+308L )  !=  1 ) exit (213);
        if ( precision_ldbl( blk_r_c_long_double_s8b[3]           , -2.004168e-292L )  !=  1 ) exit (213);
        if ( precision_ldbl( blk_r_c_long_double_s8b[2]           ,  0.0e0L         )  !=  1 ) exit (213);
        if ( precision_ldbl( blk_r_c_long_double_s8b[1]           ,  2.004168e-292L )  !=  1 ) exit (213);
        if ( precision_ldbl( blk_r_c_long_double_s8b[0]           , -1.797693e+308L )  !=  1 ) exit (213);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_ldbl( blk_r_c_long_double_s8c[i]        , 1.797693e+308L )  !=  1 ) exit (214);
        }
}
