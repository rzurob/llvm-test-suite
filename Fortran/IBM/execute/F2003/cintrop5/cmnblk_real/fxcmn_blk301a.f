...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk301a cxcmn_blk301a
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk301a
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*
!*                               Similar to fxcmn_blk301.f; but this test case  will
...
! ----------------------------------------------------------------------------
        ...
        common /blk_real_s8a/          real_s8a
        common /blk_real_s8b/          real_s8b
        common /blk_real_s8c/          real_s8c
        common /blk_real_s8d/          real_s8d

        common /blk_r_C_FLOAT_s4a/          r_C_FLOAT_s4a
        common /blk_r_C_FLOAT_s4b/          r_C_FLOAT_s4b
        common /blk_r_C_FLOAT_s4c/          r_C_FLOAT_s4c
        common /blk_r_C_FLOAT_s4d/          r_C_FLOAT_s4d

        common /blk_r_C_DOUBLE_s8a/          r_C_DOUBLE_s8a
        common /blk_r_C_DOUBLE_s8b/          r_C_DOUBLE_s8b
        ...
        common /blk_r_C_LONG_DOUBLE_s8b/          r_C_LONG_DOUBLE_s8b
        common /blk_r_C_LONG_DOUBLE_s8c/          r_C_LONG_DOUBLE_s8c
        common /blk_r_C_LONG_DOUBLE_s8d/          r_C_LONG_DOUBLE_s8d
        ...
        , /blk_r_C_DOUBLE_s8c/          &
        , /blk_r_C_DOUBLE_s8d/          &
        , /blk_r_C_LONG_DOUBLE_s8a/     &
        , /blk_r_C_LONG_DOUBLE_s8b/     &
        , /blk_r_C_LONG_DOUBLE_s8c/     &
        , /blk_r_C_LONG_DOUBLE_s8d/
