...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk128a cxcmn_blk128
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk128a fxcmn_blk128a.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
print *, res_r_c_float_s4
print *, "-----------------------"
print *, cmp_r_c_float_s4
