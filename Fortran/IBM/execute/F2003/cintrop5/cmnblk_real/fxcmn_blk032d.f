...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk032d cxcmn_blk032
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk032d fxcmn_blk032d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
	...
	call Intern_FSub()
        ...
        if ( .not. precision_r4 ( Real1     ,  1.175494E-38  )) error stop 50
