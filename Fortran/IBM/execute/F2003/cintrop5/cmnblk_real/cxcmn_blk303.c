...
struct {
        ...
        long double                     real_s16a[5];
        long double                     real_s16b[5];
        long double                     real_s16c[5];
...
for ( i = 0; i < 5; i++ ) {
        ...
        if ( precision_ldbl( blk_real.real_s16a[0]         ,  1.797693e+308l ) !=  1 ) exit (150);
        if ( precision_ldbl( blk_real.real_s16a[1]         , -2.225073e-308l ) !=  1 ) exit (151);
        if ( precision_ldbl( blk_real.real_s16a[2]         ,  0.0e0l 
     ) !=  1 ) exit (152);
        if ( precision_ldbl( blk_real.real_s16a[3]         ,  2.225073e-308l ) !=  1 ) exit (153);
        if ( precision_ldbl( blk_real.real_s16a[4]         , -1.797693e+308l ) !=  1 ) exit (154);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_ldbl( blk_real.real_s16b[i]      , -2.225073e-308l ) !=  1 ) exit (155+i);
        }

        if ( precision_ldbl( blk_real.real_s16c[0]         ,  1.797693e+308l ) !=  1 ) exit (160);
        if ( precision_ldbl( blk_real.real_s16c[1]         , -2.225073e-308l ) !=  1 ) exit (161);
        if ( precision_ldbl( blk_real.real_s16c[2]         ,  0.0e0l 
     ) !=  1 ) exit (162);
        if ( precision_ldbl( blk_real.real_s16c[3]         ,  2.225073e-308l ) !=  1 ) exit (163);
        if ( precision_ldbl( blk_real.real_s16c[4]         , -1.797693e+308l ) !=  1 ) exit (164);

        if ( precision_flt( blk_real.r_c_float_s4a[0]      ,  3.402823e+38f  ) !=  1 ) exit (165);
        if ( precision_flt( blk_real.r_c_float_s4a[1]      , -1.175494e-38f  ) !=  1 ) exit (166);
        if ( precision_flt( blk_real.r_c_float_s4a[2]      ,  0.0f  
     ) !=  1 ) exit (167);
        if ( precision_flt( blk_real.r_c_float_s4a[3]      ,  1.175494e-38f  ) !=  1 ) exit (168);
        if ( precision_flt( blk_real.r_c_float_s4a[4]      , -3.402823e+38f  ) !=  1 ) exit (169);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_flt( blk_real.r_c_float_s4b[i]   ,  1.175494e-38f  ) !=  1 ) exit (170+i);
        }

        for ( i = 0; i < 5; i++ ) {
           if ( precision_flt( blk_real.r_c_float_s4c[i]   , -3.402823e+38f  ) !=  1 ) exit (175+i);
        }

        for ( i = 0; i < 5; i++ ) {
           if ( precision_dbl( blk_real.r_c_double_s8a[i]   , 1.797693e+308  ) !=  1 ) exit (180+i);
        }

        if ( precision_dbl( blk_real.r_c_double_s8b[0]     ,  1.797693e+308  ) !=  1 ) exit (185);
        if ( precision_dbl( blk_real.r_c_double_s8b[1]     , -2.225073e-308  ) !=  1 ) exit (186);
        if ( precision_dbl( blk_real.r_c_double_s8b[2]     ,  0.0e0 
     ) !=  1 ) exit (187);
        if ( precision_dbl( blk_real.r_c_double_s8b[3]     ,  2.225073e-308  ) !=  1 ) exit (188);
        if ( precision_dbl( blk_real.r_c_double_s8b[4]     , -1.797693e+308  ) !=  1 ) exit (189);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_dbl( blk_real.r_c_double_s8c[i]  , -1.797693e+308  ) !=  1 ) exit (190+i);
        }
...
* --------------------------------------------------------------*/
        ...
        blk_real.real_s16a[4]         =  1.797693e+308l;
        blk_real.real_s16a[3]         = -2.225073e-308l;
        blk_real.real_s16a[2]         =  0.0e0l        ;
        blk_real.real_s16a[1]         =  2.225073e-308l;
        blk_real.real_s16a[0]         = -1.797693e+308l;

        for ( i = 0; i < 5; i++ ) {
           blk_real.real_s16b[i]      =  2.225073e-308l;
        }

        blk_real.real_s16c[4]         =  1.797693e+308l;
        blk_real.real_s16c[3]         = -2.225073e-308l;
        blk_real.real_s16c[2]         =  0.0e0l        ;
        blk_real.real_s16c[1]         =  2.225073e-308l;
        blk_real.real_s16c[0]         = -1.797693e+308l;
...
* --------------------------------------------------------------*/
        ...
        if ( precision_ldbl( blk_real.real_s16a[4]         ,  1.797693e+308l ) !=  1 ) exit (212);
        if ( precision_ldbl( blk_real.real_s16a[3]         , -2.225073e-308l ) !=  1 ) exit (212);
        if ( precision_ldbl( blk_real.real_s16a[2]         ,  0.0e0l         ) !=  1 ) exit (212);
        if ( precision_ldbl( blk_real.real_s16a[1]         ,  2.225073e-308l ) !=  1 ) exit (212);
        if ( precision_ldbl( blk_real.real_s16a[0]         , -1.797693e+308l ) !=  1 ) exit (212);

        for ( i = 0; i < 5; i++ ) {
           if ( precision_ldbl( blk_real.real_s16b[i]      ,  2.225073e-308l ) !=  1 ) exit (213);
        }

        if ( precision_ldbl( blk_real.real_s16c[4]         ,  1.797693e+308l ) !=  1 ) exit (214);
        if ( precision_ldbl( blk_real.real_s16c[3]         , -2.225073e-308l ) !=  1 ) exit (214);
        if ( precision_ldbl( blk_real.real_s16c[2]         ,  0.0e0l         ) !=  1 ) exit (214);
        if ( precision_ldbl( blk_real.real_s16c[1]         ,  2.225073e-308l ) !=  1 ) exit (214);
        if ( precision_ldbl( blk_real.real_s16c[0]         , -1.797693e+308l ) !=  1 ) exit (214);
