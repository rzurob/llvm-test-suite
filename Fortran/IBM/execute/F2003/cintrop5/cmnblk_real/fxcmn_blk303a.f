...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk303a cxcmn_blk303a
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk303a
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*
!*                               Similar to fxcmn_blk303.f; but this test case  will
