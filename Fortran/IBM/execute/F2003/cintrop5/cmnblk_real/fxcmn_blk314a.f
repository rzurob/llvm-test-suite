...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk314a cxcmn_blk304a
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk314a
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*				 interoperate with C variables inside Fortran sub-
!*				 program.
!*
...
!*
!*                               This testcase will also test C_LONG_DOUBLE iso_c_binding
!*				 module (so -qlongdouble must not be used).
!*
!* ===================================================================
!*  REVISION HISTORY
