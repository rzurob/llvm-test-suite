...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk090d cxcmn_blk090
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk090d fxcmn_blk090d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
         ...
         do i = -2, 2 
            if ( .not. precision_r8 ( r_C_DOUBLE_s8c(i)    ,  1.797693D+308 )) call zzrc(52+i) 
         end do 
