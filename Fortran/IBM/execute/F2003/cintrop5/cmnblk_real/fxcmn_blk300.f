...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk300 cxcmn_blk300
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: fxcmn_blk300.out
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk300 fxcmn_blk300.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
        ...
        common /blk_real/       real_s4a, real_s4b, real_s4c, real_s4d, 	& 
				...
				real_s16a, real_s16b, real_s16c, real_s16d, 	&
