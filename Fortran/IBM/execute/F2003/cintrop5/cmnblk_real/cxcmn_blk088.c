 ...
 * --------------------------------------------------------------*/ 
         ...
         if ( precision_ldbl( _L_a_b_e_l_4_U[1]         , -2.225073e-308l ) !=  1 ) exit (31); 
         if ( precision_ldbl( _L_a_b_e_l_4_U[2]         ,  0.0e0l         ) !=  1 ) exit (32); 
         if ( precision_ldbl( _L_a_b_e_l_4_U[3]         ,  2.225073e-308l ) !=  1 ) exit (33); 
 ...
 * --------------------------------------------------------------*/ 
         ...
         _L_a_b_e_l_4_U[3]         = -2.225073e-308l; 
         _L_a_b_e_l_4_U[2]         =  0.0e0l        ; 
         _L_a_b_e_l_4_U[1]         =  2.225073e-308l; 
 ...
 * --------------------------------------------------------------*/ 
         ...
         if ( precision_ldbl( _L_a_b_e_l_4_U[3]         , -2.225073e-308l ) !=  1 ) exit (41); 
         if ( precision_ldbl( _L_a_b_e_l_4_U[2]         ,  0.0e0l         ) !=  1 ) exit (42); 
         if ( precision_ldbl( _L_a_b_e_l_4_U[1]         ,  2.225073e-308l ) !=  1 ) exit (43); 
