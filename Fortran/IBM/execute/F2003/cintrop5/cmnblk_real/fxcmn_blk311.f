...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk311 cxcmn_blk301
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: fxcmn_blk311.out
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk311 fxcmn_blk311.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
        ...
        common /blk_real_s16a/          real_s16a
        common /blk_real_s16b/          real_s16b
        common /blk_real_s16c/          real_s16c
        common /blk_real_s16d/          real_s16d
