...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk088d cxcmn_blk088
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk088d fxcmn_blk088d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
         ...
         if ( .not. precision_r16 ( real_s16c(2)            ,  1.797693Q+308 )) error stop 50
         if ( .not. precision_r16 ( real_s16c(1)            , -2.225073Q-308 )) error stop 51
         if ( .not. precision_r16 ( real_s16c(0)            ,  0.0Q0         )) error stop 52
         if ( .not. precision_r16 ( real_s16c(-1)           ,  2.225073Q-308 )) error stop 53
         if ( .not. precision_r16 ( real_s16c(-2)           , -1.797693Q+308 )) error stop 54
