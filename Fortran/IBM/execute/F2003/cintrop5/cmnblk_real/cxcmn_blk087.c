 ...
 * --------------------------------------------------------------*/ 
         ...
         if ( precision_dbl( _L_a_b_e_l_4_U[1]           , -2.5e-294 )  !=  1 ) exit (31); 
         if ( precision_dbl( _L_a_b_e_l_4_U[2]           ,  0.0e0         )  !=  1 ) exit (32); 
         if ( precision_dbl( _L_a_b_e_l_4_U[3]           ,  2.5e-294 )  !=  1 ) exit (33); 
 ...
 * --------------------------------------------------------------*/ 
         ...
         _L_a_b_e_l_4_U[3]           = -2.5e-294; 
         _L_a_b_e_l_4_U[2]           =  0.0e0        ; 
         _L_a_b_e_l_4_U[1]           =  2.5e-294; 
 ...
 * --------------------------------------------------------------*/ 
         ...
         if ( precision_dbl( _L_a_b_e_l_4_U[3]           , -2.5e-294 )  !=  1 ) exit (41); 
         if ( precision_dbl( _L_a_b_e_l_4_U[2]           ,  0.0e0         )  !=  1 ) exit (42); 
         if ( precision_dbl( _L_a_b_e_l_4_U[1]           ,  2.5e-294 )  !=  1 ) exit (43); 
