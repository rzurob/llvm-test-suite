...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk085d cxcmn_blk085
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk085d fxcmn_blk085d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
         ...
         if ( .not. precision_r4 ( real_s4a(-1)             ,  3.402823E+38 )) error stop 50 
         if ( .not. precision_r4 ( real_s4a(-2)             , -1.175494E-38 )) error stop 51 
         if ( .not. precision_r4 ( real_s4a(-3)             ,  0.0          )) error stop 52 
         if ( .not. precision_r4 ( real_s4a(-4)             ,  1.175494E-38 )) error stop 53 
         if ( .not. precision_r4 ( real_s4a(-5)             , -3.402823E+38 )) error stop 54 
