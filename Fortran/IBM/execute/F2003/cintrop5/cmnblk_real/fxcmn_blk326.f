...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk326 cxcmn_blk306
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk326 fxcmn_blk326.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*                               BIND(C) common block.
!*
!*				 BIND(c) common block inside of external subroutine.
!*
!* ===================================================================
!*  REVISION HISTORY
