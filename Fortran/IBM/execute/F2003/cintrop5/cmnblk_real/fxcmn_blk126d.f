...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk126d cxcmn_blk126
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk126d fxcmn_blk126d.out
! %END
!**********************************************************************
!*  ===================================================================
...
module fmod1 
   ...
   !*** Comparison and Temporary Matrix
     real(8)         :: cmp_real_s8(8) , tmp_real_s8(2,2,2)
...
! ----------------------------------------------------------------------------
         real (kind=INT((4.4e0_8,6.5e0_8))+4 )   :: real_s8(2,2,2)               !* real*8 
...
! ----------------------------------------------------------------------------
         ...
         do i = 1, 8   
            ...
            if ( .not. precision_r4( res_real_s8(i)      ,  cmp_real_s8(i) ))            call zzrc(50+i) 
