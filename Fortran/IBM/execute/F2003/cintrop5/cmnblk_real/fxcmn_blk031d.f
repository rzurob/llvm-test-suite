...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk031d cxcmn_blk031
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk031d fxcmn_blk031d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
        ...
        if ( .not. precision_r4 ( Real1     ,  -1.175494E-38  )) error stop 5
	...
	CALL CSUB_REAL()
        ...
        if ( .not. precision_r4 ( Real1     ,  3.402823E+38  )) error stop 10
...
! ----------------------------------------------------------------------------
	...
	call Intern_FSub()
        ...
        if ( .not. precision_r4 ( Real1     ,  3.402823E+38  )) error stop 50
