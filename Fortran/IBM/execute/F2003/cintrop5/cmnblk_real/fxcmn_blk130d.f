...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk130d cxcmn_blk130
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk130d fxcmn_blk130d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
         ...
         do i = 1, 8   
            ...
            if ( .not. precision_r16( res_r_c_long_double_s8(i),  cmp_r_c_long_double_s8(i) ))      call zzrc(50+i) 
