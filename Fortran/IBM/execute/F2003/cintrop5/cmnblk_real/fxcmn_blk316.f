...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk316 cxcmn_blk306
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk316 fxcmn_blk316.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*
!*                               Similar to fxcmn_blk300.f but this testcase will
!*                               verify 3-dimensional array variables inside of
!*                               BIND(C) common block.
!*
!*				 BIND(c) common block inside of internal subroutine.
!*
!* ===================================================================
!*  REVISION HISTORY
