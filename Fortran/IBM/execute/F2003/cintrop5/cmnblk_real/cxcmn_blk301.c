...
#include "precision_r.inc"
        ...
        long double                     blk_real_s16a;
        long double                     blk_real_s16b;
        long double                     blk_real_s16c;
        long double                     blk_real_s16d;
...
* --------------------------------------------------------------*/
        ...
        if ( precision_ldbl( blk_real_s16a            ,  1.797693e+308l )  !=  1 ) exit (128);
        if ( precision_ldbl( blk_real_s16b            ,  2.225073e-308l )  !=  1 ) exit (129);
        if ( precision_ldbl( blk_real_s16c            , -1.797693e+308l )  !=  1 ) exit (130);
        if ( precision_ldbl( blk_real_s16d            , -2.225073e-308l )  !=  1 ) exit (131);
...
* --------------------------------------------------------------*/
        ...
        blk_real_s16d            =  1.797693e+308l;
        blk_real_s16c            =  2.225073e-308l;
        blk_real_s16b            = -1.797693e+308l;
        blk_real_s16a            = -2.225073e-308l;
...
* --------------------------------------------------------------*/
        ...
        if ( precision_ldbl( blk_real_s16d            ,  1.797693e+308l ) !=  1 ) exit (158);
        if ( precision_ldbl( blk_real_s16c            ,  2.225073e-308l ) !=  1 ) exit (159);
        if ( precision_ldbl( blk_real_s16b            , -1.797693e+308l ) !=  1 ) exit (160);
        if ( precision_ldbl( blk_real_s16a            , -2.225073e-308l ) !=  1 ) exit (161);
