...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_qlngdbl.sh fxcmn_blk306 cxcmn_blk306
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk306 fxcmn_blk306.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*                               BIND(C) common block.
!*
!*				 BIND(c) common block inside of main program.
!*
!* ===================================================================
!*  REVISION HISTORY
