...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk125d cxcmn_blk125
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk125d fxcmn_blk125d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
         ...
         do i = 1, 8
            ...
            if ( .not. precision_r4( res_real_s4(i)      ,  cmp_real_s4(i) ))            call zzrc(50+i)
