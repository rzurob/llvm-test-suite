...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk051d cxcmn_blk051
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk051d fxcmn_blk051d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
	...
	call Intern_FSub()
        ...
        if ( log1 	.neqv. 	.false. )      		error stop 50 
