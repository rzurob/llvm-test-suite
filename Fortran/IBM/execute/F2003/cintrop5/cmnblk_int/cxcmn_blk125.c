...
/* --------------------------------------------------------------* 
*        This C code is used by fxcmn_blk125.f                  * 
*        Please refer to fxcmn_blk125.f for further details.    * 
* --------------------------------------------------------------*/ 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
           ...
           if ( precision_flt( _1[k][j][i]          ,   cmp_real_s4[k][j][i]         )  !=  1 ) exit (30+a); 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
           ...
           if ( precision_flt( _1[k][j][i]        ,   cmp_real_s4[i][j][k]         )  !=  1 ) exit (40+i); 
