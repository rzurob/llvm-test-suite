...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk106d cxcmn_blk106
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk106d fxcmn_blk106d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
         ...
         do i = 1, 8   
           ...
           if ( res_C_SHORT(i)           .ne.    cmp_C_SHORT(i)  )               call zzrc(50+i) 
