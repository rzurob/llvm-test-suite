...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk022d cxcmn_blk022
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk022d.o cxcmn_blk022.o fxcmn_blk022d
! %END
!**********************************************************************
!*  ===================================================================
!*
