...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_noQ64.sh fxcmn_blk011 cxcmn_blk011
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk011.o cxcmn_blk011.o fxcmn_blk011
! %END
!**********************************************************************
!*  ===================================================================
!*
...
!*
!*                               Data type being tested: INTEGER (C_SIZE_T   )  without -q64
!*
!* ===================================================================
!*  REVISION HISTORY
