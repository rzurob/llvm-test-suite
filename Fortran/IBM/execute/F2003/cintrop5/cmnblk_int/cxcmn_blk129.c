...
/* --------------------------------------------------------------* 
*        This C code is used by fxcmn_blk129.f                  * 
*        Please refer to fxcmn_blk129.f for further details.    * 
* --------------------------------------------------------------*/ 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
           ...
           if ( precision_dbl( _1[k][j][i]          ,   cmp_r_c_double_s8[k][j][i]   )  !=  1 ) exit (30+a); 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
           ...
           tmp_r_c_double_s8[k][j][i]       = _1[i][j][k]; 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
           ...
           _1[k][j][i]           =       tmp_r_c_double_s8[k][j][i]; 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
           ...
           if ( precision_dbl( _1[k][j][i]        ,   cmp_r_c_double_s8[i][j][k]   )  !=  1 ) exit (40+i); 
