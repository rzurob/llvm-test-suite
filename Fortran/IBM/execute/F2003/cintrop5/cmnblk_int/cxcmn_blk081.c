 ...
 int_fast8_t      _______________________________________________________________________[5]; 
 ...
 * --------------------------------------------------------------*/ 
         ...
         for ( i = 0; i < 5; i++ ) {  
            if ( _______________________________________________________________________[i]   != 1 )  exit (30); 
         }   
