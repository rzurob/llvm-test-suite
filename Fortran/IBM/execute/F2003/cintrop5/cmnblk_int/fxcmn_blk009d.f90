...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_noQ64.sh fxcmn_blk009d cxcmn_blk009
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk009d.o cxcmn_blk009.o fxcmn_blk009d
! %END
!**********************************************************************
!*  ===================================================================
...
!*				 
!*                               Data type being tested: INTEGER (C_LONG ) without -q64
!*					
...
! ----------------------------------------------------------------------------
	...
	call Intern_FSub()
        ...
        if ( int1 .ne. 2147483647 )                         	error stop 50
