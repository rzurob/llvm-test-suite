...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk064d cxcmn_blk064
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk064d fxcmn_blk064d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
	...
	if ( int_s8(5)         .ne.  9223372036854775807_8     )    error stop 50
	if ( int_s8(4)         .ne.  b'000000000'              )    error stop 51
	if ( int_s8(3)         .ne. -9223372036854775807_8     )    error stop 52
	if ( int_s8(2)         .ne.  o'3641100'                )    error stop 53
	if ( int_s8(1)         .ne. -2147483648_8              )    error stop 54
