...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk024d cxcmn_blk024
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk024d.o cxcmn_blk024.o fxcmn_blk024d
! %END
!**********************************************************************
!*  ===================================================================
!*
