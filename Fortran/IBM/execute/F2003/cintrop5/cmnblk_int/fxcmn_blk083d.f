...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk083d cxcmn_blk083
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk083d fxcmn_blk083d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
	...
	if ( int_c_int_fast32_t(5)    .ne.  2147483647              )    error stop 50
	if ( int_c_int_fast32_t(4)    .ne.  b'1111111'              )    error stop 51
	if ( int_c_int_fast32_t(3)    .ne. -2147483648              )    error stop 52
	if ( int_c_int_fast32_t(2)    .ne.  0                       )    error stop 53
	if ( int_c_int_fast32_t(1)    .ne.  o'3641100'              )    error stop 54
