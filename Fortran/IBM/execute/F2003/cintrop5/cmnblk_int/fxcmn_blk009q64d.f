...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk_Q64.sh fxcmn_blk009q64d cxcmn_blk009q64
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk009q64d.o cxcmn_blk009q64.o fxcmn_blk009q64d
! %END
!**********************************************************************
!*  ===================================================================
...
!*				 
!*                               Data type being tested: INTEGER (C_LONG ) with -q64
!*					
...
! ----------------------------------------------------------------------------
	...
	call Intern_FSub()
        ...
        if ( int1 .ne. 9223372036854775807_8 )                          error stop 15
