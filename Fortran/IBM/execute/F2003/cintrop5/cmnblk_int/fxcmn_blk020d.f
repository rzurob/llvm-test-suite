...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk020d cxcmn_blk020
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk020d.o cxcmn_blk020.o fxcmn_blk020d
! %END
!**********************************************************************
!*  ===================================================================
!*
