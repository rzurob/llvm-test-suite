...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk122d cxcmn_blk122
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk122d fxcmn_blk122d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
         ...
         do i = 1, 8   
           ...
           if ( res_C_INT_FAST16_T(i)    .ne.    cmp_C_INT_FAST16_T(i))          call zzrc(50+i) 
