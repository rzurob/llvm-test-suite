...
/* --------------------------------------------------------------* 
*        This C code is used by fxcmn_blk108.f                  * 
*        Please refer to fxcmn_blk108.f for further details.    * 
* --------------------------------------------------------------*/ 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
         ...
         if ( _[i][j][k] !=  cmp_c_long[i][j][k]         )    exit (30+a); 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
         ...
         if ( _[k][j][i] !=  cmp_c_long[i][j][k]         )    exit (40+a); 
