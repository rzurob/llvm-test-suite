...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk074d cxcmn_blk074
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: 
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk074d fxcmn_blk074d.out
! %END
!**********************************************************************
!*  ===================================================================
...
! ----------------------------------------------------------------------------
	...
	if ( int_c_int16_t(5)           .ne.  o'77777'              )    error stop 50
	if ( int_c_int16_t(4)           .ne.  o'0'                  )    error stop 51
	if ( int_c_int16_t(3)           .ne. -32768                 )    error stop 52
	if ( int_c_int16_t(2)           .ne.  32767                 )    error stop 53
	if ( int_c_int16_t(1)           .ne.  b'1111111'            )    error stop 54
