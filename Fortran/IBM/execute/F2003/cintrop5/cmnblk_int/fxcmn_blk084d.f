...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk084d cxcmn_blk084
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk084d fxcmn_blk084d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
	...
	if ( int_c_int_fast64_t(5)    .ne.  9223372036854775807_8   )    error stop 50
	if ( int_c_int_fast64_t(4)    .ne.  b'000000000'            )    error stop 51
	if ( int_c_int_fast64_t(3)    .ne. -9223372036854775807_8   )    error stop 52
	if ( int_c_int_fast64_t(2)    .ne.  o'3641100'              )    error stop 53
	if ( int_c_int_fast64_t(1)    .ne. -2147483648_8            )    error stop 54
