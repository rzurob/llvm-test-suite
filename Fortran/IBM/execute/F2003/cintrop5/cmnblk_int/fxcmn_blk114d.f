...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk114d cxcmn_blk114
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk114d fxcmn_blk114d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
          ...
          bind(c,Name='_') ::    /blk_int_C_INT16_T/
...
! ----------------------------------------------------------------------------
         ...
         cmp_c_int16_t =  (/32767,0,-32768,32767,127,-1,-2,-3/)
...
! ----------------------------------------------------------------------------
         ...
         do i = 1, 8
           ...
           if ( res_C_INT16_T(i)         .ne.    cmp_C_INT16_T(i))               call zzrc(10+i)
...
! ----------------------------------------------------------------------------
         ...
         do k = 1, 2
            do j = 1, 2
               do i = 1, 2
                 tmp_c_int16_t(i,j,k)  =                int_c_int16_t(k,j,i)
             end do
           end do
         end do
...
! ----------------------------------------------------------------------------
         ...
         cmp_C_INT16_T  =        RESHAPE( tmp_C_INT16_T, (/8/))

         do i = 1, 8

           if ( res_C_INT16_T(i)         .ne.    cmp_C_INT16_T(i))               call zzrc(20+i)
...
! ----------------------------------------------------------------------------
         ...
         do i = 1, 8
           ...
           if ( res_C_INT16_T(i)         .ne.    cmp_C_INT16_T(i))               call zzrc(50+i)
