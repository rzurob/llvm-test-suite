...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk223 cxcmn_blk203
! %COMPOPTS: -qfree=f90 
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
! %STDOUT: fxcmn_blk223.out
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk223 fxcmn_blk223.out
! %END
!**********************************************************************
!*  ===================================================================
