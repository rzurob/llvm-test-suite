...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk019a cxcmn_blk019
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk019a.o cxcmn_blk019.o fxcmn_blk019a
! %END
!**********************************************************************
!*  ===================================================================
!*
