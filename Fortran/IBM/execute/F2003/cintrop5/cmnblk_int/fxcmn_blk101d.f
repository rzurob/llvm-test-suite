...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk101d cxcmn_blk101
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f *.o *.mod fxcmn_blk101d fxcmn_blk101d.out
! %END
!**********************************************************************
!*  ===================================================================
!*
...
! ----------------------------------------------------------------------------
        ...
        !*** Comparison Matrix
         cmp_s1 =  (/127,127,-128,0,0,0,127,-111/)

         do i = 1, 8

           if ( res_s1(i)                .ne.    cmp_s1(i)   )                   call zzrc(50+i)
