...
/* --------------------------------------------------------------* 
*        This C code is used by fxcmn_blk120.f                  * 
*        Please refer to fxcmn_blk120.f for further details.    * 
* --------------------------------------------------------------*/ 
...
// Temporary matrix used in modifying values passed from Fortran
         int_least64_t           tmp_c_int_least64_t[2][2][2]; 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
         ...
         if ( _[i][j][k] !=  cmp_c_int_least64_t[i][j][k])    exit (30+a); 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
         ...
         tmp_c_int_least64_t[k][j][i]  =     _[i][j][k];   
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
          ...
          _[k][j][i]  =     tmp_c_int_least64_t[k][j][i]; 
   ...
   for ( i = 0; i < 2; i++ ) { 
     for ( j = 0; j < 2; j++ ) { 
       for ( k = 0; k < 2; k++ ) { 
         ...
         if ( _[k][j][i] !=  cmp_c_int_least64_t[i][j][k])    exit (40+a); 
