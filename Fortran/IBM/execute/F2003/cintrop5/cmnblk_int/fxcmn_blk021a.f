...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/cmn_blk001.sh fxcmn_blk021a cxcmn_blk021
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: rm -f fxcmn_blk021a.o cxcmn_blk021.o fxcmn_blk021a
! %END
!**********************************************************************
!*  ===================================================================
!*
