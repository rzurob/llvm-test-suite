...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : varIsArrSectExprIsScalar06 - expr is a
...
PROGRAM varIsArrSectExprIsScalar06
    ...
    TYPE(tD2) :: d2Scalar
    TYPE(tD2), ALLOCATABLE :: d2Arr( : )


    d2Scalar = tD2(tD1(tB(99)))

!    d2Arr = [ (tD2(tD1(tB(i))), i = 1, 10) ]
    d2Arr = [ tD2(tD1(tB(1))),tD2(tD1(tB(2))),tD2(tD1(tB(3))),&
              tD2(tD1(tB(4))),tD2(tD1(tB(5))),tD2(tD1(tB(6))),&
              tD2(tD1(tB(7))),tD2(tD1(tB(8))),tD2(tD1(tB(9))),tD2(tD1(tB(10)))]
    CALL Dump( 10_4 )


    d2Arr( [ 2,4,6,8,10 ] ) = tD2(tD1(tB(-9)))
    CALL Dump( 40_4 )
