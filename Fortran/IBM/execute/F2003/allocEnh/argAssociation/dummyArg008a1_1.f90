...
!                               array case for test case dummyArg008a.f; with
!                               this modification, program core dump at
!                               SMP.O4.64.
!*
!* ===================================================================
...
use, intrinsic :: iso_fortran_env, only: error_unit
    ...
    co2 = container([(child([(cmplx(i,i-1), i=1,10)], str), j=1,2)])
    ...
    call assgn (co1%data, [base(null()), &
        base([(1.2d0, 2.2d0), (3.2d0, 4.2d0)]), base(null())])
!
