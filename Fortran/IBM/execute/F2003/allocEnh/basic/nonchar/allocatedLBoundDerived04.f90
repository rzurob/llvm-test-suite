...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : allocatedLBoundDerived04 - Basic Tests:
...
MODULE mModule
    ...
    TYPE, EXTENDS(dType) :: d2Type
        INTEGER :: k
    END TYPE d2Type

    TYPE(d2Type), ALLOCATABLE :: d2AllocArray( :,:,:,:,:,: )
...
PROGRAM allocatedLBoundDerived04
    ...
    TYPE(d2Type) :: d2StaticArray( -5:-4,-3:-2,-1:0,0:1,2:3,4:5 ) =&
      RESHAPE((/ (d2Type((i + 1),i,(i - 1)), i = 1, 64) /), (/ 2,2,2,2,2,2 /))
