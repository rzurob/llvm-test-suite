...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : allocatedLBoundDerived03 - Basic Tests:
...
MODULE derived
    USE base
     ...
     TYPE, EXTENDS(tBase) :: derived
        INTEGER, POINTER :: ptDerived
...
PROGRAM allocatedLBoundDerived03
    ...
    TYPE(derived) :: derived( 0:0,-1:0,0:1,-1:-1 )

    TYPE(derived), ALLOCATABLE :: derivedAlloc( :,:,:,: )


    ALLOCATE( derived :: derivedAlloc( -1:0,-1:-1,0:0,0:1 ) )
