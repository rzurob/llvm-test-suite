...
! %MAIN: YES
! %PRECMD:
! %COMPOPTS: -qfixed -qdebug=intmsg -qlanglvl=95pure
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: dcomp mxmn_langlvl_95p.f 
! %END
!**********************************************************************
!*  ===================================================================
...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : mxmn_langlvl_95p
!*
...
!*
!*  DRIVER STANZA              : xlf90
!*  REQUIRED COMPILER OPTIONS  : -qfixed -qdebug=intmsg -qlanglvl=95pure
!*
