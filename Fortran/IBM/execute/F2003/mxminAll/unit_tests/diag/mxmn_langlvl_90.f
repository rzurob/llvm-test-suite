...
! %MAIN: YES
! %PRECMD:
! %COMPOPTS: -qfixed -qdebug=intmsg -qlanglvl=90std
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
! %STDOUT:
! %EXECARGS:
! %POSTCMD: dcomp mxmn_langlvl_check_90.f
! %END
!**********************************************************************
!*  ===================================================================
...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : mxmn_langlvl_check_90 
!*
...
!*
!*  DRIVER STANZA              : xlf90
!*  REQUIRED COMPILER OPTIONS  : -qfixed -qdebug=intmsg -qlanglvl=90std
!*
