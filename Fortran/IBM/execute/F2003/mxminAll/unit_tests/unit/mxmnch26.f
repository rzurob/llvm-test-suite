...
!234567890123456789012345678901234567890123456789012345678901234567890
     ...
     +aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
     +aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
     +aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabaaaaa
     +'
      character(6700), parameter :: c = max(a, b)
      character(6700), parameter :: d = min(a, b)
      if (c(2635:2635) /= 'b') error stop 1
      if (d(2635:2635) /= 'A') error stop 2
      end
