...
!*                               use optional argument of MAX/MIN
!* ===================================================================

  program mxminConform02
     ...
     if(len(max(x, y, x1(1:3))) .ne. 8)  error stop 1_4

     if(len(min(x, y, y1(2:4))) .ne. 8) error stop 2_4
     ...
     if(any(min(x3(1:5), y3(1:5), y3(2:6)) .ne. "IBM")) error stop 7_4

     if(any(max(x3(1:5), y3((/1,1,1,1,1/)), x3(2:6)) .ne. "KGB")) error stop 8_4

     if(any(min(x3(vector(9:12)), y3(1:4), y3(2:5)) .ne. "IBM")) error stop 9_4
       
  end program mxminConform02
