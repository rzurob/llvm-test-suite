...
@process intlog
  ...
  end module ArgVarSub2 

@process intlog
  program mxminvalVarArgSub2 
    ...
    character*3 :: x(4) = (/"ddd", "bbb", "aaa", "ttt"/)
    character*3 :: z1(2,3) = reshape((/"ddd", "bbb", "aaa", "sss", "ddd", "bbb"/), (/2,3/))
    character*2 :: z2(2,3) = reshape((/"zz", "gg", "aa", "ss", "dd", "aa"/), (/2,3/))
    character*2 v(2)
  ...
  end program mxminvalVarArgSub2 
