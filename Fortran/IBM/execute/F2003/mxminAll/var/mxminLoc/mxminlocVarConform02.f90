...
!*
!*  DESCRIPTION                : MAXLOC/MINLOC with variable as its
!*                               argument. Using DIM and MASK with
...
program mxminlocConform02
    ...
    character*2 :: x(10) = (/(char(i+70), i = 1,10,1)/)
    character*2 :: y(2,3) = reshape((/"bb", "aa", "cc", "dd","ff", "gg"/),(/2,3/))
    ...
    if(any(minloc(x(3:8), mask=v4) .ne. 2)) error stop 10_4
