...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg07 cxmdvg07 
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f 
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg07.f 
!*  TEST CASE TITLE            : bind(c) attribute/statement
!*
!*  PROGRAMMER                 : Kan Tian
!*  DATE                       : Sep 14,2002 
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(c_intmax_t) with bind(c) 
!*                              attribute/statement 
...
module mod
  ...
  integer(c_intmax_t), bind(c,name="xaa") :: fx=1

  integer(c_intmax_t):: fy =2 
  bind(c,name="Xaa") :: fy
...
program testmix
  use mod
  logical ::result
  integer(c_intmax_t)::basval1,basval2
