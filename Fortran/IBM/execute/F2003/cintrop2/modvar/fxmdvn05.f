...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/fxmdvn05.sh fxmdvn05 cxmdvn05
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
if ( .not.precision_r16(a, 0.0Q0) .or. .not.precision_r16(aa, 0.0Q0) ) then
    error stop 50
end if
