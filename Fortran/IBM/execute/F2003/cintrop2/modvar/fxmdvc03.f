...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvc03 cxmdvc03 
! %COMPOPTS:   
! %GROUP: redherring.f 
! %VERIFY:
! %STDIN:
...
!*
!*  KEYWORD(S)                 : C_LONG_LONG , DIMENSION
!*  DESCRIPTION                :
...
module mod
  USE ISO_C_BINDING
  integer(C_LONG_LONG),dimension(0:5,0:4,0:3), bind(c) :: c3darray
end module mod

subroutine fsub()
  use mod
  integer(C_LONG_LONG),dimension(0:5,0:4,0:3) :: f3darray
  integer::i,j,k
  logical::res
