...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg20 cxmdvg20
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg20.f
!*
!*  DATE                       : Sep 14,2002
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(2) with bind(c)
!*                              attribute/statement
...
module mod
  ...
  integer(2), bind(c,name="xaa") :: fx=1
