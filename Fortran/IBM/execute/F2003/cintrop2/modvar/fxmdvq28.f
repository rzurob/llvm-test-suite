...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/fxmdvn01.sh fxmdvq28 cxmdvq14 
...
!*                              : in fmain and csub which calls fsub. Use module
!*                              : iso_c_binding
!234567890123456789012345678901234567890123456789012345678901234567890
module mod
use iso_c_binding
character(len = 9), parameter :: kk = "chaRaCter"
character(c_char) ch1
bind(c, name = "cha1") :: ch1

character(c_char), bind(c, name = "ch1") :: cha1

character*1 ch2
bind(c, name = kk(1:4)) :: ch2

character(c_char), bind(c, name = "CHar") :: chaR
...
character(c_char), dimension(2 ,2), bind(c, name = "  cha4   "(3:9)) :: ch6
