...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/fxmdvn05.sh fxmdvp11 cxmdvp11
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*                              : use the variable in fortran sub, called in C.
...
real*16, bind(c, name = "AA") :: aa = 0.0Q0

real(16), dimension(10), bind(c, name = "   A1  ") :: a1
real(16), dimension(10, 10), bind(c, name = "   a2  ") :: a2
real(16), bind(c, name = "   "//"a3"//"  ") :: a3(3, 2, 1)
