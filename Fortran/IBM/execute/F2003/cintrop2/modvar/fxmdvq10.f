...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/fxmdvn04.sh fxmdvq10 cxmdvq10
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*                              : binding label. Use the variable in fmain and
!*                              : csub which calls fsub.
...
complex(4), bind(c, name = "B3") :: b3(3, 2, 1)
...
complex(16), bind(c, name="D3") :: d3(3, 2, 1)
