...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvc07 cxmdvc07 
! %COMPOPTS:   
! %GROUP: redherring.f 
! %VERIFY:
! %STDIN:
...
module mod
  USE ISO_C_BINDING
  integer(C_INTMAX_T),dimension(0:5,0:4,0:3), bind(c) :: c3darray
end module mod

subroutine fsub()
  use mod
  integer(C_INTMAX_T),dimension(0:5,0:4,0:3) :: f3darray
  integer::i,j,k
  logical::res
