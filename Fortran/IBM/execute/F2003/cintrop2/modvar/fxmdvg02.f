...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg02 cxmdvg02
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg02.f
!*
!*  DATE                       : Sep 14,2002
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(c_int) with bind(c)
!*                              attribute/statement
...
module mod
  ...
  integer(c_int), bind(c,name="xaa") :: fx=1
