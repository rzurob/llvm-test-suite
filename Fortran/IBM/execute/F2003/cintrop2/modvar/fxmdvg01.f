...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg01 cxmdvg01
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg01.f
!*
!*  DATE                       : Sep 14,2002
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(c_short) with bind(c)
!*                              attribute/statement
...
module mod
  ...
  integer(c_short), bind(c,name="xaa") :: fx=1

  integer(c_short):: fy =2
  bind(c,name="Xaa") :: fy
...
program testmix
  use mod
  logical ::result
  integer(c_short)::basval1,basval2
