...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg21 cxmdvg21
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg21.f
!*
!*  DATE                       : Sep 14,2002
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(4) with bind(c)
!*                              attribute/statement
...
module mod
  ...
  integer(4), bind(c,name="xaa") :: fx=1
