...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg08 cxmdvg08
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg08.f
!*
!*  DATE                       : Sep 14,2002
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(c_int8_t) with bind(c)
!*                              attribute/statement
...
module mod
  ...
  integer(c_int8_t), bind(c,name="xaa") :: fx=1

  integer(c_int8_t):: fy =2
  bind(c,name="Xaa") :: fy
  ...
  contains
    ...
    function assert2(n1,n2)
      integer(c_int8_t), intent(in) :: n1,n2
      logical assert2
      if (n1 .ne. n2) then
      assert2= .false.
      else
...
program testmix
  use mod
  logical ::result
  integer(c_int8_t)::basval1,basval2
