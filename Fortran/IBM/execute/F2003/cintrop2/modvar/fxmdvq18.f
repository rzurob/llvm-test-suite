...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/fxmdvn06.sh fxmdvq18 cxmdvq18
...
!*                              : variable with binding lable and option -qmixed
!*                              : use the variables in fmain and csub and fsub.
!234567890123456789012345678901234567890123456789012345678901234567890

module mod
character(8), parameter :: kk = "aaaAA33"
complex(16) :: a = (0.0Q0, 1.0Q0)
bind(c, name = "A") :: a


complex*32, bind(c, name = "a") :: aa = (0.0Q0,1.0Q0)


complex(16), dimension(10), bind(c, name = "  a1  ") :: a1
complex(16), dimension(10, 10), bind(c, name = "A1") :: a2
complex(16), bind(c, name = ""//"  "//kk(5:6)//"  ") :: a3(3, 2, 1)
