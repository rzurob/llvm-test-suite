...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg03 cxmdvg03 
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f 
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg03.f 
!*  TEST CASE TITLE            : bind(c) attribute/statement
!*
!*  PROGRAMMER                 : Kan Tian
!*  DATE                       : Sep 14,2002 
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(c_long_long) with bind(c) 
!*                              attribute/statement 
...
module mod
  ...
  integer(c_long_long), bind(c,name="xaa") :: fx=1

  integer(c_long_long):: fy =2 
  bind(c,name="Xaa") :: fy
...
program testmix
  use mod
  logical ::result
  integer(c_long_long)::basval1,basval2
