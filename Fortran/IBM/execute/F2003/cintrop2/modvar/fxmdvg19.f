...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdvg19 cxmdvg19
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg19.f
!*
!*  DATE                       : Sep 14,2002
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(c_int_fast64_t) with bind(c)
!*                              attribute/statement
...
module mod
  ...
  integer(c_int_fast64_t), bind(c,name="xaa") :: fx=1

  integer(c_int_fast64_t):: fy =2
  bind(c,name="Xaa") :: fy
...
program testmix
  use mod
  logical ::result
  integer(c_int_fast64_t)::basval1,basval2
