...
! %START
! %MAIN:
! %PRECMD: ${TR_SRC}/rundev.sh fxmdvmna16 cxmdvmna16a cxmdvmna16b cxmdvmna16c
! %COMPOPTS:  -qalign
! %GROUP: redherring.f
! %VERIFY: 
! %STDIN:
...
!*
!*  KEYWORD(S)                 : C_INT, C_INT_FAST8_T , -qalign
!*  TARGET(S)                  :
!*  NUMBER OF TESTS CONDITIONS :
!*
!*  DESCRIPTION                : 
!*
!*	- testing C_INT and C_INT_FAST8_T
