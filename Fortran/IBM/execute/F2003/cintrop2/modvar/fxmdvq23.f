...
! %START
! %MAIN: YES
! %PRECMD: ${TR_SRC}/fxmdvn01.sh fxmdvq23 cxmdvq07
! %COMPOPTS: -qfree=f90
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*                              : and csub which calls fsub. Use iso_c_binding
...
real(c_long_double), bind(c, name = " D ") :: z = 0.0Q0
