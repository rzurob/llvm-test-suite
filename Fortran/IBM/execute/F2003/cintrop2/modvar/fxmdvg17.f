...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/runint16.sh fxmdvg17 cxmdvg17
! %COMPOPTS:   -qmixed
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
!*  ===================================================================
!*
!*  TEST CASE NAME             : fxmdvg17.f
!*
!*  DATE                       : Sep 14,2002
!*
!*  PRIMARY FUNCTIONS TESTED   :test integer(c_int_fast16_t) with bind(c)
!*                              attribute/statement
...
module mod
  ...
  integer(c_int_fast16_t), bind(c,name="xaa") :: fx=1

  integer(c_int_fast16_t):: fy =2
  bind(c,name="Xaa") :: fy
...
program testmix
  use mod
  logical ::result
  integer(c_int_fast16_t)::basval1,basval2
