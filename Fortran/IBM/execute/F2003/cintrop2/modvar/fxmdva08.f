...
! %START
! %MAIN: YES
! %PRECMD:  $TR_SRC/run.sh fxmdva08 cxmdva08
! %COMPOPTS:
! %GROUP: redherring.f
! %VERIFY:
! %STDIN:
...
subroutine fsub()
  use mod
  integer(C_INT8_T) :: basval1,basval2,basval3,basval4
  integer case_id
  LOGICAL ::result
