...
!*  ===================================================================
!*
!*  TEST CASE TITLE            : F2008/generic/func/generic_allocatable_pointer_f020.f
...
program generic_allocatable_pointer_f020
use f2008_generic
implicit none
   type(Base)                       :: base_res
   ...
   call child_ptr%alloc_ptr_sub(base_res, child_ptr)
