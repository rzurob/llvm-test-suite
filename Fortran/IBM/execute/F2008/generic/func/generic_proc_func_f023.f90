...
implicit none
   ...
   type Base
      integer :: i /-1/
      contains
         procedure, pass :: proc_fsub
         generic :: procfunc_sub => proc_fsub
         procedure, pass :: func_ffunc
   ...
   type, extends(Base) :: Child
      integer :: j /5/
      contains
         procedure, pass :: func_fsub, proc_ffunc
...
program generic_proc_ffunc_f023
use f2008_generic
implicit none
