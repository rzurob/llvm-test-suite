...
j1 = maxloc((/1_4, 3_4, 3_4, 2_4/), back = .true.)

j2 = maxloc((/1_4, 2_4, 3_4, 2_4/), (/.true., .true., .false., .true./), back = .true.)

j3 = maxloc(reshape((/1_4, 3_4, 3_4, 2_4/), (/2,2/)), back = .true.)

j4 = maxloc(reshape((/1_4, 2_4, 3_4, 2_4/), (/2,2/)), &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j5 = maxloc(reshape((/1_4, 3_4, 2_4, 3_4/), (/2,2/)), 2, back = .true.)

j6 = maxloc(reshape((/1_4, 3_4, 2_4, 3_4/), (/2,2/)), 2, &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back =.true.)

j7 = maxloc(reshape((/1_4, 3_4, 4_4, 2_4, 1_4, 3_4, 4_4, 2_4/), (/2,2,2/)), back = .true.)

j8 = maxloc(reshape((/1_4, 2_4, 3_4, 2_4, 1_4, 2_4, 3_4, 2_4/), (/2,2,2/)), &
            reshape((/.true., .true., .false., .true., &
                      .true., .true., .true., .true./), (/2,2,2/)), back = .true.)

j9 = maxloc(reshape((/1_4, 3_4, 2_4, 3_4, 1_4, 3_4, 2_4, 3_4/), (/2,2,2/)), 2, back = .true.)

j10 = maxloc(reshape((/1_4, 3_4, 2_4, 3_4, 1_4, 3_4, 2_4, 3_4/), (/2,2,2/)), 2, &
             reshape((/.true., .true., .false., .true., &
                       .true., .true., .true., .true./), (/2,2,2/)), back =.true.)
