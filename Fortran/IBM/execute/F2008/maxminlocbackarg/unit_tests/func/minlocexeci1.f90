...
j1 = minloc((/3_1, 1_1, 1_1, 2_1/), back = .true.)

j2 = minloc((/3_1, 2_1, 1_1, 2_1/), (/.true., .true., .false., .true./), back = .true.)

j3 = minloc(reshape((/3_1, 1_1, 1_1, 2_1/), (/2,2/)), back = .true.)

j4 = minloc(reshape((/3_1, 2_1, 1_1, 2_1/), (/2,2/)), &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j5 = minloc(reshape((/3_1, 1_1, 1_1, 2_1/), (/2,2/)), 2, back = .true.)

j6 = minloc(reshape((/1_1, 3_1, 2_1, 3_1/), (/2,2/)), 2, &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j7 = minloc(reshape((/1_1, 3_1, 4_1, 2_1, 1_1, 3_1, 4_1, 2_1/), (/2,2,2/)), back = .true.)

j8 = minloc(reshape((/2_1, 3_1, 1_1, 3_1, 2_1, 3_1, 4_1, 3_1/), (/2,2,2/)), &
            reshape((/.true., .true., .false., .true., &
                      .true., .true., .true., .true./), (/2,2,2/)), back = .true.)

j9 = minloc(reshape((/2_1, 4_1, 1_1, 4_1, 2_1, 4_1, 4_1, 3_1/), (/2,2,2/)), 2, back =.true.)

j10 = minloc(reshape((/2_1, 4_1, 1_1, 4_1, 2_1, 4_1, 4_1, 3_1/), (/2,2,2/)), 2, &
             reshape((/.true., .true., .false., .true., &
                       .true., .true., .true., .true./), (/2,2,2/)), back =.true.)
