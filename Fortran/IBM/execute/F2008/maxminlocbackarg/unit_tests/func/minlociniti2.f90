...
integer :: j1(1) = minloc((/3_2, 1_2, 1_2, 2_2/), back = .true.)

integer :: j2(1) = minloc((/3_2, 2_2, 1_2, 2_2/), &
                          (/.true., .true., .false., .true./), back = .true.)

integer :: j3(2) = minloc(reshape((/3_2, 1_2, 1_2, 2_2/), (/2,2/)), back = .true.)

integer :: j4(2) = minloc(reshape((/3_2, 2_2, 1_2, 2_2/), (/2,2/)), &
                          reshape((/.true., .true., .false., .true./), (/2,2/)), &
                          back = .true.)

integer :: j5(2) = minloc(reshape((/3_2, 1_2, 1_2, 2_2/), (/2,2/)), 2, back = .true.)

integer :: j6(2) = minloc(reshape((/1_2, 3_2, 2_2, 3_2/), (/2,2/)), 2, &
                          reshape((/.true., .true., .false., .true./), (/2,2/)), &
                          back = .true.)

integer :: j7(3) = minloc(reshape((/1_2, 3_2, 4_2, 2_2, 1_2, 3_2, 4_2, 2_2/), (/2,2,2/)), &
                          back = .true.)

integer :: j8(3) = minloc(reshape((/1_2, 2_2, 0_2, 2_2, 1_2, 2_2, 3_2, 2_2/), (/2,2,2/)), &
                          reshape((/.true., .true., .false., .true., &
                                    .true., .true., .true., .true./), (/2,2,2/)), &
                          back = .true.)

integer :: j9(2,2) = minloc(reshape((/1_2, 3_2, 0_2, 3_2, 1_2, 3_2, 3_2, 2_2/), (/2,2,2/)), 2, &
                            back =.true.)

integer :: j10(2,2) = minloc(reshape((/1_2, 3_2, 0_2, 3_2, 1_2, 3_2, 3_2, 2_2/), (/2,2,2/)), 2, &
                             reshape((/.true., .true., .false., .true., &
                                       .true., .true., .true., .true./), (/2,2,2/)), &
                             back =.true.)
