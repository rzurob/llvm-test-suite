...
integer :: j1(1) = minloc((/'c', 'a', 'a', 'b'/), back = .true.)

integer :: j2(1) = minloc((/'c', 'b', 'a', 'b'/), &
                          (/.true., .true., .false., .true./), back = .true.)

integer :: j3(2) = minloc(reshape((/'c', 'a', 'a', 'b'/), (/2,2/)), back = .true.)

integer :: j4(2) = minloc(reshape((/'c', 'b', 'a', 'b'/), (/2,2/)), &
                          reshape((/.true., .true., .false., .true./), (/2,2/)), &
                          back = .true.)

integer :: j5(2) = minloc(reshape((/'c', 'a', 'a', 'b'/), (/2,2/)), 2, back = .true.)

integer :: j6(2) = minloc(reshape((/'a', 'c', 'b', 'c'/), (/2,2/)), 2, &
                          reshape((/.true., .true., .false., .true./), (/2,2/)), &
                          back = .true.)

integer :: j7(3) = minloc(reshape((/'a', 'c', 'd', 'b', 'a', 'c', 'd', 'b'/), (/2,2,2/)), &
                          back = .true.)

integer :: j8(3) = minloc(reshape((/'b', 'c', 'a', 'c', 'b', 'c', 'd', 'c'/), (/2,2,2/)), &
                          reshape((/.true., .true., .false., .true., &
                                    .true., .true., .true., .true./), (/2,2,2/)), &
                          back = .true.)

integer :: j9(2,2) = minloc(reshape((/'b', 'd', 'a', 'd', 'b', 'd', 'd', 'c'/), (/2,2,2/)), 2, &
                            back =.true.)

integer :: j10(2,2) = minloc(reshape((/'b', 'd', 'a', 'd', 'b', 'd', 'd', 'c'/), (/2,2,2/)), 2, &
                             reshape((/.true., .true., .false., .true., &
                                       .true., .true., .true., .true./), (/2,2,2/)), &
                             back =.true.)
