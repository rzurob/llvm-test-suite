...
j1 = minloc((/3.4_16, 1.2_16, 1.2_16, 2.3_16/), back = .true.)

j2 = minloc((/3.4_16, 2.3_16, 1.2_16, 2.3_16/), (/.true., .true., .false., .true./), &
            back = .true.)

j3 = minloc(reshape((/3.4_16, 1.2_16, 1.2_16, 2.3_16/), (/2,2/)), back = .true.)

j4 = minloc(reshape((/3.4_16, 2.3_16, 1.2_16, 2.3_16/), (/2,2/)), &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j5 = minloc(reshape((/3.4_16, 1.2_16, 1.2_16, 2.3_16/), (/2,2/)), 2, back = .true.)

j6 = minloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16/), (/2,2/)), 2, &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j7 = minloc(reshape((/1.2_16, 3.4_16, 4.5_16, 2.3_16, 1.2_16, 3.4_16, 4.5_16, 2.3_16/), &
                    (/2,2,2/)), back = .true.)

j8 = minloc(reshape((/2.3_16, 3.4_16, 1.2_16, 3.4_16, 2.3_16, 3.4_16, 4.5_16, 3.4_16/), &
                    (/2,2,2/)), reshape((/.true., .true., .false., .true., &
                                          .true., .true., .true., .true./), (/2,2,2/)), &
            back = .true.)

j9 = minloc(reshape((/2.3_16, 4.5_16, 1.2_16, 4.5_16, 2.3_16, 4.5_16, 4.5_16, 3.4_16/), &
                    (/2,2,2/)), 2, back =.true.)

j10 = minloc(reshape((/2.3_16, 4.5_16, 1.2_16, 4.5_16, 2.3_16, 4.5_16, 4.5_16, 3.4_16/), &
