...
j1 = minloc((/3_2, 1_2, 1_2, 2_2/), back = .true.)

j2 = minloc((/3_2, 2_2, 1_2, 2_2/), (/.true., .true., .false., .true./), back = .true.)

j3 = minloc(reshape((/3_2, 1_2, 1_2, 2_2/), (/2,2/)), back = .true.)

j4 = minloc(reshape((/3_2, 2_2, 1_2, 2_2/), (/2,2/)), &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j5 = minloc(reshape((/3_2, 1_2, 1_2, 2_2/), (/2,2/)), 2, back = .true.)

j6 = minloc(reshape((/1_2, 3_2, 2_2, 3_2/), (/2,2/)), 2, &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j7 = minloc(reshape((/1_2, 3_2, 4_2, 2_2, 1_2, 3_2, 4_2, 2_2/), (/2,2,2/)), back = .true.)

j8 = minloc(reshape((/2_2, 3_2, 1_2, 3_2, 2_2, 3_2, 4_2, 3_2/), (/2,2,2/)), &
            reshape((/.true., .true., .false., .true., &
                      .true., .true., .true., .true./), (/2,2,2/)), back = .true.)

j9 = minloc(reshape((/2_2, 4_2, 1_2, 4_2, 2_2, 4_2, 4_2, 3_2/), (/2,2,2/)), 2, back =.true.)
