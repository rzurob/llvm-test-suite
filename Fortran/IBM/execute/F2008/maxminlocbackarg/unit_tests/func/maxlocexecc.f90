...
j1 = maxloc((/'a', 'c', 'c', 'b'/), back = .true.)

j2 = maxloc((/'a', 'b', 'c', 'b'/), (/.true., .true., .false., .true./), back = .true.)

j3 = maxloc(reshape((/'a', 'c', 'c', 'b'/), (/2,2/)), back = .true.)

j4 = maxloc(reshape((/'a', 'b', 'c', 'b'/), (/2,2/)), &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j5 = maxloc(reshape((/'a', 'c', 'b', 'c'/), (/2,2/)), 2, back = .true.)

j6 = maxloc(reshape((/'a', 'c', 'b', 'c'/), (/2,2/)), 2, &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back =.true.)

j7 = maxloc(reshape((/'a', 'c', 'd', 'b', 'a', 'c', 'd', 'b'/), (/2,2,2/)), back = .true.)

j8 = maxloc(reshape((/'a', 'b', 'c', 'b', 'a', 'b', 'c', 'b'/), (/2,2,2/)), &
            reshape((/.true., .true., .false., .true., &
                      .true., .true., .true., .true./), (/2,2,2/)), back = .true.)

j9 = maxloc(reshape((/'a', 'c', 'b', 'c', 'a', 'c', 'b', 'c'/), (/2,2,2/)), &
            2, back = .true.)

j10 = maxloc(reshape((/'a', 'c', 'b', 'c', 'a', 'c', 'b', 'c'/), (/2,2,2/)), 2, &
             reshape((/.true., .true., .false., .true., &
                       .true., .true., .true., .true./), (/2,2,2/)), back =.true.)
