...
integer :: j1(1) = minloc((/3_8, 1_8, 1_8, 2_8/), back = .true.)

integer :: j2(1) = minloc((/3_8, 2_8, 1_8, 2_8/), &
                          (/.true., .true., .false., .true./), back = .true.)

integer :: j3(2) = minloc(reshape((/3_8, 1_8, 1_8, 2_8/), (/2,2/)), back = .true.)

integer :: j4(2) = minloc(reshape((/3_8, 2_8, 1_8, 2_8/), (/2,2/)), &
                          reshape((/.true., .true., .false., .true./), (/2,2/)), &
                          back = .true.)

integer :: j5(2) = minloc(reshape((/3_8, 1_8, 1_8, 2_8/), (/2,2/)), 2, back = .true.)

integer :: j6(2) = minloc(reshape((/1_8, 3_8, 2_8, 3_8/), (/2,2/)), 2, &
                          reshape((/.true., .true., .false., .true./), (/2,2/)), &
                          back = .true.)

integer :: j7(3) = minloc(reshape((/1_8, 3_8, 4_8, 2_8, 1_8, 3_8, 4_8, 2_8/), (/2,2,2/)), &
                          back = .true.)

integer :: j8(3) = minloc(reshape((/1_8, 2_8, 0_8, 2_8, 1_8, 2_8, 3_8, 2_8/), (/2,2,2/)), &
                          reshape((/.true., .true., .false., .true., &
                                    .true., .true., .true., .true./), (/2,2,2/)), &
                          back = .true.)

integer :: j9(2,2) = minloc(reshape((/1_8, 3_8, 0_8, 3_8, 1_8, 3_8, 3_8, 2_8/), (/2,2,2/)), 2, &
                            back =.true.)

integer :: j10(2,2) = minloc(reshape((/1_8, 3_8, 0_8, 3_8, 1_8, 3_8, 3_8, 2_8/), (/2,2,2/)), 2, &
                             reshape((/.true., .true., .false., .true., &
                                       .true., .true., .true., .true./), (/2,2,2/)), &
                             back =.true.)
