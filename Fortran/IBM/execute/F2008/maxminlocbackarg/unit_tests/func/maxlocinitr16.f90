...
integer :: j1(1) = maxloc((/1.2_16, 3.4_16, 3.4_16, 2.3_16/), back = .true.)

integer :: j2(1) = maxloc((/1.2_16, 2.3_16, 3.4_16, 2.3_16/), &
                          (/.true., .true., .false., .true./), back = .true.)

integer :: j3(2) = maxloc(reshape((/1.2_16, 3.4_16, 3.4_16, 2.3_16/), (/2,2/)), back = .true.)

integer :: j4(2) = maxloc(reshape((/1.2_16, 2.3_16, 3.4_16, 2.3_16/), (/2,2/)), &
                          reshape((/.true., .true., .false., .true./), (/2,2/)), &
                          back = .true.)

integer :: j5(2) = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16/), (/2,2/)), 2, back = .true.)

integer :: j6(2) = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16/), (/2,2/)), 2, &
                           reshape((/.true., .true., .false., .true./), (/2,2/)), &
                           back =.true.)
                          
integer :: j7(3) = maxloc(reshape((/1.2_16, 3.4_16, 4.5_16, 2.3_16, 1.2_16, 3.4_16, 4.5_16, 2.3_16/), (/2,2,2/)), &
                          back = .true.)

integer :: j8(3) = maxloc(reshape((/1.2_16, 2.3_16, 3.4_16, 2.3_16, 1.2_16, 2.3_16, 3.4_16, 2.3_16/), (/2,2,2/)), &
                          reshape((/.true., .true., .false., .true., &
                                    .true., .true., .true., .true./), (/2,2,2/)), &
                          back = .true.)

integer :: j9(2,2) = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16, 1.2_16, 3.4_16, 2.3_16, 3.4_16/), (/2,2,2/)), &
                            2, back = .true.)

integer :: j10(2,2) = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16, 1.2_16, 3.4_16, 2.3_16, 3.4_16/), (/2,2,2/)), 2, &
                             reshape((/.true., .true., .false., .true., &
                                       .true., .true., .true., .true./), (/2,2,2/)), &
                             back =.true.)
