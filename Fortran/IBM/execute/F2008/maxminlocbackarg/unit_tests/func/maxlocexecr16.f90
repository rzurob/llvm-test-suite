...
j1 = maxloc((/1.2_16, 3.4_16, 3.4_16, 2.3_16/), back = .true.)

j2 = maxloc((/1.2_16, 2.3_16, 3.4_16, 2.3_16/), (/.true., .true., .false., .true./), back = .true.)

j3 = maxloc(reshape((/1.2_16, 3.4_16, 3.4_16, 2.3_16/), (/2,2/)), back = .true.)

j4 = maxloc(reshape((/1.2_16, 2.3_16, 3.4_16, 2.3_16/), (/2,2/)), &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j5 = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16/), (/2,2/)), 2, back = .true.)

j6 = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16/), (/2,2/)), 2, &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back =.true.)

j7 =  maxloc(reshape((/1.2_16, 3.4_16, 4.5_16, 2.3_16, 1.2_16, 3.4_16, 4.5_16, 2.3_16/), &
                     (/2,2,2/)), back = .true.)

j8 = maxloc(reshape((/1.2_16, 2.3_16, 3.4_16, 2.3_16, 1.2_16, 2.3_16, 3.4_16, 2.3_16/), &
                    (/2,2,2/)), reshape((/.true., .true., .false., .true., &
                                          .true., .true., .true., .true./), &
                                        (/2,2,2/)), back = .true.)

j9 = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16, 1.2_16, 3.4_16, 2.3_16, 3.4_16/), &
                    (/2,2,2/)), 2, back = .true.)

j10 = maxloc(reshape((/1.2_16, 3.4_16, 2.3_16, 3.4_16, 1.2_16, 3.4_16, 2.3_16, 3.4_16/), &
