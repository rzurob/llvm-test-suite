...
j1 = minloc((/3_4, 1_4, 1_4, 2_4/), back = .true.)

j2 = minloc((/3_4, 2_4, 1_4, 2_4/), (/.true., .true., .false., .true./), back = .true.)

j3 = minloc(reshape((/3_4, 1_4, 1_4, 2_4/), (/2,2/)), back = .true.)

j4 = minloc(reshape((/3_4, 2_4, 1_4, 2_4/), (/2,2/)), &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j5 = minloc(reshape((/3_4, 1_4, 1_4, 2_4/), (/2,2/)), 2, back = .true.)

j6 = minloc(reshape((/1_4, 3_4, 2_4, 3_4/), (/2,2/)), 2, &
            reshape((/.true., .true., .false., .true./), (/2,2/)), back = .true.)

j7 = minloc(reshape((/1_4, 3_4, 4_4, 2_4, 1_4, 3_4, 4_4, 2_4/), (/2,2,2/)), back = .true.)

j8 = minloc(reshape((/2_4, 3_4, 1_4, 3_4, 2_4, 3_4, 4_4, 3_4/), (/2,2,2/)), &
            reshape((/.true., .true., .false., .true., &
                      .true., .true., .true., .true./), (/2,2,2/)), back = .true.)

j9 = minloc(reshape((/2_4, 4_4, 1_4, 4_4, 2_4, 4_4, 4_4, 3_4/), (/2,2,2/)), 2, back =.true.)

j10 = minloc(reshape((/2_4, 4_4, 1_4, 4_4, 2_4, 4_4, 4_4, 3_4/), (/2,2,2/)), 2, &
             reshape((/.true., .true., .false., .true., &
                       .true., .true., .true., .true./), (/2,2,2/)), back =.true.)
