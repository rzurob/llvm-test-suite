...
!*  ===================================================================
!*
!*  TEST CASE NAME             : PassInterProcPtrArr.f
!*
...
program PassInterProcPtrArr
  ...
  interface
    ...
    function test2(low, high)
      integer :: low, high
    end function

    subroutine test3(x, arr)
      integer :: x
      integer, dimension(x*3) :: arr
    end subroutine

    integer function test4(arr)
      integer :: arr(1:,:,10:)
    end function

    subroutine test5(arr)
      integer :: arr(2, *)
    end subroutine
  end interface

  procedure(test1), pointer :: p1
  procedure(test2), pointer :: p2
  procedure(test3), pointer :: p3
  procedure(test4), pointer :: p4
  procedure(test5), pointer :: p5
