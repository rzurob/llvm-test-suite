...
!*  =================================================================== 
!*
!*  TEST CASE TITLE            : mult_type_bound_diag2.f 
!*
!*  PROGRAMMER                 : Paul Liu
!*  DATE                       : 2011-05-20
!*  ORIGIN                     :
...
!*                               procedure(iface), deferred, pass :: foo ,bar => real_bar
!*                               first is right,2nd is incorrect
...
module m
   ...
   type, abstract :: fox_base(k1)    ! (4)
      ...
      integer(k1)   :: i
      contains
         procedure(iface), deferred, pass :: foo ,bar => real_bar !first is right
   end type
