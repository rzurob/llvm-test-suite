...
program main
  ...
  integer :: AllocStat
  type(c_funptr), allocatable :: cproc(:)
  allocate (cproc, source = (/                                   &
                            & c_funloc(sub_int),                 &
                            & c_funloc(sub_short),               &
                            & c_funloc(sub_long),                &
                            & c_funloc(sub_long_long),           &
                            & c_funloc(sub_unsigned),            &
                            & c_funloc(sub_size_t),              &
                            & c_funloc(sub_int8_t),              &
                            & c_funloc(sub_int16_t),             &
                            & c_funloc(sub_int32_t),             &
                            & c_funloc(sub_int64_t),             &
                            & c_funloc(sub_int_least8_t),        &
                            & c_funloc(sub_int_least16_t),       &
                            & c_funloc(sub_int_least32_t),       &
                            & c_funloc(sub_int_least64_t),       &
                            & c_funloc(sub_int_fast8_t),         &
                            & c_funloc(sub_int_fast16_t),        &
                            & c_funloc(sub_int_fast32_t),        &
                            & c_funloc(sub_int_fast64_t),        &
                            & c_funloc(sub_intmax_t),            &
                            & c_funloc(sub_intptr_t),            &
                            & c_funloc(sub_float),               &
                            & c_funloc(sub_double),              &
                            & c_funloc(sub_long_double),         &
                            & c_funloc(sub_float_complex),       &
                            & c_funloc(sub_double_complex),      &
                            & c_funloc(sub_long_double_complex), &
                            & c_funloc(sub_bool),                &
                            & c_funloc(sub_char)/)               &
          & , stat=allocStat)
