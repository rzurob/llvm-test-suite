...
void check_c_to_f_to_f(CFI_cdesc_t* a,int * c_len,  int *test_no, void (*ffun));
void check_c_to_f_to_c(CFI_cdesc_t* a, int * c_len, int *test_no, void (*ffun));
...
//    check_c_to_f(a, &c_len, &test_no);
    ...
    test_no = 2;
    extent = 5;
    check_c_to_f_to_f(a, &c_len, &test_no, &ffun);  
