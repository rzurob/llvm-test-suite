...
_Bool compFloat(float, float, float);
_Bool compDouble(double, double, double);
...
_Bool compDouble(double a, double b, double epsilon ) 
{
    if (fabs(a-b) < epsilon) {
        return true;
    }
...
_Bool compFloat(float a, float b, float epsilon )
{
    if (fabs(a-b) < epsilon) {
        return true;
    }
