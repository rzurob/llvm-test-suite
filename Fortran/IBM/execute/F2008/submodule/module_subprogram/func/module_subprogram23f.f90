...
!* ===================================================================
!*
!* TEST CASE TITLE              : module_subprogram23f.f
!*
...
program p
  ...
  interface
    integer(c_int) function c_helper() bind(c)
      import
    end
  end interface

  res = c_helper()
  if (res /= 0) error stop 66
