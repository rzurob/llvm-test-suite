...
!234567890123456789012345678901234567890123456789012345678901234567890
    ...
    PROGRAM FXOPEN_NEWUNIT07
    IMPLICIT NONE

    INTEGER , PARAMETER :: NUM = 50
    INTEGER :: IVAR(NUM),RVAR(50),j=15,i
...
!**********************************************************
    ...
    DO i = 1, NUM
    OPEN(NEWUNIT=IVAR(i), ACCESS=acc, STATUS=stat)
    RVAR(i)=IVAR(i)
      IF ( IVAR(i) >= -2 ) THEN
      ERROR STOP 2_4
      ENDIF
...
!**********************************************************
    ...
    OPEN(NEWUNIT=IVAR(j), ACCESS=acc, FILE='fxopen-newunit07.dat', STATUS=stat)
