...
! This test case also tests ERFC in constant expressions
implicit none
real(4), parameter :: e = 1.0e0, eres = erfc(e)
real(8), parameter :: d = 1.0d0, dres = erfc(d), dres2 = derfc(d)
real(16), parameter :: q = 1.0q0, qres = erfc(q), qres2 = qerfc(q)
