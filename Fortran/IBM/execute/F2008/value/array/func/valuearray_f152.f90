...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f152.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*								as well as another derived type component
...
dvt1 	= t1(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",t2(200))
dvt1_r 	= t1(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",t2(200))
...
subroutine sub11(arg,n)
	...
	arg	= t1(400,4*atan(1.0),.false.,(3*atan(1.0),7*atan(1.0)),"6pq94jv382",t2(300))
end subroutine
