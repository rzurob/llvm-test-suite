...
!*                                for an array of integer type(*2 kind)
...
subroutine sub23(arg)
	integer*2, DIMENSION(SIZEOFA) :: arg
	value arg
...
subroutine sub32(arg,arg2)
	integer*2 arg2(:)
	integer*2 , DIMENSION (size(arg2)) :: arg
	value arg
