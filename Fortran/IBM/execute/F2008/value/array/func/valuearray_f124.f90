...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f124.f
!*
...
!*                                for an array of logical type(*8 kind)
...
subroutine sub23(arg)
	logical*8, DIMENSION(SIZEOFA) :: arg
	value arg
...
subroutine sub32(arg,arg2)
	logical*8 arg2(:)
	logical*8 , DIMENSION (size(arg2)) :: arg
	value arg
