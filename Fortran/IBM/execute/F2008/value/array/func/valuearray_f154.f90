...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f154.f
!*
...
subroutine sub11(arg,n)
	...
	arg	= t2(400,4*atan(1.0),.false.,(3*atan(1.0),7*atan(1.0)),"6pq94jv382",300)
end subroutine	
...
subroutine sub32(arg,arg2)
	type(t2) arg2(:)
	type(t2) , DIMENSION (size(arg2)) :: arg
	value arg
