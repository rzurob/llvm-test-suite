...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f156.f
!*
...
!*								- the derived type tested is an extension of
...
type(t2) dvt1(10),dvt1_r(10)

	
dvt1 	= t2(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",200)
dvt1_r 	= t2(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",200)
