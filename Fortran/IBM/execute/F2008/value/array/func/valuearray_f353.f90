...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f353.f
!*
...
!*								- actual arguments passed are allocatable arrays
!* =============================================================================
...
integer*4 ::  i1(:),i1_r(10)
real  r1(:),r1_r(10)
complex*8  com1(:),com1_r(10)
character(SIZEOFA) c1(:),c1_r(10)
logical  l1(:),l1_r(10)
type(t1) dvt1(:),dvt1_r(10)

allocatable i1,r1,com1,c1,l1,dvt1
