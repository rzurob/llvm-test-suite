...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f153.f
!*
...
!*								- the derived type tested has intrinsic components 
!*								as well as a two level nested derived type component
...
dvt1 	= t1(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",t2(200,t3(300)))
dvt1_r 	= t1(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",t2(200,t3(300)))
...
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 11016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 11017
end do	
call sub12(dvt1)
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 12016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 12017
end do	
call sub13(dvt1)
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 13016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 13017
end do	
call sub14(dvt1)
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 14016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 14017
end do
call sub21(dvt1,10)
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 21016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 21017
end do
call sub22(dvt1)
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 22016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 22017
end do
call sub23(dvt1)
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 23016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 23017
end do
call sub24(dvt1)
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 24016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 24017
end do
...
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 31016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 31017
end do
...
do doCounter=1,SIZEOFA	  
	...
	if (dvt1(doCounter)%nesType%i2 	.ne. dvt1_r(doCounter)%nesType%i2)	error stop 32016
	if (dvt1(doCounter)%nesType%nesType2%i3 .ne. dvt1_r(doCounter)%nesType%nesType2%i3)	error stop 32017
end do
...
subroutine sub11(arg,n)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 11106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 11107
	end do	
	...
	arg	= t1(400,4*atan(1.0),.false.,(3*atan(1.0),7*atan(1.0)),"6pq94jv382",t2(300,t3(400)))
end subroutine	
...
subroutine sub12(arg)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 12106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 12107
	end do	
...
subroutine sub13(arg)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 13106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 13107
	end do	
...
subroutine sub14(arg)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 14106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 14107
	end do	
...
subroutine sub21(arg,n)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 21106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 21107
	end do	
...
subroutine sub22(arg)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 22106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 22107
	end do	
...
subroutine sub23(arg)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 23106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 23107
	end do	
...
subroutine sub24(arg)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 24106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 24107
	end do	
...
subroutine sub31(arg,arg2)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 31106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 31107
	end do	
...
subroutine sub32(arg,arg2)
	...
	do doCounter=1,SIZEOFA	  
		...
		if (arg(doCounter)%nesType%i2 	.ne. dvt1(doCounter)%nesType%i2)error stop 32106
		if (arg(doCounter)%nesType%nesType2%i3 .ne. dvt1(doCounter)%nesType%nesType2%i3) error stop 32107
	end do	
