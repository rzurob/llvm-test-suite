...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f101.f
!*
...
!*                                for an array of integer type(*1 kind)
...
subroutine sub23(arg)
	integer*1, DIMENSION(SIZEOFA) :: arg
	value arg
...
subroutine sub32(arg,arg2)
	integer*1 arg2(:)
	integer*1 , DIMENSION (size(arg2)) :: arg
	value arg
