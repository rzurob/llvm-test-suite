...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f103.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*                                for an array of integer type(*4 kind)
...
subroutine sub23(arg)
	integer*4, DIMENSION(SIZEOFA) :: arg
	value arg
...
subroutine sub32(arg,arg2)
	integer*4 arg2(:)
	integer*4 , DIMENSION (size(arg2)) :: arg
	value arg
