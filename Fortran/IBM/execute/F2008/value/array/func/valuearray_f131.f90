...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f131.f
!*
...
!*                                for an array of complex type(*8 kind)
...
call sub11(r1,10)
	...
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 1101
	end do
call sub12(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 1201
	end do
call sub13(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 1301
	end do
call sub14(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 1401
	end do
call sub21(r1,10)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 2101
	end do
call sub22(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 2201
	end do
call sub23(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 2301
	end do
call sub24(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 2401
	end do
call sub31(r1,r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 3101
	end do
call sub32(r1,r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x8(r1(doCounter),r1_r(doCounter))) error stop 3201
	end do
...
subroutine sub23(arg)
	complex*8, DIMENSION(SIZEOFA) :: arg
	value arg
...
subroutine sub32(arg,arg2)
	complex*8 arg2(:)
	complex*8 , DIMENSION (size(arg2)) :: arg
	value arg
