...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f157.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*								- the derived type tested is extended by two levels
...
!*								- the subroutine uses class(t1) to define the argument
!* =============================================================================
...
type(t3) dvt1(10),dvt1_r(10)


dvt1 	= t3(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",200,300)
dvt1_r 	= t3(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e",200,300)
...
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 11016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 11017
end do
call sub12(dvt1)
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 12016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 12017
end do
call sub13(dvt1)
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 13016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 13017
end do
call sub14(dvt1)
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 14016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 14017
end do
call sub21(dvt1,10)
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 21016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 21017
end do
call sub22(dvt1)
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 22016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 22017
end do
call sub23(dvt1)
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 23016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 23017
end do
call sub24(dvt1)
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 24016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 24017
end do
...
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 31016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 31017
end do
...
do doCounter=1,SIZEOFA
	...
	if (dvt1(doCounter)%i2 		.ne. 	dvt1_r(doCounter)%i2)			error stop 32016
	if (dvt1(doCounter)%i3 		.ne. 	dvt1_r(doCounter)%i3)			error stop 32017
end do
...
subroutine sub11(arg,n)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 11106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 11107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 11108
		end select
	end do
	...
	do doCounter=1,SIZEOFA
		arg(doCounter)%i1 = 400 + doCounter
		arg(doCounter)%r1 = 4*atan(1.0) + doCounter
		arg(doCounter)%l1 = .false.
		arg(doCounter)%c1 = (3*atan(1.0),7*atan(1.0)) + doCounter
		arg(doCounter)%char1 = "6pq94jv382"
		select type(arg)
			type is (t2)
				arg(doCounter)%i2 = 250 + doCounter
			type is (t3)
				arg(doCounter)%i2 = 250 + doCounter
				arg(doCounter)%i3 = 250 + doCounter
		end select
	end do
end subroutine
...
subroutine sub12(arg)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 12106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 12107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 12106
		end select
	end do
...
subroutine sub13(arg)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 13106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 13107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 13106
		end select
	end do
...
subroutine sub14(arg)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 14106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 14107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 14106
		end select
	end do
...
subroutine sub21(arg,n)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 21106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 21107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 21106
		end select
	end do
...
subroutine sub22(arg)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 22106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 22107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 22106
		end select
	end do
...
subroutine sub23(arg)
	class(t1), DIMENSION(SIZEOFA) :: arg
	value arg
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 23106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 23107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 23106
		end select
	end do
...
subroutine sub24(arg)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 24106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 24107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 24106
		end select
	end do
...
subroutine sub31(arg,arg2)
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 31106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 31107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 31106
		end select
	end do
...
subroutine sub32(arg,arg2)
	class(t1) arg2(:)
	class(t1) , DIMENSION (size(arg2)) :: arg
	value arg
	...
	do doCounter=1,SIZEOFA
		...
		select type(arg)
			type is (t2)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 32106
			type is (t3)
				if (arg(doCounter)%i2 		.ne. 	dvt1(doCounter)%i2)			error stop 32107
				if (arg(doCounter)%i3 		.ne. 	dvt1(doCounter)%i3)			error stop 32106
		end select
	end do
