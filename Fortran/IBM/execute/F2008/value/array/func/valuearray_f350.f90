...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f350.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*								- dummy declaration is done using the CONTIGUOUS attribute
!* =============================================================================
...
subroutine sub1_char(arg)
    character(SIZEOFA), CONTIGUOUS :: arg(:)
	value arg
