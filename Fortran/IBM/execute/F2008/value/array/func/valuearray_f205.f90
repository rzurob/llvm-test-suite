...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f205.f
!*
...
!*                   for arrays of different types of rank 7 with shape (5,5,5,5,5,5,5)
...
integer SZA, doc1,doC2,doc3,doC4,doc5,doC6,doC7
parameter (SZA = 5)

logical, external :: precision_x8, precision_r4
integer*4 i1(SZA,SZA,SZA,SZA,SZA,SZA,SZA),i1_r(SZA,SZA,SZA,SZA,SZA,SZA,SZA)
real  r1(SZA,SZA,SZA,SZA,SZA,SZA,SZA),r1_r(SZA,SZA,SZA,SZA,SZA,SZA,SZA)
complex*8  com1(SZA,SZA,SZA,SZA,SZA,SZA,SZA),com1_r(SZA,SZA,SZA,SZA,SZA,SZA,SZA)
character(SZA) c1(SZA,SZA,SZA,SZA,SZA,SZA,SZA),c1_r(SZA,SZA,SZA,SZA,SZA,SZA,SZA)
logical  l1(SZA,SZA,SZA,SZA,SZA,SZA,SZA),l1_r(SZA,SZA,SZA,SZA,SZA,SZA,SZA)
type(t1) dvt1(SZA,SZA,SZA,SZA,SZA,SZA,SZA),dvt1_r(SZA,SZA,SZA,SZA,SZA,SZA,SZA)
...
call sub1_r(r1)
	loop1r: do doc1=1,SZA
		loop2r: do doc2=1,SZA
			loop3r: do doc3=1,SZA
				loop4r: do doc4=1,SZA
					loop5r: do doc5=1,SZA
						loop6r: do doc6=1,SZA
							loop7r: do doc7=1,SZA
...
call sub1_com(com1)
	loop1c: do doc1=1,SZA
		loop2c: do doc2=1,SZA
			loop3c: do doc3=1,SZA
				loop4c: do doc4=1,SZA
					loop5c: do doc5=1,SZA
						loop6c: do doc6=1,SZA
							loop7c: do doc7=1,SZA
...
subroutine sub1_int(arg)
	...
	if (size(arg) .ne. SZA**7) 		error stop 101
	if ( any(lbound(arg) .ne. 1)) 		error stop 102
	if ( any(ubound(arg) .ne. SZA)) error stop 103
	if (rank(arg) .ne. 7) 				error stop 104
	if (any(shape(arg) .ne. SZA)) 	error stop 105
	arg = 200	
end subroutine
...
subroutine sub1_r(arg)
	...
	if (size(arg) .ne. SZA**7) 		error stop 201
	if ( any(lbound(arg) .ne. 1)) 		error stop 202
	if ( any(ubound(arg) .ne. SZA)) error stop 203
	if (rank(arg) .ne. 7) 				error stop 204
	if (any(shape(arg) .ne. SZA)) 	error stop 205	
	arg=4*atan(1.0)
end subroutine
...
subroutine sub1_com(arg)
	...
	if (size(arg) .ne. SZA**7) 		error stop 301
	if ( any(lbound(arg) .ne. 1)) 		error stop 302
	if ( any(ubound(arg) .ne. SZA)) error stop 303
	if (rank(arg) .ne. 7) 				error stop 304
	if (any(shape(arg) .ne. SZA)) 	error stop 305
...
subroutine sub1_char(arg)
	...
	if (size(arg) .ne. SZA**7) 		error stop 401
	if ( any(lbound(arg) .ne. 1)) 		error stop 402
	if ( any(ubound(arg) .ne. SZA)) error stop 403
	if (rank(arg) .ne. 7) 				error stop 404
	if (any(shape(arg) .ne. SZA)) 	error stop 405
	arg = "abcdefghij"	
end subroutine
...
subroutine sub1_lg(arg)
	...
	if (size(arg) .ne. SZA**7) 		error stop 501
	if ( any(lbound(arg) .ne. 1)) 		error stop 502
	if ( any(ubound(arg) .ne. SZA)) error stop 503
	if (rank(arg) .ne. 7) 				error stop 504
	if (any(shape(arg) .ne. SZA)) 	error stop 505
	arg = .false.
end subroutine	
...
subroutine sub1_dvt(arg)	
	...
	if (size(arg) .ne. SZA**7) 		error stop 601
	if ( any(lbound(arg) .ne. 1)) 		error stop 602
	if ( any(ubound(arg) .ne. SZA)) error stop 603
	if (rank(arg) .ne. 7) 				error stop 604
	if (any(shape(arg) .ne. SZA)) 	error stop 605
