...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f230.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*                                for passing an array constant of different types as actual argument
...
parameter (i1=100)
parameter (r1  =atan(1.0))
parameter (com1  =(atan(1.0),2*atan(1.0)))
parameter (c1  = "1234567890")
parameter (l1  = .true.)
parameter (dvt1 	= t1(100,atan(1.0)	, .true.,(2*atan(1.0),3*atan(1.0)),"1a3b5c7d9e"))
