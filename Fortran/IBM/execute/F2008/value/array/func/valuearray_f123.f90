...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f123.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*                                for an array of logical type(*4 kind)
...
subroutine sub23(arg)
	logical*4, DIMENSION(SIZEOFA) :: arg
	value arg
...
subroutine sub32(arg,arg2)
	logical*4 arg2(:)
	logical*4 , DIMENSION (size(arg2)) :: arg
	value arg
