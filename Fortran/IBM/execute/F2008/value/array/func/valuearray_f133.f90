...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f133.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*                                for an array of complex type(*32 kind)
...
logical, external :: precision_x3
complex*32  r1(10),r1_r(10)

r1  =(qatan(1.0_16),qatan(1.0_16))
r1_r=(qatan(1.0_16),qatan(1.0_16))

call sub11(r1,10)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 1101
	end do
call sub12(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 1201
	end do
call sub13(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 1301
	end do
call sub14(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 1401
	end do
call sub21(r1,10)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 2101
	end do
call sub22(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 2201
	end do
call sub23(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 2301
	end do
call sub24(r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 2401
	end do
call sub31(r1,r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 3101
	end do
call sub32(r1,r1)
	do doCounter=1,SIZEOFA
	if (.not. precision_x3(r1(doCounter),r1_r(doCounter))) error stop 3201
	end do
...
subroutine sub11(arg,n)
	...
	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 1110
	end do
...
subroutine sub12(arg)
	...
	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 1210
	end do
...
subroutine sub13(arg)
    complex*32 :: arg(SIZEOFA)
	value arg

	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 1310
	end do
...
subroutine sub14(arg)
	...
	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 1410
	end do
...
subroutine sub21(arg,n)
	integer n
	complex*32, DIMENSION(n) :: arg
	value arg

	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 2110
	end do
...
subroutine sub22(arg)
	complex*32, DIMENSION(10) :: arg
	value arg

	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 2210
	end do
...
subroutine sub23(arg)
	complex*32, DIMENSION(SIZEOFA) :: arg
	value arg

	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 2310
	end do
...
subroutine sub24(arg)
	complex*32, DIMENSION(:) :: arg
	value arg

	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 2410
	end do
...
subroutine sub31(arg,arg2)
	complex*32 arg2(:)
	complex*32 arg(size(arg2))
	value arg

	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 3110
	end do
...
subroutine sub32(arg,arg2)
	complex*32 arg2(:)
	complex*32 , DIMENSION (size(arg2)) :: arg
	value arg

	do doCounter=1,SIZEOFA
		if (.not. precision_x3(arg(doCounter),r1(doCounter))) error stop 3210
	end do
