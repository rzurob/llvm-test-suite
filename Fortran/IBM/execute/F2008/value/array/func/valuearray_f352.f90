...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f352.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*								- actual arguments passed are pointers with CONTIGUOUS attribute
!* =============================================================================
...
integer*4 ::  i1(10),i1_r(10),i1_p(:)
real  r1(10),r1_r(10),r1_p(:)
complex*8  com1(10),com1_r(10),com1_p(:)
character(SIZEOFA) c1(10),c1_r(10),c1_p(:)
logical  l1(10),l1_r(10),l1_p(:)
type(t1) dvt1(10),dvt1_r(10),dvt1_p(:)
pointer i1_p,r1_p,com1_p,c1_p,l1_p,dvt1_p
contiguous i1_p,r1_p,com1_p,c1_p,l1_p,dvt1_p
target i1,r1,com1,c1,l1,dvt1
