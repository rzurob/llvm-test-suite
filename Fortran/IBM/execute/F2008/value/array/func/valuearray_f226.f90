...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f226.f
!*
...
!*                         		for passing arrays for different types using vector subscripts
...
INTEGER, DIMENSION(5) :: VECTOR= (/ 5,4,3,2,1 /)
logical, external :: precision_x8, precision_r4
integer*4 i1(5),i1_r(5)
real  r1(5),r1_r(5)
complex*8  com1(5),com1_r(5)
character(10) c1(5),c1_r(5)
logical  l1(5),l1_r(5)
type(t1) dvt1(5),dvt1_r(5)

i1  =(/ 6,7,8,9,10 /)
i1_r=(/ 6,7,8,9,10 /)

r1  =(/ atan(1.0),2*atan(1.0),3*atan(1.0),4*atan(1.0),5*atan(1.0) /)
r1_r=(/ atan(1.0),2*atan(1.0),3*atan(1.0),4*atan(1.0),5*atan(1.0) /)
...
subroutine sub1_int(arg)
	...
	do doCounter=1,size(arg)
		if (arg((SIZEOFA+1)-doCounter) .ne. i1(doCounter)) error stop 110
	end do		
...
subroutine sub1_r(arg)
	...
	value arg
	do doCounter=1,size(arg)
		if (.not. precision_r4(arg((SIZEOFA+1)-doCounter),r1(doCounter))) error stop 210
	end do	
