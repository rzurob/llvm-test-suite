...
!*  ============================================================================
!*
!*  TEST CASE NAME             : F2008/value/array/func/valuearray_f104.f
!*
!*  DATE                       : 2015-09-24
!*
...
!*                                for an array of integer type(*8 kind)
...
subroutine sub23(arg)
	integer*8, DIMENSION(SIZEOFA) :: arg
	value arg
...
subroutine sub32(arg,arg2)
	integer*8 arg2(:)
	integer*8 , DIMENSION (size(arg2)) :: arg
	value arg
