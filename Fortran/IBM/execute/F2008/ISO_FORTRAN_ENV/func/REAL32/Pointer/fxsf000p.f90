...
C
      INTEGER(REAL32)   I4ARG1,I4ARG2,I4ARG_B1,I4ARG_B2 
...
C     POINTER VARIABLES USED IN STATEMENT FUNCTION EXPRESSIONS
      INTEGER(REAL32) I4VAR1, I4VAR2, I4ARR(2)
      INTEGER(REAL32) I4VAR_B1, I4VAR_B2, I4ARR_B(2)
      POINTER (I4VAR1P,I4VAR1), (I4VAR2P,I4VAR2), (I4ARRP,I4ARR) 
      INTEGER(REAL32) SF_RETURN, RESET          ! STATEMENT FUNCTION VALUES
      POINTER (P, SF_RETURN) 
...
C
      INTEGER(REAL32) SF01,SF03, SF11,SF13, SF21,SF23
