C#######################################################################
C SCCS ID Information
C %W%, %I%
C Extract Date/Time: %D% %T%
C Checkin Date/Time: %E% %U%
C#######################################################################
C***************************************************************************
C %START
C %MAIN: YES
...
C***********************************************************************
C* =================================================================== *
C* XLF FORTRAN TEST CASE                         IBM INTERNAL USE ONLY *
C* =================================================================== *
C*                                                                     *
C* TEST CASE TITLE : Statement functions: POINTER 
C*                                                                     *
C* TEST CASE NAME             : fxsf000p                               *
C*                                                                     *
C* PROGRAMMER                 : Steve Yau                              *
C*                                                                     *
C* DATE                       : 25 October 1990                        *
C*                                                                     *
C* ORIGIN                     : IBM Canada Laboratory                  *
C*                                                                     *
...
C
      INTEGER(INT8)   I4ARG1,I4ARG2,I4ARG_B1,I4ARG_B2 
...
C     POINTER VARIABLES USED IN STATEMENT FUNCTION EXPRESSIONS
      INTEGER(INT8) I4VAR1, I4VAR2, I4ARR(2)
      INTEGER(INT8) I4VAR_B1, I4VAR_B2, I4ARR_B(2)
      POINTER (I4VAR1P,I4VAR1), (I4VAR2P,I4VAR2), (I4ARRP,I4ARR) 
      INTEGER(INT8) SF_RETURN, RESET          ! STATEMENT FUNCTION VALUES
      POINTER (P, SF_RETURN) 
...
C
      INTEGER(INT8) SF01,SF03, SF11,SF13, SF21,SF23
