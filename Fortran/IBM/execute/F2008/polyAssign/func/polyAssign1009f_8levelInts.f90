...
!* ===================================================================
!*
!* TEST CASE TITLE              : F2008/polyAssign/func/polyAssign1009f_8levelInts.f
!*
...
!*                              : Use integer*1, integer*2, integer*4, integer*8 to the derived type to test polymorphic assignment with different integers.
!*---------------------------------------------------------------------
