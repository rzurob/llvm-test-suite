...
!* ===================================================================
!*
!* TEST CASE TITLE              : F2008/polyAssign/func/polyAssign1029f_arrDim2LHSunallocSameTypeSameShape.f
!*
...
Program polyAssign1029
    ...
    if (a1(0,1)%i1 /= 2) error stop 245
    if (a1(0,2)%i1 /= 2) error stop 246
    if (a1(0,3)%i1 /= 2) error stop 247
    if (a1(0,4)%i1 /= 2) error stop 248
    if (a1(0,5)%i1 /= 2) error stop 249
    if (a1(0,7)%i1 /= 2) error stop 250
    if (a1(0,8)%i1 /= 2) error stop 251
    if (a1(0,9)%i1 /= 2) error stop 252
    if (a1(0,10)%i1 /= 2) error stop 253
