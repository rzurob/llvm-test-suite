...
!* ===================================================================
!*
!* TEST CASE TITLE              : F2008/polyAssign/func/polyAssign1023f_LHSallocInitialization.f
!*
...
!*
!* DESCRIPTION                  
!*                              : Test the basic situation that the LHS array is allocated, and the initialization for LHS with base derived type.
