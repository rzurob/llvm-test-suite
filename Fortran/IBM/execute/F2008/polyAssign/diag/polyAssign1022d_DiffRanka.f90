...
Program polyAssign1022d
    ...
    a1 = b1 !<-- Operands must be conformable
    a2 = b2 !<-- Operands must be conformable
    a1 = b2 !<-- Operands must be conformable
    a2 = b1 !<-- Operands must be conformable
End
