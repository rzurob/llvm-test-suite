!*  ============================================================================
!*
!*  TEST CASE NAME             : assumedShapeCoarray06.f
!*
!*  DATE                       : 2011-02-18
!*
...
program main
   ...
   call asc_L_1(L_1_2(1:SIZE/2))
   call asc_L_1(L_1_3(1:SIZE/2))
   call asc_L_1(L_1_4(1:SIZE/2))
   call asc_L_1(L_1_5(1:SIZE/2))
   call asc_L_1(L_1_6(1:SIZE/2))
   call asc_L_2(L_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_2(L_2_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_2(L_2_3(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_2(L_2_4(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_2(L_2_5(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_2(L_2_6(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_3(L_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_3(L_3_2(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_3(L_3_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_3(L_3_4(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_3(L_3_5(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_L_3(L_3_6(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)

   call asc_C_1(C_1(1:SIZE/2))
   call asc_C_1(C_1_2(1:SIZE/2))
   call asc_C_1(C_1_3(1:SIZE/2))
   call asc_C_1(C_1_4(1:SIZE/2))
   call asc_C_1(C_1_5(1:SIZE/2))
   call asc_C_1(C_1_6(1:SIZE/2))
   call asc_C_2(C_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_2(C_2_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_2(C_2_3(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_2(C_2_4(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_2(C_2_5(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_2(C_2_6(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_3(C_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_3(C_3_2(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_3(C_3_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_3(C_3_4(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_3(C_3_5(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_C_3(C_3_6(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)

   call asc_I_1(I_1(1:SIZE/2))
   call asc_I_1(I_1_2(1:SIZE/2))
   call asc_I_1(I_1_3(1:SIZE/2))
   call asc_I_1(I_1_4(1:SIZE/2))
   call asc_I_1(I_1_5(1:SIZE/2))
   call asc_I_1(I_1_6(1:SIZE/2))
   call asc_I_2(I_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_2(I_2_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_2(I_2_3(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_2(I_2_4(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_2(I_2_5(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_2(I_2_6(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_3(I_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_3(I_3_2(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_3(I_3_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_3(I_3_4(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_3(I_3_5(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_I_3(I_3_6(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)

   call asc_R_1(R_1(1:SIZE/2))
   call asc_R_1(R_1_2(1:SIZE/2))
   call asc_R_1(R_1_3(1:SIZE/2))
   call asc_R_1(R_1_4(1:SIZE/2))
   call asc_R_1(R_1_5(1:SIZE/2))
   call asc_R_1(R_1_6(1:SIZE/2))
   call asc_R_2(R_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_2(R_2_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_2(R_2_3(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_2(R_2_4(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_2(R_2_5(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_2(R_2_6(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_3(R_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_3(R_3_2(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_3(R_3_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_3(R_3_4(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_3(R_3_5(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_R_3(R_3_6(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)

   call asc_COMPLEX_1(COMPLEX_1(1:SIZE/2))
   call asc_COMPLEX_1(COMPLEX_1_2(1:SIZE/2))
   call asc_COMPLEX_1(COMPLEX_1_3(1:SIZE/2))
   call asc_COMPLEX_1(COMPLEX_1_4(1:SIZE/2))
   call asc_COMPLEX_1(COMPLEX_1_5(1:SIZE/2))
   call asc_COMPLEX_1(COMPLEX_1_6(1:SIZE/2))
   call asc_COMPLEX_2(COMPLEX_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_2(COMPLEX_2_2(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_2(COMPLEX_2_3(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_2(COMPLEX_2_4(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_2(COMPLEX_2_5(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_2(COMPLEX_2_6(1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_3(COMPLEX_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_3(COMPLEX_3_2(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_3(COMPLEX_3_3(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_3(COMPLEX_3_4(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_3(COMPLEX_3_5(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
   call asc_COMPLEX_3(COMPLEX_3_6(1:SIZE/2, 1:SIZE/2, 1:SIZE/2), SIZE/2)
