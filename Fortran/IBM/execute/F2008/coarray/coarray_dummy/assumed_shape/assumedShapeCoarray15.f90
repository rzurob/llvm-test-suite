!*  ============================================================================
!*
!*  TEST CASE NAME             : assumedShapeCoarray15.f
!*
!*  DATE                       : 2011-02-18
!*
...
module asc
   ...
   subroutine verifyCopy(A, image, left_image, right_image)
      ...
      S = SIZE(A)
      do i = 1, S/3
         if (A(i)[left_image] .NEQV. A(i)[image]) then
            print *,A(i)[left_image]," .NEQV. ",A(i)[image]
            ERROR STOP 101
         else if (A(i+S-S/3)[right_image] .NEQV. A(i+S-S/3)[image]) then
            print *,A(i+S-S/3)[right_image]," NEQV ",A(i+S-S/3)[image]
            ERROR STOP 102
         end if
      end do
