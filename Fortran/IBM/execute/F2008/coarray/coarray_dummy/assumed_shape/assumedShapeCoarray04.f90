...
!*  ============================================================================
!*
!*  TEST CASE NAME             : assumedShapeCoarray04.f
!*  TEST CASE TITLE            : 
!*
...
program main
   ...
   do x = SIZE/4+1, SIZE-SIZE/4
      ...
      C_1(x) = achar(A + (x-(SIZE/4)) + num_images())
      I_1(x) = (x-(SIZE/4)) + num_images()
      R_1(x) = (x-(SIZE/4)) + num_images() * 1.5
   ...
   do x = SIZE/4+1, SIZE-SIZE/4
      do y = SIZE/4+1, SIZE-SIZE/4
         ...
         C_2(x, y) = achar(A + (x-(SIZE/4)) + (y-(SIZE/4)) + num_images())
         I_2(x, y) = (x-(SIZE/4)) + (y-(SIZE/4)) + num_images()
         R_2(x, y) = (x-(SIZE/4)) + (y-(SIZE/4)) + num_images() * 2.5
         COMPLEX_2(x, y) = ((x-(SIZE/4)) + (y-(SIZE/4)) + num_images() * 2.5, (x-(SIZE/4)) + (y-(SIZE/4)) + num_images() * 1.5)
      end do
   end do
   do x = SIZE/4+1, SIZE-SIZE/4
      do y = SIZE/4+1, SIZE-SIZE/4
         do z = SIZE/4+1, SIZE-SIZE/4
            ...
            C_3(x, y, z) = achar(A + (x-(SIZE/4)) + (y-(SIZE/4)) + (z-(SIZE/4)) + num_images())
            I_3(x, y, z) = (x-(SIZE/4)) + (y-(SIZE/4)) + (z-(SIZE/4)) + num_images()
            R_3(x, y, z) = (x-(SIZE/4)) + (y-(SIZE/4)) + (z-(SIZE/4)) + num_images() * 3.5
            COMPLEX_3(x, y, z) = ((x-(SIZE/4)) + (y-(SIZE/4)) + (z-(SIZE/4)) + num_images() * 3.5, (x-(SIZE/4)) + (y-(SIZE/4)) + (z-(SIZE/4)) + num_images() * 2.5)
         end do
      end do
   end do
   ...
   call asc_L_3(L_3(SIZE/4+1:SIZE-SIZE/4, SIZE/4+1:SIZE-SIZE/4, SIZE/4+1:SIZE), SIZE/4)
