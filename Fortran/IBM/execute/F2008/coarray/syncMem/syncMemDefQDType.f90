...
!*  ============================================================================
!*
!*  TEST CASE NAME             : syncMemDefQDType
!*
!*  PROGRAMMER                 : dforster
!*  DATE                       : 2010-09-22
...
!*  SECONDARY FUNCTIONS TESTED : Define followed by Query of dynamic type
...
!*  precedes its query of Q's variable type, once the handshake is done.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program syncMemDefQDType
    ...
    case (Q)
      ...
      ! Query dynamic type
      dtype = getType(covar(L1,L2)[P])
      if (dtype /= getType('x')) then
        print *, curImage, 'type:  ', dtype, '; expecting: ', getType('x')
        error stop 10
      end if
