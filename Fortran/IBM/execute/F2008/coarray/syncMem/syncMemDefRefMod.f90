...
!*  ============================================================================
!*
!*  TEST CASE NAME             : syncMemDefRefMod
!*
!*  DATE                       : 2010-09-22
!*
!*  PRIMARY FUNCTIONS TESTED   : CAF SYNC MEMORY
!*  SECONDARY FUNCTIONS TESTED : sync memory in different contexts: main and module subroutine
!*  REFERENCE                  : Feature Number 351605.25
!*  REQUIRED COMPILER OPTIONS  : -qcaf -qcaf=images=<num>
!*  ADAPTED FROM               : syncMemDefRefExt
!*
!*  DESCRIPTION
!*
!*  Like syncMemDefRefExt, but the reference and the sync memory are now in an module subroutine.
!*  This works well, since the coarray is already in the module.
!*
!* ============================================================================
...
module defRefMod
  ...
  contains
	...
	end subroutine doModReference

end module defRefMod


program syncMemDefRefMod
    use :: defRefMod
    ...
    if (curImage == P) then
      ...
      ! Step 3: signal Q that the update to iCovar is complete
