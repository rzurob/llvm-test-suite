...
!*  ADAPTED FROM               : saModuleNIntern (<-saMainNModule<-saProgramUnit<-saBasicSync<-saBasic)
!*
!*  DESCRIPTION
!*
!*  Verify that all images wait at the SYNC ALL until all have arrived there,
!*  even if the SYNC ALL appears in different places (an external or an internal procedure).
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module saInternNExternMod
...
end module saInternNExternMod


program saInternNExtern

   use :: saInternNExternMod
   implicit none
