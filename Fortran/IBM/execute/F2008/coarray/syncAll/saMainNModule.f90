...
!*  ============================================================================
!*
!*  TEST CASE NAME             : saMainNModule
!*
!*  DATE                       : 2010-07-26
!*
!*  PRIMARY FUNCTIONS TESTED   : CAF SYNC ALL
!*  SECONDARY FUNCTIONS TESTED : synchronisation from main program and module procedures
!*  REFERENCE                  : Feature Number 379697
!*  REQUIRED COMPILER OPTIONS  : -qcaf -qcaf=images=<num>
!*  ADAPTED FROM               : saProgramUnit (<-saBasicSync<-saBasic)
!*
!*  DESCRIPTION
!*
!*  Verify that all images wait at the SYNC ALL until all have arrived there,
!*  even if the SYNC ALL appears in different places (a module procedure or the main program).
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

module saMainNModuleMod
...
end module saMainNModuleMod


program saMainNModule

   use :: saMainNModuleMod
   implicit none
   ...
   !! We have 3 different contexts. In each we tell the buddy on the
   !! right that we have arrived, then sync.
