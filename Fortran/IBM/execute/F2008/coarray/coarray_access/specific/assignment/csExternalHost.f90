...
!*  SECONDARY FUNCTIONS TESTED : in procedures internal to external procedure, assign host-associated constants and variables of various intrinsic types to host-associated coarray variables and assign coarray variables to host-associated variables
!*  ADAPTED FROM               : csExternal (<-csSimpleInteger<-csSimpleLogical)
!*
!*  DESCRIPTION
!*
!*  Assign simple values to integer coarray scalars and arrays of different kinds
!*  in a subroutine internal to an external subroutine.  The coarrays are defined
!*  only in the external subroutine -> host association from within the internal procedure.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program csExternalHost

    implicit none
    external ext
    call ext
end program csExternalHost
