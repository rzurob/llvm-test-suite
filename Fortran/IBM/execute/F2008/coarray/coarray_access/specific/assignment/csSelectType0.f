...
contains
  ...
  subroutine vhandle(p)
    ...
    select type (v => p)
       ...
       type is (integer(1))
          v = [1,1,2,3,5,8,13,21,34,min1]
          ia1 = v
          v = 0
          if (any(ia1/=[1,1,2,3,5,8,13,21,34,min1])) error stop 16
          v = ia1
          if (any(v/=[1,1,2,3,5,8,13,21,34,min1])) error stop 17
       ...
       type is (integer(2))
          ...
          ia2(1:9:2) = v(1:9:2)
          v = -1
          if (any(ia2/=[v2,0,v2,0,v2,0,v2,0,v2,0])) error stop 26
          v = ia2
          if (any(v/=[v2,0,v2,0,v2,0,v2,0,v2,0])) error stop 27
       ...
       type is (integer(4))
          ...
          v = 0
          if (any(ia4/=[0,min4,0,min4,0,min4,0,min4,0,min4])) error stop 46
          v = ia4
          if (any(v/=[0,min4,0,min4,0,min4,0,min4,0,min4])) error stop 47
       ...
       type is (integer(8))
          ...
          ia8(9:1:-2) = v(1:5)
          v = 0
          if (any(ia8/=[min8,0,min8,0,min8,0,min8,0,min8,0])) error stop 86
          v = ia8
          if (any(v/=[min8,0,min8,0,min8,0,min8,0,min8,0])) error stop 87
