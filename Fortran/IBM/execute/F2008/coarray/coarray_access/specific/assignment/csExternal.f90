...
!*  ============================================================================
!*
!*  TEST CASE NAME             : csExternal
!*
!*  DATE                       : 2010-10-04
!*
!*  PRIMARY FUNCTIONS TESTED   : CAF coarray access (specific) - assignment
!*  SECONDARY FUNCTIONS TESTED : in external procedure, assign constants and variables of various intrinsic types to coarray variables and assign coarray variables to variables, all of which are defined in the external procedure
