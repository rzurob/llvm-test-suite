...
!*  ============================================================================
!*
!*  TEST CASE NAME             : csAllocatableIntrinsic
!*
!*  PROGRAMMER                 : dforster
!*  DATE                       : 2010-10-04
...
!*  SECONDARY FUNCTIONS TESTED : in main program, assign values in allocatable intrinsic variables to coarray variables and vice-versa
!*  ADAPTED FROM               : csSimpleInteger (<-csSimpleLogical)
!*
!*  DESCRIPTION
!*
!*  Assign simple values from allocatable variables to integer coarray scalars and
!*  arrays of different kinds in the main program.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program csAllocatableIntrinsic
    ...
    integer(1) :: v1, itmp1, iatmp1(:)
    integer(2) :: v2, itmp2, iatmp2(:)
    integer(4) :: v4, itmp4, iatmp4(:)
    integer(8) :: v8, itmp8, iatmp8(:)

    allocatable :: v1, iatmp1, v2, iatmp2, v4, iatmp4, v8, iatmp8
...
end program csAllocatableIntrinsic
