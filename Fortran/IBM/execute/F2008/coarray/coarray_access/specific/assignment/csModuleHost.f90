...
!*  SECONDARY FUNCTIONS TESTED : in procedures internal to module procedure, assign host-associated constants and variables of various intrinsic types to host-associated coarray variables and assign coarray variables to host-associated variables
!*  ADAPTED FROM               : csMainHost (<-csSimpleInteger<-csSimpleLogical)
!*
!*  DESCRIPTION
!*
!*  Call a subroutine defined in a module to do the work: the module subroutine
!*  invokes another subroutine, internal to it, which accesses coarray scalars
!*  and arrays of different kinds from the module procedure.
!*
!* ============================================================================
