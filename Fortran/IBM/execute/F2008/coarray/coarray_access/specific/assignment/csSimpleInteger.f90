...
!*  ============================================================================
!*
!*  TEST CASE NAME             : csSimpleInteger
!*
!*  DATE                       : 2010-10-04
!*
!*  PRIMARY FUNCTIONS TESTED   : CAF coarray access (specific) - assignment
!*  SECONDARY FUNCTIONS TESTED : assign INTEGER noncoarray variables to coarray variables (scalar and array) in main program and vice-versa
