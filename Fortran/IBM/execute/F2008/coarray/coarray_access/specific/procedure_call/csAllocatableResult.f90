...
!*  ADAPTED FROM               : csAllocatableDT ()
!*
!*  DESCRIPTION
!*
!*  Allocate a structure, fill it from coarrays, and return it as a function result.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program csAllocatableResult
...
contains
  ...
  type(der2(3,4)) function copy(v2, v3, v4)
    ...
    real(4) :: v4[*]
    allocatable :: copy
    allocate(copy, source = der2(3,4)(v2,v3,v4))
  end function copy
...
end program csAllocatableResult
