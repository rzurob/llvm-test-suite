...
!*  SECONDARY FUNCTIONS TESTED : pass CHARACTER scalar coarray actual argument to procedure which examines it and modifies it
!*  ADAPTED FROM               : csSimpleCharacter (<-csSimpleInteger<-csSimpleLogical)
!*
!*  DESCRIPTION
!*
