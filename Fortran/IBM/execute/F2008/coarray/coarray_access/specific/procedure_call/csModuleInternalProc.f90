...
!*  ============================================================================
!*
!*  TEST CASE NAME             : csModuleInternalProc
!*
!*  PROGRAMMER                 : dforster
!*  DATE                       : 2010-10-04
...
!*  SECONDARY FUNCTIONS TESTED : pass coarray actual arguments to module procedure, which passes it on and modifies or processes it in an internal procedure
!*  ADAPTED FROM               : csIntentInOutArg (<-csCharacterArg<-csSimpleCharacter<-csSimpleInteger<-csSimpleLogical)
!*
!*  DESCRIPTION
!*
!*  In the main program, invoke module procedures and procedures internal to them
...
end program csModuleInternalProc
