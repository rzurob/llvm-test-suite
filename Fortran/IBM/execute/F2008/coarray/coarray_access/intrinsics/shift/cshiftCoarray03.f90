!*  ============================================================================
!*
!*  TEST CASE NAME             : cshiftCoarray03.f
!*
!*  DATE                       : 2010-12-16
!*
...
!*
!*  Using SYNC IMAGES(*) so that image 1 can update the data
!*  before read by others and SYNC IMAGES(1) so that all other
!*  images wait for image 1 before reading the data
!*
!* ============================================================================
...
program main
   ...
   if (this_image() .EQ. 1) then
      ...
      M_I = M_I - this_image()
      do row = 1, SIZE
         if (M_I(row) .NE. M_I(row)[1]) ERROR STOP 103
      end do
   end if
   ...
   if (this_image() .EQ. 1) then
      ...
      do row = 1, SIZE
         do col = 1, SIZE
            do z = 1, SIZE
               if (X_I(z,col,row) .NE. X_I(z,col,row)[1]) ERROR STOP 107
            end do
         end do
      end do
   end if
   ...
   if (this_image() .EQ. 1) then
      ...
      M_R = M_R - this_image()
      do row = 1, SIZE
         if (M_R(row) .NE. M_R(row)[1]) ERROR STOP 203
      end do
   end if
   ...
   if (this_image() .EQ. 1) then
      ...
      do row = 1, SIZE
         do col = 1, SIZE
            do z = 1, SIZE
               if (X_R(z,col,row) .NE. X_R(z,col,row)[1]) ERROR STOP 207
            end do
         end do
      end do
   end if
   ...
   if (this_image() .EQ. 1) then
      ...
      M_C = M_C - this_image()
      do row = 1, SIZE
         if (M_C(row) .NE. M_C(row)[1]) ERROR STOP 303
      end do
   end if
   ...
   if (this_image() .EQ. 1) then
      ...
      do row = 1, SIZE
         do col = 1, SIZE
            do z = 1, SIZE
               if (X_C(z,col,row) .NE. X_C(z,col,row)[1]) ERROR STOP 307
            end do
         end do
      end do
   end if
