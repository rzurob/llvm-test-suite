...
!*  ===================================================================
!*
!*  TEST CASE NAME             : sync_images_app_2.f
!*  TEST CASE TITLE            :
!*
!*  PROGRAMMER                 : Feng Ye
!*  DATE                       : July 11 2011
...
!*  
!*  Divide images into 3 teams: the number of images in each team differs 
!*  and achieve synchronization among the teams. 
!*  but make one team not participate in synchronization 
!*  ()
!*
!234567890123456789012345678901234567890123456789012345678901234567890
  ...
  INTEGER :: j
    ...
    IF ( me .EQ. 1) THEN   ! team 1
      ! team 1 not in synchronization 
    ELSE IF (me .EQ. num_img) THEN  !team 2
      SYNC IMAGES(images_set(2:num_img-1))
    ELSE  ! team 3 - a bigger team
      SYNC IMAGES(images_set(num_img))
    END IF

    IF ((me .GT. 1) .AND. (me .LT. num_img) ) THEN 
