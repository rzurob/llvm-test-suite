...
!                                corank = 4, explicit shape, assumed-size and
!                                assumed-shape 
!*
!*  KEY.or.(S)                 :
!*  TARGET(S)                  :
...
program coindex_procedure_011f
    implicit none
    integer, save ::caf1[1,4,1,5:*], caf2(10)[2,2,2,*]
    real(4), save ::caf3(10)[2,2,2,*]
    real(4) ::array1(10)
    real(4) sum1, sum2, sum3, t1, t2
    integer me, num, left, i, j, k, l, m, n, i1
    interface
    ...
    do i = 1, 2 
        do j = 1, 2
            do k = 1,2
                do l = 1,2
                    n = image_index(caf3, [i,j,k,l]) 
                    sum1 = 0.0
                    sum2 = 0.0
                    do m=1,10
                        sum2 = caf3(m)[i,j,k,l] + sum2
                    end do
                    call arraysum1(caf3(:)[i,j,k,l], 10, sum1)
                    print *, "caf3(:)[",i,j,k,l,"] =", sum1, ",", sum2
                    sum3 = arraysum2(caf3(:)[i,j,k,l],10)
                    if ( .not. precision_r4(sum1*2, sum2+sum3)) then
                        print *, "++++++++++++++++++++++++"
