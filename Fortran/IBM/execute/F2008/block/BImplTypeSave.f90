...
!*  SECONDARY FUNCTIONS TESTED : implicit typing (var appears in SAVE statement)
...
!*  "SAVE") have a type prescribed by the IMPLICIT statement.
!*  Now introduce variables via a SAVE statement, some identical in name
!*  to variables in the main program, and some unique to the block.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program BImplTypeSave
