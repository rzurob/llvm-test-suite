...
!*  "POINTER") have a type prescribed by the IMPLICIT statement.
!*  Now introduce variables via a POINTER statement, some identical in name
!*  to variables in the main program, and some unique to the block.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program BImplTypePtr
  ...
  block
    pointer :: b1, b6, i3, d4, s5, s7

    allocate(b1, b6, i3, d4, s5, s7)
