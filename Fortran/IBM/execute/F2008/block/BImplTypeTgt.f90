...
!*  ============================================================================
!*
!*  TEST CASE NAME             : BImplTypeTgt
!*
!*  DATE                       : 2010-12-14
!*
!*  PRIMARY FUNCTIONS TESTED   : F2008 BLOCK
!*  SECONDARY FUNCTIONS TESTED : implicit typing (var appears in TARGET statement)
...
!*  "TARGET") have a type prescribed by the IMPLICIT statement.
!*  Now introduce variables via a TARGET statement, some identical in name
!*  to variables in the main program, and some unique to the block.
!*
!* ============================================================================
!234567890123456789012345678901234567890123456789012345678901234567890123456789

program BImplTypeTgt
