...
!*  SECONDARY FUNCTIONS TESTED : block in different contexts (internal procedure)
!*
!*  DESCRIPTION
!*
!*  block in different contexts (internal procedure)
!*
!* ============================================================================
