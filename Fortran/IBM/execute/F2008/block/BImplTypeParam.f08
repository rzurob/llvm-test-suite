...
program BImplTypeParam
  ...
  b1 = book(1949,'1984',['Blair, Eric Arthur (aka George Orwell)'])
  ...
  block
    parameter (b1 = book(1968,'2001: A Space Odyssey',['Clarke, Arthur C.']))
    parameter (b6 = book(1532,'Il Principe', ['Machiavelli, Niccolo di Bernardo dei']))
    parameter (i3 = 7654321, d4 = 3.14159265358979323_8, s5 = 'Gnitset', s7 = 'extras')
