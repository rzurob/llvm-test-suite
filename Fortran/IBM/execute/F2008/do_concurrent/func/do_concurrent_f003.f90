...
!2345678901234567890123456789012345678901234567890123456789012345678901234567890
      program main
        ...
        integer, allocatable :: i_res(:), i_arr(:), i_arr2(:)
        integer*4, allocatable :: i_arr3(:), i_res2(:,:)
        integer*2, allocatable :: i_res3(:), i_res4(:), i_res5(:,:)
        logical :: lvar = .true.

        allocate(i_res(5), i_arr(5), i_arr2(5), i_arr3(10), i_res2(5,5))
        allocate(i_res3(10), i_res4(10), i_res5(5,5))
        i_res = 0
        i_arr = (/ 11, 22, 33, 44, 55 /)
        i_arr2 = 0
        i_arr3 = 10
        i_res2 = 0
        i_res3 = 0
