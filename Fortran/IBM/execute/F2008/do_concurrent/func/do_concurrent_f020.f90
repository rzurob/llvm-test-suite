...
SUBROUTINE sub1( array,n )
   ...
   DO CONCURRENT ( integer*1 :: in1 = 1:n )
      array(in1) = in1
   END DO
END SUBROUTINE
...
SUBROUTINE sub2( array,n )
   ...
   DO CONCURRENT ( integer*2 :: in1 = -10:n )
      array(in1) = in1
...
SUBROUTINE sub3( array,n )
   ...
   DO CONCURRENT ( integer*4 ::in1 = 4:n:4 )
...
SUBROUTINE sub4( array,m,n )
   ...
   DO CONCURRENT ( integer*4 ::in1 = 1:m, in2 = 1:n )
...
SUBROUTINE sub4b( array,m,n )
   ...
   DO CONCURRENT (integer*2 :: in1 = 1:m )
      array(in1,:) = in1
   END DO
END SUBROUTINE
...
SUBROUTINE sub5( array,m,n )
   ...
   DO CONCURRENT ( integer*4 ::in1 = -5:m, in2 = -2:n )
     array(in1,in2) = in1+in2
   END DO
...
SUBROUTINE sub6( array,m,n )
   ...
   DO CONCURRENT ( integer*4::in1 = -5:m )
...
SUBROUTINE sub10( array,m,n )
   ...
   DO CONCURRENT ( integer*4:: in1 = 1:m, in2 = 1:n:n )
      array(in1,in2) = in1
